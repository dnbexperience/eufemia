import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{B as n}from"./index-DdG6L_K8.js";import r from"./demos-C_FzSXWP.js";var i=e(t());function a(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,ul:`ul`,...n(),...e.components};return(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(t.h2,{children:`Import`}),`
...
`,(0,i.jsxs)(t.p,{children:[`To get autocomplete and compile-time checking on the `,(0,i.jsx)(t.code,{children:`itemPath`}),` prop, derive the item type from your registered root data with `,(0,i.jsx)(t.code,{children:`TypedItemField`}),`. See `,(0,i.jsx)(t.a,{href:`/uilib/extensions/forms/typed-paths/#type-checking-itempath-inside-iterate`,children:`Type-checked paths`}),`.`]}),`
