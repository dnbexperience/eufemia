import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{K as n}from"./index-ppRu2ktv.js";import r from"./ListDataContextComponents-BWJ3mCfK.js";var i=e(t());function a(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,p:`p`,pre:`pre`,...n(),...e.components};return(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(t.h1,{children:`DataContext`}),`
...
`,(0,i.jsxs)(t.p,{children:[`The reference to a specific field's value in the dataset is given with a property called `,(0,i.jsx)(t.code,{children:`path`}),`. Paths are defined in a syntax called JSON Pointer, which is basically a slash-separated string that can go several levels, and consist of both object-properties and array indexes. Examples of paths are: `,(0,i.jsx)(t.code,{children:`/firstName`}),`, `,(0,i.jsx)(t.code,{children:`/nested/path/to/value`}),` and `,(0,i.jsx)(t.code,{children:`/list/2/keyInThirdObject`}),`. More information about JSON Pointers can be found on `,(0,i.jsx)(t.a,{href:`https://json-schema.org/draft/2020-12/relative-json-pointer.html`,children:`the website of JSON Schema`}),`.`]}),`
