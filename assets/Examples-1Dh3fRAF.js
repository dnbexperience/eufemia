import{t as e}from"./jsx-runtime-BgMs7Gb-.js";import{G as t,J as n,K as r,Q as i,X as a,Y as o,Z as s,q as c,t as l}from"./ComponentBox-C64JNWnl.js";function u(e,t){let n=i(e,t?.in).getDay();return n===0||n===6}function d(e,t){let n=a(),r=t?.weekStartsOn??t?.locale?.options?.weekStartsOn??n.weekStartsOn??n.locale?.options?.weekStartsOn??0,o=i(e,t?.in),s=o.getDay(),c=(s<r?-7:0)+6-(s-r);return o.setHours(0,0,0,0),o.setDate(o.getDate()+c),o}var f=e(),p=()=>(0,f.jsx)(l,{scope:{addDays:s,startOfMonth:c,lastDayOfMonth:r,startOfWeek:o,lastDayOfWeek:d},children:`<DatePicker
  label="DatePicker"
