import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{t as r}from"./Avatar-CZqh4vYq.js";import{n as i,r as a,t as o}from"./Tr-Bl0Rf6NO.js";import{c as s}from"./ToggleButton-D3NEk3jO.js";import{t as c}from"./Card-C6UABezd.js";import{a as l}from"./Selection-DXfzor9j.js";import{t as u}from"./Form-C16rVaXm.js";import{t as d}from"./ajv-244GHn5p.js";import{t as f}from"./Field-B5trC2Cn.js";import{t as p}from"./ValueBlock-JYGXhQOu.js";import{t as m}from"./Value-DvCb56Kz.js";import{n as h}from"./Wizard-DMAIqrxA.js";import{t as g}from"./Iterate-BEyV0dg2.js";import{t as _}from"./Tools-B0-vRSQX.js";import{v}from"./index-BCXtuv-b.js";import{t as y}from"./ComponentBox-B2X8809Z.js";import{t as b}from"./Examples-Bl2AL28m.js";var x=e({AnimatedContainer:()=>b,ArrayFromFormHandler:()=>A,DynamicPathValue:()=>M,FilledViewAndEditContainer:()=>B,InitialOpenWithToolbarVariant:()=>I,InitiallyOpen:()=>P,MinItems:()=>F,NestedIterate:()=>W,NestedIterateWithPushContainer:()=>G,ObjectItems:()=>D,PrimitiveItemsFields:()=>C,PrimitiveItemsValues:()=>w,RenderPropsObjectItems:()=>k,RenderPropsPrimitiveItems:()=>O,RequiredWithPushButton:()=>H,RequiredWithPushContainer:()=>U,ToolbarVariantMiniumOneItemOneItem:()=>L,ToolbarVariantMiniumOneItemTwoItems:()=>R,ValueComposition:()=>T,ViewAndEditContainer:()=>j,ViewAndEditContainerWithLineDivider:()=>V,WithArrayValidator:()=>z,WithTable:()=>E,WithVisibility:()=>N}),S=t(n()),C=()=>(0,S.jsx)(y,{stableName:`PrimitiveItemsFields`,sourceImports:[`import { Avatar, Flex, Table, Td, Th, Tr } from '@dnb/eufemia'`,`import { Iterate, Field, Value, Form, Tools, Wizard, ValueBlock, FieldBlock, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Iterate:g,Field:f},children:`<Iterate.Array
...
`}),A=()=>(0,S.jsx)(y,{"data-visual-test":`animated-container`,stableName:`ArrayFromFormHandler`,sourceImports:[`import { Avatar, Flex, Table, Td, Th, Tr } from '@dnb/eufemia'`,`import { Iterate, Field, Value, Form, Tools, Wizard, ValueBlock, FieldBlock, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:u,Flex:s,Card:c,Iterate:g,Value:m,Field:f},children:`<Form.Handler
  data={{
    avengers: [
      {
        nickname: 'Iron Man',
...
`}),j=()=>(0,S.jsx)(y,{"data-visual-test":`view-and-edit-container`,stableName:`ViewAndEditContainer`,sourceImports:[`import { Avatar, Flex, Table, Td, Th, Tr } from '@dnb/eufemia'`,`import { Iterate, Field, Value, Form, Tools, Wizard, ValueBlock, FieldBlock, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Field:f,Iterate:g,Value:m,Form:u,Flex:s,Card:c},noInline:!0,children:`const MyEditItemForm = () => {
  return (
    <Field.Composition>
      <Field.Name.First itemPath="/firstName" width="medium" />
...
render(<MyForm />)
`}),M=()=>(0,S.jsx)(y,{stableName:`DynamicPathValue`,sourceImports:[`import { Avatar, Flex, Table, Td, Th, Tr } from '@dnb/eufemia'`,`import { Iterate, Field, Value, Form, Tools, Wizard, ValueBlock, FieldBlock, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:u,Flex:s,Field:f,Iterate:g,Tools:_},children:`<Form.Handler
  defaultData={{
    count: 0,
  }}
>
...
`}),N=()=>(0,S.jsx)(y,{stableName:`WithVisibility`,sourceImports:[`import { Avatar, Flex, Table, Td, Th, Tr } from '@dnb/eufemia'`,`import { Iterate, Field, Value, Form, Tools, Wizard, ValueBlock, FieldBlock, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:u,Iterate:g,Flex:s,Field:f},children:`<Form.Handler>
...
`}),P=()=>(0,S.jsx)(y,{scope:{Iterate:g},stableName:`InitiallyOpen`,sourceImports:[`import { Avatar, Flex, Table, Td, Th, Tr } from '@dnb/eufemia'`,`import { Iterate, Field, Value, Form, Tools, Wizard, ValueBlock, FieldBlock, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:u,Wizard:h,Card:c,Iterate:g,Value:m,Field:f,Tools:_},children:`<Form.Handler required>
  <Wizard.Container>
    <Wizard.Step>
      <Form.Card>
        <Iterate.Array path="/myList" defaultValue={[{}]}>
...
`}),F=()=>(0,S.jsx)(y,{hideCode:!0,scope:{makeAjvInstance:d},stableName:`MinItems`,sourceImports:[`import { Avatar, Flex, Table, Td, Th, Tr } from '@dnb/eufemia'`,`import { Iterate, Field, Value, Form, Tools, Wizard, ValueBlock, FieldBlock, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:u,Iterate:g,Value:m,Field:f,Tools:_},noInline:!0,children:`const ajv = makeAjvInstance()
const schema = {
  type: 'object',
  properties: {
    myList: {
...
`}),I=()=>(0,S.jsx)(y,{scope:{Iterate:g},stableName:`InitialOpenWithToolbarVariant`,sourceImports:[`import { Avatar, Flex, Table, Td, Th, Tr } from '@dnb/eufemia'`,`import { Iterate, Field, Value, Form, Tools, Wizard, ValueBlock, FieldBlock, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Value:m,Form:u,Flex:s,Card:c,Iterate:g,Field:f,Tools:_},noInline:!0,children:`const MyForm = () => {
...
`}),z=()=>(0,S.jsx)(y,{stableName:`WithArrayValidator`,sourceImports:[`import { Avatar, Flex, Table, Td, Th, Tr } from '@dnb/eufemia'`,`import { Iterate, Field, Value, Form, Tools, Wizard, ValueBlock, FieldBlock, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:u,Card:c,Iterate:g,Flex:s,Field:f},children:`<Form.Handler
  defaultData={{
    items: ['foo'],
  }}
...
`}),B=()=>(0,S.jsx)(y,{"data-visual-test":`filled-view-and-edit-container`,hideCode:!0,stableName:`FilledViewAndEditContainer`,sourceImports:[`import { Avatar, Flex, Table, Td, Th, Tr } from '@dnb/eufemia'`,`import { Iterate, Field, Value, Form, Tools, Wizard, ValueBlock, FieldBlock, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Flex:s,Field:f,Iterate:g,Avatar:r,Value:m,Form:u,Card:c},noInline:!0,children:`const MyEditItemForm = () => {
  return (
    <Flex.Stack>
...
`}),V=()=>(0,S.jsx)(y,{"data-visual-test":`view-and-edit-container-with-line-divider`,hideCode:!0,stableName:`ViewAndEditContainerWithLineDivider`,sourceImports:[`import { Avatar, Flex, Table, Td, Th, Tr } from '@dnb/eufemia'`,`import { Iterate, Field, Value, Form, Tools, Wizard, ValueBlock, FieldBlock, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Iterate:g,Field:f,Value:m,Form:u,Flex:s,Card:c},noInline:!0,children:`const MyEditItem = () => {
  return (
...
`}),H=()=>(0,S.jsx)(y,{stableName:`RequiredWithPushButton`,sourceImports:[`import { Avatar, Flex, Table, Td, Th, Tr } from '@dnb/eufemia'`,`import { Iterate, Field, Value, Form, Tools, Wizard, ValueBlock, FieldBlock, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:u,Card:c,Iterate:g,Flex:s,Field:f},children:`<Form.Handler>
  <Form.Card>
    <Iterate.Array
      path="/items"
      animate
...
`}),U=()=>(0,S.jsx)(y,{stableName:`RequiredWithPushContainer`,sourceImports:[`import { Avatar, Flex, Table, Td, Th, Tr } from '@dnb/eufemia'`,`import { Iterate, Field, Value, Form, Tools, Wizard, ValueBlock, FieldBlock, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Iterate:g,Value:m,Field:f,Form:u,Card:c},noInline:!0,children:`const MyViewItem = () => {
  return (
    <Iterate.ViewContainer title="Account holder {itemNo}">
      <Value.SummaryList>
        <Value.Name.First itemPath="/firstName" />
...
`}),W=()=>(0,S.jsx)(y,{stableName:`NestedIterate`,sourceImports:[`import { Avatar, Flex, Table, Td, Th, Tr } from '@dnb/eufemia'`,`import { Iterate, Field, Value, Form, Tools, Wizard, ValueBlock, FieldBlock, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:u,Iterate:g,Field:f,Tools:_},children:`<Form.Handler
  data={{
    outer: [
      {
        inner: ['foo', 'bar'],
