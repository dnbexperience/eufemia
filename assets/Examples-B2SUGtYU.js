import{n as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{$ as r,I as i,v as a,w as o}from"./Anchor-CUnuD5Cj.js";import{t as s}from"./Icon-95bES1gL.js";import{s as c}from"./ToggleButton-EPOyxk36.js";import{t as l}from"./Accordion-qnN6lpSz.js";import{t as u}from"./Button-CmA8Qaoz.js";import{t as d}from"./P-DSNzygKs.js";import{t as f}from"./Heading-Z0RGhEBm.js";import{t as p}from"./export-DpQkjcdy.js";import{t as m}from"./ComponentBox-DOwlXUSS.js";var h=t(e()),g=t(n()),_=()=>(0,g.jsx)(m,{"data-visual-test":`accordion-default`,stableName:`AccordionDefaultExample`,sourceImports:[`import { useRef } from 'react'`,`import { bell, add_medium as AddIcon, subtract_medium as SubtractIcon } from '@dnb/eufemia/icons'`,`import { Accordion, P, Icon, Grid, Flex, Heading, Button } from '@dnb/eufemia'`],__buildScope:{Accordion:l,P:d,Provider:r},children:`
...
`}),y=()=>(0,g.jsx)(m,{"data-visual-test":`accordion-custom`,scope:{bell:i},stableName:`AccordionCustomisationExample`,sourceImports:[`import { useRef } from 'react'`,`import { bell, add_medium as AddIcon, subtract_medium as SubtractIcon } from '@dnb/eufemia/icons'`,`import { Accordion, P, Icon, Grid, Flex, Heading, Button } from '@dnb/eufemia'`],__buildScope:{Accordion:l,Icon:s,P:d},children:`
...
`}),C=()=>(0,g.jsx)(m,{"data-visual-test":`accordion-disabled`,stableName:`AccordionDisabledExample`,sourceImports:[`import { useRef } from 'react'`,`import { bell, add_medium as AddIcon, subtract_medium as SubtractIcon } from '@dnb/eufemia/icons'`,`import { Accordion, P, Icon, Grid, Flex, Heading, Button } from '@dnb/eufemia'`],__buildScope:{Accordion:l,P:d,Provider:r},children:`
