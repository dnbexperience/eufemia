import{a as e,r as t}from"./rolldown-runtime-BYbx6iT9.js";import{n,t as r}from"./jsx-runtime-BgMs7Gb-.js";import{Bn as i,Hi as a,In as o,Lr as s,Wi as c,Xi as l,en as u,gr as d,un as f,wr as p,y as m}from"./index-mmuoVhax.js";import{t as h}from"./ComponentBox-XDAvsf_r.js";var g=t({Components:()=>K,FourDirections:()=>J,InnerSpace:()=>S,InnerSpaceMediaQueries:()=>Z,MagicBox:()=>H,MarginCollapse:()=>C,Margins:()=>w,Method1:()=>y,Method2:()=>b,Method3:()=>x,ProviderExample:()=>Y,ResponsiveOuterSpace:()=>$,ResponsiveSpacing:()=>T,SameResult1:()=>W,SameResult2:()=>G,Shorthand:()=>q,SpaceInlineBlock:()=>Q,SpaceMediaQueries:()=>X,SpaceVisibleWhenVisualTestElements:()=>D,SpaceVisibleWhenVisualTestPatterns:()=>E,SpaceVisibleWhenVisualTestReset:()=>O,VisualSpace:()=>U}),_=e(n()),v=e(r()),y=()=>(0,v.jsx)(k,{children:(0,v.jsx)(h,{"data-visual-test":`spacing-method-space`,scope:{RedBox:M},stableName:`Method1`,sourceImports:[`import { useEffect, useRef, useState } from 'react'`,`import styled from '@emotion/styled'`,`import { Space, Input, Button, P, Code, Flex, Heading, Section } from '@dnb/eufemia'`,`import { Provider } from '@dnb/eufemia/shared'`,`import { useSpacing } from '@dnb/eufemia/components/space/SpacingUtils'`,`import { Theme } from '@emotion/react'`],__buildScope:{Space:s,Input:d},children:`<RedBox>
  <Space top="large x-small">
    <Input label="Input" />
  </Space>
</RedBox>
`})}),b=()=>(0,v.jsx)(k,{children:(0,v.jsx)(h,{"data-visual-test":`spacing-method-component`,stableName:`Method2`,sourceImports:[`import { useEffect, useRef, useState } from 'react'`,`import styled from '@emotion/styled'`,`import { Space, Input, Button, P, Code, Flex, Heading, Section } from '@dnb/eufemia'`,`import { Provider } from '@dnb/eufemia/shared'`,`import { useSpacing } from '@dnb/eufemia/components/space/SpacingUtils'`,`import { Theme } from '@emotion/react'`],__buildScope:{Input:d},children:`
<Input label="Input A" bottom="small" />
<Input label="Input B" />

`})}),x=()=>(0,v.jsx)(k,{children:(0,v.jsx)(h,{scope:{RedBox:M,useSpacing:l},"data-visual-test":`spacing-method-form-row`,stableName:`Method3`,sourceImports:[`import { useEffect, useRef, useState } from 'react'`,`import styled from '@emotion/styled'`,`import { Space, Input, Button, P, Code, Flex, Heading, Section } from '@dnb/eufemia'`,`import { Provider } from '@dnb/eufemia/shared'`,`import { useSpacing } from '@dnb/eufemia/components/space/SpacingUtils'`,`import { Theme } from '@emotion/react'`],__buildScope:{Space:s},noInline:!0,children:`const Component = ({ className = null, style = null, ...props }) => {
...
`,H=e=>{let t=(0,_.useRef)(null),[n,r]=(0,_.useState)(``),[i,a]=(0,_.useState)(null);return(0,_.useEffect)(()=>{let e=t.current,n=()=>{try{let t=window.getComputedStyle(e.parentElement).getPropertyValue(`margin-top`);r(`${parseFloat(t)/16}`),a(e.parentElement.getAttribute(`class`))}catch(e){console.warn(e)}};return document.readyState===`complete`?n():typeof window<`u`&&window.addEventListener(`load`,n),()=>{window.removeEventListener(`load`,n)}},[]),(0,v.jsxs)(N,{...e,ref:t,title:i,children:[(0,v.jsx)(P,{style:{height:`${n}rem`}}),(0,v.jsx)(V,{children:n})]})},U=({children:e,...t})=>{let n=(0,_.useRef)(null),r={top:0,left:0,right:0,bottom:0},[i,a]=(0,_.useState)(r),[o,c]=(0,_.useState)(r),[l,u]=(0,_.useState)(null);(0,_.useEffect)(()=>{let e=n.current,t=()=>{try{let t={...r},n={...r},i=window.getComputedStyle(e.children[0]);Object.keys(r).forEach(e=>{t[e]=parseFloat(i.getPropertyValue(`margin-${e}`))/16,n[e]=parseFloat(i.getPropertyValue(`padding-${e}`))/16}),a(t),c(n),u(e.parentElement.getAttribute(`class`))}catch(e){console.warn(e)}};document.readyState===`complete`?t():typeof window<`u`&&window.addEventListener(`load`,t);let i,o=()=>{clearTimeout(i),i=setTimeout(t,10)};return window.addEventListener(`resize`,o),()=>{typeof window<`u`&&(window.removeEventListener(`load`,t),window.removeEventListener(`resize`,o))}},[]);let d=({space:e,unit:t})=>Object.keys(r).map(n=>{let r={unit:t},i=null;switch(n){case`top`:i=L;break;case`right`:i=B;break;case`bottom`:i=R;break;case`left`:i=z;break}return(0,v.jsx)(i,{theme:r,style:{[n===`top`||n===`bottom`?`height`:`width`]:`${e[n]}rem`},children:(0,v.jsx)(V,{children:e[n]||``})},n)});return(0,v.jsx)(s,{...t,title:l,children:(0,v.jsxs)(F,{ref:n,children:[e,d({space:i,unit:`margin`}),d({space:o,unit:`padding`})]})})},W=()=>(0,v.jsx)(h,{hidePreview:!0,hideToolbar:!0,stableName:`SameResult1`,sourceImports:[`import { useEffect, useRef, useState } from 'react'`,`import styled from '@emotion/styled'`,`import { Space, Input, Button, P, Code, Flex, Heading, Section } from '@dnb/eufemia'`,`import { Provider } from '@dnb/eufemia/shared'`,`import { useSpacing } from '@dnb/eufemia/components/space/SpacingUtils'`,`import { Theme } from '@emotion/react'`],__buildScope:{Space:s},children:`
