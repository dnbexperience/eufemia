...
`})}),p=()=>(0,u.jsx)(b,{children:(0,u.jsx)(i,{scope:{RedBox:C,applySpacing:a},"data-visual-test":`spacing-method-form-row`,noInline:!0,children:`const Component = ({ className = null, style = null, ...props }) => {
...
`,N=e=>{let t=l.useRef(null),[n,r]=l.useState(``),[i,a]=l.useState(null);return l.useEffect(()=>{let e=t.current,n=()=>{try{let t=window.getComputedStyle(e.parentElement).getPropertyValue(`margin-top`);r(`${parseFloat(t)/16}`),a(e.parentElement.getAttribute(`class`))}catch(e){console.warn(e)}};return document.readyState===`complete`?n():typeof window<`u`&&window.addEventListener(`load`,n),()=>{window.removeEventListener(`load`,n)}},[]),(0,u.jsxs)(w,{...e,ref:t,title:i,children:[(0,u.jsx)(T,{style:{height:`${n}rem`}}),(0,u.jsx)(M,{children:n})]})},P=({children:e,...t})=>{let n=l.useRef(null),r={top:0,left:0,right:0,bottom:0},[i,a]=l.useState(r),[s,c]=l.useState(r),[d,f]=l.useState(null);l.useEffect(()=>{let e=n.current,t=()=>{try{let t={...r},n={...r},i=window.getComputedStyle(e.children[0]);Object.keys(r).forEach(e=>{t[e]=parseFloat(i.getPropertyValue(`margin-${e}`))/16,n[e]=parseFloat(i.getPropertyValue(`padding-${e}`))/16}),a(t),c(n),f(e.parentElement.getAttribute(`class`))}catch(e){console.warn(e)}};document.readyState===`complete`?t():typeof window<`u`&&window.addEventListener(`load`,t);let i,o=()=>{clearTimeout(i),i=setTimeout(t,10)};return window.addEventListener(`resize`,o),()=>{typeof window<`u`&&(window.removeEventListener(`load`,t),window.removeEventListener(`resize`,o))}},[]);let p=({space:e,unit:t})=>Object.keys(r).map(n=>{let r={unit:t},i=null;switch(n){case`top`:i=O;break;case`right`:i=j;break;case`bottom`:i=k;break;case`left`:i=A;break}return(0,u.jsx)(i,{theme:r,style:{[n===`top`||n===`bottom`?`height`:`width`]:`${e[n]}rem`},children:(0,u.jsx)(M,{children:e[n]||``})},n)});return(0,u.jsx)(o,{...t,title:d,children:(0,u.jsxs)(E,{ref:n,children:[e,p({space:i,unit:`margin`}),p({space:s,unit:`padding`})]})})},F=()=>(0,u.jsx)(i,{hidePreview:!0,hideToolbar:!0,children:`
