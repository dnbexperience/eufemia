import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{c as r}from"./ToggleButton-_NsXxiTa.js";import{t as i}from"./Card-ChPhpBPz.js";import{t as a}from"./Form-JTiJXf2d.js";import{t as o}from"./Field-DqRpWyNm.js";import{t as s}from"./Value-OsZalonW.js";import{t as c}from"./ComponentBox-R2c6Bo76.js";var l=e({AnimatedVisibility:()=>C,CombinedLayout:()=>v,DefaultLayout:()=>d,DefaultLayoutWithHelp:()=>m,GridLayout:()=>f,GridLayoutWithHelp:()=>h,GridLayoutWithHelpAndLabel:()=>g,HelpButton:()=>w,HorizontalLayout:()=>p,HorizontalLayoutWithHelp:()=>_,HorizontalLayoutWithoutLabel:()=>x,InheritLabel:()=>b,InheritVisibility:()=>y,MaxWidth:()=>T,WithHelpInInfoOverlay:()=>S}),u=t(n()),d=()=>(0,u.jsx)(c,{"data-visual-test":`forms-value-summary-list-default`,stableName:`DefaultLayout`,sourceImports:[`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`,`import { Flex } from '@dnb/eufemia/components'`],__buildScope:{Form:a,Card:i,Value:s},children:`<Form.Handler
  data={{
    firstName: 'John',
    lastName: 'Doe',
  }}
