import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{c as r}from"./ToggleButton-T4E3Coih.js";import{t as i}from"./Card-Dsou21Li.js";import{t as a}from"./Form-B9l6EvGx.js";import{t as o}from"./Field-DHicZJEj.js";import{t as s}from"./Value-whMgauSk.js";import{t as c}from"./ComponentBox-Cb1rLw_D.js";var l=e({AnimatedVisibility:()=>C,CombinedLayout:()=>v,DefaultLayout:()=>d,DefaultLayoutWithHelp:()=>m,GridLayout:()=>f,GridLayoutWithHelp:()=>h,GridLayoutWithHelpAndLabel:()=>g,HelpButton:()=>w,HorizontalLayout:()=>p,HorizontalLayoutWithHelp:()=>_,HorizontalLayoutWithoutLabel:()=>x,InheritLabel:()=>b,InheritVisibility:()=>y,MaxWidth:()=>T,WithHelpInInfoOverlay:()=>S}),u=t(n()),d=()=>(0,u.jsx)(c,{"data-visual-test":`forms-value-summary-list-default`,stableName:`DefaultLayout`,sourceImports:[`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`,`import { Flex } from '@dnb/eufemia/components'`],__buildScope:{Form:a,Card:i,Value:s},children:`<Form.Handler
  data={{
    firstName: 'John',
    lastName: 'Doe',
  }}
