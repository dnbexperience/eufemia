import{r as e}from"./rolldown-runtime-BYbx6iT9.js";import{n as t,t as n}from"./jsx-runtime-BgMs7Gb-.js";import{t as r}from"./stop-B5si1F-h.js";import{t as i}from"./ComponentBox-geTEYZ7b.js";import{ka as a}from"./index-CMgyXmp3.js";import{s as o}from"./Examples-DcqJXyuQ.js";var s=e({AsyncChangeAndValidation:()=>p,AsyncOnSubmitRequest:()=>f,AsyncSubmit:()=>u,AsyncSubmitComplete:()=>d,Autofill:()=>h,FilterData:()=>v,Locale:()=>g,RequiredAndOptionalFields:()=>l,SessionStorage:()=>m,TransformData:()=>y,VisibleData:()=>_,WithHelp:()=>b});t();var c=n(),l=()=>(0,c.jsx)(i,{"data-visual-test":`required-and-optional-fields`,children:`<Form.Handler required>
  <Form.Card>
...
`}),u=()=>(0,c.jsx)(i,{children:`<Form.Handler onSubmit={async (data) => console.log('onSubmit', data)}>
  <Form.Card>
...
`}),d=()=>(0,c.jsx)(i,{children:`<Form.Handler
  data={{
    myField: 'Some value',
  }}
  onSubmit={async (data) => {
...
`}),f=()=>(0,c.jsx)(i,{children:`<Form.Handler
...
`}),p=()=>(0,c.jsx)(i,{scope:{debounceAsync:a,createRequest:o,stopIcon:r},noInline:!0,children:`const validator = debounceAsync(async function secondValidator(
  value: string
) {
  try {
...
render(<MyForm />)
`}),m=()=>(0,c.jsx)(i,{children:`<Form.Handler
...
`}),h=()=>(0,c.jsx)(i,{children:`<Form.Handler
...
`}),g=()=>(0,c.jsx)(i,{noInline:!0,children:`const myTranslations = {
  'nb-NO': {
    PhoneNumber: {
...
render(<MyForm />)
`}),_=()=>(0,c.jsx)(i,{children:`<Form.Handler
  defaultData={{
    isVisible: true,
  }}
...
`}),v=()=>(0,c.jsx)(i,{noInline:!0,children:`const id = 'my-form'
...
`}),y=()=>(0,c.jsx)(i,{noInline:!0,children:`const MyForm = () => {
...
render(<MyForm />)
`}),b=()=>(0,c.jsx)(i,{children:`<Form.Handler
  defaultData={{
    myField: 12345,
  }}
>
