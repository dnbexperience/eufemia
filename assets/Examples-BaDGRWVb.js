import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{c as r}from"./ToggleButton-BMi2PwcS.js";import{t as i}from"./Card-ClZNWqpG.js";import{t as a}from"./Form-C8lTzZqR.js";import{t as o}from"./Field-neGd0eKd.js";import{t as s}from"./Value-Cjs3mKU7.js";import{t as c}from"./ComponentBox-CG7uqrFy.js";var l=e({AnimatedVisibility:()=>C,CombinedLayout:()=>v,DefaultLayout:()=>d,DefaultLayoutWithHelp:()=>m,GridLayout:()=>f,GridLayoutWithHelp:()=>h,GridLayoutWithHelpAndLabel:()=>g,HelpButton:()=>w,HorizontalLayout:()=>p,HorizontalLayoutWithHelp:()=>_,HorizontalLayoutWithoutLabel:()=>x,InheritLabel:()=>b,InheritVisibility:()=>y,MaxWidth:()=>T,WithHelpInInfoOverlay:()=>S}),u=t(n()),d=()=>(0,u.jsx)(c,{"data-visual-test":`forms-value-summary-list-default`,stableName:`DefaultLayout`,sourceImports:[`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`,`import { Flex } from '@dnb/eufemia/components'`],__buildScope:{Form:a,Card:i,Value:s},children:`<Form.Handler
  data={{
    firstName: 'John',
    lastName: 'Doe',
  }}
