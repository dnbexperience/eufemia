import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{At as n,Mt as r,Nt as i,Ot as a,bt as o,ht as s,jt as c,kt as l}from"./forms-DuwGqcp3.js";import{d as u,s as d}from"./Table-L2SFy5VR.js";import{t as f}from"./ComponentBox-41YKKsr3.js";function p(e,t){let n=i(e,t?.in).getDay();return n===0||n===6}function m(e,t){let n=i(e,t?.in),r=n.getMonth();return n.setFullYear(n.getFullYear(),r+1,0),n.setHours(0,0,0,0),i(n,t?.in)}function h(e,t){let n=c(),r=t?.weekStartsOn??t?.locale?.options?.weekStartsOn??n.weekStartsOn??n.locale?.options?.weekStartsOn??0,a=i(e,t?.in),o=a.getDay(),s=(o<r?-7:0)+6-(o-r);return a.setHours(0,0,0,0),a.setDate(a.getDate()+s),a}var g=e(t()),_=()=>(0,g.jsx)(f,{scope:{addDays:r,startOfMonth:a,lastDayOfMonth:m,startOfWeek:n,lastDayOfWeek:h},stableName:`DatePickerRange`,sourceImports:[`import { addDays, isSameDay, startOfMonth, lastDayOfMonth, startOfWeek, lastDayOfWeek, isWeekend } from 'date-fns'`,`import { DatePicker, HelpButton } from '@dnb/eufemia'`,`import { getOsloDate } from '@dnb/eufemia/components/date-format/DateFormatUtils'`],__buildScope:{DatePicker:s},children:`<DatePicker
  label="DatePicker"
...
/>
`}),C=()=>(0,g.jsx)(f,{stableName:`DatePickerSuffix`,sourceImports:[`import { addDays, isSameDay, startOfMonth, lastDayOfMonth, startOfWeek, lastDayOfWeek, isWeekend } from 'date-fns'`,`import { DatePicker, HelpButton } from '@dnb/eufemia'`,`import { getOsloDate } from '@dnb/eufemia/components/date-format/DateFormatUtils'`],__buildScope:{DatePicker:s,HelpButton:d,Modal:u},children:`<DatePicker
  label="DatePicker"
  date={new Date()}
  showInput
  suffix={<HelpButton title="Modal Title">Modal content</HelpButton>}
/>
`}),w=()=>(0,g.jsx)(f,{"data-visual-test":`date-picker-input`,stableName:`DatePickerLinked`,sourceImports:[`import { addDays, isSameDay, startOfMonth, lastDayOfMonth, startOfWeek, lastDayOfWeek, isWeekend } from 'date-fns'`,`import { DatePicker, HelpButton } from '@dnb/eufemia'`,`import { getOsloDate } from '@dnb/eufemia/components/date-format/DateFormatUtils'`],__buildScope:{DatePicker:s},children:`<DatePicker label="DatePicker" range link showInput />
...
`}),D=()=>(0,g.jsx)(f,{stableName:`DatePickerErrorStatus`,sourceImports:[`import { addDays, isSameDay, startOfMonth, lastDayOfMonth, startOfWeek, lastDayOfWeek, isWeekend } from 'date-fns'`,`import { DatePicker, HelpButton } from '@dnb/eufemia'`,`import { getOsloDate } from '@dnb/eufemia/components/date-format/DateFormatUtils'`],__buildScope:{DatePicker:s},children:`<DatePicker
  ...
  status="error"
/>
`}),O=()=>(0,g.jsx)(f,{background:`plain`,stableName:`DatePickerCalendarInline`,sourceImports:[`import { addDays, isSameDay, startOfMonth, lastDayOfMonth, startOfWeek, lastDayOfWeek, isWeekend } from 'date-fns'`,`import { DatePicker, HelpButton } from '@dnb/eufemia'`,`import { getOsloDate } from '@dnb/eufemia/components/date-format/DateFormatUtils'`],__buildScope:{DatePicker:s},children:`<DatePicker inline range startDate="2019-05-05" endDate="2019-06-05" />
`}),k=()=>(0,g.jsx)(f,{scope:{addDays:r},hidePreview:!0,hideToolbar:!0,stableName:`DatePickerDateFns`,sourceImports:[`import { addDays, isSameDay, startOfMonth, lastDayOfMonth, startOfWeek, lastDayOfWeek, isWeekend } from 'date-fns'`,`import { DatePicker, HelpButton } from '@dnb/eufemia'`,`import { getOsloDate } from '@dnb/eufemia/components/date-format/DateFormatUtils'`],__buildScope:{DatePicker:s},children:`<DatePicker
  shortcuts={[
    {
      title: 'Set date',
      date: '1969-07-15',
...
/>
`}),M=()=>(0,g.jsx)(f,{scope:{getOsloDate:o,isSameDay:l},stableName:`DatePickerOsloDate`,sourceImports:[`import { addDays, isSameDay, startOfMonth, lastDayOfMonth, startOfWeek, lastDayOfWeek, isWeekend } from 'date-fns'`,`import { DatePicker, HelpButton } from '@dnb/eufemia'`,`import { getOsloDate } from '@dnb/eufemia/components/date-format/DateFormatUtils'`],__buildScope:{DatePicker:s},noInline:!0,children:`const osloDate = getOsloDate()
render(
  <DatePicker
    onDaysRender={(days) => {
      return days.map((dayObject) => {
...
`}),N=()=>(0,g.jsx)(f,{stableName:`DatePickerYearNavigation`,sourceImports:[`import { addDays, isSameDay, startOfMonth, lastDayOfMonth, startOfWeek, lastDayOfWeek, isWeekend } from 'date-fns'`,`import { DatePicker, HelpButton } from '@dnb/eufemia'`,`import { getOsloDate } from '@dnb/eufemia/components/date-format/DateFormatUtils'`],__buildScope:{DatePicker:s},children:`<DatePicker showInput yearNavigation />
