import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{X as r}from"./Anchor-ywdvt45E.js";import{M as i}from"./Autocomplete-DM3xptYi.js";import{t as a}from"./Section-UYj7uQy5.js";import{c as o}from"./ToggleButton-D3NEk3jO.js";import{t as s}from"./Card-C6UABezd.js";import{D as c,_ as l,a as u}from"./Selection-DXfzor9j.js";import{t as d}from"./NumberFormatExport-WfPKRk7o.js";import{t as f}from"./Slider-lEY9INSg.js";import{t as p}from"./Form-C16rVaXm.js";import{t as m}from"./Field-B5trC2Cn.js";import{t as h}from"./ValueBlock-JYGXhQOu.js";import{t as g}from"./Value-DvCb56Kz.js";import{n as _}from"./Wizard-DMAIqrxA.js";import{t as v}from"./Iterate-BEyV0dg2.js";import{t as y}from"./ComponentBox-B2X8809Z.js";var b=e({BaseFieldComponents:()=>E,CreateBasicFieldComponent:()=>C,CreateBasicValueComponent:()=>S,CreateComposedFieldComponent:()=>T,FeatureFields:()=>D,GettingStarted:()=>w,LayoutComponents:()=>O,QuickStart:()=>I,Transformers:()=>F,UsingFormHandler:()=>A,UsingFormSection:()=>N,UsingIterate:()=>P,UsingWizard:()=>M,Validation:()=>j,VisibilityBasedOnData:()=>k}),x=t(n()),S=()=>(0,x.jsx)(y,{scope:{ValueBlock:h},hideCode:!0,stableName:`CreateBasicValueComponent`,sourceImports:[`import { useCallback } from 'react'`,`import { Input, Slider, Flex, NumberFormat } from '@dnb/eufemia'`,`import { Form, Field, Value, FieldBlock, useFieldProps, DataContext, ValueBlock, Wizard, Iterate } from '@dnb/eufemia/extensions/forms'`],__buildScope:{ValueBlock:h,NumberFormat:d},noInline:!0,children:`const MyValue = ({ value, ...props }) => {
  return (
    <ValueBlock {...props}>
