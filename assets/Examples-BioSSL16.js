import{a as e,n as t,s as n,t as r}from"./jsx-runtime-DnlWeMvz.js";import{Q as i,et as a}from"./Anchor-oyitbGgC.js";import{a as o}from"./SpacingUtils-DQwKFNxd.js";import{s}from"./ToggleButton-DFl1k6dD.js";import{t as c}from"./Space-Cd41aw7T.js";import{t as l}from"./Button-DLh19lOb.js";import{F as u}from"./Autocomplete-BkdRYvuo.js";import{t as d}from"./P-CVJzad03.js";import{t as f}from"./Section-D1rn7dEf.js";import{t as p}from"./Heading-M5ntQRjT.js";import{w as m}from"./index-Ct8Ggqh9.js";import{t as h}from"./ComponentBox-41YKKsr3.js";var g=e({Components:()=>K,FourDirections:()=>J,InnerSpace:()=>S,InnerSpaceMediaQueries:()=>Z,MagicBox:()=>H,MarginCollapse:()=>C,Margins:()=>w,Method1:()=>y,Method2:()=>b,Method3:()=>x,ProviderExample:()=>Y,ResponsiveOuterSpace:()=>$,ResponsiveSpacing:()=>T,SameResult1:()=>W,SameResult2:()=>G,Shorthand:()=>q,SpaceInlineBlock:()=>Q,SpaceMediaQueries:()=>X,SpaceVisibleWhenVisualTestElements:()=>D,SpaceVisibleWhenVisualTestPatterns:()=>E,SpaceVisibleWhenVisualTestReset:()=>O,VisualSpace:()=>U}),_=n(t()),v=n(r()),y=()=>(0,v.jsx)(k,{children:(0,v.jsx)(h,{"data-visual-test":`spacing-method-space`,scope:{RedBox:M},stableName:`Method1`,sourceImports:[`import { useEffect, useRef, useState } from 'react'`,`import styled from '@emotion/styled'`,`import { Space, Input, Button, P, Code, Flex, Heading, Section } from '@dnb/eufemia'`,`import { Provider } from '@dnb/eufemia/shared'`,`import { useSpacing } from '@dnb/eufemia/components/space/SpacingUtils'`,`import { Theme } from '@emotion/react'`],__buildScope:{Space:c,Input:u},children:`<RedBox>
