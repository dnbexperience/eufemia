...
`}),m=()=>(0,u.jsx)(c,{scope:{question:n},"data-visual-test":`button-error`,stableName:`ButtonErrorState`,sourceImports:[`import { bell_medium as Bell, question } from '@dnb/eufemia/icons'`,`import { Button, IconPrimary, Section } from '@dnb/eufemia'`,`import { VippsLogo } from '@dnb/eufemia/extensions/vipps-wallet-button/VippsWalletButton'`,`import { VisibilityByTheme } from '@dnb/eufemia/shared'`],__buildScope:{Button:a},children:`
<Button
...
`}),S=()=>(0,u.jsx)(c,{scope:{question:n,VisibilityByTheme:s},"data-visual-test":`button-icons`,stableName:`ButtonIcon`,sourceImports:[`import { bell_medium as Bell, question } from '@dnb/eufemia/icons'`,`import { Button, IconPrimary, Section } from '@dnb/eufemia'`,`import { VippsLogo } from '@dnb/eufemia/extensions/vipps-wallet-button/VippsWalletButton'`,`import { VisibilityByTheme } from '@dnb/eufemia/shared'`],__buildScope:{Button:a},children:`
<Button
...
`}),T=()=>(0,u.jsx)(c,{scope:{Bell:i},stableName:`ButtonStretch`,sourceImports:[`import { bell_medium as Bell, question } from '@dnb/eufemia/icons'`,`import { Button, IconPrimary, Section } from '@dnb/eufemia'`,`import { VippsLogo } from '@dnb/eufemia/extensions/vipps-wallet-button/VippsWalletButton'`,`import { VisibilityByTheme } from '@dnb/eufemia/shared'`],__buildScope:{Button:a},children:`<Button
  text="A stretched button"
  icon={<Bell />}
  size="large"
  data-visual-test="button-stretch"
/>
`}),E=()=>(0,u.jsx)(c,{scope:{Bell:i},hideCode:!0,stableName:`PrimaryButtonSizes`,sourceImports:[`import { bell_medium as Bell, question } from '@dnb/eufemia/icons'`,`import { Button, IconPrimary, Section } from '@dnb/eufemia'`,`import { VippsLogo } from '@dnb/eufemia/extensions/vipps-wallet-button/VippsWalletButton'`,`import { VisibilityByTheme } from '@dnb/eufemia/shared'`],__buildScope:{Button:a},children:`
<Button
  text="Default button"
  onClick={() => {
    console.log('onClick')
...
`}),D=()=>(0,u.jsx)(c,{scope:{Bell:i},hideCode:!0,stableName:`SecondaryButtonSizes`,sourceImports:[`import { bell_medium as Bell, question } from '@dnb/eufemia/icons'`,`import { Button, IconPrimary, Section } from '@dnb/eufemia'`,`import { VippsLogo } from '@dnb/eufemia/extensions/vipps-wallet-button/VippsWalletButton'`,`import { VisibilityByTheme } from '@dnb/eufemia/shared'`],__buildScope:{Button:a},children:`
<Button
  text="Default button"
  onClick={() => {
    console.log('onClick')
...
`}),O=()=>(0,u.jsx)(c,{scope:{Bell:i},hideCode:!0,stableName:`TertiaryButtonSizes`,sourceImports:[`import { bell_medium as Bell, question } from '@dnb/eufemia/icons'`,`import { Button, IconPrimary, Section } from '@dnb/eufemia'`,`import { VippsLogo } from '@dnb/eufemia/extensions/vipps-wallet-button/VippsWalletButton'`,`import { VisibilityByTheme } from '@dnb/eufemia/shared'`],__buildScope:{Button:a},children:`
<Button
  text="Default button"
  onClick={() => {
    console.log('onClick')
