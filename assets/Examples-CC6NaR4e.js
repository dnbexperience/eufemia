import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{$ as n}from"./Anchor-CUnuD5Cj.js";import{s as r}from"./ToggleButton-EPOyxk36.js";import{j as i,l as a,m as o,v as s,w as c}from"./forms-D__hPZDv.js";import{t as l}from"./Card-DZd-xLSg.js";import{t as u}from"./ComponentBox-DOwlXUSS.js";var d=e(t()),f=()=>(0,d.jsx)(u,{hideCode:!0,stableName:`BecomeCorporateCustomer`,sourceImports:[`import { Flex } from '@dnb/eufemia'`,`import { Form, Field, Value, Wizard, Tools } from '@dnb/eufemia/extensions/forms'`,`import { Provider } from '@dnb/eufemia/shared'`],__buildScope:{Form:c,Tools:a,Wizard:o,Card:l,Field:i,Flex:r,Value:s},noInline:!0,children:`const Output = () => {
...
`});function p(){return(0,d.jsx)(u,{hideCode:!0,stableName:`PizzaDemo`,sourceImports:[`import { Flex } from '@dnb/eufemia'`,`import { Form, Field, Value, Wizard, Tools } from '@dnb/eufemia/extensions/forms'`,`import { Provider } from '@dnb/eufemia/shared'`],__buildScope:{Wizard:o,Form:c,Provider:n,Card:l,Field:i,Value:s,Tools:a},noInline:!0,children:`const MyForm = () => {
  // Routers like "react-router" are supported as well
