import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{s as r}from"./ToggleButton-DfKpi57X.js";import{j as i,l as a,ut as o,v as s,w as c}from"./forms-D54jfDKN.js";import{t as l}from"./P-CVKBz4XO.js";import{t as u}from"./Card-BvVSLAbs.js";import{t as d}from"./Section-_oyssAWe.js";import{t as f}from"./ajv-C39zvwvV.js";import{t as p}from"./ComponentBox-sLMgHvLi.js";var m=e({AllFieldsRequired:()=>S,BasicViewAndEditContainer:()=>b,NestedPathSection:()=>_,NestedSections:()=>T,OverwriteProps:()=>x,SchemaSupport:()=>C,SectionLevelZodSchema:()=>D,ViewAndEditContainer:()=>v,ViewAndEditContainerValidation:()=>y,WithVisibility:()=>w,WithoutDataContext:()=>g}),h=t(n()),g=()=>(0,h.jsx)(p,{stableName:`WithoutDataContext`,sourceImports:[`import { Flex, P } from '@dnb/eufemia'`,`import { Field, Form, JSONSchema, SectionProps, Tools, Value, makeAjvInstance, z } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:c,Section:d,Field:i},children:`<Form.Section
  data={{
    myField: 'Value',
  }}
