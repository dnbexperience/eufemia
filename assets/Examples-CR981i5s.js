...
`})}),p=()=>(0,u.jsx)(b,{children:(0,u.jsx)(i,{scope:{RedBox:C,applySpacing:s},"data-visual-test":`spacing-method-form-row`,noInline:!0,children:`const Component = ({ className = null, style = null, ...props }) => {
...
`,C=({children:e,...t})=>(0,u.jsx)(x,{children:(0,u.jsx)(P,{...t,children:e})}),w=o.div`
  position: relative;
