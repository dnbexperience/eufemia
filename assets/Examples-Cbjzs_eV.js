import{a as e}from"./rolldown-runtime-BYbx6iT9.js";import{t}from"./jsx-runtime-BgMs7Gb-.js";import{A as n,C as r,M as i,N as a,T as o,a as s,k as c}from"./DateFormatUtils-A38kJZOi.js";import{t as l}from"./DatePicker-BZEeL7pj.js";import{Cn as u,bn as d}from"./index-Da-r8F54.js";import{t as f}from"./ComponentBox-DXeEXSK2.js";function p(e,t){let n=a(e,t?.in).getDay();return n===0||n===6}function m(e,t){let n=a(e,t?.in),r=n.getMonth();return n.setFullYear(n.getFullYear(),r+1,0),n.setHours(0,0,0,0),a(n,t?.in)}function h(e,t){let r=n(),i=t?.weekStartsOn??t?.locale?.options?.weekStartsOn??r.weekStartsOn??r.locale?.options?.weekStartsOn??0,o=a(e,t?.in),s=o.getDay(),c=(s<i?-7:0)+6-(s-i);return o.setHours(0,0,0,0),o.setDate(o.getDate()+c),o}var g=e(t()),_=()=>(0,g.jsx)(f,{scope:{addDays:i,startOfMonth:r,lastDayOfMonth:m,startOfWeek:c,lastDayOfWeek:h},stableName:`DatePickerRange`,sourceImports:[`import { addDays, isSameDay, startOfMonth, lastDayOfMonth, startOfWeek, lastDayOfWeek, isWeekend } from 'date-fns'`,`import { DatePicker, HelpButton } from '@dnb/eufemia'`,`import { getOsloDate } from '@dnb/eufemia/components/date-format/DateFormatUtils'`],__buildScope:{DatePicker:l},children:`<DatePicker
  label="DatePicker"
...
/>
`}),C=()=>(0,g.jsx)(f,{stableName:`DatePickerSuffix`,sourceImports:[`import { addDays, isSameDay, startOfMonth, lastDayOfMonth, startOfWeek, lastDayOfWeek, isWeekend } from 'date-fns'`,`import { DatePicker, HelpButton } from '@dnb/eufemia'`,`import { getOsloDate } from '@dnb/eufemia/components/date-format/DateFormatUtils'`],__buildScope:{DatePicker:l,HelpButton:d,Modal:u},children:`<DatePicker
  label="DatePicker"
  date={new Date()}
  showInput
  suffix={<HelpButton title="Modal Title">Modal content</HelpButton>}
/>
`}),w=()=>(0,g.jsx)(f,{"data-visual-test":`date-picker-input`,stableName:`DatePickerLinked`,sourceImports:[`import { addDays, isSameDay, startOfMonth, lastDayOfMonth, startOfWeek, lastDayOfWeek, isWeekend } from 'date-fns'`,`import { DatePicker, HelpButton } from '@dnb/eufemia'`,`import { getOsloDate } from '@dnb/eufemia/components/date-format/DateFormatUtils'`],__buildScope:{DatePicker:l},children:`<DatePicker label="DatePicker" range link showInput />
...
`}),D=()=>(0,g.jsx)(f,{stableName:`DatePickerErrorStatus`,sourceImports:[`import { addDays, isSameDay, startOfMonth, lastDayOfMonth, startOfWeek, lastDayOfWeek, isWeekend } from 'date-fns'`,`import { DatePicker, HelpButton } from '@dnb/eufemia'`,`import { getOsloDate } from '@dnb/eufemia/components/date-format/DateFormatUtils'`],__buildScope:{DatePicker:l},children:`<DatePicker
  ...
  status="error"
/>
`}),O=()=>(0,g.jsx)(f,{background:`plain`,stableName:`DatePickerCalendarInline`,sourceImports:[`import { addDays, isSameDay, startOfMonth, lastDayOfMonth, startOfWeek, lastDayOfWeek, isWeekend } from 'date-fns'`,`import { DatePicker, HelpButton } from '@dnb/eufemia'`,`import { getOsloDate } from '@dnb/eufemia/components/date-format/DateFormatUtils'`],__buildScope:{DatePicker:l},children:`<DatePicker inline range startDate="2019-05-05" endDate="2019-06-05" />
`}),k=()=>(0,g.jsx)(f,{scope:{addDays:i},hidePreview:!0,hideToolbar:!0,stableName:`DatePickerDateFns`,sourceImports:[`import { addDays, isSameDay, startOfMonth, lastDayOfMonth, startOfWeek, lastDayOfWeek, isWeekend } from 'date-fns'`,`import { DatePicker, HelpButton } from '@dnb/eufemia'`,`import { getOsloDate } from '@dnb/eufemia/components/date-format/DateFormatUtils'`],__buildScope:{DatePicker:l},children:`<DatePicker
  shortcuts={[
    {
      title: 'Set date',
      date: '1969-07-15',
...
/>
`}),M=()=>(0,g.jsx)(f,{scope:{getOsloDate:s,isSameDay:o},stableName:`DatePickerOsloDate`,sourceImports:[`import { addDays, isSameDay, startOfMonth, lastDayOfMonth, startOfWeek, lastDayOfWeek, isWeekend } from 'date-fns'`,`import { DatePicker, HelpButton } from '@dnb/eufemia'`,`import { getOsloDate } from '@dnb/eufemia/components/date-format/DateFormatUtils'`],__buildScope:{DatePicker:l},noInline:!0,children:`const osloDate = getOsloDate()
render(
  <DatePicker
    onDaysRender={(days) => {
      return days.map((dayObject) => {
...
`}),N=()=>(0,g.jsx)(f,{stableName:`DatePickerYearNavigation`,sourceImports:[`import { addDays, isSameDay, startOfMonth, lastDayOfMonth, startOfWeek, lastDayOfWeek, isWeekend } from 'date-fns'`,`import { DatePicker, HelpButton } from '@dnb/eufemia'`,`import { getOsloDate } from '@dnb/eufemia/components/date-format/DateFormatUtils'`],__buildScope:{DatePicker:l},children:`<DatePicker showInput yearNavigation />
