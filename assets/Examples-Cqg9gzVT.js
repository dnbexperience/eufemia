import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{Q as n}from"./Anchor-BPx9fjvj.js";import{t as r}from"./Icon-C5IFEhlK.js";import{t as i}from"./confetti_medium-CNWbDi-u.js";import{t as a}from"./ToggleButton-DfKpi57X.js";import{t as o}from"./Button-kSqfAUVR.js";import{F as s}from"./Autocomplete-eAFtuLbJ.js";import{t as c}from"./Section-_oyssAWe.js";import{F as l}from"./index-BsJ3GLEw.js";import{t as u}from"./ComponentBox-sLMgHvLi.js";var d=e(t()),f=()=>(0,d.jsx)(u,{"data-visual-test":`global-status`,stableName:`GlobalInfoOverlayError`,sourceImports:[`import { createContext, useContext, useEffect, useRef, useState } from 'react'`,`import { GlobalStatus, Button, Input, Section, ToggleButton, Icon } from '@dnb/eufemia'`,`import { confetti_medium } from '@dnb/eufemia/icons'`,`import { Provider } from '@dnb/eufemia/shared'`],__buildScope:{GlobalStatus:l},children:`<GlobalStatus
  title="Custom Title"
  text="Failure text"
  items={[
    {
...
`}),g=()=>(0,d.jsx)(u,{scope:{confetti_medium:i},"data-visual-test":`global-status-icon`,stableName:`GlobalInfoCustomIcon`,sourceImports:[`import { createContext, useContext, useEffect, useRef, useState } from 'react'`,`import { GlobalStatus, Button, Input, Section, ToggleButton, Icon } from '@dnb/eufemia'`,`import { confetti_medium } from '@dnb/eufemia/icons'`,`import { Provider } from '@dnb/eufemia/shared'`],__buildScope:{GlobalStatus:l,Icon:r},children:`<GlobalStatus
  ...
  id="demo-icon"
/>
`}),_=()=>(0,d.jsx)(u,{stableName:`GlobalStatusCoupling`,sourceImports:[`import { createContext, useContext, useEffect, useRef, useState } from 'react'`,`import { GlobalStatus, Button, Input, Section, ToggleButton, Icon } from '@dnb/eufemia'`,`import { confetti_medium } from '@dnb/eufemia/icons'`,`import { Provider } from '@dnb/eufemia/shared'`],__buildScope:{Input:s},noInline:!0,children:`const InputWithError = () => {
...
`}),v=()=>(0,d.jsx)(u,{hideCode:!0,stableName:`GlobalStatusAddRemoveItems`,sourceImports:[`import { createContext, useContext, useEffect, useRef, useState } from 'react'`,`import { GlobalStatus, Button, Input, Section, ToggleButton, Icon } from '@dnb/eufemia'`,`import { confetti_medium } from '@dnb/eufemia/icons'`,`import { Provider } from '@dnb/eufemia/shared'`],__buildScope:{GlobalStatus:l,Button:o},noInline:!0,children:`function AddRemoveItems() {
...
`}),y=()=>(0,d.jsx)(u,{hideCode:!0,stableName:`GlobalStatusScrolling`,sourceImports:[`import { createContext, useContext, useEffect, useRef, useState } from 'react'`,`import { GlobalStatus, Button, Input, Section, ToggleButton, Icon } from '@dnb/eufemia'`,`import { confetti_medium } from '@dnb/eufemia/icons'`,`import { Provider } from '@dnb/eufemia/shared'`],__buildScope:{Button:o,GlobalStatus:l},children:`<Button
...
/>
`}),b=()=>(0,d.jsx)(u,{hideCode:!0,stableName:`GlobalStatusUpdate`,sourceImports:[`import { createContext, useContext, useEffect, useRef, useState } from 'react'`,`import { GlobalStatus, Button, Input, Section, ToggleButton, Icon } from '@dnb/eufemia'`,`import { confetti_medium } from '@dnb/eufemia/icons'`,`import { Provider } from '@dnb/eufemia/shared'`],__buildScope:{GlobalStatus:l,Input:s,Section:c,ToggleButton:a,Button:o},noInline:!0,children:`const Context = createContext(null)
const UpdateDemo = () => {
...
`}),S=()=>(0,d.jsx)(u,{hidePreview:!0,hideToolbar:!0,stableName:`GlobalStatusInfoExample2`,sourceImports:[`import { createContext, useContext, useEffect, useRef, useState } from 'react'`,`import { GlobalStatus, Button, Input, Section, ToggleButton, Icon } from '@dnb/eufemia'`,`import { confetti_medium } from '@dnb/eufemia/icons'`,`import { Provider } from '@dnb/eufemia/shared'`],__buildScope:{GlobalStatus:l,Input:s},children:`
