import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{At as n,Dt as r,Mt as i,Ot as a,bt as o,ht as s,jt as c,kt as l}from"./forms-QYD2kahG.js";import{d as u,s as d}from"./Table-v8T3COIV.js";import{t as f}from"./ComponentBox-B6YSImfw.js";function p(e,t){let n=i(e,t?.in).getDay();return n===0||n===6}function m(e,t){let n=i(e,t?.in),r=n.getMonth();return n.setFullYear(n.getFullYear(),r+1,0),n.setHours(0,0,0,0),i(n,t?.in)}function h(e,t){let r=n(),a=t?.weekStartsOn??t?.locale?.options?.weekStartsOn??r.weekStartsOn??r.locale?.options?.weekStartsOn??0,o=i(e,t?.in),s=o.getDay(),c=(s<a?-7:0)+6-(s-a);return o.setHours(0,0,0,0),o.setDate(o.getDate()+c),o}var g=e(t()),_=()=>(0,g.jsx)(f,{scope:{addDays:c,startOfMonth:r,lastDayOfMonth:m,startOfWeek:l,lastDayOfWeek:h},stableName:`DatePickerRange`,sourceImports:[`import { addDays, isSameDay, startOfMonth, lastDayOfMonth, startOfWeek, lastDayOfWeek, isWeekend } from 'date-fns'`,`import { DatePicker, HelpButton } from '@dnb/eufemia'`,`import { getOsloDate } from '@dnb/eufemia/components/date-format/DateFormatUtils'`],__buildScope:{DatePicker:s},children:`<DatePicker
  label="DatePicker"
...
`}),k=()=>(0,g.jsx)(f,{scope:{addDays:c},hidePreview:!0,hideToolbar:!0,stableName:`DatePickerDateFns`,sourceImports:[`import { addDays, isSameDay, startOfMonth, lastDayOfMonth, startOfWeek, lastDayOfWeek, isWeekend } from 'date-fns'`,`import { DatePicker, HelpButton } from '@dnb/eufemia'`,`import { getOsloDate } from '@dnb/eufemia/components/date-format/DateFormatUtils'`],__buildScope:{DatePicker:s},children:`<DatePicker
  shortcuts={[
    {
      title: 'Set date',
      date: '1969-07-15',
...
/>
`}),M=()=>(0,g.jsx)(f,{scope:{getOsloDate:o,isSameDay:a},stableName:`DatePickerOsloDate`,sourceImports:[`import { addDays, isSameDay, startOfMonth, lastDayOfMonth, startOfWeek, lastDayOfWeek, isWeekend } from 'date-fns'`,`import { DatePicker, HelpButton } from '@dnb/eufemia'`,`import { getOsloDate } from '@dnb/eufemia/components/date-format/DateFormatUtils'`],__buildScope:{DatePicker:s},noInline:!0,children:`const osloDate = getOsloDate()
render(
  <DatePicker
    onDaysRender={(days) => {
      return days.map((dayObject) => {
