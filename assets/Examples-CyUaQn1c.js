import{r as e}from"./rolldown-runtime-BYbx6iT9.js";import{n as t,t as n}from"./jsx-runtime-BgMs7Gb-.js";import{t as r}from"./ComponentBox-geTEYZ7b.js";import{ka as i}from"./index-CMgyXmp3.js";import{s as a}from"./Examples-DcqJXyuQ.js";var o=e({AsyncWizardContainer:()=>l,Default:()=>c,OnSubmitRequest:()=>f,WithStatusMessage:()=>u,WithStatusMessageInMenu:()=>d});t();var s=n(),c=()=>(0,s.jsx)(r,{"data-visual-test":`wizard-layout-card-border`,noInline:!0,children:`const initialData = {
  firstName: 'John',
  lastName: 'Doe',
...
render(<MyForm />)
`}),l=()=>(0,s.jsx)(r,{scope:{createRequest:a,debounceAsync:i},noInline:!0,children:`const MyForm = () => {
...
render(<MyForm />)
`}),u=()=>(0,s.jsx)(r,{"data-visual-test":`wizard-with-status-message`,children:`<Form.Handler>
  <Wizard.Container
...
`}),d=()=>(0,s.jsx)(r,{"data-visual-test":`wizard-with-status-message-in-menu`,children:`<Form.Handler
  onSubmit={(data) => {
    console.log('onSubmit', data)
  }}
>
