import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{Ft as n,It as r,Lt as i,j as a,w as o}from"./forms-DuwGqcp3.js";import{F as s}from"./Autocomplete-BkdRYvuo.js";import{c,s as l}from"./Table-L2SFy5VR.js";import{t as u}from"./Card-DLQPvlXB.js";import{t as d}from"./TermDefinition-CLps80Gu.js";import{t as f}from"./ComponentBox-41YKKsr3.js";var p=e(t()),m=()=>(0,p.jsx)(f,{"data-visual-test":`help-button-default`,stableName:`HelpButtonDefaultExample`,sourceImports:[`import { HelpButton, Input, Dl, Dt, Dd, Dialog, TermDefinition } from '@dnb/eufemia'`,`import { Field, Form } from '@dnb/eufemia/extensions/forms'`],__buildScope:{HelpButton:l},children:`<HelpButton>Text</HelpButton>
...
`}),v=()=>(0,p.jsx)(f,{stableName:`HelpButtonInfoIconExample`,sourceImports:[`import { HelpButton, Input, Dl, Dt, Dd, Dialog, TermDefinition } from '@dnb/eufemia'`,`import { Field, Form } from '@dnb/eufemia/extensions/forms'`],__buildScope:{HelpButton:l,Dl:r,Dt:n,Dd:i},children:`<HelpButton icon="information" tooltip="More info">
  <Dl>
    <Dt>Term</Dt>
    <Dd>Description</Dd>
    <Dd>Description</Dd>
