import{a as e,n as t,s as n,t as r}from"./jsx-runtime-DnlWeMvz.js";import{a as i}from"./SpacingUtils-C2Ry62fw.js";import{$ as a,tt as o}from"./Anchor-ntifJ4U1.js";import{s}from"./ToggleButton-Bom-ZokA.js";import{t as c}from"./Space-DVeGblOo.js";import{t as l}from"./Button-U6duHosb.js";import{F as u}from"./Autocomplete-Ufk0jtry.js";import{t as d}from"./P-CfFm60MO.js";import{t as f}from"./Section-NtuOAPun.js";import{t as p}from"./Heading-3hHaA9oD.js";import{w as m}from"./index-D1L5wabr.js";import{t as h}from"./ComponentBox-B6YSImfw.js";var g=e({Components:()=>K,FourDirections:()=>J,InnerSpace:()=>S,InnerSpaceMediaQueries:()=>Z,MagicBox:()=>H,MarginCollapse:()=>C,Margins:()=>w,Method1:()=>y,Method2:()=>b,Method3:()=>x,ProviderExample:()=>Y,ResponsiveOuterSpace:()=>$,ResponsiveSpacing:()=>T,SameResult1:()=>W,SameResult2:()=>G,Shorthand:()=>q,SpaceInlineBlock:()=>Q,SpaceMediaQueries:()=>X,SpaceVisibleWhenVisualTestElements:()=>D,SpaceVisibleWhenVisualTestPatterns:()=>E,SpaceVisibleWhenVisualTestReset:()=>O,VisualSpace:()=>U}),_=n(t()),v=n(r()),y=()=>(0,v.jsx)(k,{children:(0,v.jsx)(h,{"data-visual-test":`spacing-method-space`,scope:{RedBox:M},stableName:`Method1`,sourceImports:[`import { useEffect, useRef, useState } from 'react'`,`import styled from '@emotion/styled'`,`import { Space, Input, Button, P, Code, Flex, Heading, Section } from '@dnb/eufemia'`,`import { Provider } from '@dnb/eufemia/shared'`,`import { useSpacing } from '@dnb/eufemia/components/space/SpacingUtils'`,`import { Theme } from '@emotion/react'`],__buildScope:{Space:c,Input:u},children:`<RedBox>
