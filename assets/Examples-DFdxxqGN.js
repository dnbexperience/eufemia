import{r as e}from"./rolldown-runtime-BYbx6iT9.js";import{t}from"./jsx-runtime-BgMs7Gb-.js";import{t as n}from"./ComponentBox-C64JNWnl.js";var r=e({AnimatedVisibility:()=>_,CombinedLayout:()=>f,DefaultLayout:()=>a,DefaultLayoutWithHelp:()=>c,GridLayout:()=>o,GridLayoutWithHelp:()=>l,GridLayoutWithHelpAndLabel:()=>u,HelpButton:()=>v,HorizontalLayout:()=>s,HorizontalLayoutWithHelp:()=>d,HorizontalLayoutWithoutLabel:()=>h,InheritLabel:()=>m,InheritVisibility:()=>p,MaxWidth:()=>y,WithHelpInInfoOverlay:()=>g}),i=t(),a=()=>(0,i.jsx)(n,{"data-visual-test":`forms-value-summary-list-default`,children:`<Form.Handler
  data={{
    firstName: 'John',
    lastName: 'Doe',
  }}
...
`}),o=()=>(0,i.jsx)(n,{"data-visual-test":`forms-value-summary-list-grid`,children:`<Form.Handler
  data={{
    firstName: 'John',
    lastName: 'Doe',
  }}
...
`}),s=()=>(0,i.jsx)(n,{"data-visual-test":`forms-value-summary-list-horizontal`,children:`<Form.Handler
  data={{
    firstName: 'John',
    lastName: 'Doe',
  }}
...
`}),c=()=>(0,i.jsx)(n,{"data-visual-test":`forms-value-summary-list-default-with-help`,children:`<Form.Handler
  data={{
    firstName: 'John',
    lastName: 'Doe',
    nickName: 'JD',
...
`}),l=()=>(0,i.jsx)(n,{"data-visual-test":`forms-value-summary-list-grid-with-help`,children:`<Form.Handler
  data={{
    firstName: 'John',
    lastName: 'Doe',
    nickName: 'JD',
...
`}),u=()=>(0,i.jsx)(n,{"data-visual-test":`forms-value-summary-list-grid-with-help-and-label`,children:`<Form.Handler
  data={{
    firstName: 'John',
    lastName: 'Doe',
    nickName: 'JD',
...
`}),d=()=>(0,i.jsx)(n,{"data-visual-test":`forms-value-summary-list-horizontal-with-help`,children:`<Form.Handler
  data={{
    firstName: 'John',
    lastName: 'Doe',
    nickName: 'JD',
...
`}),f=()=>(0,i.jsx)(n,{"data-visual-test":`forms-value-summary-list-combined`,children:`<Form.Handler
  data={{
    firstName: 'John',
    lastName: 'Doe',
    streetName: 'Osloveien',
...
`});function p(){return(0,i.jsx)(n,{children:`<Form.Handler>
  <Form.Card>
    <Field.Boolean
      variant="button"
      path="/isVisible"
...
`})}function m(){return(0,i.jsx)(n,{children:`<Form.Handler>
  <Form.Card>
...
`})}var h=()=>(0,i.jsx)(n,{"data-visual-test":`forms-value-summary-empty-label`,children:`<Value.SummaryList layout="horizontal">
  <Value.String value="foo" label="Foo" />
  <Value.String value="bar" />
  <Value.String value="baz" label="Baz" />
</Value.SummaryList>
`}),g=()=>(0,i.jsx)(n,{"data-visual-test":`forms-value-summary-with-help-in-info-overlay`,children:`<Form.Handler
  data={{
    firstName: 'John',
    lastName: 'Doe',
  }}
...
`});function _(){return(0,i.jsx)(n,{children:`<Form.Handler>
  <Flex.Stack>
    <Field.Boolean
...
`})}var v=()=>(0,i.jsx)(n,{"data-visual-test":`forms-value-summary-list-with-help-button`,children:`<Form.Handler>
  <Flex.Stack>
    <Form.Card>
      <Value.SummaryList>
        <Value.Boolean
...
`}),y=()=>(0,i.jsx)(n,{"data-visual-test":`forms-value-summary-list-with-max-width`,children:`<Form.Handler>
  <Form.Card>
    <Value.SummaryList>
      <Value.String
...
`});export{r as a,u as c,d,h as f,g,y as h,c as i,v as l,p as m,f as n,o,m as p,a as r,l as s,_ as t,s as u};