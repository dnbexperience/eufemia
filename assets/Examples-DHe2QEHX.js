import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{$ as r}from"./Anchor-BqZ7Pm7_.js";import{M as i}from"./Autocomplete-6fC_p2_U.js";import{t as a}from"./Section-BV74bciL.js";import{c as o}from"./ToggleButton-T4E3Coih.js";import{t as s}from"./Card-Dsou21Li.js";import{a as c,d as l,y as u}from"./Selection-5ph0VyAS.js";import{t as d}from"./NumberFormatExport-DHHZHF0w.js";import{t as f}from"./Slider-DcXU9hC-.js";import{t as p}from"./Form-B9l6EvGx.js";import{t as m}from"./Field-DHicZJEj.js";import{t as h}from"./ValueBlock-Cyu8DoZX.js";import{t as g}from"./Value-whMgauSk.js";import{n as _}from"./Wizard-DnoPfq0q.js";import{t as v}from"./Iterate-B2rVv1xi.js";import{t as y}from"./ComponentBox-Cb1rLw_D.js";var b=e({BaseFieldComponents:()=>E,CreateBasicFieldComponent:()=>C,CreateBasicValueComponent:()=>S,CreateComposedFieldComponent:()=>T,FeatureFields:()=>D,GettingStarted:()=>w,LayoutComponents:()=>O,QuickStart:()=>I,Transformers:()=>F,UsingFormHandler:()=>A,UsingFormSection:()=>N,UsingIterate:()=>P,UsingWizard:()=>M,Validation:()=>j,VisibilityBasedOnData:()=>k}),x=t(n()),S=()=>(0,x.jsx)(y,{scope:{ValueBlock:h},hideCode:!0,stableName:`CreateBasicValueComponent`,sourceImports:[`import { useCallback } from 'react'`,`import { Input, Slider, Flex, NumberFormat } from '@dnb/eufemia'`,`import { Form, Field, Value, FieldBlock, useFieldProps, DataContext, ValueBlock, Wizard, Iterate } from '@dnb/eufemia/extensions/forms'`],__buildScope:{ValueBlock:h,NumberFormat:d},noInline:!0,children:`const MyValue = ({ value, ...props }) => {
  return (
    <ValueBlock {...props}>
...
`}),C=()=>(0,x.jsx)(y,{scope:{useFieldProps:l},hideCode:!0,stableName:`CreateBasicFieldComponent`,sourceImports:[`import { useCallback } from 'react'`,`import { Input, Slider, Flex, NumberFormat } from '@dnb/eufemia'`,`import { Form, Field, Value, FieldBlock, useFieldProps, DataContext, ValueBlock, Wizard, Iterate } from '@dnb/eufemia/extensions/forms'`],__buildScope:{FieldBlock:c,Input:i},noInline:!0,children:`const MyField = (props) => {
...
render(<Component />)
`}),T=()=>(0,x.jsx)(y,{scope:{DataContext:u,useFieldProps:l},hideCode:!0,stableName:`CreateComposedFieldComponent`,sourceImports:[`import { useCallback } from 'react'`,`import { Input, Slider, Flex, NumberFormat } from '@dnb/eufemia'`,`import { Form, Field, Value, FieldBlock, useFieldProps, DataContext, ValueBlock, Wizard, Iterate } from '@dnb/eufemia/extensions/forms'`],__buildScope:{FieldBlock:c,Flex:o,Field:m,Slider:f,DataContext:u,Provider:r},noInline:!0,children:`const MyComposedField = (props) => {
