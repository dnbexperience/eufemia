import{a as e,r as t}from"./rolldown-runtime-BYbx6iT9.js";import{t as n}from"./jsx-runtime-BgMs7Gb-.js";import{b as r,g as i,t as a}from"./ComponentBox-a4aOn231.js";import{J as o,R as s}from"./index-DqqByKA2.js";var c=t({BaseFieldComponents:()=>m,CreateBasicFieldComponent:()=>d,CreateBasicValueComponent:()=>u,CreateComposedFieldComponent:()=>p,FeatureFields:()=>h,GettingStarted:()=>f,LayoutComponents:()=>g,QuickStart:()=>w,Transformers:()=>C,UsingFormHandler:()=>v,UsingFormSection:()=>x,UsingIterate:()=>S,UsingWizard:()=>b,Validation:()=>y,VisibilityBasedOnData:()=>_}),l=e(n()),u=()=>(0,l.jsx)(a,{scope:{ValueBlock:r},hideCode:!0,stableName:`CreateBasicValueComponent`,noInline:!0,children:`const MyValue = ({ value, ...props }) => {
  return (
    <ValueBlock {...props}>
...
`}),d=()=>(0,l.jsx)(a,{scope:{useFieldProps:s},hideCode:!0,stableName:`CreateBasicFieldComponent`,noInline:!0,children:`const MyField = (props) => {
...
`}),f=()=>(0,l.jsx)(a,{hideCode:!0,stableName:`GettingStarted`,noInline:!0,children:`const existingData = {
  companyName: 'DNB',
...
render(<Component />)
`}),p=()=>(0,l.jsx)(a,{scope:{DataContext:o,useFieldProps:s},hideCode:!0,stableName:`CreateComposedFieldComponent`,noInline:!0,children:`const MyComposedField = (props) => {
...
`}),m=()=>(0,l.jsx)(a,{scope:{Value:i},stableName:`BaseFieldComponents`,children:`<Form.Card>
  <Field.String
    label="Text field"
    value="Lorem Ipsum"
...
`}),h=()=>(0,l.jsx)(a,{scope:{Value:i},stableName:`FeatureFields`,children:`<Form.Card>
...
`}),g=()=>(0,l.jsx)(a,{scope:{Value:i},stableName:`LayoutComponents`,children:`<Flex.Stack>
...
`}),_=()=>(0,l.jsx)(a,{scope:{Value:i},stableName:`VisibilityBasedOnData`,children:`<Form.Handler
  defaultData={{
    firstName: undefined,
    lastName: 'Smith',
    advanced: false,
...
`}),v=()=>(0,l.jsx)(a,{scope:{Value:i},stableName:`UsingFormHandler`,children:`<Form.Handler
  defaultData={{
    firstName: 'John',
    lastName: 'Smith',
    ssn: '20058512345',
...
`}),y=()=>(0,l.jsx)(a,{scope:{Value:i},stableName:`Validation`,children:`<Form.Handler
  defaultData={{
    firstName: undefined,
    lastName: 'Smith',
    ssn: '123',
...
`}),b=()=>(0,l.jsx)(a,{stableName:`UsingWizard`,noInline:!0,children:`function MyForm() {
...
render(<MyForm />)
`}),x=()=>(0,l.jsx)(a,{stableName:`UsingFormSection`,noInline:!0,children:`const MyEditContainer = () => {
  return (
...
`}),S=()=>(0,l.jsx)(a,{stableName:`UsingIterate`,noInline:!0,children:`const MyEditItemForm = () => {
  return (
    <Field.Composition>
...
render(<MyForm />)
`}),C=()=>(0,l.jsx)(a,{hideCode:!0,stableName:`Transformers`,noInline:!0,children:`const MyForm = () => {
...
render(<MyForm />)
`}),w=()=>(0,l.jsx)(a,{hideCode:!0,stableName:`QuickStart`,noInline:!0,children:`const existingData = {
  companyName: 'DNB',
}
function MyForm() {
  return (
...
render(<MyForm />)
`});export{c as a,g as c,v as d,x as f,_ as g,y as h,p as i,w as l,b as m,d as n,h as o,S as p,u as r,f as s,m as t,C as u};