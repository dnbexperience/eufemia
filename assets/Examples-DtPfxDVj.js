import{a as e}from"./rolldown-runtime-BYbx6iT9.js";import{t}from"./jsx-runtime-BgMs7Gb-.js";import{t as n}from"./confetti_medium-DnvMT790.js";import{$t as r,Bn as i,Ft as a,Hi as o,Oi as s,gr as c,wr as l}from"./index-mmuoVhax.js";import{t as u}from"./ComponentBox-XDAvsf_r.js";var d=e(t()),f=()=>(0,d.jsx)(u,{"data-visual-test":`global-status`,stableName:`GlobalInfoOverlayError`,sourceImports:[`import { createContext, useContext, useEffect, useRef, useState } from 'react'`,`import { GlobalStatus, Button, Input, Section, ToggleButton, Icon } from '@dnb/eufemia'`,`import { confetti_medium } from '@dnb/eufemia/icons'`,`import { Provider } from '@dnb/eufemia/shared'`],__buildScope:{GlobalStatus:r},children:`<GlobalStatus
  title="Custom Title"
  text="Failure text"
  items={[
    {
...
`}),h=()=>(0,d.jsx)(u,{"data-visual-test":`global-status-success`,stableName:`GlobalInfoOverlaySuccess`,sourceImports:[`import { createContext, useContext, useEffect, useRef, useState } from 'react'`,`import { GlobalStatus, Button, Input, Section, ToggleButton, Icon } from '@dnb/eufemia'`,`import { confetti_medium } from '@dnb/eufemia/icons'`,`import { Provider } from '@dnb/eufemia/shared'`],__buildScope:{GlobalStatus:r},children:`<GlobalStatus
  ...
  id="demo-6"
/>
`}),g=()=>(0,d.jsx)(u,{scope:{confetti_medium:n},"data-visual-test":`global-status-icon`,stableName:`GlobalInfoCustomIcon`,sourceImports:[`import { createContext, useContext, useEffect, useRef, useState } from 'react'`,`import { GlobalStatus, Button, Input, Section, ToggleButton, Icon } from '@dnb/eufemia'`,`import { confetti_medium } from '@dnb/eufemia/icons'`,`import { Provider } from '@dnb/eufemia/shared'`],__buildScope:{GlobalStatus:r,Icon:s},children:`<GlobalStatus
  ...
  id="demo-icon"
/>
`}),_=()=>(0,d.jsx)(u,{stableName:`GlobalStatusCoupling`,sourceImports:[`import { createContext, useContext, useEffect, useRef, useState } from 'react'`,`import { GlobalStatus, Button, Input, Section, ToggleButton, Icon } from '@dnb/eufemia'`,`import { confetti_medium } from '@dnb/eufemia/icons'`,`import { Provider } from '@dnb/eufemia/shared'`],__buildScope:{Input:c},noInline:!0,children:`const InputWithError = () => {
...
`}),v=()=>(0,d.jsx)(u,{hideCode:!0,stableName:`GlobalStatusAddRemoveItems`,sourceImports:[`import { createContext, useContext, useEffect, useRef, useState } from 'react'`,`import { GlobalStatus, Button, Input, Section, ToggleButton, Icon } from '@dnb/eufemia'`,`import { confetti_medium } from '@dnb/eufemia/icons'`,`import { Provider } from '@dnb/eufemia/shared'`],__buildScope:{GlobalStatus:r,Button:l},noInline:!0,children:`function AddRemoveItems() {
...
`}),y=()=>(0,d.jsx)(u,{hideCode:!0,stableName:`GlobalStatusScrolling`,sourceImports:[`import { createContext, useContext, useEffect, useRef, useState } from 'react'`,`import { GlobalStatus, Button, Input, Section, ToggleButton, Icon } from '@dnb/eufemia'`,`import { confetti_medium } from '@dnb/eufemia/icons'`,`import { Provider } from '@dnb/eufemia/shared'`],__buildScope:{Button:l,GlobalStatus:r},children:`<Button
...
/>
`}),b=()=>(0,d.jsx)(u,{hideCode:!0,stableName:`GlobalStatusUpdate`,sourceImports:[`import { createContext, useContext, useEffect, useRef, useState } from 'react'`,`import { GlobalStatus, Button, Input, Section, ToggleButton, Icon } from '@dnb/eufemia'`,`import { confetti_medium } from '@dnb/eufemia/icons'`,`import { Provider } from '@dnb/eufemia/shared'`],__buildScope:{GlobalStatus:r,Input:c,Section:i,ToggleButton:a,Button:l},noInline:!0,children:`const Context = createContext(null)
const UpdateDemo = () => {
...
render(<UpdateDemo />)
`}),x=()=>(0,d.jsx)(u,{hidePreview:!0,hideToolbar:!0,stableName:`GlobalStatusInfoExample1`,sourceImports:[`import { createContext, useContext, useEffect, useRef, useState } from 'react'`,`import { GlobalStatus, Button, Input, Section, ToggleButton, Icon } from '@dnb/eufemia'`,`import { confetti_medium } from '@dnb/eufemia/icons'`,`import { Provider } from '@dnb/eufemia/shared'`],__buildScope:{GlobalStatus:r},children:`<GlobalStatus id="other-global-status" />
`}),S=()=>(0,d.jsx)(u,{hidePreview:!0,hideToolbar:!0,stableName:`GlobalStatusInfoExample2`,sourceImports:[`import { createContext, useContext, useEffect, useRef, useState } from 'react'`,`import { GlobalStatus, Button, Input, Section, ToggleButton, Icon } from '@dnb/eufemia'`,`import { confetti_medium } from '@dnb/eufemia/icons'`,`import { Provider } from '@dnb/eufemia/shared'`],__buildScope:{GlobalStatus:r,Input:c},children:`
...
`}),C=()=>(0,d.jsx)(u,{hidePreview:!0,hideToolbar:!0,stableName:`GlobalStatusInfoExample3`,sourceImports:[`import { createContext, useContext, useEffect, useRef, useState } from 'react'`,`import { GlobalStatus, Button, Input, Section, ToggleButton, Icon } from '@dnb/eufemia'`,`import { confetti_medium } from '@dnb/eufemia/icons'`,`import { Provider } from '@dnb/eufemia/shared'`],__buildScope:{GlobalStatus:r,Provider:o,Input:c},children:`
<GlobalStatus id="other-global-status" />
<Provider
  formElement={{
    globalStatus: {
...
`}),w=()=>(0,d.jsx)(u,{hidePreview:!0,hideToolbar:!0,stableName:`GlobalStatusInfoExampleManipulate1`,sourceImports:[`import { createContext, useContext, useEffect, useRef, useState } from 'react'`,`import { GlobalStatus, Button, Input, Section, ToggleButton, Icon } from '@dnb/eufemia'`,`import { confetti_medium } from '@dnb/eufemia/icons'`,`import { Provider } from '@dnb/eufemia/shared'`],__buildScope:{GlobalStatus:r},noInline:!0,children:`// 1. Update / extend the status like so:
...
`}),T=()=>(0,d.jsx)(u,{hidePreview:!0,hideToolbar:!0,stableName:`GlobalStatusInfoExampleManipulate2`,sourceImports:[`import { createContext, useContext, useEffect, useRef, useState } from 'react'`,`import { GlobalStatus, Button, Input, Section, ToggleButton, Icon } from '@dnb/eufemia'`,`import { confetti_medium } from '@dnb/eufemia/icons'`,`import { Provider } from '@dnb/eufemia/shared'`],__buildScope:{GlobalStatus:r},children:`
