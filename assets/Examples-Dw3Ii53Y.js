import{a as e}from"./rolldown-runtime-BYbx6iT9.js";import{n as t,t as n}from"./jsx-runtime-BgMs7Gb-.js";import{at as r,it as i,ot as a,t as o}from"./ComponentBox-a4aOn231.js";import{Ji as s,Un as c,ni as l,y as u}from"./index-DqqByKA2.js";var d=e(t()),f=e(n()),p=u.div`
  [data-visual-test] {
...
`,m=()=>(0,f.jsx)(p,{children:(0,f.jsx)(o,{scope:{topMovies:O},stableName:`AutocompleteDefaultExample`,children:`<Autocomplete data={topMovies} label="Label" />
`})}),h=()=>(0,f.jsx)(p,{children:(0,f.jsx)(o,{"data-visual-test":`autocomplete-status-information`,scope:{topMovies:O},stableName:`AutocompleteStatusInfoExample`,children:`<Autocomplete
  data={topMovies}
  label="Label"
  ...
  showSubmitButton
/>
`})}),g=()=>(0,f.jsx)(p,{children:(0,f.jsx)(o,{"data-visual-test":`autocomplete-status-error`,scope:{topMovies:O},stableName:`AutocompleteStatusErrorExample`,children:`<Autocomplete
  label="Status error"
  data={[topMovies[0]]}
  status="Error"
  statusState="error"
  ...
  direction="bottom"
/>
`})}),_=[i(20001234567),i(22233344425),a(1234.5),r(`+47116000`)],v=()=>(0,f.jsx)(p,{children:(0,f.jsx)(o,{scope:{numbersData:_},stableName:`AutocompleteNumbersExample`,children:`<Autocomplete
  inputValue="201"
  showClearButton
  label="Label"
  data={numbersData}
  searchNumbers={true}
/>
`})}),y=()=>(0,f.jsx)(p,{children:(0,f.jsx)(o,{"data-visual-test":`autocomplete-closed`,scope:{topMovies:O},stableName:`AutocompleteWithCustomTitle`,children:`<Autocomplete
  data={topMovies}
  keepValue={true}
...
/>
`})}),b=()=>(0,f.jsx)(p,{children:(0,f.jsx)(o,{scope:{topMovies:O},stableName:`AutocompleteDynamicallyUpdatedData`,noInline:!0,children:`const onTypeHandler = ({
  value,
  showIndicator,
  hideIndicator,
  updateData,
...
`})}),x=()=>(0,f.jsx)(p,{children:(0,f.jsx)(o,{scope:{topMovies:O},stableName:`AutocompleteFirstFocusUpdate`,noInline:!0,children:`const onFocusHandler = ({ updateData, dataList, showIndicatorItem }) => {
  if (!dataList.length) {
    showIndicatorItem()
    setTimeout(() => {
...
`})}),S=()=>(0,f.jsx)(p,{children:(0,f.jsx)(o,{"data-visual-test":`autocomplete-drawer-button`,scope:{topMovies:O},stableName:`AutocompleteToggleExample`,children:`<Autocomplete
  label="Label"
  value={10}
...
`})}),C=()=>(0,f.jsx)(p,{children:(0,f.jsx)(o,{"data-visual-test":`autocomplete-drawer-search`,scope:{topMovies:O},stableName:`AutocompletePredefinedInput`,children:`<Autocomplete
  label="Label"
...
`})}),w=()=>(0,f.jsx)(p,{children:(0,f.jsx)(o,{"data-visual-test":`autocomplete-sizes`,scope:{topMovies:O},stableName:`AutocompleteDifferentSizes`,children:`<Flex.Vertical>
...
`})}),T=()=>(0,f.jsx)(o,{"data-visual-test":`autocomplete-input-width`,scope:{topMovies:O},stableName:`AutocompleteCustomWidth`,noInline:!0,children:`const CustomWidthOne = styled(Autocomplete)\`
...
`}),E=()=>{let{locale:e}=(0,d.useContext)(s),t=i(20001234567,{locale:e}),n=a(12345678,{locale:e});return(0,f.jsx)(o,{"data-visual-test":`autocomplete-suffix`,scope:{numbers:[{selectedValue:`Brukskonto`,suffixValue:n,content:[`Brukskonto`,t]},{selectedValue:`BSU`,suffixValue:n,content:[`BSU`,t]},{selectedValue:`Sparekonto`,suffixValue:n,content:[`Sparekonto`,t]},{selectedValue:`Brukskonto`,suffixValue:n,content:[`Brukskonto`,t]}]},stableName:`AutocompleteSuffix`,noInline:!0,children:`const CustomWidth = styled(Autocomplete)\`
  .dnb-drawer-list__root,
  .dnb-autocomplete__shell {
    width: 50vw;
    min-width: 15rem;
...
`})},D=()=>(0,f.jsx)(p,{children:(0,f.jsx)(o,{"data-visual-test":`autocomplete-opened`,scope:{topMovies:O},hideCode:!0,stableName:`AutocompleteOpened`,children:`
<Autocomplete
  label="Label"
  inputValue="lord"
  open
...
`})}),A=()=>(0,f.jsx)(p,{children:(0,f.jsx)(o,{"data-visual-test":`autocomplete-disabled-options`,stableName:`AutocompleteDisabledOptionsExample`,children:`<Autocomplete
  showSubmitButton
  data={[
    {
      disabled: true,
  ...
  bottom
/>
`})}),j=()=>(0,f.jsx)(p,{children:(0,f.jsx)(o,{hidePreview:!0,stableName:`AutocompleteContentAsArrayExample`,children:`<Autocomplete
  data={[
    {
      content: [
  ...
  label="Label"
/>
`})}),M=()=>(0,f.jsx)(p,{children:(0,f.jsx)(o,{hidePreview:!0,stableName:`AutocompleteContentAsFragmentExample`,children:`<Autocomplete
  data={[
    {
      content: (
        <>
  ...
  label="Label"
/>
`})}),N=()=>(0,f.jsx)(p,{children:(0,f.jsx)(o,{hidePreview:!0,stableName:`AutocompleteContentDecoupledExample`,children:`<Autocomplete
  data={[
    {
  ...
  label="Label"
/>
`})}),P=()=>(0,f.jsx)(p,{children:(0,f.jsx)(o,{"data-visual-test":`autocomplete-groups`,stableName:`AutocompleteGroups`,children:`<Autocomplete
...
/>
`})});export{E as _,m as a,A as c,P as d,v as f,h as g,g as h,T as i,b as l,C as m,M as n,w as o,D as p,N as r,k as s,j as t,x as u,S as v,y};