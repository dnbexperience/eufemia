...
`}),R=()=>(0,w.jsx)(r,{scope:{Connectors:N,getMockDataAddress:j,mockFetch:I},stableName:`Address`,noInline:!0,children:`const { withConfig } = Connectors.createContext({
  fetchConfig: {
    url: async (value, { countryCode }) => {
