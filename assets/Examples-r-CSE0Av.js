import{a as e}from"./rolldown-runtime-BYbx6iT9.js";import{n as t,t as n}from"./jsx-runtime-BgMs7Gb-.js";import{$ as r,et as i,t as a,tt as o}from"./ComponentBox-geTEYZ7b.js";import{_n as s,a as c,qi as l,ti as u}from"./index-CMgyXmp3.js";var d=e(t()),f=n(),p=c.div`
  [data-visual-test] {
...
`,m=()=>(0,f.jsx)(p,{children:(0,f.jsx)(a,{scope:{topMovies:O},children:`<Autocomplete data={topMovies} label="Label" />
`})}),h=()=>(0,f.jsx)(p,{children:(0,f.jsx)(a,{"data-visual-test":`autocomplete-status-information`,scope:{topMovies:O},children:`<Autocomplete
  data={topMovies}
  label="Label"
  ...
  showSubmitButton
/>
`})}),g=()=>(0,f.jsx)(p,{children:(0,f.jsx)(a,{"data-visual-test":`autocomplete-status-error`,scope:{topMovies:O},children:`<Autocomplete
  label="Status error"
  data={[topMovies[0]]}
  status="Error"
  statusState="error"
  ...
  direction="bottom"
/>
`})}),_=[r(20001234567),r(22233344425),o(1234.5),i(`+47116000`)],v=()=>(0,f.jsx)(p,{children:(0,f.jsx)(a,{scope:{numbersData:_},children:`<Autocomplete
  inputValue="201"
  showClearButton
  label="Label"
  data={numbersData}
  searchNumbers={true}
/>
`})}),y=()=>(0,f.jsx)(p,{children:(0,f.jsx)(a,{"data-visual-test":`autocomplete-closed`,scope:{topMovies:O},children:`<Autocomplete
  data={topMovies}
  keepValue={true}
...
/>
`})}),b=()=>(0,f.jsx)(p,{children:(0,f.jsx)(a,{scope:{topMovies:O},noInline:!0,children:`const onTypeHandler = ({
  value,
  showIndicator,
  hideIndicator,
  updateData,
...
`})}),x=()=>(0,f.jsx)(p,{children:(0,f.jsx)(a,{scope:{topMovies:O},noInline:!0,children:`const onFocusHandler = ({ updateData, dataList, showIndicatorItem }) => {
  if (!dataList.length) {
    showIndicatorItem()
    setTimeout(() => {
...
`})}),S=()=>(0,f.jsx)(p,{children:(0,f.jsx)(a,{"data-visual-test":`autocomplete-drawer-button`,scope:{topMovies:O},children:`<Autocomplete
  label="Label"
  value={10}
...
`})}),C=()=>(0,f.jsx)(p,{children:(0,f.jsx)(a,{"data-visual-test":`autocomplete-drawer-search`,scope:{topMovies:O},children:`<Autocomplete
  label="Label"
...
`})}),w=()=>(0,f.jsx)(p,{children:(0,f.jsx)(a,{"data-visual-test":`autocomplete-sizes`,scope:{topMovies:O},children:`<Flex.Vertical>
...
`})}),T=()=>(0,f.jsx)(a,{"data-visual-test":`autocomplete-input-width`,scope:{topMovies:O},noInline:!0,children:`const CustomWidthOne = styled(Autocomplete)\`
...
`})},D=()=>(0,f.jsx)(p,{children:(0,f.jsx)(a,{"data-visual-test":`autocomplete-opened`,scope:{topMovies:O},hideCode:!0,children:`
<Autocomplete
  label="Label"
  inputValue="lord"
  open
...
`})}),A=()=>(0,f.jsx)(p,{children:(0,f.jsx)(a,{"data-visual-test":`autocomplete-disabled-options`,children:`<Autocomplete
  showSubmitButton
  data={[
    {
      disabled: true,
  ...
  bottom
/>
`})}),j=()=>(0,f.jsx)(p,{children:(0,f.jsx)(a,{hidePreview:!0,children:`<Autocomplete
  data={[
    {
      content: [
  ...
  label="Label"
/>
`})}),M=()=>(0,f.jsx)(p,{children:(0,f.jsx)(a,{hidePreview:!0,children:`<Autocomplete
  data={[
    {
      content: (
        <>
  ...
  label="Label"
/>
`})}),N=()=>(0,f.jsx)(p,{children:(0,f.jsx)(a,{hidePreview:!0,children:`<Autocomplete
  data={[
    {
  ...
  label="Label"
/>
`})}),P=()=>(0,f.jsx)(p,{children:(0,f.jsx)(a,{"data-visual-test":`autocomplete-groups`,children:`<Autocomplete
