import{a as e,r as t}from"./rolldown-runtime-BYbx6iT9.js";import{t as n}from"./jsx-runtime-BgMs7Gb-.js";import{t as r}from"./ComponentBox-a4aOn231.js";var i=t({AsynchronousExternalBlurValidator:()=>T,AsynchronousExternalChangeValidator:()=>C,Capitalize:()=>f,Clear:()=>h,Disabled:()=>g,HorizontalLayout:()=>u,Icons:()=>m,LabelAndDescription:()=>c,LabelAndValue:()=>s,MaximumLengthWithTextCounter:()=>N,MultipleEmpty:()=>E,MultipleLabelAndValue:()=>k,MultipleOneRow:()=>D,MultiplePlaceholder:()=>O,MultipleWithHelp:()=>A,OnInput:()=>M,Placeholder:()=>o,SynchronousExternalBlurValidator:()=>w,SynchronousExternalChangeValidator:()=>S,TransformInAndOut:()=>j,ValidateMaximumLengthCustomError:()=>b,ValidateMinimumLength:()=>y,ValidatePattern:()=>x,ValidateRequired:()=>v,Widths:()=>p,WithHelp:()=>d,WithMultipleError:()=>_,WithStatus:()=>l}),a=e(n()),o=()=>(0,a.jsx)(r,{stableName:`Placeholder`,children:`<Field.String
  label="Label text"
  placeholder="Enter a text..."
  onChange={(value) => console.log('onChange', value)}
/>
`}),s=()=>(0,a.jsx)(r,{stableName:`LabelAndValue`,children:`<Field.String
  label="Label text"
  defaultValue="foo"
  onChange={(value) => console.log('onChange', value)}
/>
`}),c=()=>(0,a.jsx)(r,{"data-visual-test":`string-label-description`,stableName:`LabelAndDescription`,children:`<Form.Card>
  <Field.String
    label="Label text"
...
`}),l=()=>(0,a.jsx)(r,{"data-visual-test":`string-status`,stableName:`WithStatus`,children:`<Form.Card>
  <Field.String
    label="Label text"
    defaultValue="foo"
...
`}),u=()=>(0,a.jsx)(r,{"data-visual-test":`string-horizontal-layout`,stableName:`HorizontalLayout`,children:`<Form.Card>
  <Field.Provider
    layout="horizontal"
    layoutOptions={{
...
`}),d=()=>(0,a.jsx)(r,{stableName:`WithHelp`,children:`<Field.String
  label="Label text"
  defaultValue="foo"
  help={{
  ...
  onChange={(value) => console.log('onChange', value)}
/>
`}),f=()=>(0,a.jsx)(r,{stableName:`Capitalize`,children:`<Field.String
  label="Label text"
  defaultValue="foo bar"
  capitalize
  onChange={(value) => console.log('onChange', value)}
/>
`}),p=()=>(0,a.jsx)(r,{hideCode:!0,"data-visual-test":`string-widths`,stableName:`Widths`,children:`<Flex.Stack>
  <Field.String
...
`}),m=()=>(0,a.jsx)(r,{stableName:`Icons`,children:`<Form.Card>
  <Field.String
    label="Icon left"
    defaultValue="foo"
    leftIcon="check"
...
`}),h=()=>(0,a.jsx)(r,{stableName:`Clear`,children:`<Field.String
  defaultValue="foo"
  onChange={(value) => console.log('onChange', value)}
  clear
/>
`}),g=()=>(0,a.jsx)(r,{stableName:`Disabled`,children:`<Field.String
  defaultValue="foo"
  label="Label text"
  onChange={(value) => console.log('onChange', value)}
  disabled
/>
`}),_=()=>(0,a.jsx)(r,{"data-visual-test":`multiple-errors`,stableName:`WithMultipleError`,children:`<Field.String
  ...
  validateInitially
/>
`}),v=()=>(0,a.jsx)(r,{stableName:`ValidateRequired`,children:`<Field.String
  defaultValue="foo"
  label="Label text"
  onChange={(value) => console.log('onChange', value)}
  required
/>
`}),y=()=>(0,a.jsx)(r,{stableName:`ValidateMinimumLength`,children:`<Field.String
  defaultValue="foo"
  label="Label text (minimum 8 characters)"
  onChange={(value) => console.log('onChange', value)}
  minLength={8}
/>
`}),b=()=>(0,a.jsx)(r,{stableName:`ValidateMaximumLengthCustomError`,children:`<Field.String
  defaultValue="foo"
...
/>
`}),x=()=>(0,a.jsx)(r,{stableName:`ValidatePattern`,children:`<Field.String
  defaultValue="foo"
  label="Label text"
  onChange={(value) => console.log('onChange', value)}
  pattern="^foo123"
/>
`}),S=()=>(0,a.jsx)(r,{stableName:`SynchronousExternalChangeValidator`,children:`<Field.String
  defaultValue="foo"
  ...
  onChange={(value) => console.log('onChange', value)}
/>
`}),C=()=>(0,a.jsx)(r,{stableName:`AsynchronousExternalChangeValidator`,children:`<Field.String
  defaultValue="foo"
  label="Label text (minimum 4 characters)"
  onChangeValidator={(value) =>
    new Promise((resolve) =>
  ...
  onChange={(value) => console.log('onChange', value)}
/>
`}),w=()=>(0,a.jsx)(r,{stableName:`SynchronousExternalBlurValidator`,children:`<Field.String
  defaultValue="foo"
  label="Label text (minimum 4 characters)"
  ...
  onChange={(value) => console.log('onChange', value)}
/>
`}),T=()=>(0,a.jsx)(r,{stableName:`AsynchronousExternalBlurValidator`,children:`<Field.String
  defaultValue="foo"
  label="Label text (minimum 4 characters)"
  onBlurValidator={(value) =>
    new Promise((resolve) =>
  ...
  onChange={(value) => console.log('onChange', value)}
/>
`}),E=()=>(0,a.jsx)(r,{stableName:`MultipleEmpty`,children:`<Field.String
  onChange={(value) => console.log('onChange', value)}
  multiline
/>
`}),D=()=>(0,a.jsx)(r,{stableName:`MultipleOneRow`,children:`<Field.String
  label="Label text"
  ...
  characterCounter={40}
/>
`}),O=()=>(0,a.jsx)(r,{stableName:`MultiplePlaceholder`,children:`<Field.String
  placeholder="Enter text here"
  onChange={(value) => console.log('onChange', value)}
  multiline
/>
`}),k=()=>(0,a.jsx)(r,{stableName:`MultipleLabelAndValue`,children:`<Field.String
  ...
  multiline
/>
`}),A=()=>(0,a.jsx)(r,{stableName:`MultipleWithHelp`,children:`<Field.String
  label="Label text"
  help={{
    title: 'Help is available',
  ...
  onChange={(value) => console.log('onChange', value)}
/>
`});function j(){return(0,a.jsx)(r,{stableName:`TransformInAndOut`,noInline:!0,children:`// From the Field (internal value) to the data context or event parameter
...
render(<MyForm />)
`})}var M=()=>(0,a.jsx)(r,{stableName:`OnInput`,noInline:!0,children:`const forbiddenRegex = /\\d/
...
`}),N=()=>(0,a.jsx)(r,{stableName:`MaximumLengthWithTextCounter`,noInline:!0,children:`const MyFieldStringWithTextCounter = () => {
