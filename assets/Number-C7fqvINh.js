import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{U as n}from"./index-kfZVC31v.js";import r from"./demos-BKNHclhu.js";var i=e(t());function a(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,ul:`ul`,...n(),...e.components};return(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(t.h2,{children:`Import`}),`
...
`,(0,i.jsx)(t.h2,{children:`Non-finite values (Infinity and NaN)`}),`
`,(0,i.jsxs)(t.p,{children:[`A derived value can sometimes resolve to a non-finite number. A common example is a calculated percentage where the previous value is `,(0,i.jsx)(t.code,{children:`0`}),`, which results in a division by zero and produces `,(0,i.jsx)(t.code,{children:`Infinity`}),`.`]}),`
`,(0,i.jsxs)(t.p,{children:[(0,i.jsx)(t.code,{children:`Field.Number`}),` renders non-finite values (`,(0,i.jsx)(t.code,{children:`Infinity`}),`, `,(0,i.jsx)(t.code,{children:`-Infinity`}),` and `,(0,i.jsx)(t.code,{children:`NaN`}),`) as an empty input rather than a partial value like `,(0,i.jsx)(t.code,{children:`-`}),`. They are still invalid: validation fails with a clear, localized message (`,(0,i.jsx)(t.code,{children:`NumberField.errorInvalidNumber`}),`, for example "Must be a valid number.") instead of a cryptic type error, so the user is blocked until an empty or finite value is provided. The value stored in the data context is left untouched.`]}),`
`,(0,i.jsxs)(t.p,{children:[`For an impossible calculation, store an empty value (such as `,(0,i.jsx)(t.code,{children:`undefined`}),`) instead of a non-finite number so the field is valid. The same applies when you provide your own `,(0,i.jsx)(t.code,{children:`schema`}),` – see `,(0,i.jsx)(t.a,{href:`/uilib/extensions/forms/Form/schema-validation/#non-finite-numbers-infinity-and-nan`,children:`Schema validation`}),` for details.`]}),`
