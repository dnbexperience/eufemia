import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{U as n}from"./index-CGxQ8PRe.js";import r from"./demos-CW1uDfiT.js";var i=e(t());function a(e){let t={a:`a`,code:`code`,h2:`h2`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(t.h2,{children:`Import`}),`
...
`,(0,i.jsxs)(t.p,{children:[`The `,(0,i.jsx)(t.code,{children:`formHandlerId`}),` is required. The matching `,(0,i.jsx)(t.code,{children:`Form.Handler`}),` can be rendered before or after the outlet. The outlet stays empty until the handler context is available and then connects automatically.`]}),`
