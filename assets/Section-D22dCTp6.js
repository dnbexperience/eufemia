import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{B as n}from"./index-DdG6L_K8.js";import r from"./demos-DqyHr4UL.js";var i=e(t());function a(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,li:`li`,ol:`ol`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(t.h2,{children:`Import`}),`
...
const MySection = (props) => {
  return (
    <Form.Section {...props}>
      ...
      <Field.Name path="//user/profile/name" />
    </Form.Section>
  )
}
...
`})}),`
`,(0,i.jsxs)(t.p,{children:[`To get autocomplete and compile-time checking on the section-relative `,(0,i.jsx)(t.code,{children:`path`}),` props, derive the section type from your registered root data with `,(0,i.jsx)(t.code,{children:`TypedSectionField`}),`. See `,(0,i.jsx)(t.a,{href:`/uilib/extensions/forms/typed-paths/#type-checking-section-relative-paths`,children:`Type-checked paths`}),`.`]}),`
