import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{m as r,w as i}from"./forms-CsJzlVUF.js";import{t as a}from"./P-CbimSwQH.js";import{t as o}from"./Card-DP9KYSzC.js";import{t as s}from"./Heading-CDZ3ehTc.js";import{B as c}from"./index-DdG6L_K8.js";import{t as l}from"./ComponentBox-q_23Ylzi.js";import u from"./components-CTpCXG_L.js";var d=e({IntroExample:()=>p}),f=t(n()),p=()=>(0,f.jsx)(l,{hideCode:!0,stableName:`IntroExample`,sourceImports:[`import { Form, Wizard } from '@dnb/eufemia/extensions/forms'`,`import { P } from '@dnb/eufemia'`],__buildScope:{Wizard:r,Form:i,Heading:s,Card:o,P:a},noInline:!0,children:`const MyForm = () => {
...
render(<MyForm />)
`});function m(e){let t={a:`a`,code:`code`,h2:`h2`,li:`li`,p:`p`,pre:`pre`,ul:`ul`,...c(),...e.components};return d||g(`Examples`,!1),p||g(`Examples.IntroExample`,!0),(0,f.jsxs)(f.Fragment,{children:[(0,f.jsx)(t.h2,{children:`Import`}),`
...
`})})]})}function h(e={}){let{wrapper:t}={...c(),...e.components};return t?(0,f.jsx)(t,{...e,children:(0,f.jsx)(m,{...e})}):m(e)}function g(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}function _(e){return(0,f.jsxs)(f.Fragment,{children:[(0,f.jsx)(h,{}),`
`,(0,f.jsx)(u,{})]})}function v(e={}){let{wrapper:t}={...c(),...e.components};return t?(0,f.jsx)(t,{...e,children:(0,f.jsx)(_,{...e})}):_(e)}export{v as default};