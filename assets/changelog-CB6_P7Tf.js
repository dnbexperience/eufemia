import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{B as n}from"./index-DdG6L_K8.js";var r=e(t());function i(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,li:`li`,p:`p`,ul:`ul`,...n(),...e.components};return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(t.h1,{children:`Change log`}),`
...
`,(0,r.jsx)(t.h2,{children:`v11.7.0`}),`
`,(0,r.jsxs)(t.ul,{children:[`
`,(0,r.jsxs)(t.li,{children:[`Added `,(0,r.jsx)(t.a,{href:`/uilib/extensions/forms/Form/Outlet/`,children:`Form.Outlet`}),` to connect fields and submit controls outside a `,(0,r.jsx)(t.code,{children:`Form.Handler`}),` subtree to the same form state.`]}),`
`,(0,r.jsxs)(t.li,{children:[`Added `,(0,r.jsx)(t.a,{href:`/uilib/extensions/forms/typed-paths/`,children:`type-checked paths`}),`: register your form data type once via the `,(0,r.jsx)(t.code,{children:`Register`}),` interface, then use the pre-typed `,(0,r.jsx)(t.code,{children:`RegisteredField`}),`, `,(0,r.jsx)(t.code,{children:`RegisteredValue`}),`, `,(0,r.jsx)(t.code,{children:`RegisteredForm`}),` and `,(0,r.jsx)(t.code,{children:`RegisteredIterate`}),` namespaces for autocomplete and compile-time checking of the `,(0,r.jsx)(t.code,{children:`path`}),` prop.`]}),`
`,(0,r.jsx)(t.li,{children:`Optimized data updates to reduce unnecessary field and derived-value updates when unrelated form data paths change, improving responsiveness in large forms.`}),`
`]}),`
