import{a as e,r as t}from"./rolldown-runtime-BYbx6iT9.js";import{t as n}from"./jsx-runtime-BgMs7Gb-.js";import{Bn as r,In as i,Rr as a,Wi as o,un as s}from"./index-Da-r8F54.js";import{t as c}from"./ComponentBox-DXeEXSK2.js";var l=t({CodeExample:()=>d}),u=e(n());function d(){return(0,u.jsx)(c,{stableName:`CodeExample`,sourceImports:[`import { Code, Flex, P, Section } from '@dnb/eufemia'`],__buildScope:{Flex:s,P:i,Code:o,Section:r},children:`<Flex.Stack>
  <P>
...
`})}function f(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...a(),...e.components};return l||m(`Examples`,!1),d||m(`Examples.CodeExample`,!0),(0,u.jsxs)(u.Fragment,{children:[(0,u.jsx)(t.h2,{children:`Import`}),`
...
`]}),`
`,(0,u.jsxs)(t.p,{children:[`You can find the theme and its definitions in the `,(0,u.jsx)(t.a,{href:`https://github.com/dnbexperience/eufemia/blob/main/packages/dnb-eufemia/src/style/themes/ui/prism/dnb-prism-theme.js`,children:`GitHub repository`}),`.`]})]})}function p(e={}){let{wrapper:t}={...a(),...e.components};return t?(0,u.jsx)(t,{...e,children:(0,u.jsx)(f,{...e})}):f(e)}function m(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{p as default};