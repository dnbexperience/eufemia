import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{t as n}from"./Icon-BZYo2248.js";import{t as r}from"./Button-QIkiaQEp.js";import{B as i,U as a}from"./index-DdG6L_K8.js";import{t as o}from"./ComponentBox-q_23Ylzi.js";var s=e(t()),c=()=>(0,s.jsx)(o,{stableName:`LargeButtonsAndIconsExample`,sourceImports:[`import { Button, Icon } from '@dnb/eufemia'`,`import styled from '@emotion/styled'`,`import { hamburger as hamburgerIcon } from '@dnb/eufemia/icons'`],__buildScope:{Button:r},children:`
<Button
  variant="secondary"
...
`}),l=()=>(0,s.jsx)(o,{scope:{hamburgerIcon:a},stableName:`ExtendedExample`,sourceImports:[`import { Button, Icon } from '@dnb/eufemia'`,`import styled from '@emotion/styled'`,`import { hamburger as hamburgerIcon } from '@dnb/eufemia/icons'`],__buildScope:{Button:r,Icon:n},noInline:!0,children:`const Wrapper = styled.div\`
  .dnb-button {
    --button-width: 4rem;
    --button-height: 4rem;
