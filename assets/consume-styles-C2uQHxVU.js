import{t as e}from"./jsx-runtime-BgMs7Gb-.js";import{Lr as t}from"./index-DVm0MbGb.js";var n=e();function r(e){let r={a:`a`,code:`code`,h1:`h1`,h2:`h2`,p:`p`,pre:`pre`,strong:`strong`,...t(),...e.components};return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(r.h1,{children:`Importing the CSS`}),`
...
`})}),`
`,(0,n.jsx)(r.h2,{children:`Runtime theme switching`}),`
`,(0,n.jsx)(r.p,{children:`If your application needs to switch theme at runtime, preload the relevant theme CSS files and update the active theme through your application state.`}),`
