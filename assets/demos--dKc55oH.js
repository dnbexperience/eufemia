import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{s as r}from"./ToggleButton-Cp78oGqp.js";import{j as i,w as a}from"./forms-So8FhW-K.js";import{t as o}from"./Section-84TIytH1.js";import{U as s}from"./index-GbBmkyvI.js";import{t as c}from"./ComponentBox-Brk_-GCP.js";var l=e({Default:()=>d,FilterData:()=>f}),u=t(n());function d(){return(0,u.jsx)(c,{stableName:`Default`,sourceImports:[`import { Flex, Section } from '@dnb/eufemia'`,`import { Form, Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:a,Field:i},noInline:!0,children:`const existingData = {
  foo: 'bar',
}
const Component = () => {
...
render(<Component />)
`})}function f(){return(0,u.jsx)(c,{stableName:`FilterData`,sourceImports:[`import { Flex, Section } from '@dnb/eufemia'`,`import { Form, Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:a,Flex:r,Field:i,Section:o},noInline:!0,children:`// Method A (if you know the paths)
