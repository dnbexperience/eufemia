import{n as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{Q as r}from"./Anchor-BPx9fjvj.js";import{c as i,s as a}from"./SpacingUtils-Bo00Pdpx.js";import{n as o,r as s,t as c}from"./withComponentMarkers-ClZmq6eb.js";import{t as l}from"./Element-erlxUm8v.js";import{t as u}from"./ToggleButton-DfKpi57X.js";import{t as d}from"./Space-FJLTI-Fc.js";import{t as f}from"./Button-kSqfAUVR.js";import{F as p}from"./Autocomplete-eAFtuLbJ.js";import{t as m}from"./P-CVKBz4XO.js";import{t as h}from"./H2-DASO3mku.js";import{t as g}from"./Paragraph-JD42OzMS.js";import{t as _}from"./Heading-OwOHsD1e.js";import{L as v,U as y,m as b}from"./index-BsJ3GLEw.js";import{t as x}from"./ComponentBox-sLMgHvLi.js";import{n as S,t as C}from"./Examples-C5x0PYG4.js";var w=t(n());function T({ref:e,...t}){return(0,w.jsx)(l,{as:`div`,skeletonMethod:`shape`,ref:e,...t})}c(T,{_supportsSpacingProps:!0});var E=T,D=t(e());function O({rows:e=3,children:t=null,...n}){let r=(0,D.useMemo)(()=>{let t=[70,80,60,40,50,20,0];return Array.from({length:Number(e)},(e,n)=>{let r=n%t.length;return r===t.length-1&&t.reverse(),t[r]})},[e]);return(0,w.jsxs)(`div`,{className:a(`dnb-skeleton__figure`,`dnb-skeleton__figure--show`),"aria-busy":!0,...n,children:[(0,w.jsx)(d,{element:`div`,bottom:`large`,className:a(`dnb-h--xx-large`,`dnb-skeleton`,`dnb-skeleton--shape`),"aria-hidden":!0,style:{width:`50%`},children:`‌`}),r.map((e,t)=>(0,w.jsx)(d,{element:`div`,top:`x-small`,className:a(`dnb-p`,`dnb-skeleton`,`dnb-skeleton--shape`),style:{width:`${e}%`},children:`‌`},t)),typeof t==`function`?t():t]})}var k=()=>(0,w.jsx)(x,{stableName:`SkeletonInputExample`,sourceImports:[`import { Suspense, useContext, useState } from 'react'`,`import Context from '@dnb/eufemia/shared/Context'`,`import { Input, H2, P, Button, Skeleton, ToggleButton, Div } from '@dnb/eufemia'`,`import { AllComponentsHorizontalTestCase, AllComponentsVerticalLabelsTestCase } from '../../layout/Examples'`,`import Provider from '@dnb/eufemia/shared/Provider'`,`import { Article } from '@dnb/eufemia/components/skeleton/figures'`,`import { createSkeletonClass, skeletonDOMAttributes } from '@dnb/eufemia/components/skeleton/SkeletonHelper'`],__buildScope:{Input:p},children:`<Input label="Input" skeleton />
