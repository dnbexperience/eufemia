import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{a as r,t as i}from"./HelpButton-Cz0h9G-Q.js";import{c as a}from"./ToggleButton-BtQrsiHY.js";import{t as o}from"./Card--_AKADDp.js";import{g as s}from"./Upload-Cy4J3xfd.js";import{t as c}from"./Form-913YPZs6.js";import{t as l}from"./Field-CbVmykdw.js";import{W as u,m as d}from"./index-D7e1avVt.js";import{t as f}from"./ComponentBox-CE7bpcJy.js";var p=e({Autoresize:()=>b,CharacterCounter:()=>v,Disabled:()=>S,FormStatus:()=>x,MaxLength:()=>T,Placeholder:()=>g,RowsCols:()=>h,Sizes:()=>w,Stretched:()=>y,Suffix:()=>C,Vertical:()=>_}),m=t(n()),h=()=>(0,m.jsx)(E,{children:(0,m.jsx)(f,{"data-visual-test":`textarea-default`,stableName:`RowsCols`,sourceImports:[`import styled from '@emotion/styled'`,`import { Textarea, HelpButton, Flex } from '@dnb/eufemia'`,`import { Field, Form } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Textarea:s},children:`<Textarea
  label="Default"
  rows="2"
  cols="20"
