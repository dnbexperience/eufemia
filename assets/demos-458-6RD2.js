...
\`
render(<Example />)
`})}function h(){return(0,d.jsx)(u,{stableName:`HeightAnimationUntilFound`,sourceImports:[`import { useState } from 'react'`,`import styled from '@emotion/styled'`,`import { HeightAnimation, ToggleButton, Section, Button, Anchor, P, Space } from '@dnb/eufemia'`],__buildScope:{ToggleButton:r,HeightAnimation:i,Space:a,Section:c,P:s},noInline:!0,children:`const Example = () => {
  const [openState, setOpenState] = useState(false)
  return (
    <>
      <ToggleButton
...
`,(0,d.jsxs)(t.p,{children:[`The `,(0,d.jsx)(t.code,{children:`untilFound`}),` prop keeps collapsed content available to the browser's find-in-page feature using `,(0,d.jsx)(t.code,{children:`hidden="until-found"`}),`. Search this page for `,(0,d.jsx)(t.strong,{children:`“Findable banking content”`}),`. HeightAnimation reveals the match itself, while the optional `,(0,d.jsx)(t.code,{children:`onBeforeMatch`}),` callback synchronizes the toggle's external state.`]}),`
