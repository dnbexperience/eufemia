import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{c as r}from"./ToggleButton-_NsXxiTa.js";import{t as i}from"./Slider-DPZMIsHa.js";import{f as a}from"./Upload-CSUC0Eyp.js";import{t as o}from"./Form-JTiJXf2d.js";import{t as s}from"./Field-DqRpWyNm.js";import{K as c}from"./index-ppRu2ktv.js";import{t as l}from"./ComponentBox-R2c6Bo76.js";var u=e({NestedSize:()=>p,Size:()=>f}),d=t(n()),f=()=>(0,d.jsx)(l,{"data-visual-test":`form-appearance-size`,stableName:`Size`,sourceImports:[`import { Form, Field } from '@dnb/eufemia/extensions/forms'`,`import { Flex } from '@dnb/eufemia'`,`import { FormAppearanceProps } from '@dnb/eufemia/extensions/forms/Form/Appearance'`],__buildScope:{Form:o,Flex:r,Field:s,Slider:i,Upload:a},noInline:!0,children:`type AppearanceData = {
...
render(<Appearance />)
`}),p=()=>(0,d.jsx)(l,{"data-visual-test":`form-appearance-size-nested`,stableName:`NestedSize`,sourceImports:[`import { Form, Field } from '@dnb/eufemia/extensions/forms'`,`import { Flex } from '@dnb/eufemia'`,`import { FormAppearanceProps } from '@dnb/eufemia/extensions/forms/Form/Appearance'`],__buildScope:{Form:o,Flex:r,Field:s},children:`<Form.Appearance size="medium">
  <Form.Handler>
    <Flex.Stack>
