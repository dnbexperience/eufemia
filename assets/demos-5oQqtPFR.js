import{a as e}from"./rolldown-runtime-BYbx6iT9.js";import{t}from"./jsx-runtime-BgMs7Gb-.js";import{t as n}from"./newspaper-BXngBJwU.js";import{t as r}from"./ComponentBox-a4aOn231.js";import{_i as i,vi as a,y as o,zr as s}from"./index-DqqByKA2.js";var c=e(t()),l=o.div`
...
`})}),f=()=>(0,c.jsx)(l,{children:(0,c.jsx)(r,{"data-visual-test":`dropdown-closed`,stableName:`DropdownNoValue`,noInline:!0,children:`const data = [
...
`})}),p=()=>(0,c.jsx)(l,{children:(0,c.jsx)(r,{"data-visual-test":`dropdown-ellipsis`,stableName:`DropdownEllipsisOverflow`,children:`<Dropdown
  data={['Long text that will overflow with CSS ellipsis']}
  value={0}
  label="Label"
/>
`})}),m=()=>(0,c.jsx)(l,{children:(0,c.jsx)(r,{scope:{visualTestProps:e=>e?{direction:`top`}:{}},"data-visual-test":`dropdown-item-directions`,stableName:`DropdownDirections`,children:`<Dropdown
  label="Label"
  data={[
    ['Vertical', 'alignment'],
    <>
...
/>
`})}),h=()=>(0,c.jsx)(l,{children:(0,c.jsx)(r,{scope:{data:u},"data-visual-test":`dropdown-left-icon`,stableName:`DropdownIconLeft`,children:`<Dropdown
  label="Label"
  iconPosition="left"
  data={data}
  value={3}
...
/>
`})}),g=()=>(0,c.jsx)(l,{children:(0,c.jsx)(r,{scope:{data:u},"data-visual-test":`dropdown-tertiary`,stableName:`DropdownTertiary`,children:`<Dropdown
  variant="tertiary"
  direction="bottom"
  ...
  data={data}
/>
`})}),_=()=>(0,c.jsx)(l,{children:(0,c.jsx)(r,{scope:{data:u},"data-visual-test":`dropdown-tertiary-right`,stableName:`DropdownTertiaryRight`,children:`<Dropdown
  variant="tertiary"
  direction="bottom"
  independentWidth={true}
  iconPosition="right"
  ...
  data={data}
/>
`})}),v=()=>(0,c.jsx)(l,{children:(0,c.jsx)(r,{"data-visual-test":`dropdown-independent_width_left`,stableName:`DropdownIndependentWidthLeft`,children:`<Dropdown
  independentWidth={true}
  iconPosition="left"
  direction="top"
  ...
  right="small"
/>
`})}),y=()=>(0,c.jsx)(l,{children:(0,c.jsx)(r,{"data-visual-test":`dropdown-independent_width_right`,stableName:`DropdownIndependentWidthRight`,children:`<Dropdown
  independentWidth={true}
  iconPosition="right"
  direction="top"
  title="Choose an item"
  ...
  right="small"
/>
`})}),b=()=>(0,c.jsx)(l,{children:(0,c.jsx)(r,{scope:{data:u},"data-visual-test":`dropdown-disabled`,stableName:`DropdownDisabled`,children:`<Dropdown disabled data={['Disabled Dropdown']} label="Label" />
`})}),x=()=>(0,c.jsx)(l,{children:(0,c.jsx)(r,{"data-visual-test":`dropdown-disabled-options`,stableName:`DropdownDisabledOptions`,children:`<Dropdown
  data={[
    {
      content: 'Item 1 Content',
    },
  ...
  label="Label"
/>
`})}),S=()=>(0,c.jsx)(l,{children:(0,c.jsx)(r,{"data-visual-test":`dropdown-disabled-tertiary`,stableName:`DropdownDisabledTertiary`,children:`<Dropdown
  disabled
  variant="tertiary"
  data={['Disabled Dropdown']}
  label="Disabled tertiary dropdown"
/>
`})}),C=()=>(0,c.jsx)(l,{children:(0,c.jsx)(r,{"data-visual-test":`dropdown-sizes`,scope:{data:u},stableName:`DropdownSizes`,children:`<Flex.Vertical>
...
`})}),w=()=>(0,c.jsx)(l,{children:(0,c.jsx)(r,{scope:{data:u},stableName:`DropdownCustomWidth`,noInline:!0,children:`const CustomWidthOne = styled(Dropdown)\`
  .dnb-dropdown__shell {
    width: 10rem;
  }
\`
...
`})}),T=()=>(0,c.jsx)(l,{children:(0,c.jsx)(r,{"data-visual-test":`dropdown-status-error`,scope:{data:u},stableName:`DropdownStatusVertical`,children:`<Dropdown data={data} label="Label" status="Message to the user" />
`})}),E=()=>(0,c.jsx)(l,{children:(0,c.jsx)(r,{"data-visual-test":`dropdown-list`,scope:{data:u},hideCode:!0,stableName:`DropdownListOpened`,children:`<span className="dnb-drawer-list__list">
...
`})}),D=()=>(0,c.jsx)(l,{children:(0,c.jsx)(r,{scope:{chevron_right:i,newspaper:n,chevron_down:a},stableName:`DropdownCustomizedLook`,noInline:!0,children:`const styles = {
  customTrigger: {
...
`})}),O=()=>(0,c.jsx)(l,{children:(0,c.jsx)(r,{"data-visual-test":`dropdown-groups`,stableName:`DropdownGroups`,children:`<Dropdown
...
/>
`})});function k(e){let t={code:`code`,h2:`h2`,h3:`h3`,p:`p`,...s(),...e.components},{VisibleWhenVisualTest:n}=t;return n||j(`VisibleWhenVisualTest`,!0),(0,c.jsxs)(c.Fragment,{children:[(0,c.jsx)(t.h2,{children:`Demos`}),`
...
`,(0,c.jsx)(O,{})]})}function A(e={}){let{wrapper:t}={...s(),...e.components};return t?(0,c.jsx)(t,{...e,children:(0,c.jsx)(k,{...e})}):k(e)}function j(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{A as default};