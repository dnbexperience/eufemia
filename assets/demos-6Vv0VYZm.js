import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{t as n}from"./Anchor-VfvEVqst.js";import{n as r,t as i}from"./Dt-DEsWpbJ1.js";import{n as a,t as o}from"./Ul-CJsdjIEO.js";import{t as s}from"./Link-CbyKMXKy.js";import{R as c,W as l,z as u}from"./index-D7e1avVt.js";import{t as d}from"./ComponentBox-CE7bpcJy.js";var f=e(t()),p=()=>(0,f.jsx)(d,{hideCode:!0,"data-visual-test":`lists-dl`,stableName:`DefinitionListExample`,sourceImports:[`import { Dl, Dt, Dd, Ul, Li, Ol, Anchor } from '@dnb/eufemia'`,`import styled from '@emotion/styled'`],__buildScope:{Dl:u,Dt:i,Dd:r},children:`<Dl>
  <Dt>Term</Dt>
  <Dd>Description</Dd>
  <Dt>Term</Dt>
  <Dd>Description 1</Dd>
...
`}),m=()=>(0,f.jsx)(d,{hideCode:!0,"data-visual-test":`lists-dl-horizontal`,stableName:`DefinitionListHorizontalExample`,sourceImports:[`import { Dl, Dt, Dd, Ul, Li, Ol, Anchor } from '@dnb/eufemia'`,`import styled from '@emotion/styled'`],__buildScope:{Dl:u,Dt:i,Dd:r},children:`<Dl layout="horizontal">
  <Dl.Item>
    <Dt>Term 1</Dt>
    <Dd>Description 1</Dd>
  </Dl.Item>
...
`}),h=()=>(0,f.jsx)(d,{hideCode:!0,"data-visual-test":`lists-dl-grid`,stableName:`DefinitionListGridExample`,sourceImports:[`import { Dl, Dt, Dd, Ul, Li, Ol, Anchor } from '@dnb/eufemia'`,`import styled from '@emotion/styled'`],__buildScope:{Dl:u,Dt:i,Dd:r},children:`<Dl layout="grid">
  <Dt>Term 1</Dt>
  <Dd>Description 1</Dd>
...
`}),g=()=>(0,f.jsx)(d,{hideCode:!0,"data-visual-test":`lists-ul`,stableName:`UnorderedListExample`,sourceImports:[`import { Dl, Dt, Dd, Ul, Li, Ol, Anchor } from '@dnb/eufemia'`,`import styled from '@emotion/styled'`],__buildScope:{Ul:o,Li:a,Anchor:n,Link:s},children:`<Ul>
  <Li>Item 1</Li>
  <Li>Item 2</Li>
  <Li>
    Item 3
...
`}),_=()=>(0,f.jsx)(d,{hideCode:!0,"data-visual-test":`lists-ol`,stableName:`OrderedListNestedExample`,sourceImports:[`import { Dl, Dt, Dd, Ul, Li, Ol, Anchor } from '@dnb/eufemia'`,`import styled from '@emotion/styled'`],__buildScope:{Ol:c,Li:a},children:`<Ol nested>
  <Li>Item</Li>
  <Li>
    Item
    <Ol>
...
`}),v=()=>(0,f.jsx)(d,{hideCode:!0,"data-visual-test":`lists-ol-style-position`,stableName:`OrderedListStylePositionExample`,sourceImports:[`import { Dl, Dt, Dd, Ul, Li, Ol, Anchor } from '@dnb/eufemia'`,`import styled from '@emotion/styled'`],__buildScope:{Ol:c,Li:a},noInline:!0,children:`const WidthLimit = styled.div\`
  max-width: 22rem;
  .dnb-ol li::before {
...
`}),y=()=>(0,f.jsx)(d,{hideCode:!0,"data-visual-test":`lists-ol-types`,stableName:`OrderedListOtherTypesExample`,sourceImports:[`import { Dl, Dt, Dd, Ul, Li, Ol, Anchor } from '@dnb/eufemia'`,`import styled from '@emotion/styled'`],__buildScope:{Ol:c,Li:a},children:`<Ol type="A">
  <Li>Item</Li>
  <Li>
    Item
    <Ol type="I" start={3}>
...
`}),x=()=>(0,f.jsx)(d,{hideCode:!0,"data-visual-test":`ul-inside-ol`,stableName:`UlInsideOl`,sourceImports:[`import { Dl, Dt, Dd, Ul, Li, Ol, Anchor } from '@dnb/eufemia'`,`import styled from '@emotion/styled'`],__buildScope:{Ol:c,Li:a,Ul:o},children:`<Ol>
  <Li>
    Ordered item 1
    <Ul>
...
`});function S(e){let t={code:`code`,em:`em`,h2:`h2`,h3:`h3`,h4:`h4`,p:`p`,...l(),...e.components};return(0,f.jsxs)(f.Fragment,{children:[(0,f.jsx)(t.h2,{children:`Demos`}),`
...
`,(0,f.jsx)(b,{})]})}function C(e={}){let{wrapper:t}={...l(),...e.components};return t?(0,f.jsx)(t,{...e,children:(0,f.jsx)(S,{...e})}):S(e)}export{C as default};