import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{t as n}from"./Anchor-C8qEa0kQ.js";import{Ft as r,It as i,Lt as a,Pt as o}from"./forms-So8FhW-K.js";import{n as s,t as c}from"./Ul-BYrNoJV6.js";import{t as l}from"./Link-CL6QqJQ4.js";import{U as u}from"./index-GbBmkyvI.js";import{t as d}from"./ComponentBox-Brk_-GCP.js";var f=e(t()),p=()=>(0,f.jsx)(d,{hideCode:!0,"data-visual-test":`lists-dl`,stableName:`DefinitionListExample`,sourceImports:[`import { Dl, Dt, Dd, Ul, Li, Ol, Anchor } from '@dnb/eufemia'`,`import styled from '@emotion/styled'`],__buildScope:{Dl:i,Dt:r,Dd:a},children:`<Dl>
  <Dt>Term</Dt>
  <Dd>Description</Dd>
  <Dt>Term</Dt>
  <Dd>Description 1</Dd>
...
`}),m=()=>(0,f.jsx)(d,{hideCode:!0,"data-visual-test":`lists-dl-horizontal`,stableName:`DefinitionListHorizontalExample`,sourceImports:[`import { Dl, Dt, Dd, Ul, Li, Ol, Anchor } from '@dnb/eufemia'`,`import styled from '@emotion/styled'`],__buildScope:{Dl:i,Dt:r,Dd:a},children:`<Dl layout="horizontal">
  <Dl.Item>
    <Dt>Term 1</Dt>
    <Dd>Description 1</Dd>
  </Dl.Item>
...
`}),h=()=>(0,f.jsx)(d,{hideCode:!0,"data-visual-test":`lists-dl-grid`,stableName:`DefinitionListGridExample`,sourceImports:[`import { Dl, Dt, Dd, Ul, Li, Ol, Anchor } from '@dnb/eufemia'`,`import styled from '@emotion/styled'`],__buildScope:{Dl:i,Dt:r,Dd:a},children:`<Dl layout="grid">
  <Dt>Term 1</Dt>
  <Dd>Description 1</Dd>
...
`}),_=()=>(0,f.jsx)(d,{hideCode:!0,"data-visual-test":`lists-ol`,stableName:`OrderedListNestedExample`,sourceImports:[`import { Dl, Dt, Dd, Ul, Li, Ol, Anchor } from '@dnb/eufemia'`,`import styled from '@emotion/styled'`],__buildScope:{Ol:o,Li:s},children:`<Ol nested>
  <Li>Item</Li>
  <Li>
    Item
    <Ol>
...
`}),v=()=>(0,f.jsx)(d,{hideCode:!0,"data-visual-test":`lists-ol-style-position`,stableName:`OrderedListStylePositionExample`,sourceImports:[`import { Dl, Dt, Dd, Ul, Li, Ol, Anchor } from '@dnb/eufemia'`,`import styled from '@emotion/styled'`],__buildScope:{Ol:o,Li:s},noInline:!0,children:`const WidthLimit = styled.div\`
  max-width: 22rem;
  .dnb-ol li::before {
...
`}),y=()=>(0,f.jsx)(d,{hideCode:!0,"data-visual-test":`lists-ol-types`,stableName:`OrderedListOtherTypesExample`,sourceImports:[`import { Dl, Dt, Dd, Ul, Li, Ol, Anchor } from '@dnb/eufemia'`,`import styled from '@emotion/styled'`],__buildScope:{Ol:o,Li:s},children:`<Ol type="A">
  <Li>Item</Li>
  <Li>
    Item
    <Ol type="I" start={3}>
...
`}),x=()=>(0,f.jsx)(d,{hideCode:!0,"data-visual-test":`ul-inside-ol`,stableName:`UlInsideOl`,sourceImports:[`import { Dl, Dt, Dd, Ul, Li, Ol, Anchor } from '@dnb/eufemia'`,`import styled from '@emotion/styled'`],__buildScope:{Ol:o,Li:s,Ul:c},children:`<Ol>
  <Li>
    Ordered item 1
    <Ul>
