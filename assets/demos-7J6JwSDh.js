import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{U as n}from"./index-kfZVC31v.js";import{a as r,c as i,d as a,f as o,i as s,l as c,n as l,o as u,r as d,s as f,t as p,u as m}from"./Examples-C1b30eGF.js";var h=e(t());function g(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,p:`p`,pre:`pre`,strong:`strong`,...n(),...e.components},{VisibilityByTheme:g,VisibleWhenVisualTest:_}=t;return g||v(`VisibilityByTheme`,!0),_||v(`VisibleWhenVisualTest`,!0),(0,h.jsxs)(h.Fragment,{children:[(0,h.jsx)(t.h2,{children:`Demos`}),`
...
`,(0,h.jsx)(t.p,{children:`Accordion can be disabled, though it is not exactly defined what the use case is.`}),`
`,(0,h.jsx)(r,{}),`
...
`,(0,h.jsxs)(t.p,{children:[`A lightweight variant that renders a tertiary button with a chevron icon. The button and content can be placed separately in the tree by sharing the same `,(0,h.jsx)(t.code,{children:`connectedTo`}),` identifier. The button automatically sets `,(0,h.jsx)(t.code,{children:`aria-expanded`}),` and `,(0,h.jsx)(t.code,{children:`aria-controls`}),` to link it with the content panel. When activated by keyboard or screen reader style input, focus moves to the content region. Pointer clicks do not move focus.`]}),`
`,(0,h.jsx)(o,{}),`
