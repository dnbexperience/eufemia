import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{s as r}from"./ToggleButton-Bh3Eln0h.js";import{dt as i,g as a,j as o,l as s,w as c}from"./forms-Ce7VSRGW.js";import{t as l}from"./Card-C4jdcnXT.js";import{t as u}from"./Section-CEKACurl.js";import{t as d}from"./ajv-biK4rg3L.js";import{U as f}from"./index-DHCu7dhB.js";import{t as p}from"./ComponentBox-CmvipvMU.js";var m=e({DataSetSchema:()=>_,DependentListSchema:()=>y,DependentSchemaValidation:()=>b,DependentSchemaValidationWithZod:()=>x,IfRuleSchema:()=>v,SingleFieldSchema:()=>g}),h=t(n()),g=()=>(0,h.jsx)(p,{scope:{makeAjvInstance:d},stableName:`SingleFieldSchema`,sourceImports:[`import { Flex, Section } from '@dnb/eufemia'`,`import { z, Form, Field, Iterate, Tools, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:c,Field:o},noInline:!0,children:`const ajv = makeAjvInstance()
const schema = {
  type: 'string',
  minLength: 5,
}
