...
`}),p=()=>(0,l.jsx)(s,{stableName:`LinkedLabel`,sourceImports:[`import { FormLabel, Checkbox, Switch } from '@dnb/eufemia'`],__buildScope:{FormLabel:r,Switch:o},children:`<form>
  <div>
    <div>
...
`});function m(e){let t={code:`code`,h2:`h2`,h3:`h3`,...a(),...e.components};return c||g(`Examples`,!1),u||g(`Examples.Default`,!0),d||g(`Examples.Horizontal`,!0),p||g(`Examples.LinkedLabel`,!0),f||g(`Examples.NoForId`,!0),(0,l.jsxs)(l.Fragment,{children:[(0,l.jsx)(t.h2,{children:`Demos`}),`
...
`,(0,l.jsx)(p,{})]})}function h(e={}){let{wrapper:t}={...a(),...e.components};return t?(0,l.jsx)(t,{...e,children:(0,l.jsx)(m,{...e})}):m(e)}function g(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{h as default};