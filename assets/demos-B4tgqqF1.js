...
`}),s=()=>(0,a.jsx)(r,{stableName:`DropdownPlaceholder`,children:`<Field.Selection
...
`}),c=()=>(0,a.jsx)(r,{stableName:`DropdownLabel`,children:`<Field.Selection
  label="Label text"
  onChange={(value) => console.log('onChange', value)}
>
  <Field.Option value="foo" title="Foo!" />
...
`});function l(){return(0,a.jsx)(r,{stableName:`DropdownTransformSelection`,children:`<Field.Selection
  label="Label"
  value="bar"
...
`})}var u=()=>(0,a.jsx)(r,{"data-visual-test":`selection-dropdown-default`,stableName:`DropdownLabelAndOptionSelected`,children:`<Field.Selection
  value="bar"
  label="Label text"
  onChange={(value) => console.log('onChange', value)}
>
...
`}),d=()=>(0,a.jsx)(r,{"data-visual-test":`selection-dropdown-help`,stableName:`WithHelp`,children:`<Field.Selection
  value="bar"
  label="Label text"
  help={{
...
`}),f=()=>(0,a.jsx)(r,{"data-visual-test":`selection-dropdown-horizontal`,stableName:`HorizontalLayout`,children:`<Field.Selection
  value="bar"
  label="Label text"
  layout="horizontal"
  onChange={(value) => console.log('onChange', value)}
...
`}),p=()=>(0,a.jsx)(r,{hideCode:!0,"data-visual-test":`selection-dropdown-widths`,stableName:`DropdownWidths`,children:`<Flex.Stack>
...
`}),m=()=>(0,a.jsx)(r,{stableName:`DropdownDisabled`,children:`<Field.Selection
  value="bar"
  label="Label text"
  onChange={(value) => console.log('onChange', value)}
  disabled
...
`}),h=()=>(0,a.jsx)(r,{stableName:`DropdownDisabledOptions`,noInline:!0,children:`const Example = () => {
  return (
...
render(<Example />)
`}),g=()=>(0,a.jsx)(r,{stableName:`DropdownError`,children:`<Field.Selection
  value="bar"
  label="Label text"
  onChange={(value) => console.log('onChange', value)}
...
`}),_=()=>(0,a.jsx)(r,{stableName:`DropdownDynamicOptions`,noInline:!0,children:`const Example = () => {
...
render(<Example />)
`}),v=()=>(0,a.jsx)(r,{stableName:`DropdownHighNumberOfOptions`,children:`<Field.Selection
  value="option-15"
  label="Label text"
  onChange={(value) => console.log('onChange', value)}
>
...
`}),y=()=>(0,a.jsx)(r,{stableName:`DropdownValidationRequired`,children:`<Field.Selection
  value="foo"
  label="Label text"
  onChange={(value) => console.log('onChange', value)}
  onFocus={(value) => console.log('onFocus', value)}
...
`}),b=()=>(0,a.jsx)(r,{stableName:`DropdownWithData`,children:`<Field.Selection
  label="Label text"
  data={[
    {
      title: 'One',
...
/>
`}),x=()=>(0,a.jsx)(r,{stableName:`DropdownWithAPath`,children:`<Form.Handler
  data={{
    example: {
      list: [
        {
...
`}),S=()=>(0,a.jsx)(r,{"data-visual-test":`selection-dropdown-groups`,stableName:`DropdownGroups`,children:`<Field.Selection
  label="Label text"
  path="/selection"
  dataPath="/example/list"
  groups={['Foos', 'Bars']}
...
`}),C=()=>(0,a.jsx)(r,{stableName:`AutocompleteLabel`,children:`<Field.Selection
...
`}),w=()=>(0,a.jsx)(r,{stableName:`AutocompleteValidationRequired`,children:`<Field.Selection
  variant="autocomplete"
  label="Label text"
  onChange={(value) => console.log('onChange', value)}
  onFocus={(value) => console.log('onFocus', value)}
...
`}),T=()=>(0,a.jsx)(r,{"data-visual-test":`selection-autocomplete-groups`,stableName:`AutocompleteGroups`,children:`<Field.Selection
  variant="autocomplete"
  label="Label text"
  path="/selection"
  dataPath="/example/list"
...
`}),E=()=>(0,a.jsx)(r,{stableName:`RadioEmpty`,children:`<Field.Selection
  variant="radio"
  onChange={(value) => console.log('onChange', value)}
>
  <Field.Option value="foo" title="Foo!" />
...
`}),D=()=>(0,a.jsx)(r,{"data-visual-test":`selection-radio-options-vertical`,stableName:`RadioLabel`,children:`<Field.Selection
  variant="radio"
  label="Label text"
  onChange={(value) => console.log('onChange', value)}
>
...
`}),O=()=>(0,a.jsx)(r,{"data-visual-test":`selection-radio-vertical`,stableName:`RadioOptionSelected`,children:`<Field.Selection
  variant="radio"
  label="Label text"
  value="bar"
  onChange={(value) => console.log('onChange', value)}
...
`}),k=()=>(0,a.jsx)(r,{"data-visual-test":`selection-radio-horizontal`,stableName:`RadioHorizontalLayout`,children:`<Field.Selection
  variant="radio"
  label="Label text"
  value="bar"
  layout="horizontal"
...
`}),A=()=>(0,a.jsx)(r,{"data-visual-test":`selection-radio-options-horizontal`,stableName:`RadioHorizontalOptionsLayout`,children:`<Field.Selection
  variant="radio"
  label="Label text"
  value="bar"
...
`}),j=()=>(0,a.jsx)(r,{stableName:`RadioHorizontalLayoutAndHorizontalOptionsLayout`,children:`<Field.Selection
  variant="radio"
  label="Label text"
  value="bar"
  layout="horizontal"
...
`}),M=()=>(0,a.jsx)(r,{stableName:`RadioDisabled`,children:`<Field.Selection
  variant="radio"
  value="bar"
  label="Label text"
  onChange={(value) => console.log('onChange', value)}
...
`}),N=()=>(0,a.jsx)(r,{stableName:`RadioDisabledOptions`,noInline:!0,children:`const Example = () => {
  return (
...
render(<Example />)
`}),P=()=>(0,a.jsx)(r,{stableName:`RadioError`,children:`<Field.Selection
  variant="radio"
  value="bar"
  label="Label text"
  onChange={(value) => console.log('onChange', value)}
...
`}),F=()=>(0,a.jsx)(r,{stableName:`RadioWithData`,children:`<Field.Selection
  variant="radio"
  label="Label text"
  data={[
    {
...
/>
`}),I=()=>(0,a.jsx)(r,{stableName:`RadioWithAPath`,children:`<Form.Handler
  data={{
    example: {
      list: [
        {
...
`}),L=()=>(0,a.jsx)(r,{stableName:`RadioWithListComposition`,children:`<Form.Handler
  defaultData={{
    selection: 'bar',
    myDataPath: [
      {
...
`}),R=()=>(0,a.jsx)(r,{hideCode:!0,"data-visual-test":`selection-radio-nesting-logic`,stableName:`RadioNestingWithLogic`,children:`<Form.Handler onSubmit={console.log}>
  <Form.Card>
    <Field.Selection
      variant="radio"
...
`}),z=()=>(0,a.jsx)(r,{hideCode:!0,"data-visual-test":`selection-radio-advanced-nesting-logic`,stableName:`RadioNestingAdvanced`,children:`<Form.Handler
  defaultData={{
    mySelection: 'first',
...
`}),B=()=>(0,a.jsx)(r,{stableName:`ButtonEmpty`,children:`<Field.Selection
  variant="button"
  onChange={(value) => console.log('onChange', value)}
>
  <Field.Option value="foo" title="Foo!" />
...
`}),V=()=>(0,a.jsx)(r,{"data-visual-test":`selection-button-options-vertical`,stableName:`ButtonLabel`,children:`<Field.Selection
  variant="button"
  label="Label text"
  onChange={(value) => console.log('onChange', value)}
>
...
`}),H=()=>(0,a.jsx)(r,{"data-visual-test":`selection-button-options-horizontal`,stableName:`ButtonHorizontalOptionsLayout`,children:`<Field.Selection
  variant="button"
  label="Label text"
  optionsLayout="horizontal"
  onChange={(value) => console.log('onChange', value)}
...
`}),U=()=>(0,a.jsx)(r,{"data-visual-test":`selection-button-vertical`,stableName:`ButtonOptionSelected`,children:`<Field.Selection
  variant="button"
  label="Label text"
  value="bar"
  onChange={(value) => console.log('onChange', value)}
...
`}),W=()=>(0,a.jsx)(r,{stableName:`ButtonDisabled`,children:`<Field.Selection
  variant="button"
  value="bar"
  label="Label text"
  onChange={(value) => console.log('onChange', value)}
...
`}),G=()=>(0,a.jsx)(r,{stableName:`ButtonDisabledOptions`,noInline:!0,children:`const Example = () => {
  return (
...
render(<Example />)
`}),K=()=>(0,a.jsx)(r,{stableName:`ButtonError`,children:`<Field.Selection
  variant="button"
  value="bar"
  label="Label text"
  onChange={(value) => console.log('onChange', value)}
...
`}),q=()=>(0,a.jsx)(r,{stableName:`ButtonWithData`,children:`<Field.Selection
  variant="button"
  label="Label text"
  data={[
    {
...
/>
`}),J=()=>(0,a.jsx)(r,{stableName:`ButtonWithAPath`,children:`<Form.Handler
  data={{
    example: {
      list: [
        {
...
`}),Y=()=>(0,a.jsx)(r,{"data-visual-test":`selection-button-nesting-logic`,stableName:`ButtonNestingWithLogic`,children:`<Form.Handler>
  <Form.Card>
    <Field.Selection
      variant="button"
      label="Make a selection"
...
`}),X=()=>(0,a.jsx)(r,{"data-visual-test":`selection-dropdown-error-message`,stableName:`SelectionErrorMessage`,children:`<Field.Selection label="Label" error="This is what is wrong...">
  <Field.Option value="foo">Foo</Field.Option>
  <Field.Option value="bar">Bar</Field.Option>
</Field.Selection>
`}),Z=()=>(0,a.jsx)(r,{"data-visual-test":`selection-dropdown-info-message`,stableName:`SelectionInfoMessage`,children:`<Field.Selection label="Label" info="Useful information (?)">
  <Field.Option value="foo">Foo</Field.Option>
  <Field.Option value="bar">Bar</Field.Option>
</Field.Selection>
`}),Q=()=>(0,a.jsx)(r,{"data-visual-test":`selection-dropdown-warning-message`,stableName:`SelectionWarningMessage`,children:`<Field.Selection label="Label" warning="I'm warning you...">
  <Field.Option value="foo">Foo</Field.Option>
  <Field.Option value="bar">Bar</Field.Option>
</Field.Selection>
