import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{c as n}from"./ToggleButton-DoxBGtHF.js";import{t as r}from"./P-CbimSwQH.js";import{t as i}from"./Card-DP9KYSzC.js";import{A as a,B as o,C as s,D as c,E as l,O as u,T as d,j as f,k as p}from"./index-DdG6L_K8.js";import{t as m}from"./ComponentBox-q_23Ylzi.js";var h=e(t());function g(e){switch(e?.name){case`sbanken`:return a;case`carnegie`:return l;case`eiendom`:return u;default:return c}}var _=()=>(0,h.jsx)(m,{scope:{DnbDefault:c,SbankenCompact:p,SbankenDefault:a,SbankenHorizontal:f,CarnegieDefault:l,EiendomDefault:u},"data-visual-test":`logo-all`,stableName:`LogoAllExample`,sourceImports:[`import { Card, Logo, Flex, P } from '@dnb/eufemia'`,`import { DnbDefault, SbankenCompact, SbankenDefault, SbankenHorizontal, CarnegieDefault, EiendomDefault } from '@dnb/eufemia/components/Logo'`,`import MyThemeSelector from '../../../../core/ChangeStyleTheme'`,`import { ThemeProps } from '@dnb/eufemia/shared/Theme'`],__buildScope:{Flex:n,Logo:d},children:`<Flex.Vertical>
...
`}),S=()=>(0,h.jsx)(m,{scope:{MyThemeSelector:s,myLogoSelector:g,SbankenDefault:a,CarnegieDefault:l,EiendomDefault:u,DnbDefault:c},"data-visual-test":`logo-theme-change`,stableName:`LogoChangeExample`,sourceImports:[`import { Card, Logo, Flex, P } from '@dnb/eufemia'`,`import { DnbDefault, SbankenCompact, SbankenDefault, SbankenHorizontal, CarnegieDefault, EiendomDefault } from '@dnb/eufemia/components/Logo'`,`import MyThemeSelector from '../../../../core/ChangeStyleTheme'`,`import { ThemeProps } from '@dnb/eufemia/shared/Theme'`],__buildScope:{Card:i,Logo:d},noInline:!0,children:`function myLogoSelector(theme: ThemeProps) {
  switch (theme?.name) {
    case 'sbanken':
...
`}),w=()=>(0,h.jsx)(m,{"data-visual-test":`logo-in-text`,scope:{myLogoSelector:g},stableName:`LogoInTextExample`,sourceImports:[`import { Card, Logo, Flex, P } from '@dnb/eufemia'`,`import { DnbDefault, SbankenCompact, SbankenDefault, SbankenHorizontal, CarnegieDefault, EiendomDefault } from '@dnb/eufemia/components/Logo'`,`import MyThemeSelector from '../../../../core/ChangeStyleTheme'`,`import { ThemeProps } from '@dnb/eufemia/shared/Theme'`],__buildScope:{P:r,Logo:d},children:`<P>
  This logo is in the middle <Logo svg={myLogoSelector} /> of some text.
</P>
`});function T(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,h4:`h4`,p:`p`,pre:`pre`,...o(),...e.components},{VisibleWhenVisualTest:n}=t;return n||D(`VisibleWhenVisualTest`,!0),(0,h.jsxs)(h.Fragment,{children:[(0,h.jsx)(t.h2,{children:`Demos`}),`
...
`,(0,h.jsx)(x,{}),`
`,(0,h.jsx)(n,{children:(0,h.jsx)(w,{})})]})}function E(e={}){let{wrapper:t}={...o(),...e.components};return t?(0,h.jsx)(t,{...e,children:(0,h.jsx)(T,{...e})}):T(e)}function D(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{E as default};