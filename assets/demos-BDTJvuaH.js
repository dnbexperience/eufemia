import{a as e}from"./rolldown-runtime-BYbx6iT9.js";import{t}from"./jsx-runtime-BgMs7Gb-.js";import{n,t as r}from"./Dt-FqnacRx_.js";import{t as i}from"./Link-BdzJ-zwi.js";import{Br as a,Dn as o,Nn as s,On as c,Rr as l,_n as u}from"./index-mmuoVhax.js";import{t as d}from"./ComponentBox-XDAvsf_r.js";var f=e(t()),p=()=>(0,f.jsx)(d,{hideCode:!0,"data-visual-test":`lists-dl`,stableName:`DefinitionListExample`,sourceImports:[`import { Dl, Dt, Dd, Ul, Li, Ol, Anchor } from '@dnb/eufemia'`,`import styled from '@emotion/styled'`],__buildScope:{Dl:s,Dt:r,Dd:n},children:`<Dl>
  <Dt>Term</Dt>
  <Dd>Description</Dd>
  <Dt>Term</Dt>
  <Dd>Description 1</Dd>
...
`}),m=()=>(0,f.jsx)(d,{hideCode:!0,"data-visual-test":`lists-dl-horizontal`,stableName:`DefinitionListHorizontalExample`,sourceImports:[`import { Dl, Dt, Dd, Ul, Li, Ol, Anchor } from '@dnb/eufemia'`,`import styled from '@emotion/styled'`],__buildScope:{Dl:s,Dt:r,Dd:n},children:`<Dl layout="horizontal">
  <Dl.Item>
    <Dt>Term 1</Dt>
    <Dd>Description 1</Dd>
  </Dl.Item>
...
`}),h=()=>(0,f.jsx)(d,{hideCode:!0,"data-visual-test":`lists-dl-grid`,stableName:`DefinitionListGridExample`,sourceImports:[`import { Dl, Dt, Dd, Ul, Li, Ol, Anchor } from '@dnb/eufemia'`,`import styled from '@emotion/styled'`],__buildScope:{Dl:s,Dt:r,Dd:n},children:`<Dl layout="grid">
  <Dt>Term 1</Dt>
  <Dd>Description 1</Dd>
...
`}),g=()=>(0,f.jsx)(d,{hideCode:!0,"data-visual-test":`lists-ul`,stableName:`UnorderedListExample`,sourceImports:[`import { Dl, Dt, Dd, Ul, Li, Ol, Anchor } from '@dnb/eufemia'`,`import styled from '@emotion/styled'`],__buildScope:{Ul:u,Li:c,Anchor:a,Link:i},children:`<Ul>
  <Li>Item 1</Li>
  <Li>Item 2</Li>
  <Li>
    Item 3
...
`}),_=()=>(0,f.jsx)(d,{hideCode:!0,"data-visual-test":`lists-ol`,stableName:`OrderedListNestedExample`,sourceImports:[`import { Dl, Dt, Dd, Ul, Li, Ol, Anchor } from '@dnb/eufemia'`,`import styled from '@emotion/styled'`],__buildScope:{Ol:o,Li:c},children:`<Ol nested>
  <Li>Item</Li>
  <Li>
    Item
    <Ol>
...
`}),v=()=>(0,f.jsx)(d,{hideCode:!0,"data-visual-test":`lists-ol-style-position`,stableName:`OrderedListStylePositionExample`,sourceImports:[`import { Dl, Dt, Dd, Ul, Li, Ol, Anchor } from '@dnb/eufemia'`,`import styled from '@emotion/styled'`],__buildScope:{Ol:o,Li:c},noInline:!0,children:`const WidthLimit = styled.div\`
  max-width: 22rem;
  .dnb-ol li::before {
...
`}),y=()=>(0,f.jsx)(d,{hideCode:!0,"data-visual-test":`lists-ol-types`,stableName:`OrderedListOtherTypesExample`,sourceImports:[`import { Dl, Dt, Dd, Ul, Li, Ol, Anchor } from '@dnb/eufemia'`,`import styled from '@emotion/styled'`],__buildScope:{Ol:o,Li:c},children:`<Ol type="A">
  <Li>Item</Li>
  <Li>
    Item
    <Ol type="I" start={3}>
...
`}),x=()=>(0,f.jsx)(d,{hideCode:!0,"data-visual-test":`ul-inside-ol`,stableName:`UlInsideOl`,sourceImports:[`import { Dl, Dt, Dd, Ul, Li, Ol, Anchor } from '@dnb/eufemia'`,`import styled from '@emotion/styled'`],__buildScope:{Ol:o,Li:c,Ul:u},children:`<Ol>
  <Li>
    Ordered item 1
    <Ul>
