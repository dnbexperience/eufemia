import{n as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{c as r,l as i}from"./SpacingUtils-zztAGE8o.js";import{$ as a}from"./Anchor-DN_sG59G.js";import{n as o,r as s,t as c}from"./withComponentMarkers-DlLPEsBr.js";import{t as l}from"./Element-C8scBYd-.js";import{t as u}from"./ToggleButton-Bh3Eln0h.js";import{t as d}from"./Space-Dchde6mn.js";import{t as f}from"./Button-DOLBvLh7.js";import{F as p}from"./Autocomplete-BMBTNqbT.js";import{t as m}from"./P-CX3-UwOl.js";import{t as h}from"./H2-DVL-d26d.js";import{t as g}from"./Paragraph-DEsjVcz_.js";import{t as _}from"./Heading-DOORWpmT.js";import{L as v,U as y,m as b}from"./index-DHCu7dhB.js";import{t as x}from"./ComponentBox-CmvipvMU.js";import{n as S,t as C}from"./Examples-C2OEHJWf.js";var w=t(n());function T({ref:e,...t}){return(0,w.jsx)(l,{as:`div`,skeletonMethod:`shape`,ref:e,...t})}c(T,{_supportsSpacingProps:!0});var E=T,D=t(e());function O({rows:e=3,children:t=null,...n}){let i=(0,D.useMemo)(()=>{let t=[70,80,60,40,50,20,0];return Array.from({length:Number(e)},(e,n)=>{let r=n%t.length;return r===t.length-1&&t.reverse(),t[r]})},[e]);return(0,w.jsxs)(`div`,{className:r(`dnb-skeleton__figure`,`dnb-skeleton__figure--show`),"aria-busy":!0,...n,children:[(0,w.jsx)(d,{element:`div`,bottom:`large`,className:r(`dnb-h--xx-large`,`dnb-skeleton`,`dnb-skeleton--shape`),"aria-hidden":!0,style:{width:`50%`},children:`‌`}),i.map((e,t)=>(0,w.jsx)(d,{element:`div`,top:`x-small`,className:r(`dnb-p`,`dnb-skeleton`,`dnb-skeleton--shape`),style:{width:`${e}%`},children:`‌`},t)),typeof t==`function`?t():t]})}var k=()=>(0,w.jsx)(x,{stableName:`SkeletonInputExample`,sourceImports:[`import { Suspense, useContext, useState } from 'react'`,`import Context from '@dnb/eufemia/shared/Context'`,`import { Input, H2, P, Button, Skeleton, ToggleButton, Div } from '@dnb/eufemia'`,`import { AllComponentsHorizontalTestCase, AllComponentsVerticalLabelsTestCase } from '../../layout/Examples'`,`import Provider from '@dnb/eufemia/shared/Provider'`,`import { Article } from '@dnb/eufemia/components/skeleton/figures'`,`import { createSkeletonClass, skeletonDOMAttributes } from '@dnb/eufemia/components/skeleton/SkeletonHelper'`],__buildScope:{Input:p},children:`<Input label="Input" skeleton />
`}),A=()=>(0,w.jsx)(x,{"data-visual-test":`skeleton-exclude`,stableName:`SkeletonToggleExample`,sourceImports:[`import { Suspense, useContext, useState } from 'react'`,`import Context from '@dnb/eufemia/shared/Context'`,`import { Input, H2, P, Button, Skeleton, ToggleButton, Div } from '@dnb/eufemia'`,`import { AllComponentsHorizontalTestCase, AllComponentsVerticalLabelsTestCase } from '../../layout/Examples'`,`import Provider from '@dnb/eufemia/shared/Provider'`,`import { Article } from '@dnb/eufemia/components/skeleton/figures'`,`import { createSkeletonClass, skeletonDOMAttributes } from '@dnb/eufemia/components/skeleton/SkeletonHelper'`],__buildScope:{Skeleton:v,H2:h,Heading:_,P:m,Paragraph:g,Input:p,ToggleButton:u},noInline:!0,children:`const UserData = () => {
...
render(<Component />)
`});function B(e){let t={code:`code`,h2:`h2`,p:`p`,pre:`pre`,...y(),...e.components},{VisibleWhenVisualTest:n}=t;return n||H(`VisibleWhenVisualTest`,!0),(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)(t.h2,{children:`Demos`}),`
`,(0,w.jsx)(b,{}),`
...
`})}),`
`,(0,w.jsx)(N,{}),`
`,(0,w.jsx)(n,{children:(0,w.jsx)(P,{})})]})}function V(e={}){let{wrapper:t}={...y(),...e.components};return t?(0,w.jsx)(t,{...e,children:(0,w.jsx)(B,{...e})}):B(e)}function H(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{R as a,V as default,F as i,L as n,I as r,z as t};