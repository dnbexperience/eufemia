import{a as e}from"./rolldown-runtime-BYbx6iT9.js";import{t}from"./jsx-runtime-BgMs7Gb-.js";import{t as n}from"./formatCurrency-Bkte9ksA.js";import{n as r,t as i}from"./Slider-DDql3QUf.js";import{Cn as a,Rr as o,Zn as s,bn as c,gr as l,un as u}from"./index-mmuoVhax.js";import{t as d}from"./ComponentBox-XDAvsf_r.js";var f=e(t()),p=()=>(0,f.jsx)(d,{"data-visual-test":`slider-default`,stableName:`SliderExampleDefault`,sourceImports:[`import styled from '@emotion/styled'`,`import { useState } from 'react'`,`import { formatCurrency, formatPercent } from '@dnb/eufemia/components/number-format/NumberUtils'`,`import { Slider, HelpButton, Input, Flex } from '@dnb/eufemia'`,`import { SliderMarker } from '@dnb/eufemia/components/slider/Slider'`],__buildScope:{Slider:i},children:`<Slider
  min={0}
  max={100}
  value={70}
...
`}),g=()=>(0,f.jsx)(d,{scope:{formatCurrency:n},stableName:`SliderExampleHorizontalSync`,sourceImports:[`import styled from '@emotion/styled'`,`import { useState } from 'react'`,`import { formatCurrency, formatPercent } from '@dnb/eufemia/components/number-format/NumberUtils'`,`import { Slider, HelpButton, Input, Flex } from '@dnb/eufemia'`,`import { SliderMarker } from '@dnb/eufemia/components/slider/Slider'`],__buildScope:{Slider:i,Input:l},noInline:!0,children:`const Component = () => {
...
\`
render(<Component />)
`}),_=()=>(0,f.jsx)(d,{stableName:`SliderExampleSuffix`,sourceImports:[`import styled from '@emotion/styled'`,`import { useState } from 'react'`,`import { formatCurrency, formatPercent } from '@dnb/eufemia/components/number-format/NumberUtils'`,`import { Slider, HelpButton, Input, Flex } from '@dnb/eufemia'`,`import { SliderMarker } from '@dnb/eufemia/components/slider/Slider'`],__buildScope:{Slider:i,HelpButton:c,Modal:a},children:`<Slider
  min={0}
  max={100}
  value={70}
...
/>
`});function b(e){let t={code:`code`,h2:`h2`,h3:`h3`,p:`p`,pre:`pre`,...o(),...e.components};return(0,f.jsxs)(f.Fragment,{children:[(0,f.jsx)(t.h2,{children:`Demos`}),`
...
`})}),`
`,(0,f.jsx)(y,{})]})}function x(e={}){let{wrapper:t}={...o(),...e.components};return t?(0,f.jsx)(t,{...e,children:(0,f.jsx)(b,{...e})}):b(e)}export{x as default};