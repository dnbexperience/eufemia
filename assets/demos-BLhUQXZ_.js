import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{s as n}from"./ToggleButton-DFl1k6dD.js";import{Ht as r,J as i,q as a}from"./forms-DuwGqcp3.js";import{F as o,p as s}from"./Autocomplete-BkdRYvuo.js";import{d as c,s as l}from"./Table-L2SFy5VR.js";import{U as u}from"./index-Ct8Ggqh9.js";import{t as d}from"./ComponentBox-41YKKsr3.js";var f=e(t()),p=()=>(0,f.jsx)(d,{"data-visual-test":`slider-default`,stableName:`SliderExampleDefault`,sourceImports:[`import styled from '@emotion/styled'`,`import { useState } from 'react'`,`import { formatCurrency, formatPercent } from '@dnb/eufemia/components/number-format/NumberUtils'`,`import { Slider, HelpButton, Input, Flex } from '@dnb/eufemia'`,`import { SliderMarker } from '@dnb/eufemia/components/slider/Slider'`],__buildScope:{Slider:a},children:`<Slider
  min={0}
  max={100}
  value={70}
...
`}),g=()=>(0,f.jsx)(d,{scope:{formatCurrency:r},stableName:`SliderExampleHorizontalSync`,sourceImports:[`import styled from '@emotion/styled'`,`import { useState } from 'react'`,`import { formatCurrency, formatPercent } from '@dnb/eufemia/components/number-format/NumberUtils'`,`import { Slider, HelpButton, Input, Flex } from '@dnb/eufemia'`,`import { SliderMarker } from '@dnb/eufemia/components/slider/Slider'`],__buildScope:{Slider:a,Input:o},noInline:!0,children:`const Component = () => {
