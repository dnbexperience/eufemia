...
`}),I=()=>(0,C.jsx)(S,{hideCode:!0,"data-visual-test":`table-accordion`,stableName:`Accordion`,sourceImports:[`import { useCallback, useEffect, useState } from 'react'`,`import styled from '@emotion/styled'`,`import { useMedia } from '@dnb/eufemia/shared'`,`import { H2, P, Dl, Dt, Dd, Code, Anchor, Card, Flex, Badge, Heading, Icon, Menu } from '@dnb/eufemia'`,`import { stop as stopIcon, compose as composeIcon, view as eyeIcon, launch as launchIcon, trash as trashIcon } from '@dnb/eufemia/icons'`,`import { Button, Pagination, Checkbox, Input, Section, Stat } from '@dnb/eufemia/components'`,`import TableContainer from '@dnb/eufemia/components/table/TableContainer'`,`import useHandleSortState from '@dnb/eufemia/components/table/useHandleSortState'`,`import Table, { Th, Td, Tr, useTableKeyboardNavigation, useTableHighlight } from '@dnb/eufemia/components/Table'`,`import { Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Checkbox:l,Input:g,Tr:y,Td:v,Section:me,Dl:p,Dt:d,Dd:m,Table:f,Th:b,ScrollView:x},noInline:!0,children:`const AccordionTable = ({ id, showCheckbox = false, ...props }) => {
  const TdCheckbox = () => {
...
`}),L=()=>(0,C.jsx)(S,{hideCode:!0,"data-visual-test":`table-accordion-mixed`,stableName:`AccordionMixed`,sourceImports:[`import { useCallback, useEffect, useState } from 'react'`,`import styled from '@emotion/styled'`,`import { useMedia } from '@dnb/eufemia/shared'`,`import { H2, P, Dl, Dt, Dd, Code, Anchor, Card, Flex, Badge, Heading, Icon, Menu } from '@dnb/eufemia'`,`import { stop as stopIcon, compose as composeIcon, view as eyeIcon, launch as launchIcon, trash as trashIcon } from '@dnb/eufemia/icons'`,`import { Button, Pagination, Checkbox, Input, Section, Stat } from '@dnb/eufemia/components'`,`import TableContainer from '@dnb/eufemia/components/table/TableContainer'`,`import useHandleSortState from '@dnb/eufemia/components/table/useHandleSortState'`,`import Table, { Th, Td, Tr, useTableKeyboardNavigation, useTableHighlight } from '@dnb/eufemia/components/Table'`,`import { Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Checkbox:l,Input:g,Table:f,Tr:y,Th:b,Td:v,Section:me,Dl:p,Dt:d,Dd:m,ScrollView:x},noInline:!0,children:`const AccordionTable = ({ id, showCheckbox = false, ...props }) => {
  const TdCheckbox = () => {
    return <Checkbox label="Select row" labelSrOnly />
  }
  const TdInput = () => {
