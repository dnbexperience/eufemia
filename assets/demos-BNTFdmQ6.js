import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{W as n,g as r,t as i}from"./Anchor-BPx9fjvj.js";import{t as a}from"./Button-kSqfAUVR.js";import{t as o}from"./P-CVKBz4XO.js";import{t as s}from"./H2-DASO3mku.js";import{t as c}from"./Section-_oyssAWe.js";import{L as l,U as u,w as d}from"./index-BsJ3GLEw.js";import{t as f}from"./ComponentBox-sLMgHvLi.js";var p=e(t()),m=d.div`
...
`})}),b=()=>(0,p.jsx)(m,{children:(0,p.jsx)(f,{hideCode:!0,scope:{Example:h},stableName:`AnchorExampleHelperClasses`,sourceImports:[`import styled from '@emotion/styled'`,`import { Section, Anchor, IconPrimary, H2, P } from '@dnb/eufemia'`,`import { Theme } from '@dnb/eufemia/shared'`],__buildScope:{Anchor:i,Button:a,Skeleton:l},children:`
<Example>
  <Anchor
...
`})});function A(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,ul:`ul`,...u(),...e.components},{VisibilityByTheme:n,VisibleWhenVisualTest:r}=t;return n||M(`VisibilityByTheme`,!0),r||M(`VisibleWhenVisualTest`,!0),(0,p.jsxs)(p.Fragment,{children:[(0,p.jsx)(t.h2,{children:`Demos`}),`
...
`,(0,p.jsxs)(t.p,{children:[`Use `,(0,p.jsx)(t.a,{href:`/uilib/components/section/demos/#dark-surface`,children:`Section`}),` or `,(0,p.jsx)(t.a,{href:`/uilib/usage/customisation/theming/theme#surface-property`,children:`Theme.Context`}),` with `,(0,p.jsx)(t.code,{children:`surface="dark"`}),` to provide dark surface context to supporting components.`]}),`
`,(0,p.jsx)(v,{}),`
...
`,(0,p.jsx)(_,{}),`
`,(0,p.jsxs)(r,{children:[(0,p.jsx)(y,{}),(0,p.jsx)(S,{}),(0,p.jsx)(O,{}),(0,p.jsx)(k,{}),(0,p.jsx)(x,{})]})]})}function j(e={}){let{wrapper:t}={...u(),...e.components};return t?(0,p.jsx)(t,{...e,children:(0,p.jsx)(A,{...e})}):A(e)}function M(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{j as default};