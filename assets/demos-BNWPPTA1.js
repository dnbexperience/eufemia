import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{F as r,a as i,c as a}from"./SpacingUtils-zztAGE8o.js";import{a as o,t as s,tt as c}from"./Anchor-DN_sG59G.js";import{t as l}from"./withComponentMarkers-DlLPEsBr.js";import{t as ee}from"./Icon-D6Afic1o.js";import{c as te}from"./Space-BQmfgJs1.js";import{t as u}from"./compose-DuKyYhRr.js";import{m as ne,o as d,p as re,s as ie}from"./ToggleButton-Bh3Eln0h.js";import{t as ae}from"./stop-BVULijT-.js";import{Ft as oe,H as f,It as p,Pt as m,j as se}from"./forms-Ce7VSRGW.js";import{t as h}from"./Button-DOLBvLh7.js";import{F as g}from"./Autocomplete-BMBTNqbT.js";import{t as _}from"./P-CX3-UwOl.js";import{_ as v,a as y,i as ce,n as le,o as b,r as ue,s as de}from"./Table-L_32gf4n.js";import{t as fe}from"./H2-DVL-d26d.js";import{t as pe}from"./Card-C4jdcnXT.js";import{t as me}from"./Section-CEKACurl.js";import{t as he}from"./ListExport-BgHwvYvI.js";import{t as ge}from"./Heading-DOORWpmT.js";import{t as _e}from"./MenuExport-B0vOv0X5.js";import{t as ve}from"./StatExport-AiMrip3C.js";import{t as ye}from"./Pagination-Dyx6GWGE.js";import{H as be,U as xe}from"./index-DHCu7dhB.js";import{t as x}from"./ComponentBox-CmvipvMU.js";import{t as S}from"./ScrollView-D4O5PrR5.js";import{t as Se}from"./useHandleSortState-D8T6j6Sf.js";var C=t(n());function w(e){let{children:t,className:n,...o}=e;r(e,o);let s=i(e,{className:a(`dnb-table__container`,n),...o}),c=ce,l=Array.isArray(t)?t:[t];return l[0]?.type!==w.Head&&l.unshift((0,C.jsx)(w.Head,{},`head`)),l[2]?.type!==w.Foot&&l.push((0,C.jsx)(w.Foot,{},`foot`)),(0,C.jsx)(`section`,{...s,children:(0,C.jsx)(c,{children:l})})}function Ce(e){let{children:t,className:n,...r}=e;return(0,C.jsx)(`div`,{className:a(`dnb-table__container__body`,n),...r,children:t})}function we(e){let{children:t,className:n,...r}=e;return(0,C.jsx)(`div`,{className:a(`dnb-table__container__head`,!t&&`dnb-table__container__head--empty`,n),...r,children:t})}function Te(e){let{children:t,className:n,...r}=e;return(0,C.jsx)(`div`,{className:a(`dnb-table__container__foot`,!t&&`dnb-table__container__foot--empty`,n),...r,children:t})}w.Body=Ce,w.Head=we,w.Foot=Te,l(w,{_supportsSpacingProps:!0});var Ee=e({Accordion:()=>I,AccordionMixed:()=>L,AccordionRow:()=>R,ClassHelpers:()=>P,ClickableCells:()=>H,ClickableRows:()=>B,ColumnHighlight:()=>Z,ContainerEmptyHeaderFooter:()=>N,InCard:()=>Y,InOneContainer:()=>K,KeyboardNavigation:()=>z,LongHeader:()=>F,MultipleTbody:()=>Q,NavigationMixed:()=>V,NoStriped:()=>A,PaginationTable:()=>G,ResponsiveInCard:()=>J,RowScopeOnly:()=>k,SizeMedium:()=>E,SizeSmall:()=>D,StackedContainer:()=>M,Sticky:()=>U,StickyMaxHeight:()=>W,TableInAccordionTable:()=>X,VariantBasic:()=>T,VariantCombinations:()=>q,VariantComplex:()=>O,VariantFixed:()=>j}),T=()=>(0,C.jsx)(x,{hideCode:!0,"data-visual-test":`table-default`,scope:{useHandleSortState:Se},stableName:`VariantBasic`,sourceImports:[`import { useCallback, useEffect, useState } from 'react'`,`import styled from '@emotion/styled'`,`import { useMedia } from '@dnb/eufemia/shared'`,`import { H2, P, Dl, Dt, Dd, Code, Anchor, Card, Flex, Badge, Heading, Icon, Menu } from '@dnb/eufemia'`,`import { stop as stopIcon, compose as composeIcon, view as eyeIcon, launch as launchIcon, trash as trashIcon } from '@dnb/eufemia/icons'`,`import { Button, Pagination, Checkbox, Input, Section, Stat } from '@dnb/eufemia/components'`,`import TableContainer from '@dnb/eufemia/components/table/TableContainer'`,`import useHandleSortState from '@dnb/eufemia/components/table/useHandleSortState'`,`import Table, { Th, Td, Tr, useTableKeyboardNavigation, useTableHighlight } from '@dnb/eufemia/components/Table'`,`import { Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Table:f,ScrollView:S,Tr:y,Th:b,Button:h,HelpButton:de,Td:v,P:_,Code:c},noInline:!0,children:`const BasicTable = () => {
...
render(<BasicTable />)
`}),E=()=>(0,C.jsx)(x,{hideCode:!0,"data-visual-test":`table-size-medium`,stableName:`SizeMedium`,sourceImports:[`import { useCallback, useEffect, useState } from 'react'`,`import styled from '@emotion/styled'`,`import { useMedia } from '@dnb/eufemia/shared'`,`import { H2, P, Dl, Dt, Dd, Code, Anchor, Card, Flex, Badge, Heading, Icon, Menu } from '@dnb/eufemia'`,`import { stop as stopIcon, compose as composeIcon, view as eyeIcon, launch as launchIcon, trash as trashIcon } from '@dnb/eufemia/icons'`,`import { Button, Pagination, Checkbox, Input, Section, Stat } from '@dnb/eufemia/components'`,`import TableContainer from '@dnb/eufemia/components/table/TableContainer'`,`import useHandleSortState from '@dnb/eufemia/components/table/useHandleSortState'`,`import Table, { Th, Td, Tr, useTableKeyboardNavigation, useTableHighlight } from '@dnb/eufemia/components/Table'`,`import { Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Table:f,ScrollView:S,Tr:y,Th:b,Td:v,P:_},children:`<Table.ScrollView>
  <Table size="medium">
    <caption className="dnb-sr-only">A Table Caption</caption>
    <thead>
      <Tr>
...
`}),O=()=>(0,C.jsx)(x,{hideCode:!0,"data-visual-test":`table-complex`,stableName:`VariantComplex`,sourceImports:[`import { useCallback, useEffect, useState } from 'react'`,`import styled from '@emotion/styled'`,`import { useMedia } from '@dnb/eufemia/shared'`,`import { H2, P, Dl, Dt, Dd, Code, Anchor, Card, Flex, Badge, Heading, Icon, Menu } from '@dnb/eufemia'`,`import { stop as stopIcon, compose as composeIcon, view as eyeIcon, launch as launchIcon, trash as trashIcon } from '@dnb/eufemia/icons'`,`import { Button, Pagination, Checkbox, Input, Section, Stat } from '@dnb/eufemia/components'`,`import TableContainer from '@dnb/eufemia/components/table/TableContainer'`,`import useHandleSortState from '@dnb/eufemia/components/table/useHandleSortState'`,`import Table, { Th, Td, Tr, useTableKeyboardNavigation, useTableHighlight } from '@dnb/eufemia/components/Table'`,`import { Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Table:f,ScrollView:S,Tr:y,Th:b,Td:v,Button:h,Code:c},children:`<Table.ScrollView>
...
`}),k=()=>(0,C.jsx)(x,{hideCode:!0,"data-visual-test":`table-row-scope-only`,stableName:`RowScopeOnly`,sourceImports:[`import { useCallback, useEffect, useState } from 'react'`,`import styled from '@emotion/styled'`,`import { useMedia } from '@dnb/eufemia/shared'`,`import { H2, P, Dl, Dt, Dd, Code, Anchor, Card, Flex, Badge, Heading, Icon, Menu } from '@dnb/eufemia'`,`import { stop as stopIcon, compose as composeIcon, view as eyeIcon, launch as launchIcon, trash as trashIcon } from '@dnb/eufemia/icons'`,`import { Button, Pagination, Checkbox, Input, Section, Stat } from '@dnb/eufemia/components'`,`import TableContainer from '@dnb/eufemia/components/table/TableContainer'`,`import useHandleSortState from '@dnb/eufemia/components/table/useHandleSortState'`,`import Table, { Th, Td, Tr, useTableKeyboardNavigation, useTableHighlight } from '@dnb/eufemia/components/Table'`,`import { Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Table:f,ScrollView:S,Tr:y,Th:b,Td:v},children:`<Table.ScrollView>
...
`}),A=()=>(0,C.jsx)(x,{hideCode:!0,"data-visual-test":`table-no-striped`,stableName:`NoStriped`,sourceImports:[`import { useCallback, useEffect, useState } from 'react'`,`import styled from '@emotion/styled'`,`import { useMedia } from '@dnb/eufemia/shared'`,`import { H2, P, Dl, Dt, Dd, Code, Anchor, Card, Flex, Badge, Heading, Icon, Menu } from '@dnb/eufemia'`,`import { stop as stopIcon, compose as composeIcon, view as eyeIcon, launch as launchIcon, trash as trashIcon } from '@dnb/eufemia/icons'`,`import { Button, Pagination, Checkbox, Input, Section, Stat } from '@dnb/eufemia/components'`,`import TableContainer from '@dnb/eufemia/components/table/TableContainer'`,`import useHandleSortState from '@dnb/eufemia/components/table/useHandleSortState'`,`import Table, { Th, Td, Tr, useTableKeyboardNavigation, useTableHighlight } from '@dnb/eufemia/components/Table'`,`import { Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Table:f,ScrollView:S,Tr:y,Th:b,Td:v},children:`<Table.ScrollView>
  <Table striped={false}>
    <caption className="dnb-sr-only">A Table Caption</caption>
    <thead>
      <Tr>
...
`}),j=()=>(0,C.jsx)(x,{hideCode:!0,"data-visual-test":`table-fixed`,stableName:`VariantFixed`,sourceImports:[`import { useCallback, useEffect, useState } from 'react'`,`import styled from '@emotion/styled'`,`import { useMedia } from '@dnb/eufemia/shared'`,`import { H2, P, Dl, Dt, Dd, Code, Anchor, Card, Flex, Badge, Heading, Icon, Menu } from '@dnb/eufemia'`,`import { stop as stopIcon, compose as composeIcon, view as eyeIcon, launch as launchIcon, trash as trashIcon } from '@dnb/eufemia/icons'`,`import { Button, Pagination, Checkbox, Input, Section, Stat } from '@dnb/eufemia/components'`,`import TableContainer from '@dnb/eufemia/components/table/TableContainer'`,`import useHandleSortState from '@dnb/eufemia/components/table/useHandleSortState'`,`import Table, { Th, Td, Tr, useTableKeyboardNavigation, useTableHighlight } from '@dnb/eufemia/components/Table'`,`import { Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Table:f,ScrollView:S,Tr:y,Th:b,Td:v},noInline:!0,children:`const FixedTable = styled(Table)\`
  min-width: 70rem;
...
`}),M=()=>(0,C.jsx)(x,{hideCode:!0,"data-visual-test":`table-container`,scope:{TableContainer:w,isFullscreen:/data-visual-test|fullscreen/.test(globalThis?.location?.href)},stableName:`StackedContainer`,sourceImports:[`import { useCallback, useEffect, useState } from 'react'`,`import styled from '@emotion/styled'`,`import { useMedia } from '@dnb/eufemia/shared'`,`import { H2, P, Dl, Dt, Dd, Code, Anchor, Card, Flex, Badge, Heading, Icon, Menu } from '@dnb/eufemia'`,`import { stop as stopIcon, compose as composeIcon, view as eyeIcon, launch as launchIcon, trash as trashIcon } from '@dnb/eufemia/icons'`,`import { Button, Pagination, Checkbox, Input, Section, Stat } from '@dnb/eufemia/components'`,`import TableContainer from '@dnb/eufemia/components/table/TableContainer'`,`import useHandleSortState from '@dnb/eufemia/components/table/useHandleSortState'`,`import Table, { Th, Td, Tr, useTableKeyboardNavigation, useTableHighlight } from '@dnb/eufemia/components/Table'`,`import { Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{H2:fe,P:_,Table:f,Tr:y,Th:b,Anchor:s,Td:v},noInline:!0,children:`const StyledContainer = styled(TableContainer)\`
  /* 
            Define the width of the THs so they are aligned across tables.
...
`}),P=()=>(0,C.jsx)(x,{hideCode:!0,"data-visual-test":`table-classes`,stableName:`ClassHelpers`,sourceImports:[`import { useCallback, useEffect, useState } from 'react'`,`import styled from '@emotion/styled'`,`import { useMedia } from '@dnb/eufemia/shared'`,`import { H2, P, Dl, Dt, Dd, Code, Anchor, Card, Flex, Badge, Heading, Icon, Menu } from '@dnb/eufemia'`,`import { stop as stopIcon, compose as composeIcon, view as eyeIcon, launch as launchIcon, trash as trashIcon } from '@dnb/eufemia/icons'`,`import { Button, Pagination, Checkbox, Input, Section, Stat } from '@dnb/eufemia/components'`,`import TableContainer from '@dnb/eufemia/components/table/TableContainer'`,`import useHandleSortState from '@dnb/eufemia/components/table/useHandleSortState'`,`import Table, { Th, Td, Tr, useTableKeyboardNavigation, useTableHighlight } from '@dnb/eufemia/components/Table'`,`import { Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Table:f,ScrollView:S,Th:b},children:`<Table.ScrollView>
...
`}),F=()=>(0,C.jsx)(x,{hideCode:!0,"data-visual-test":`table-header`,stableName:`LongHeader`,sourceImports:[`import { useCallback, useEffect, useState } from 'react'`,`import styled from '@emotion/styled'`,`import { useMedia } from '@dnb/eufemia/shared'`,`import { H2, P, Dl, Dt, Dd, Code, Anchor, Card, Flex, Badge, Heading, Icon, Menu } from '@dnb/eufemia'`,`import { stop as stopIcon, compose as composeIcon, view as eyeIcon, launch as launchIcon, trash as trashIcon } from '@dnb/eufemia/icons'`,`import { Button, Pagination, Checkbox, Input, Section, Stat } from '@dnb/eufemia/components'`,`import TableContainer from '@dnb/eufemia/components/table/TableContainer'`,`import useHandleSortState from '@dnb/eufemia/components/table/useHandleSortState'`,`import Table, { Th, Td, Tr, useTableKeyboardNavigation, useTableHighlight } from '@dnb/eufemia/components/Table'`,`import { Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Table:f,ScrollView:S,Tr:y,Th:b,Td:v,P:_},children:`<Table.ScrollView>
  <Table>
    <caption className="dnb-sr-only">A Table Caption</caption>
    <thead>
      <Tr>
...
`}),I=()=>(0,C.jsx)(x,{hideCode:!0,"data-visual-test":`table-accordion`,stableName:`Accordion`,sourceImports:[`import { useCallback, useEffect, useState } from 'react'`,`import styled from '@emotion/styled'`,`import { useMedia } from '@dnb/eufemia/shared'`,`import { H2, P, Dl, Dt, Dd, Code, Anchor, Card, Flex, Badge, Heading, Icon, Menu } from '@dnb/eufemia'`,`import { stop as stopIcon, compose as composeIcon, view as eyeIcon, launch as launchIcon, trash as trashIcon } from '@dnb/eufemia/icons'`,`import { Button, Pagination, Checkbox, Input, Section, Stat } from '@dnb/eufemia/components'`,`import TableContainer from '@dnb/eufemia/components/table/TableContainer'`,`import useHandleSortState from '@dnb/eufemia/components/table/useHandleSortState'`,`import Table, { Th, Td, Tr, useTableKeyboardNavigation, useTableHighlight } from '@dnb/eufemia/components/Table'`,`import { Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Checkbox:d,Input:g,Tr:y,Td:v,Section:me,Dl:oe,Dt:m,Dd:p,Table:f,Th:b,ScrollView:S},noInline:!0,children:`const AccordionTable = ({ id, showCheckbox = false, ...props }) => {
  const TdCheckbox = () => {
...
`}),L=()=>(0,C.jsx)(x,{hideCode:!0,"data-visual-test":`table-accordion-mixed`,stableName:`AccordionMixed`,sourceImports:[`import { useCallback, useEffect, useState } from 'react'`,`import styled from '@emotion/styled'`,`import { useMedia } from '@dnb/eufemia/shared'`,`import { H2, P, Dl, Dt, Dd, Code, Anchor, Card, Flex, Badge, Heading, Icon, Menu } from '@dnb/eufemia'`,`import { stop as stopIcon, compose as composeIcon, view as eyeIcon, launch as launchIcon, trash as trashIcon } from '@dnb/eufemia/icons'`,`import { Button, Pagination, Checkbox, Input, Section, Stat } from '@dnb/eufemia/components'`,`import TableContainer from '@dnb/eufemia/components/table/TableContainer'`,`import useHandleSortState from '@dnb/eufemia/components/table/useHandleSortState'`,`import Table, { Th, Td, Tr, useTableKeyboardNavigation, useTableHighlight } from '@dnb/eufemia/components/Table'`,`import { Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Checkbox:d,Input:g,Table:f,Tr:y,Th:b,Td:v,Section:me,Dl:oe,Dt:m,Dd:p,ScrollView:S},noInline:!0,children:`const AccordionTable = ({ id, showCheckbox = false, ...props }) => {
  const TdCheckbox = () => {
    return <Checkbox label="Select row" labelSrOnly />
  }
  const TdInput = () => {
...
`}),B=()=>(0,C.jsx)(x,{hideCode:!0,"data-visual-test":`table-navigation`,stableName:`ClickableRows`,sourceImports:[`import { useCallback, useEffect, useState } from 'react'`,`import styled from '@emotion/styled'`,`import { useMedia } from '@dnb/eufemia/shared'`,`import { H2, P, Dl, Dt, Dd, Code, Anchor, Card, Flex, Badge, Heading, Icon, Menu } from '@dnb/eufemia'`,`import { stop as stopIcon, compose as composeIcon, view as eyeIcon, launch as launchIcon, trash as trashIcon } from '@dnb/eufemia/icons'`,`import { Button, Pagination, Checkbox, Input, Section, Stat } from '@dnb/eufemia/components'`,`import TableContainer from '@dnb/eufemia/components/table/TableContainer'`,`import useHandleSortState from '@dnb/eufemia/components/table/useHandleSortState'`,`import Table, { Th, Td, Tr, useTableKeyboardNavigation, useTableHighlight } from '@dnb/eufemia/components/Table'`,`import { Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Checkbox:d,Input:g,Tr:y,Td:v,Table:f,Th:b,ScrollView:S},noInline:!0,children:`const NavigationTable = ({ id, showCheckbox = false, ...props }) => {
  const TdCheckbox = () => {
    return <Checkbox label="Select row" labelSrOnly />
  }
  const TdInput = () => {
...
`}),V=()=>(0,C.jsx)(x,{hideCode:!0,"data-visual-test":`table-navigation-mixed`,stableName:`NavigationMixed`,sourceImports:[`import { useCallback, useEffect, useState } from 'react'`,`import styled from '@emotion/styled'`,`import { useMedia } from '@dnb/eufemia/shared'`,`import { H2, P, Dl, Dt, Dd, Code, Anchor, Card, Flex, Badge, Heading, Icon, Menu } from '@dnb/eufemia'`,`import { stop as stopIcon, compose as composeIcon, view as eyeIcon, launch as launchIcon, trash as trashIcon } from '@dnb/eufemia/icons'`,`import { Button, Pagination, Checkbox, Input, Section, Stat } from '@dnb/eufemia/components'`,`import TableContainer from '@dnb/eufemia/components/table/TableContainer'`,`import useHandleSortState from '@dnb/eufemia/components/table/useHandleSortState'`,`import Table, { Th, Td, Tr, useTableKeyboardNavigation, useTableHighlight } from '@dnb/eufemia/components/Table'`,`import { Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Checkbox:d,Input:g,Table:f,Tr:y,Th:b,Td:v,ScrollView:S},noInline:!0,children:`const NavigationTable = ({ id, showCheckbox = false, ...props }) => {
  const TdCheckbox = () => {
    return <Checkbox label="Select row" labelSrOnly />
  }
  const TdInput = () => {
...
`}),H=()=>(0,C.jsx)(x,{hideCode:!0,"data-visual-test":`table-navigation-cell`,scope:{eyeIcon:re,launchIcon:o},stableName:`ClickableCells`,sourceImports:[`import { useCallback, useEffect, useState } from 'react'`,`import styled from '@emotion/styled'`,`import { useMedia } from '@dnb/eufemia/shared'`,`import { H2, P, Dl, Dt, Dd, Code, Anchor, Card, Flex, Badge, Heading, Icon, Menu } from '@dnb/eufemia'`,`import { stop as stopIcon, compose as composeIcon, view as eyeIcon, launch as launchIcon, trash as trashIcon } from '@dnb/eufemia/icons'`,`import { Button, Pagination, Checkbox, Input, Section, Stat } from '@dnb/eufemia/components'`,`import TableContainer from '@dnb/eufemia/components/table/TableContainer'`,`import useHandleSortState from '@dnb/eufemia/components/table/useHandleSortState'`,`import Table, { Th, Td, Tr, useTableKeyboardNavigation, useTableHighlight } from '@dnb/eufemia/components/Table'`,`import { Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Table:f,ScrollView:S,Tr:y,Th:b,Td:v},noInline:!0,children:`const handleClick = (event, { trElement, thElement }) => {
  console.log(
...
`}),U=()=>{let e=/data-visual-test|fullscreen/.test(globalThis?.location?.href),t=globalThis.IS_TEST;return(0,C.jsx)(x,{hideCode:!0,scope:{isFullscreen:e,isVisibleWhenVisualTest:t},stableName:`Sticky`,sourceImports:[`import { useCallback, useEffect, useState } from 'react'`,`import styled from '@emotion/styled'`,`import { useMedia } from '@dnb/eufemia/shared'`,`import { H2, P, Dl, Dt, Dd, Code, Anchor, Card, Flex, Badge, Heading, Icon, Menu } from '@dnb/eufemia'`,`import { stop as stopIcon, compose as composeIcon, view as eyeIcon, launch as launchIcon, trash as trashIcon } from '@dnb/eufemia/icons'`,`import { Button, Pagination, Checkbox, Input, Section, Stat } from '@dnb/eufemia/components'`,`import TableContainer from '@dnb/eufemia/components/table/TableContainer'`,`import useHandleSortState from '@dnb/eufemia/components/table/useHandleSortState'`,`import Table, { Th, Td, Tr, useTableKeyboardNavigation, useTableHighlight } from '@dnb/eufemia/components/Table'`,`import { Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Table:f,ScrollView:S,Tr:y,Th:b,Td:v,P:_,Code:c},children:`<Table.ScrollView>
  <Table
...
render(<Example />)
`}),Y=()=>(0,C.jsx)(x,{scope:{composeIcon:u,stopIcon:ae,eyeIcon:re,trashIcon:ne},hideCode:!0,"data-visual-test":`table-in-card`,stableName:`InCard`,sourceImports:[`import { useCallback, useEffect, useState } from 'react'`,`import styled from '@emotion/styled'`,`import { useMedia } from '@dnb/eufemia/shared'`,`import { H2, P, Dl, Dt, Dd, Code, Anchor, Card, Flex, Badge, Heading, Icon, Menu } from '@dnb/eufemia'`,`import { stop as stopIcon, compose as composeIcon, view as eyeIcon, launch as launchIcon, trash as trashIcon } from '@dnb/eufemia/icons'`,`import { Button, Pagination, Checkbox, Input, Section, Stat } from '@dnb/eufemia/components'`,`import TableContainer from '@dnb/eufemia/components/table/TableContainer'`,`import useHandleSortState from '@dnb/eufemia/components/table/useHandleSortState'`,`import Table, { Th, Td, Tr, useTableKeyboardNavigation, useTableHighlight } from '@dnb/eufemia/components/Table'`,`import { Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Table:f,ScrollView:S,Tr:y,Th:b,Td:v,Stat:ve,Button:h,Card:pe,Flex:ie,Icon:ee,Heading:ge,Menu:_e,List:he},noInline:!0,children:`const MyTable = () => {
  const rows = [
    {
...
`}),X=()=>(0,C.jsx)(x,{hideCode:!0,"data-visual-test":`table-inside-of-accordion-table`,stableName:`TableInAccordionTable`,sourceImports:[`import { useCallback, useEffect, useState } from 'react'`,`import styled from '@emotion/styled'`,`import { useMedia } from '@dnb/eufemia/shared'`,`import { H2, P, Dl, Dt, Dd, Code, Anchor, Card, Flex, Badge, Heading, Icon, Menu } from '@dnb/eufemia'`,`import { stop as stopIcon, compose as composeIcon, view as eyeIcon, launch as launchIcon, trash as trashIcon } from '@dnb/eufemia/icons'`,`import { Button, Pagination, Checkbox, Input, Section, Stat } from '@dnb/eufemia/components'`,`import TableContainer from '@dnb/eufemia/components/table/TableContainer'`,`import useHandleSortState from '@dnb/eufemia/components/table/useHandleSortState'`,`import Table, { Th, Td, Tr, useTableKeyboardNavigation, useTableHighlight } from '@dnb/eufemia/components/Table'`,`import { Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Checkbox:d,Input:g,Tr:y,Td:v,Table:f,Th:b,ScrollView:S},noInline:!0,children:`const AccordionTable = ({ id, showCheckbox = false, ...props }) => {
  const TdCheckbox = () => {
    return <Checkbox label="Select row" labelSrOnly />
  }
  const TdInput = () => {
...
`}),Q=()=>(0,C.jsx)(x,{"data-visual-test":`table-multiple-tbody`,stableName:`MultipleTbody`,sourceImports:[`import { useCallback, useEffect, useState } from 'react'`,`import styled from '@emotion/styled'`,`import { useMedia } from '@dnb/eufemia/shared'`,`import { H2, P, Dl, Dt, Dd, Code, Anchor, Card, Flex, Badge, Heading, Icon, Menu } from '@dnb/eufemia'`,`import { stop as stopIcon, compose as composeIcon, view as eyeIcon, launch as launchIcon, trash as trashIcon } from '@dnb/eufemia/icons'`,`import { Button, Pagination, Checkbox, Input, Section, Stat } from '@dnb/eufemia/components'`,`import TableContainer from '@dnb/eufemia/components/table/TableContainer'`,`import useHandleSortState from '@dnb/eufemia/components/table/useHandleSortState'`,`import Table, { Th, Td, Tr, useTableKeyboardNavigation, useTableHighlight } from '@dnb/eufemia/components/Table'`,`import { Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Table:f,ScrollView:S,Tr:y,Th:b,Td:v,Badge:be},children:`<Table.ScrollView>
