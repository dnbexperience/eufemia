import{r as e}from"./rolldown-runtime-BYbx6iT9.js";import{t}from"./jsx-runtime-BgMs7Gb-.js";import{t as n}from"./ComponentBox-geTEYZ7b.js";import{Et as r,Rr as i}from"./index-CMgyXmp3.js";import{s as a}from"./Examples-DcqJXyuQ.js";import{T as o}from"./Examples-Br2IfCHA.js";var s=e({BasicUsage:()=>l,CompactVariant:()=>u,CompactVariantHelpButton:()=>d,Customized:()=>h,Required:()=>f,SessionStorage:()=>x,Width:()=>w,WithAsyncFileHandler:()=>_,WithAsyncOnFileClick:()=>b,WithAsyncOnFileDelete:()=>y,WithFileItemOptions:()=>S,WithFileSizeValidation:()=>C,WithHelp:()=>p,WithHelpWithoutLabelDescription:()=>m,WithIterateArray:()=>E,WithOnValidationError:()=>T,WithPath:()=>g,WithSyncFileHandler:()=>v}),c=t(),l=()=>(0,c.jsx)(n,{children:`<Form.Handler>
  <Field.Upload
...
render(<MyForm />)
`}),C=()=>(0,c.jsx)(n,{scope:{FormError:r},noInline:!0,children:`const MAX_SIZE = 500 * 1024 // 500 KB
...
`,(0,c.jsx)(E,{}),`
`,(0,c.jsxs)(n,{children:[(0,c.jsx)(w,{}),(0,c.jsx)(m,{}),(0,c.jsx)(d,{})]})]})}function O(e={}){let{wrapper:t}={...i(),...e.components};return t?(0,c.jsx)(t,{...e,children:(0,c.jsx)(D,{...e})}):D(e)}function k(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{O as default};