...
render(<BasicTable />)
`}),E=()=>(0,C.jsx)(S,{hideCode:!0,"data-visual-test":`table-size-medium`,stableName:`SizeMedium`,sourceImports:[`import { useCallback, useEffect, useState } from 'react'`,`import styled from '@emotion/styled'`,`import { useMedia } from '@dnb/eufemia/shared'`,`import { H2, P, Dl, Dt, Dd, Code, Anchor, Card, Flex, Badge, Heading, Icon, Menu } from '@dnb/eufemia'`,`import { stop as stopIcon, compose as composeIcon, view as eyeIcon, launch as launchIcon, trash as trashIcon } from '@dnb/eufemia/icons'`,`import { Button, Pagination, Checkbox, Input, Section, Stat } from '@dnb/eufemia/components'`,`import TableContainer from '@dnb/eufemia/components/table/TableContainer'`,`import useHandleSortState from '@dnb/eufemia/components/table/useHandleSortState'`,`import Table, { Th, Td, Tr, useTableKeyboardNavigation, useTableHighlight } from '@dnb/eufemia/components/Table'`,`import { Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Table:p,ScrollView:x,Tr:y,Th:b,Td:v,P:_},children:`<Table.ScrollView>
  <Table size="medium">
    <caption className="dnb-sr-only">A Table Caption</caption>
    <thead>
      <Tr>
...
`}),O=()=>(0,C.jsx)(S,{hideCode:!0,"data-visual-test":`table-complex`,stableName:`VariantComplex`,sourceImports:[`import { useCallback, useEffect, useState } from 'react'`,`import styled from '@emotion/styled'`,`import { useMedia } from '@dnb/eufemia/shared'`,`import { H2, P, Dl, Dt, Dd, Code, Anchor, Card, Flex, Badge, Heading, Icon, Menu } from '@dnb/eufemia'`,`import { stop as stopIcon, compose as composeIcon, view as eyeIcon, launch as launchIcon, trash as trashIcon } from '@dnb/eufemia/icons'`,`import { Button, Pagination, Checkbox, Input, Section, Stat } from '@dnb/eufemia/components'`,`import TableContainer from '@dnb/eufemia/components/table/TableContainer'`,`import useHandleSortState from '@dnb/eufemia/components/table/useHandleSortState'`,`import Table, { Th, Td, Tr, useTableKeyboardNavigation, useTableHighlight } from '@dnb/eufemia/components/Table'`,`import { Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Table:p,ScrollView:x,Tr:y,Th:b,Td:v,Button:h,Code:i},children:`<Table.ScrollView>
...
`}),k=()=>(0,C.jsx)(S,{hideCode:!0,"data-visual-test":`table-row-scope-only`,stableName:`RowScopeOnly`,sourceImports:[`import { useCallback, useEffect, useState } from 'react'`,`import styled from '@emotion/styled'`,`import { useMedia } from '@dnb/eufemia/shared'`,`import { H2, P, Dl, Dt, Dd, Code, Anchor, Card, Flex, Badge, Heading, Icon, Menu } from '@dnb/eufemia'`,`import { stop as stopIcon, compose as composeIcon, view as eyeIcon, launch as launchIcon, trash as trashIcon } from '@dnb/eufemia/icons'`,`import { Button, Pagination, Checkbox, Input, Section, Stat } from '@dnb/eufemia/components'`,`import TableContainer from '@dnb/eufemia/components/table/TableContainer'`,`import useHandleSortState from '@dnb/eufemia/components/table/useHandleSortState'`,`import Table, { Th, Td, Tr, useTableKeyboardNavigation, useTableHighlight } from '@dnb/eufemia/components/Table'`,`import { Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Table:p,ScrollView:x,Tr:y,Th:b,Td:v},children:`<Table.ScrollView>
...
`}),j=()=>(0,C.jsx)(S,{hideCode:!0,"data-visual-test":`table-fixed`,stableName:`VariantFixed`,sourceImports:[`import { useCallback, useEffect, useState } from 'react'`,`import styled from '@emotion/styled'`,`import { useMedia } from '@dnb/eufemia/shared'`,`import { H2, P, Dl, Dt, Dd, Code, Anchor, Card, Flex, Badge, Heading, Icon, Menu } from '@dnb/eufemia'`,`import { stop as stopIcon, compose as composeIcon, view as eyeIcon, launch as launchIcon, trash as trashIcon } from '@dnb/eufemia/icons'`,`import { Button, Pagination, Checkbox, Input, Section, Stat } from '@dnb/eufemia/components'`,`import TableContainer from '@dnb/eufemia/components/table/TableContainer'`,`import useHandleSortState from '@dnb/eufemia/components/table/useHandleSortState'`,`import Table, { Th, Td, Tr, useTableKeyboardNavigation, useTableHighlight } from '@dnb/eufemia/components/Table'`,`import { Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Table:p,ScrollView:x,Tr:y,Th:b,Td:v},noInline:!0,children:`const FixedTable = styled(Table)\`
  min-width: 70rem;
...
`}),M=()=>(0,C.jsx)(S,{hideCode:!0,"data-visual-test":`table-container`,scope:{TableContainer:w,isFullscreen:/data-visual-test|fullscreen/.test(globalThis?.location?.href)},stableName:`StackedContainer`,sourceImports:[`import { useCallback, useEffect, useState } from 'react'`,`import styled from '@emotion/styled'`,`import { useMedia } from '@dnb/eufemia/shared'`,`import { H2, P, Dl, Dt, Dd, Code, Anchor, Card, Flex, Badge, Heading, Icon, Menu } from '@dnb/eufemia'`,`import { stop as stopIcon, compose as composeIcon, view as eyeIcon, launch as launchIcon, trash as trashIcon } from '@dnb/eufemia/icons'`,`import { Button, Pagination, Checkbox, Input, Section, Stat } from '@dnb/eufemia/components'`,`import TableContainer from '@dnb/eufemia/components/table/TableContainer'`,`import useHandleSortState from '@dnb/eufemia/components/table/useHandleSortState'`,`import Table, { Th, Td, Tr, useTableKeyboardNavigation, useTableHighlight } from '@dnb/eufemia/components/Table'`,`import { Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{H2:fe,P:_,Table:p,Tr:y,Th:b,Anchor:a,Td:v},noInline:!0,children:`const StyledContainer = styled(TableContainer)\`
  /* 
            Define the width of the THs so they are aligned across tables.
...
`}),N=()=>(0,C.jsx)(S,{hideCode:!0,"data-visual-test":`table-container-empty`,scope:{TableContainer:w},stableName:`ContainerEmptyHeaderFooter`,sourceImports:[`import { useCallback, useEffect, useState } from 'react'`,`import styled from '@emotion/styled'`,`import { useMedia } from '@dnb/eufemia/shared'`,`import { H2, P, Dl, Dt, Dd, Code, Anchor, Card, Flex, Badge, Heading, Icon, Menu } from '@dnb/eufemia'`,`import { stop as stopIcon, compose as composeIcon, view as eyeIcon, launch as launchIcon, trash as trashIcon } from '@dnb/eufemia/icons'`,`import { Button, Pagination, Checkbox, Input, Section, Stat } from '@dnb/eufemia/components'`,`import TableContainer from '@dnb/eufemia/components/table/TableContainer'`,`import useHandleSortState from '@dnb/eufemia/components/table/useHandleSortState'`,`import Table, { Th, Td, Tr, useTableKeyboardNavigation, useTableHighlight } from '@dnb/eufemia/components/Table'`,`import { Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Table:p,Tr:y,Th:b,Td:v},noInline:!0,children:`render(
...
`}),P=()=>(0,C.jsx)(S,{hideCode:!0,"data-visual-test":`table-classes`,stableName:`ClassHelpers`,sourceImports:[`import { useCallback, useEffect, useState } from 'react'`,`import styled from '@emotion/styled'`,`import { useMedia } from '@dnb/eufemia/shared'`,`import { H2, P, Dl, Dt, Dd, Code, Anchor, Card, Flex, Badge, Heading, Icon, Menu } from '@dnb/eufemia'`,`import { stop as stopIcon, compose as composeIcon, view as eyeIcon, launch as launchIcon, trash as trashIcon } from '@dnb/eufemia/icons'`,`import { Button, Pagination, Checkbox, Input, Section, Stat } from '@dnb/eufemia/components'`,`import TableContainer from '@dnb/eufemia/components/table/TableContainer'`,`import useHandleSortState from '@dnb/eufemia/components/table/useHandleSortState'`,`import Table, { Th, Td, Tr, useTableKeyboardNavigation, useTableHighlight } from '@dnb/eufemia/components/Table'`,`import { Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Table:p,ScrollView:x,Th:b},children:`<Table.ScrollView>
...
`}),I=()=>(0,C.jsx)(S,{hideCode:!0,"data-visual-test":`table-accordion`,stableName:`Accordion`,sourceImports:[`import { useCallback, useEffect, useState } from 'react'`,`import styled from '@emotion/styled'`,`import { useMedia } from '@dnb/eufemia/shared'`,`import { H2, P, Dl, Dt, Dd, Code, Anchor, Card, Flex, Badge, Heading, Icon, Menu } from '@dnb/eufemia'`,`import { stop as stopIcon, compose as composeIcon, view as eyeIcon, launch as launchIcon, trash as trashIcon } from '@dnb/eufemia/icons'`,`import { Button, Pagination, Checkbox, Input, Section, Stat } from '@dnb/eufemia/components'`,`import TableContainer from '@dnb/eufemia/components/table/TableContainer'`,`import useHandleSortState from '@dnb/eufemia/components/table/useHandleSortState'`,`import Table, { Th, Td, Tr, useTableKeyboardNavigation, useTableHighlight } from '@dnb/eufemia/components/Table'`,`import { Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Checkbox:u,Input:g,Tr:y,Td:v,Section:me,Dl:f,Dt:oe,Dd:m,Table:p,Th:b,ScrollView:x},noInline:!0,children:`const AccordionTable = ({ id, showCheckbox = false, ...props }) => {
  const TdCheckbox = () => {
...
`}),L=()=>(0,C.jsx)(S,{hideCode:!0,"data-visual-test":`table-accordion-mixed`,stableName:`AccordionMixed`,sourceImports:[`import { useCallback, useEffect, useState } from 'react'`,`import styled from '@emotion/styled'`,`import { useMedia } from '@dnb/eufemia/shared'`,`import { H2, P, Dl, Dt, Dd, Code, Anchor, Card, Flex, Badge, Heading, Icon, Menu } from '@dnb/eufemia'`,`import { stop as stopIcon, compose as composeIcon, view as eyeIcon, launch as launchIcon, trash as trashIcon } from '@dnb/eufemia/icons'`,`import { Button, Pagination, Checkbox, Input, Section, Stat } from '@dnb/eufemia/components'`,`import TableContainer from '@dnb/eufemia/components/table/TableContainer'`,`import useHandleSortState from '@dnb/eufemia/components/table/useHandleSortState'`,`import Table, { Th, Td, Tr, useTableKeyboardNavigation, useTableHighlight } from '@dnb/eufemia/components/Table'`,`import { Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Checkbox:u,Input:g,Table:p,Tr:y,Th:b,Td:v,Section:me,Dl:f,Dt:oe,Dd:m,ScrollView:x},noInline:!0,children:`const AccordionTable = ({ id, showCheckbox = false, ...props }) => {
  const TdCheckbox = () => {
    return <Checkbox label="Select row" labelSrOnly />
  }
  const TdInput = () => {
...
`}),z=()=>(0,C.jsx)(S,{scope:{useTableKeyboardNavigation:ue,trashIcon:l,Field:se},stableName:`KeyboardNavigation`,sourceImports:[`import { useCallback, useEffect, useState } from 'react'`,`import styled from '@emotion/styled'`,`import { useMedia } from '@dnb/eufemia/shared'`,`import { H2, P, Dl, Dt, Dd, Code, Anchor, Card, Flex, Badge, Heading, Icon, Menu } from '@dnb/eufemia'`,`import { stop as stopIcon, compose as composeIcon, view as eyeIcon, launch as launchIcon, trash as trashIcon } from '@dnb/eufemia/icons'`,`import { Button, Pagination, Checkbox, Input, Section, Stat } from '@dnb/eufemia/components'`,`import TableContainer from '@dnb/eufemia/components/table/TableContainer'`,`import useHandleSortState from '@dnb/eufemia/components/table/useHandleSortState'`,`import Table, { Th, Td, Tr, useTableKeyboardNavigation, useTableHighlight } from '@dnb/eufemia/components/Table'`,`import { Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Table:p,Th:b,Td:v,Field:se,Button:h},noInline:!0,children:`const KeyboardNavigationTable = () => {
...
`}),B=()=>(0,C.jsx)(S,{hideCode:!0,"data-visual-test":`table-navigation`,stableName:`ClickableRows`,sourceImports:[`import { useCallback, useEffect, useState } from 'react'`,`import styled from '@emotion/styled'`,`import { useMedia } from '@dnb/eufemia/shared'`,`import { H2, P, Dl, Dt, Dd, Code, Anchor, Card, Flex, Badge, Heading, Icon, Menu } from '@dnb/eufemia'`,`import { stop as stopIcon, compose as composeIcon, view as eyeIcon, launch as launchIcon, trash as trashIcon } from '@dnb/eufemia/icons'`,`import { Button, Pagination, Checkbox, Input, Section, Stat } from '@dnb/eufemia/components'`,`import TableContainer from '@dnb/eufemia/components/table/TableContainer'`,`import useHandleSortState from '@dnb/eufemia/components/table/useHandleSortState'`,`import Table, { Th, Td, Tr, useTableKeyboardNavigation, useTableHighlight } from '@dnb/eufemia/components/Table'`,`import { Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Checkbox:u,Input:g,Tr:y,Td:v,Table:p,Th:b,ScrollView:x},noInline:!0,children:`const NavigationTable = ({ id, showCheckbox = false, ...props }) => {
  const TdCheckbox = () => {
    return <Checkbox label="Select row" labelSrOnly />
  }
  const TdInput = () => {
...
`}),V=()=>(0,C.jsx)(S,{hideCode:!0,"data-visual-test":`table-navigation-mixed`,stableName:`NavigationMixed`,sourceImports:[`import { useCallback, useEffect, useState } from 'react'`,`import styled from '@emotion/styled'`,`import { useMedia } from '@dnb/eufemia/shared'`,`import { H2, P, Dl, Dt, Dd, Code, Anchor, Card, Flex, Badge, Heading, Icon, Menu } from '@dnb/eufemia'`,`import { stop as stopIcon, compose as composeIcon, view as eyeIcon, launch as launchIcon, trash as trashIcon } from '@dnb/eufemia/icons'`,`import { Button, Pagination, Checkbox, Input, Section, Stat } from '@dnb/eufemia/components'`,`import TableContainer from '@dnb/eufemia/components/table/TableContainer'`,`import useHandleSortState from '@dnb/eufemia/components/table/useHandleSortState'`,`import Table, { Th, Td, Tr, useTableKeyboardNavigation, useTableHighlight } from '@dnb/eufemia/components/Table'`,`import { Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Checkbox:u,Input:g,Table:p,Tr:y,Th:b,Td:v,ScrollView:x},noInline:!0,children:`const NavigationTable = ({ id, showCheckbox = false, ...props }) => {
  const TdCheckbox = () => {
    return <Checkbox label="Select row" labelSrOnly />
  }
  const TdInput = () => {
...
`}),H=()=>(0,C.jsx)(S,{hideCode:!0,"data-visual-test":`table-navigation-cell`,scope:{eyeIcon:ae,launchIcon:r},stableName:`ClickableCells`,sourceImports:[`import { useCallback, useEffect, useState } from 'react'`,`import styled from '@emotion/styled'`,`import { useMedia } from '@dnb/eufemia/shared'`,`import { H2, P, Dl, Dt, Dd, Code, Anchor, Card, Flex, Badge, Heading, Icon, Menu } from '@dnb/eufemia'`,`import { stop as stopIcon, compose as composeIcon, view as eyeIcon, launch as launchIcon, trash as trashIcon } from '@dnb/eufemia/icons'`,`import { Button, Pagination, Checkbox, Input, Section, Stat } from '@dnb/eufemia/components'`,`import TableContainer from '@dnb/eufemia/components/table/TableContainer'`,`import useHandleSortState from '@dnb/eufemia/components/table/useHandleSortState'`,`import Table, { Th, Td, Tr, useTableKeyboardNavigation, useTableHighlight } from '@dnb/eufemia/components/Table'`,`import { Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Table:p,ScrollView:x,Tr:y,Th:b,Td:v},noInline:!0,children:`const handleClick = (event, { trElement, thElement }) => {
  console.log(
...
`}),U=()=>{let e=/data-visual-test|fullscreen/.test(globalThis?.location?.href),t=globalThis.IS_TEST;return(0,C.jsx)(S,{hideCode:!0,scope:{isFullscreen:e,isVisibleWhenVisualTest:t},stableName:`Sticky`,sourceImports:[`import { useCallback, useEffect, useState } from 'react'`,`import styled from '@emotion/styled'`,`import { useMedia } from '@dnb/eufemia/shared'`,`import { H2, P, Dl, Dt, Dd, Code, Anchor, Card, Flex, Badge, Heading, Icon, Menu } from '@dnb/eufemia'`,`import { stop as stopIcon, compose as composeIcon, view as eyeIcon, launch as launchIcon, trash as trashIcon } from '@dnb/eufemia/icons'`,`import { Button, Pagination, Checkbox, Input, Section, Stat } from '@dnb/eufemia/components'`,`import TableContainer from '@dnb/eufemia/components/table/TableContainer'`,`import useHandleSortState from '@dnb/eufemia/components/table/useHandleSortState'`,`import Table, { Th, Td, Tr, useTableKeyboardNavigation, useTableHighlight } from '@dnb/eufemia/components/Table'`,`import { Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Table:p,ScrollView:x,Tr:y,Th:b,Td:v,P:_,Code:i},children:`<Table.ScrollView>
  <Table
...
`})}var K=()=>(0,C.jsx)(S,{hideToolbar:!0,hidePreview:!0,scope:{TableContainer:w},stableName:`InOneContainer`,sourceImports:[`import { useCallback, useEffect, useState } from 'react'`,`import styled from '@emotion/styled'`,`import { useMedia } from '@dnb/eufemia/shared'`,`import { H2, P, Dl, Dt, Dd, Code, Anchor, Card, Flex, Badge, Heading, Icon, Menu } from '@dnb/eufemia'`,`import { stop as stopIcon, compose as composeIcon, view as eyeIcon, launch as launchIcon, trash as trashIcon } from '@dnb/eufemia/icons'`,`import { Button, Pagination, Checkbox, Input, Section, Stat } from '@dnb/eufemia/components'`,`import TableContainer from '@dnb/eufemia/components/table/TableContainer'`,`import useHandleSortState from '@dnb/eufemia/components/table/useHandleSortState'`,`import Table, { Th, Td, Tr, useTableKeyboardNavigation, useTableHighlight } from '@dnb/eufemia/components/Table'`,`import { Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{H2:fe,Heading:ge,Table:p,P:_},children:`<TableContainer>
  <TableContainer.Head>
    <H2>Heading</H2>
  </TableContainer.Head>
...
render(<Example />)
`}),Y=()=>(0,C.jsx)(S,{scope:{composeIcon:ie,stopIcon:d,eyeIcon:ae,trashIcon:l},hideCode:!0,"data-visual-test":`table-in-card`,stableName:`InCard`,sourceImports:[`import { useCallback, useEffect, useState } from 'react'`,`import styled from '@emotion/styled'`,`import { useMedia } from '@dnb/eufemia/shared'`,`import { H2, P, Dl, Dt, Dd, Code, Anchor, Card, Flex, Badge, Heading, Icon, Menu } from '@dnb/eufemia'`,`import { stop as stopIcon, compose as composeIcon, view as eyeIcon, launch as launchIcon, trash as trashIcon } from '@dnb/eufemia/icons'`,`import { Button, Pagination, Checkbox, Input, Section, Stat } from '@dnb/eufemia/components'`,`import TableContainer from '@dnb/eufemia/components/table/TableContainer'`,`import useHandleSortState from '@dnb/eufemia/components/table/useHandleSortState'`,`import Table, { Th, Td, Tr, useTableKeyboardNavigation, useTableHighlight } from '@dnb/eufemia/components/Table'`,`import { Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Table:p,ScrollView:x,Tr:y,Th:b,Td:v,Stat:ve,Button:h,Card:pe,Flex:c,Icon:ne,Heading:ge,Menu:_e,List:he},noInline:!0,children:`const MyTable = () => {
  const rows = [
    {
...
`}),Q=()=>(0,C.jsx)(S,{"data-visual-test":`table-multiple-tbody`,stableName:`MultipleTbody`,sourceImports:[`import { useCallback, useEffect, useState } from 'react'`,`import styled from '@emotion/styled'`,`import { useMedia } from '@dnb/eufemia/shared'`,`import { H2, P, Dl, Dt, Dd, Code, Anchor, Card, Flex, Badge, Heading, Icon, Menu } from '@dnb/eufemia'`,`import { stop as stopIcon, compose as composeIcon, view as eyeIcon, launch as launchIcon, trash as trashIcon } from '@dnb/eufemia/icons'`,`import { Button, Pagination, Checkbox, Input, Section, Stat } from '@dnb/eufemia/components'`,`import TableContainer from '@dnb/eufemia/components/table/TableContainer'`,`import useHandleSortState from '@dnb/eufemia/components/table/useHandleSortState'`,`import Table, { Th, Td, Tr, useTableKeyboardNavigation, useTableHighlight } from '@dnb/eufemia/components/Table'`,`import { Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Table:p,ScrollView:x,Tr:y,Th:b,Td:v,Badge:xe},children:`<Table.ScrollView>
...
`,(0,C.jsxs)(a,{children:[(0,C.jsx)(L,{}),(0,C.jsx)(V,{}),(0,C.jsx)(X,{})]})]})}function Oe(e={}){let{wrapper:t}={...be(),...e.components};return t?(0,C.jsx)(t,{...e,children:(0,C.jsx)(De,{...e})}):De(e)}function $(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{Oe as default};