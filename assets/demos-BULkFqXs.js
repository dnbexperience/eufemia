import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{C as n,t as r}from"./Anchor-BPx9fjvj.js";import{n as i,r as a,t as o}from"./trash_medium-CJbJz0bX.js";import{k as s,s as c}from"./ToggleButton-DfKpi57X.js";import{j as l,w as u}from"./forms-D54jfDKN.js";import{n as d}from"./FormStatus-82f84R4x.js";import{t as f}from"./Button-kSqfAUVR.js";import{F as p,f as m}from"./Autocomplete-eAFtuLbJ.js";import{t as h}from"./P-CVKBz4XO.js";import{c as g,d as _}from"./Table-DeLWJx8P.js";import{t as v}from"./Card-BvVSLAbs.js";import{U as y,V as b}from"./index-BsJ3GLEw.js";import{t as x}from"./ComponentBox-sLMgHvLi.js";var S=e(t()),C=()=>(0,S.jsx)(x,{"data-visual-test":`dialog-default`,stableName:`DialogExampleDefault`,sourceImports:[`import { useRef, useState } from 'react'`,`import { trash_medium, log_out_medium, cookie_medium, bell_medium, edit } from '@dnb/eufemia/icons'`,`import { Anchor, Button, Dialog, Flex, ProgressIndicator, FormStatus, Breadcrumb, P, Input } from '@dnb/eufemia'`,`import { Form, Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Dialog:g,P:h,Modal:_,Button:f},children:`<Dialog title="What is a Dialog?">
  <P>
...
`}),w=()=>(0,S.jsx)(x,{"data-visual-test":`dialog-help-button`,stableName:`DialogExampleHelpButton`,sourceImports:[`import { useRef, useState } from 'react'`,`import { trash_medium, log_out_medium, cookie_medium, bell_medium, edit } from '@dnb/eufemia/icons'`,`import { Anchor, Button, Dialog, Flex, ProgressIndicator, FormStatus, Breadcrumb, P, Input } from '@dnb/eufemia'`,`import { Form, Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Input:p,Dialog:g,P:h},children:`<Input
  label="Input"
...
/>
`}),T=()=>(0,S.jsx)(x,{"data-visual-test":`dialog-vertical-alignment`,stableName:`DialogExampleVerticalAlignment`,sourceImports:[`import { useRef, useState } from 'react'`,`import { trash_medium, log_out_medium, cookie_medium, bell_medium, edit } from '@dnb/eufemia/icons'`,`import { Anchor, Button, Dialog, Flex, ProgressIndicator, FormStatus, Breadcrumb, P, Input } from '@dnb/eufemia'`,`import { Form, Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Dialog:g},children:`<Dialog
...
/>
`}),D=()=>(0,S.jsx)(x,{stableName:`DialogExampleDelayClose`,sourceImports:[`import { useRef, useState } from 'react'`,`import { trash_medium, log_out_medium, cookie_medium, bell_medium, edit } from '@dnb/eufemia/icons'`,`import { Anchor, Button, Dialog, Flex, ProgressIndicator, FormStatus, Breadcrumb, P, Input } from '@dnb/eufemia'`,`import { Form, Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Dialog:g,P:h,Input:p},children:`<Dialog
...
`}),O=()=>(0,S.jsx)(x,{"data-visual-test":`dialog-custom-trigger`,stableName:`DialogExampleCustomTrigger`,sourceImports:[`import { useRef, useState } from 'react'`,`import { trash_medium, log_out_medium, cookie_medium, bell_medium, edit } from '@dnb/eufemia/icons'`,`import { Anchor, Button, Dialog, Flex, ProgressIndicator, FormStatus, Breadcrumb, P, Input } from '@dnb/eufemia'`,`import { Form, Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Dialog:g,Button:f,P:h,Modal:_},children:`<Dialog
  title="Modal Title"
  trigger={(props) => (
...
`}),k=()=>(0,S.jsx)(x,{"data-visual-test":`full-dialog`,stableName:`FullDialogExample`,sourceImports:[`import { useRef, useState } from 'react'`,`import { trash_medium, log_out_medium, cookie_medium, bell_medium, edit } from '@dnb/eufemia/icons'`,`import { Anchor, Button, Dialog, Flex, ProgressIndicator, FormStatus, Breadcrumb, P, Input } from '@dnb/eufemia'`,`import { Form, Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Dialog:g,Breadcrumb:b,P:h,Button:f,FormStatus:d},noInline:!0,children:`const handleBack = () => null
render(
  <>
...
`}),A=()=>(0,S.jsx)(x,{stableName:`DialogExampleNested`,sourceImports:[`import { useRef, useState } from 'react'`,`import { trash_medium, log_out_medium, cookie_medium, bell_medium, edit } from '@dnb/eufemia/icons'`,`import { Anchor, Button, Dialog, Flex, ProgressIndicator, FormStatus, Breadcrumb, P, Input } from '@dnb/eufemia'`,`import { Form, Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Dialog:g,P:h},children:`<Dialog
...
`}),j=()=>(0,S.jsx)(x,{"data-visual-test":`dialog-progress-indicator`,stableName:`DialogExampleProgressIndicator`,sourceImports:[`import { useRef, useState } from 'react'`,`import { trash_medium, log_out_medium, cookie_medium, bell_medium, edit } from '@dnb/eufemia/icons'`,`import { Anchor, Button, Dialog, Flex, ProgressIndicator, FormStatus, Breadcrumb, P, Input } from '@dnb/eufemia'`,`import { Form, Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Dialog:g,ProgressIndicator:m},children:`<Dialog
  spacing={false}
  fullscreen={false}
...
/>
`}),P=()=>(0,S.jsx)(x,{"data-visual-test":`dialog-confirm-loggedout`,scope:{log_out_medium:i},stableName:`DialogConfirmLoggedOut`,sourceImports:[`import { useRef, useState } from 'react'`,`import { trash_medium, log_out_medium, cookie_medium, bell_medium, edit } from '@dnb/eufemia/icons'`,`import { Anchor, Button, Dialog, Flex, ProgressIndicator, FormStatus, Breadcrumb, P, Input } from '@dnb/eufemia'`,`import { Form, Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Button:f,Dialog:g},noInline:!0,children:`const DemoComponent = () => {
...
`}),F=()=>(0,S.jsx)(x,{"data-visual-test":`dialog-confirm-cookie`,scope:{cookie_medium:a,edit:s},stableName:`DialogConfirmCookies`,sourceImports:[`import { useRef, useState } from 'react'`,`import { trash_medium, log_out_medium, cookie_medium, bell_medium, edit } from '@dnb/eufemia/icons'`,`import { Anchor, Button, Dialog, Flex, ProgressIndicator, FormStatus, Breadcrumb, P, Input } from '@dnb/eufemia'`,`import { Form, Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Dialog:g,Anchor:r,Button:f},children:`<Dialog
  triggerProps={{
...
`}),I=()=>(0,S.jsx)(x,{scope:{trash_medium:o},stableName:`DialogConfirmError`,sourceImports:[`import { useRef, useState } from 'react'`,`import { trash_medium, log_out_medium, cookie_medium, bell_medium, edit } from '@dnb/eufemia/icons'`,`import { Anchor, Button, Dialog, Flex, ProgressIndicator, FormStatus, Breadcrumb, P, Input } from '@dnb/eufemia'`,`import { Form, Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Dialog:g},children:`<Dialog
  variant="confirmation"
  confirmType="warning"
  title="Are you sure you want to delete this?"
  icon={trash_medium}
...
/>
`}),L=()=>(0,S.jsx)(x,{"data-visual-test":`dialog-scroll-content`,stableName:`DialogConfirmScrollableContent`,sourceImports:[`import { useRef, useState } from 'react'`,`import { trash_medium, log_out_medium, cookie_medium, bell_medium, edit } from '@dnb/eufemia/icons'`,`import { Anchor, Button, Dialog, Flex, ProgressIndicator, FormStatus, Breadcrumb, P, Input } from '@dnb/eufemia'`,`import { Form, Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Dialog:g,Anchor:r,Button:f},noInline:!0,children:`const MockComponent = () => {
...
`}),R=()=>(0,S.jsx)(x,{"data-visual-test":`dialog-scroll-content-info`,stableName:`DialogInformationScrollableContent`,sourceImports:[`import { useRef, useState } from 'react'`,`import { trash_medium, log_out_medium, cookie_medium, bell_medium, edit } from '@dnb/eufemia/icons'`,`import { Anchor, Button, Dialog, Flex, ProgressIndicator, FormStatus, Breadcrumb, P, Input } from '@dnb/eufemia'`,`import { Form, Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Dialog:g,Form:u,Flex:c,P:h,Card:v,Field:l},noInline:!0,children:`const MockComponent = () => {
  const scrollRef = useRef(null)
  return (
    <Dialog
      triggerProps={{
...
render(<MockComponent />)
`});function z(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,li:`li`,ol:`ol`,p:`p`,...y(),...e.components},{VisibleWhenVisualTest:n}=t;return n||V(`VisibleWhenVisualTest`,!0),(0,S.jsxs)(S.Fragment,{children:[(0,S.jsx)(t.h2,{children:`Table of contents`}),`
...
`,(0,S.jsx)(N,{}),`
`,(0,S.jsx)(t.h3,{children:`Dialog with a status message`}),`
`,(0,S.jsxs)(t.p,{children:[`Use the `,(0,S.jsx)(t.code,{children:`status`}),` property to display a status message as a `,(0,S.jsx)(t.a,{href:`/uilib/components/form-status`,children:`FormStatus`}),` below the action buttons.`]}),`
`,(0,S.jsx)(I,{}),`
...
`,(0,S.jsx)(F,{}),`
`,(0,S.jsxs)(n,{children:[(0,S.jsx)(L,{}),(0,S.jsx)(R,{})]})]})}function B(e={}){let{wrapper:t}={...y(),...e.components};return t?(0,S.jsx)(t,{...e,children:(0,S.jsx)(z,{...e})}):z(e)}function V(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{B as default};