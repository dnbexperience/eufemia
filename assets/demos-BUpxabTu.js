import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{H as r,Q as i,U as a}from"./Anchor-CDwNjfi4.js";import{pt as o}from"./forms-CsJzlVUF.js";import{t as s}from"./P-CbimSwQH.js";import{B as c}from"./index-DdG6L_K8.js";import{t as l}from"./ComponentBox-q_23Ylzi.js";var u=t(n());function d({off:e,children:t}){return e?(0,u.jsx)(i,{formElement:{translate:`no`},children:(0,u.jsx)(a,{translate:`no`,children:t})}):(0,u.jsx)(u.Fragment,{children:t})}var f=e({BrowserTranslateExample:()=>m,PortalRootExample:()=>p}),p=()=>(0,u.jsx)(l,{stableName:`PortalRootExample`,sourceImports:[`import { P, PortalRoot, Dropdown } from '@dnb/eufemia'`,`import { BrowserTranslate } from '@dnb/eufemia/shared'`],__buildScope:{PortalRoot:r,P:s},children:`
<PortalRoot>
  <div
    style={{
      position: 'fixed',
