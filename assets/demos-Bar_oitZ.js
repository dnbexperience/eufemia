...
`}),f=()=>(0,c.jsx)(r,{scope:{DataContext:o,Value:n,testData:u,TestDataSchema:l,ajv:i()},children:`<DataContext.Provider
  data={testData}
...
`});function p(e){let t={h2:`h2`,h3:`h3`,...a(),...e.components};return s||h(`Examples`,!1),d||h(`Examples.Default`,!0),f||h(`Examples.ValidationWithJsonSchema`,!0),(0,c.jsxs)(c.Fragment,{children:[(0,c.jsx)(t.h2,{children:`Demos`}),`
