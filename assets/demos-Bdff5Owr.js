import{a as e}from"./rolldown-runtime-BYbx6iT9.js";import{t}from"./jsx-runtime-BgMs7Gb-.js";import{n,r,t as i}from"./trash_medium-B-PAv1zt.js";import{x as a}from"./view_medium-BGCKigyJ.js";import{t as o}from"./ComponentBox-a4aOn231.js";import{li as s,zr as c}from"./index-DqqByKA2.js";var l=e(t()),u=()=>(0,l.jsx)(o,{"data-visual-test":`dialog-default`,stableName:`DialogExampleDefault`,children:`<Dialog title="What is a Dialog?">
  <P>
...
`}),d=()=>(0,l.jsx)(o,{"data-visual-test":`dialog-help-button`,stableName:`DialogExampleHelpButton`,children:`<Input
  label="Input"
...
/>
`}),f=()=>(0,l.jsx)(o,{"data-visual-test":`dialog-vertical-alignment`,stableName:`DialogExampleVerticalAlignment`,children:`<Dialog
...
/>
`}),p=()=>(0,l.jsx)(o,{"data-visual-test":`dialog-fullscreen`,stableName:`DialogExampleFullscreen`,children:`<Dialog
...
/>
`}),m=()=>(0,l.jsx)(o,{stableName:`DialogExampleDelayClose`,children:`<Dialog
...
`}),h=()=>(0,l.jsx)(o,{"data-visual-test":`dialog-custom-trigger`,stableName:`DialogExampleCustomTrigger`,children:`<Dialog
  title="Modal Title"
  trigger={(props) => (
...
`}),g=()=>(0,l.jsx)(o,{"data-visual-test":`full-dialog`,stableName:`FullDialogExample`,noInline:!0,children:`const handleBack = () => null
render(
  <>
...
`}),_=()=>(0,l.jsx)(o,{"data-visual-test":`dialog-progress-indicator`,stableName:`DialogExampleProgressIndicator`,children:`<Dialog
  spacing={false}
  fullscreen={false}
...
`}),v=()=>(0,l.jsx)(o,{"data-visual-test":`dialog-confirm-default`,scope:{bell_medium:s},stableName:`DialogConfirmDefault`,children:`<Dialog
...
/>
`}),y=()=>(0,l.jsx)(o,{"data-visual-test":`dialog-confirm-delete`,scope:{trash_medium:i},stableName:`DialogConfirmDelete`,children:`<Dialog
  variant="confirmation"
  confirmType="warning"
...
/>
`}),b=()=>(0,l.jsx)(o,{"data-visual-test":`dialog-confirm-loggedout`,scope:{log_out_medium:n},stableName:`DialogConfirmLoggedOut`,noInline:!0,children:`const DemoComponent = () => {
...
`}),x=()=>(0,l.jsx)(o,{"data-visual-test":`dialog-confirm-cookie`,scope:{cookie_medium:r,edit:a},stableName:`DialogConfirmCookies`,children:`<Dialog
  triggerAttributes={{
...
`}),S=()=>(0,l.jsx)(o,{"data-visual-test":`dialog-scroll-content`,stableName:`DialogConfirmScrollableContent`,noInline:!0,children:`const MockComponent = () => {
...
`}),C=()=>(0,l.jsx)(o,{"data-visual-test":`dialog-scroll-content-info`,stableName:`DialogInformationScrollableContent`,noInline:!0,children:`const MockComponent = () => {
  const scrollRef = useRef(null)
  return (
    <Dialog
      triggerAttributes={{
...
render(<MockComponent />)
`});function w(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,li:`li`,ol:`ol`,p:`p`,...c(),...e.components},{VisibleWhenVisualTest:n}=t;return n||E(`VisibleWhenVisualTest`,!0),(0,l.jsxs)(l.Fragment,{children:[(0,l.jsx)(t.h2,{children:`Table of contents`}),`
...
`,(0,l.jsx)(x,{}),`
`,(0,l.jsxs)(n,{children:[(0,l.jsx)(S,{}),(0,l.jsx)(C,{})]})]})}function T(e={}){let{wrapper:t}={...c(),...e.components};return t?(0,l.jsx)(t,{...e,children:(0,l.jsx)(w,{...e})}):w(e)}function E(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{T as default};