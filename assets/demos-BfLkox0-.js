import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{n as r}from"./HelpButton-C7xeEDxM.js";import{t as i}from"./Section-BtXmNREe.js";import{c as a}from"./ToggleButton-_NsXxiTa.js";import{t as o}from"./Form-JTiJXf2d.js";import{t as s}from"./Field-DqRpWyNm.js";import{K as c}from"./index-ppRu2ktv.js";import{t as l}from"./ComponentBox-R2c6Bo76.js";var u=e({WithCustomReturnStatus:()=>m,WithDialog:()=>f,WithStateContent:()=>p}),d=t(n()),f=()=>(0,d.jsx)(l,{stableName:`WithDialog`,sourceImports:[`import { ReactNode } from 'react'`,`import { Dialog, Flex, Section } from '@dnb/eufemia'`,`import { Field, Form } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:o,Flex:a,Field:s,Dialog:r},children:`<Form.Handler
  locale="en-GB"
  onSubmit={async () => {
...
`}),p=()=>(0,d.jsx)(l,{stableName:`WithStateContent`,sourceImports:[`import { ReactNode } from 'react'`,`import { Dialog, Flex, Section } from '@dnb/eufemia'`,`import { Field, Form } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:o,Flex:a,Field:s,Dialog:r},children:`<Form.Handler
  locale="en-GB"
  onSubmit={async () => {
    await new Promise((resolve) => setTimeout(resolve, 2000))
  }}
...
`}),m=()=>(0,d.jsx)(l,{stableName:`WithCustomReturnStatus`,sourceImports:[`import { ReactNode } from 'react'`,`import { Dialog, Flex, Section } from '@dnb/eufemia'`,`import { Field, Form } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:o,Flex:a,Field:s,Dialog:r,Section:i},children:`<Form.Handler
  locale="en-GB"
  onSubmit={async () => {
    await new Promise((resolve) => setTimeout(resolve, 2000))
    return {
