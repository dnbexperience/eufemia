import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{t as r}from"./Anchor-ywdvt45E.js";import{M as i}from"./Autocomplete-DM3xptYi.js";import{c as a}from"./ToggleButton-D3NEk3jO.js";import{t as o}from"./Card-C6UABezd.js";import{a as s}from"./Selection-DXfzor9j.js";import{t as c}from"./Slider-lEY9INSg.js";import{t as l}from"./Form-C16rVaXm.js";import{t as u}from"./TestElement-pdBUkdrQ.js";import{t as d}from"./Field-B5trC2Cn.js";import{W as f,j as p}from"./index-BCXtuv-b.js";import{t as m}from"./ComponentBox-B2X8809Z.js";var h=e({CombineErrorMessages:()=>D,Default:()=>_,Horizontal:()=>y,HorizontalAutoSize:()=>T,HorizontalWithInfo:()=>x,HorizontalWrap:()=>b,InlineHelpButtonCompositionFields:()=>F,InlineHelpButtonHTML:()=>M,InlineHelpButtonHorizontalLabel:()=>P,InlineHelpButtonLabelDescription:()=>A,InlineHelpButtonLabelDescriptionNoLabel:()=>j,InlineHelpButtonVerticalLabel:()=>k,InlineHelpButtonVerticalLabelDescription:()=>N,LabelSize:()=>E,StatusPositionAbove:()=>O,Widths:()=>S,WithDescription:()=>C,WithDescriptionNoLabel:()=>w,WithInfo:()=>v,WrappingLabel:()=>I,WrappingLabelDescription:()=>L}),g=t(n()),_=()=>(0,g.jsx)(m,{stableName:`Default`,sourceImports:[`import { FieldBlock, Field, TestElement, Form } from '@dnb/eufemia/extensions/forms'`,`import { Anchor, Flex, Slider } from '@dnb/eufemia'`],__buildScope:{FieldBlock:s,Input:i},children:`<FieldBlock label="Label text">Input features goes here</FieldBlock>
`}),v=()=>(0,g.jsx)(m,{stableName:`WithInfo`,sourceImports:[`import { FieldBlock, Field, TestElement, Form } from '@dnb/eufemia/extensions/forms'`,`import { Anchor, Flex, Slider } from '@dnb/eufemia'`],__buildScope:{FieldBlock:s,Input:i},children:`<FieldBlock label="Label text" info="For your information">
  Input features goes here
</FieldBlock>
`}),y=()=>(0,g.jsx)(m,{stableName:`Horizontal`,sourceImports:[`import { FieldBlock, Field, TestElement, Form } from '@dnb/eufemia/extensions/forms'`,`import { Anchor, Flex, Slider } from '@dnb/eufemia'`],__buildScope:{FieldBlock:s,Input:i},children:`<FieldBlock label="Label text" layout="horizontal">
  Input features goes here
</FieldBlock>
`}),b=()=>(0,g.jsx)(m,{"data-visual-test":`forms-field-block-horizontal-wrap`,stableName:`HorizontalWrap`,sourceImports:[`import { FieldBlock, Field, TestElement, Form } from '@dnb/eufemia/extensions/forms'`,`import { Anchor, Flex, Slider } from '@dnb/eufemia'`],__buildScope:{FieldBlock:s,Field:d},children:`<FieldBlock layout="horizontal" composition width="large">
  <Field.String label="Foo" width="medium" />
  <Field.String label="Bar" width="medium" />
</FieldBlock>
`}),x=()=>(0,g.jsx)(m,{stableName:`HorizontalWithInfo`,sourceImports:[`import { FieldBlock, Field, TestElement, Form } from '@dnb/eufemia/extensions/forms'`,`import { Anchor, Flex, Slider } from '@dnb/eufemia'`],__buildScope:{FieldBlock:s,Input:i},children:`<FieldBlock
  label="Label text"
  layout="horizontal"
...
`}),S=()=>(0,g.jsx)(m,{scope:{TestElement:u},hideCode:!0,"data-visual-test":`forms-field-block-widths`,stableName:`Widths`,sourceImports:[`import { FieldBlock, Field, TestElement, Form } from '@dnb/eufemia/extensions/forms'`,`import { Anchor, Flex, Slider } from '@dnb/eufemia'`],__buildScope:{Flex:a,FieldBlock:s},children:`<Flex.Stack>
...
`}),C=()=>(0,g.jsx)(m,{"data-visual-test":`forms-field-block-label-description`,stableName:`WithDescription`,sourceImports:[`import { FieldBlock, Field, TestElement, Form } from '@dnb/eufemia/extensions/forms'`,`import { Anchor, Flex, Slider } from '@dnb/eufemia'`],__buildScope:{FieldBlock:s,Input:i},children:`<FieldBlock label="Label text" labelDescription="Description text">
  Input features goes here
</FieldBlock>
`}),w=()=>(0,g.jsx)(m,{"data-visual-test":`forms-field-block-label-description-no-label`,stableName:`WithDescriptionNoLabel`,sourceImports:[`import { FieldBlock, Field, TestElement, Form } from '@dnb/eufemia/extensions/forms'`,`import { Anchor, Flex, Slider } from '@dnb/eufemia'`],__buildScope:{FieldBlock:s,Input:i},children:`<FieldBlock labelDescription="Description text">
  Input features goes here
</FieldBlock>
`}),T=()=>(0,g.jsx)(m,{stableName:`HorizontalAutoSize`,sourceImports:[`import { FieldBlock, Field, TestElement, Form } from '@dnb/eufemia/extensions/forms'`,`import { Anchor, Flex, Slider } from '@dnb/eufemia'`],__buildScope:{FieldBlock:s,Flex:a,Field:d,Slider:c},children:`<FieldBlock label="Label">
  <Flex.Container>
    <Flex.Item
      span={{
        small: 12,
...
`}),E=()=>(0,g.jsx)(m,{"data-visual-test":`forms-field-block-label-size`,stableName:`LabelSize`,sourceImports:[`import { FieldBlock, Field, TestElement, Form } from '@dnb/eufemia/extensions/forms'`,`import { Anchor, Flex, Slider } from '@dnb/eufemia'`],__buildScope:{Form:l,Flex:a,Heading:p,FieldBlock:s,Field:d},children:`<Form.Handler>
  <Flex.Stack>
...
`}),D=()=>(0,g.jsx)(m,{"data-visual-test":`forms-field-block-combined-errors`,stableName:`CombineErrorMessages`,sourceImports:[`import { FieldBlock, Field, TestElement, Form } from '@dnb/eufemia/extensions/forms'`,`import { Anchor, Flex, Slider } from '@dnb/eufemia'`],__buildScope:{Field:d},children:`<Field.Composition>
  <Field.Number
    width="small"
    label="Number"
    value={99}
...
`}),O=()=>(0,g.jsx)(m,{"data-visual-test":`forms-field-block-status-position-above`,stableName:`StatusPositionAbove`,sourceImports:[`import { FieldBlock, Field, TestElement, Form } from '@dnb/eufemia/extensions/forms'`,`import { Anchor, Flex, Slider } from '@dnb/eufemia'`],__buildScope:{Field:d},children:`<Field.String
  label="Field with status above"
  warning="Warning message"
  info="Info message"
  statusPosition="above"
/>
`}),k=()=>(0,g.jsx)(m,{"data-visual-test":`forms-field-block-help-button-vertical-label`,stableName:`InlineHelpButtonVerticalLabel`,sourceImports:[`import { FieldBlock, Field, TestElement, Form } from '@dnb/eufemia/extensions/forms'`,`import { Anchor, Flex, Slider } from '@dnb/eufemia'`],__buildScope:{Flex:a,Field:d,Anchor:r},children:`<Flex.Stack>
  <Field.String
...
`}),A=()=>(0,g.jsx)(m,{"data-visual-test":`forms-field-block-help-button-label-description`,stableName:`InlineHelpButtonLabelDescription`,sourceImports:[`import { FieldBlock, Field, TestElement, Form } from '@dnb/eufemia/extensions/forms'`,`import { Anchor, Flex, Slider } from '@dnb/eufemia'`],__buildScope:{Flex:a,Field:d},children:`<Flex.Stack>
  <Field.String
    label="Ønsket lånebeløp"
...
`}),M=()=>(0,g.jsx)(m,{"data-visual-test":`forms-field-block-help-button-html`,stableName:`InlineHelpButtonHTML`,sourceImports:[`import { FieldBlock, Field, TestElement, Form } from '@dnb/eufemia/extensions/forms'`,`import { Anchor, Flex, Slider } from '@dnb/eufemia'`],__buildScope:{Flex:a,Field:d,Anchor:r},children:`<Flex.Stack>
  <Field.String
...
`}),N=()=>(0,g.jsx)(m,{"data-visual-test":`forms-field-block-help-button-vertical-label-description`,stableName:`InlineHelpButtonVerticalLabelDescription`,sourceImports:[`import { FieldBlock, Field, TestElement, Form } from '@dnb/eufemia/extensions/forms'`,`import { Anchor, Flex, Slider } from '@dnb/eufemia'`],__buildScope:{Form:l,Card:o,Field:d},children:`<Form.Card>
  <Field.String
    label="Ønsket lånebeløp"
    labelDescription="Description"
    help={{
...
`,(0,g.jsx)(S,{}),`
`,(0,g.jsxs)(n,{children:[(0,g.jsx)(b,{}),(0,g.jsx)(I,{}),(0,g.jsx)(L,{})]})]})}function z(e={}){let{wrapper:t}={...f(),...e.components};return t?(0,g.jsx)(t,{...e,children:(0,g.jsx)(R,{...e})}):R(e)}function B(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{z as default};