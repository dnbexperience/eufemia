import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{t as r}from"./Section-BV74bciL.js";import{c as i}from"./ToggleButton-T4E3Coih.js";import{t as a}from"./Card-Dsou21Li.js";import{H as o}from"./Selection-5ph0VyAS.js";import{t as s}from"./ajv-BlX4ktVn.js";import{t as c}from"./Form-B9l6EvGx.js";import{t as l}from"./Field-DHicZJEj.js";import{t as u}from"./Iterate-B2rVv1xi.js";import{t as d}from"./Tools-DabwYqKy.js";import{K as f}from"./index-CsG353ar.js";import{t as p}from"./ComponentBox-Cb1rLw_D.js";var m=e({DataSetSchema:()=>_,DependentListSchema:()=>y,DependentSchemaValidation:()=>b,DependentSchemaValidationWithZod:()=>x,IfRuleSchema:()=>v,SingleFieldSchema:()=>g}),h=t(n()),g=()=>(0,h.jsx)(p,{scope:{makeAjvInstance:s},stableName:`SingleFieldSchema`,sourceImports:[`import { Flex, Section } from '@dnb/eufemia'`,`import { z, Form, Field, Iterate, Tools, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:c,Field:l},noInline:!0,children:`const ajv = makeAjvInstance()
const schema = {
  type: 'string',
  minLength: 5,
}
...
`}),_=()=>(0,h.jsx)(p,{scope:{makeAjvInstance:s},stableName:`DataSetSchema`,sourceImports:[`import { Flex, Section } from '@dnb/eufemia'`,`import { z, Form, Field, Iterate, Tools, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:c,Card:a,Field:l},noInline:!0,children:`const ajv = makeAjvInstance()
const schema = {
  type: 'object',
  properties: {
    name: {
...
`}),v=()=>(0,h.jsx)(p,{scope:{makeAjvInstance:s},stableName:`IfRuleSchema`,sourceImports:[`import { Flex, Section } from '@dnb/eufemia'`,`import { z, Form, Field, Iterate, Tools, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:c,Card:a,Field:l},noInline:!0,children:`const ajv = makeAjvInstance()
const schema = {
  type: 'object',
  properties: {
    name: {
...
`}),y=()=>(0,h.jsx)(p,{scope:{makeAjvInstance:s},stableName:`DependentListSchema`,sourceImports:[`import { Flex, Section } from '@dnb/eufemia'`,`import { z, Form, Field, Iterate, Tools, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:c,Flex:i,Card:a,Field:l,Iterate:u},noInline:!0,children:`const ajv = makeAjvInstance()
const schema = {
  type: 'object',
  definitions: {
    account: {
...
`}),b=()=>(0,h.jsx)(p,{scope:{makeAjvInstance:s,Tools:d},stableName:`DependentSchemaValidation`,sourceImports:[`import { Flex, Section } from '@dnb/eufemia'`,`import { z, Form, Field, Iterate, Tools, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:c,Flex:i,Card:a,Field:l,Iterate:u,Section:r,Tools:d},noInline:!0,children:`const ajv = makeAjvInstance()
const counts = [1, 2, 3]
const schema = {
  type: 'object',
  properties: {
...
`}),x=()=>(0,h.jsx)(p,{scope:{Tools:d,z:o},stableName:`DependentSchemaValidationWithZod`,sourceImports:[`import { Flex, Section } from '@dnb/eufemia'`,`import { z, Form, Field, Iterate, Tools, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:c,Flex:i,Card:a,Field:l,Iterate:u,Section:r,Tools:d},noInline:!0,children:`const counts = [1, 2, 3]
