...
`}),N=()=>(0,w.jsx)(x,{scope:{Article:O},"data-visual-test":`skeleton-figure-article`,stableName:`SkeletonFiguresExample`,sourceImports:[`import { Suspense, useContext, useState } from 'react'`,`import Context from '@dnb/eufemia/shared/Context'`,`import { Input, H2, P, Button, Skeleton, ToggleButton, Div } from '@dnb/eufemia'`,`import { AllComponentsHorizontalTestCase, AllComponentsVerticalLabelsTestCase } from '../../layout/Examples'`,`import Provider from '@dnb/eufemia/shared/Provider'`,`import { Article } from '@dnb/eufemia/components/skeleton/figures'`,`import { createSkeletonClass, skeletonDOMAttributes } from '@dnb/eufemia/components/skeleton/SkeletonHelper'`],__buildScope:{Skeleton:_},children:`<Skeleton show figure={<Article rows={5} />}>
  hidden content
</Skeleton>
`}),P=()=>(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)(_,{show:!0,noAnimation:!0,children:(0,w.jsx)(C,{"data-visual-test":`skeleton-all-horizontal`})}),(0,w.jsx)(_,{show:!0,noAnimation:!0,children:(0,w.jsx)(S,{"data-visual-test":`skeleton-all-vertical`})})]}),F=()=>(0,w.jsx)(x,{hidePreview:!0,stableName:`SkeletonInfoProvider`,sourceImports:[`import { Suspense, useContext, useState } from 'react'`,`import Context from '@dnb/eufemia/shared/Context'`,`import { Input, H2, P, Button, Skeleton, ToggleButton, Div } from '@dnb/eufemia'`,`import { AllComponentsHorizontalTestCase, AllComponentsVerticalLabelsTestCase } from '../../layout/Examples'`,`import Provider from '@dnb/eufemia/shared/Provider'`,`import { Article } from '@dnb/eufemia/components/skeleton/figures'`,`import { createSkeletonClass, skeletonDOMAttributes } from '@dnb/eufemia/components/skeleton/SkeletonHelper'`],__buildScope:{Div:E,Skeleton:_,Input:f},children:`<Div id="your-app">
  <Skeleton show={true}>
