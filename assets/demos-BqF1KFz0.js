import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{t as r,tt as i}from"./Anchor-BqZ7Pm7_.js";import{t as a}from"./fish_medium-CF1gHfUZ.js";import{t as o}from"./Button-DbtiL1rf.js";import{f as s}from"./Autocomplete-6fC_p2_U.js";import{t as c}from"./Avatar-BgBLWhYe.js";import{t as l}from"./P-D0SeNBSG.js";import{i as u}from"./HelpButton-B8IG5rB3.js";import{t as d}from"./Link-BWr1lrzo.js";import{t as ee}from"./Span-DTZxqsnH.js";import{c as f}from"./ToggleButton-T4E3Coih.js";import{t as p}from"./Card-Dsou21Li.js";import{t as m}from"./DateFormat-kf2DXBdD.js";import{t as h}from"./ListExport-2kiUgtRC.js";import{t as g}from"./export-CLcjsEdd.js";import{t as _}from"./NumberFormatExport-DHHZHF0w.js";import{t as v}from"./Form-B9l6EvGx.js";import{t as y}from"./Field-DHicZJEj.js";import{t as b}from"./Value-whMgauSk.js";import{G as x,K as S,M as C,W as w}from"./index-CsG353ar.js";import{t as T}from"./ComponentBox-Cb1rLw_D.js";var E=e({Accordion:()=>H,BackgroundColor:()=>L,FooterWithButtons:()=>A,GridColumns:()=>q,InsideCard:()=>J,InsideCardWithoutScrollView:()=>Y,ListSubline:()=>W,NavigableItem:()=>j,NavigableItemWithCustomElement:()=>N,NavigableItemWithHref:()=>M,PendingState:()=>z,ProgressIndicatorRow:()=>B,RowsWithSlots:()=>k,SelectedState:()=>I,SeparatedLists:()=>V,SimpleRows:()=>O,SkeletonState:()=>R,WithAnchor:()=>P,WithAvatar:()=>F,WithBadge:()=>G,WithDateFormat:()=>U,WithFormElements:()=>K,WithShowMoreButton:()=>X}),D=t(n()),O=()=>(0,D.jsx)(T,{stableName:`SimpleRows`,sourceImports:[`import { Anchor, Avatar, Badge, Button, Code, DateFormat, Flex, Grid, Heading, List, NumberFormat, P, ProgressIndicator, Span } from '@dnb/eufemia'`,`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`,`import { fish_medium } from '@dnb/eufemia/icons'`],__buildScope:{List:h,Value:b},noInline:!0,children:`const myList = [
  {
    name: 'List item 1',
    amount: 10000,
  },
...
`}),k=()=>(0,D.jsx)(T,{"data-visual-test":`list-slots`,scope:{fish_medium:a},stableName:`RowsWithSlots`,sourceImports:[`import { Anchor, Avatar, Badge, Button, Code, DateFormat, Flex, Grid, Heading, List, NumberFormat, P, ProgressIndicator, Span } from '@dnb/eufemia'`,`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`,`import { fish_medium } from '@dnb/eufemia/icons'`],__buildScope:{List:h,P:l},children:`<List.Container>
  <List.Item.Basic>
...
`}),A=()=>(0,D.jsx)(T,{"data-visual-test":`list-footer`,scope:{fish_medium:a},stableName:`FooterWithButtons`,sourceImports:[`import { Anchor, Avatar, Badge, Button, Code, DateFormat, Flex, Grid, Heading, List, NumberFormat, P, ProgressIndicator, Span } from '@dnb/eufemia'`,`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`,`import { fish_medium } from '@dnb/eufemia/icons'`],__buildScope:{List:h,NumberFormat:_,Flex:f,Button:o,Value:b,Span:ee,Accordion:x,P:l},children:`<List.Container>
...
`}),j=()=>(0,D.jsx)(T,{"data-visual-test":`list-action`,scope:{fish_medium:a},stableName:`NavigableItem`,sourceImports:[`import { Anchor, Avatar, Badge, Button, Code, DateFormat, Flex, Grid, Heading, List, NumberFormat, P, ProgressIndicator, Span } from '@dnb/eufemia'`,`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`,`import { fish_medium } from '@dnb/eufemia/icons'`],__buildScope:{List:h,NumberFormat:_},children:`<List.Container>
  <List.Item.Action
    icon={fish_medium}
...
`}),N=()=>(0,D.jsx)(T,{scope:{fish_medium:a},stableName:`NavigableItemWithCustomElement`,sourceImports:[`import { Anchor, Avatar, Badge, Button, Code, DateFormat, Flex, Grid, Heading, List, NumberFormat, P, ProgressIndicator, Span } from '@dnb/eufemia'`,`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`,`import { fish_medium } from '@dnb/eufemia/icons'`],__buildScope:{List:h,NumberFormat:_},noInline:!0,children:`// Example using a custom link component (e.g. React Router's Link).
...
`}),P=()=>(0,D.jsx)(T,{scope:{fish_medium:a},stableName:`WithAnchor`,sourceImports:[`import { Anchor, Avatar, Badge, Button, Code, DateFormat, Flex, Grid, Heading, List, NumberFormat, P, ProgressIndicator, Span } from '@dnb/eufemia'`,`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`,`import { fish_medium } from '@dnb/eufemia/icons'`],__buildScope:{List:h,Anchor:r,Link:d,NumberFormat:_},children:`<List.Container>
...
`}),F=()=>(0,D.jsx)(T,{"data-visual-test":`list-avatar`,stableName:`WithAvatar`,sourceImports:[`import { Anchor, Avatar, Badge, Button, Code, DateFormat, Flex, Grid, Heading, List, NumberFormat, P, ProgressIndicator, Span } from '@dnb/eufemia'`,`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`,`import { fish_medium } from '@dnb/eufemia/icons'`],__buildScope:{List:h,Avatar:c,NumberFormat:_,Value:b,Accordion:x,P:l},children:`<List.Container>
...
`}),I=()=>(0,D.jsx)(T,{stableName:`SelectedState`,sourceImports:[`import { Anchor, Avatar, Badge, Button, Code, DateFormat, Flex, Grid, Heading, List, NumberFormat, P, ProgressIndicator, Span } from '@dnb/eufemia'`,`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`,`import { fish_medium } from '@dnb/eufemia/icons'`],__buildScope:{List:h},children:`<List.Container>
...
`}),B=()=>(0,D.jsx)(T,{stableName:`ProgressIndicatorRow`,sourceImports:[`import { Anchor, Avatar, Badge, Button, Code, DateFormat, Flex, Grid, Heading, List, NumberFormat, P, ProgressIndicator, Span } from '@dnb/eufemia'`,`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`,`import { fish_medium } from '@dnb/eufemia/icons'`],__buildScope:{List:h,ProgressIndicator:s},children:`<List.Container>
  <List.Item.Basic>
    <List.Cell.Start>
      <ProgressIndicator
        size="medium"
...
`}),V=()=>(0,D.jsx)(T,{"data-visual-test":`list-separated`,scope:{fish_medium:a},stableName:`SeparatedLists`,sourceImports:[`import { Anchor, Avatar, Badge, Button, Code, DateFormat, Flex, Grid, Heading, List, NumberFormat, P, ProgressIndicator, Span } from '@dnb/eufemia'`,`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`,`import { fish_medium } from '@dnb/eufemia/icons'`],__buildScope:{List:h,Value:b},children:`<List.Container separated>
...
`}),H=()=>(0,D.jsx)(T,{"data-visual-test":`list-accordion`,scope:{fish_medium:a},stableName:`Accordion`,sourceImports:[`import { Anchor, Avatar, Badge, Button, Code, DateFormat, Flex, Grid, Heading, List, NumberFormat, P, ProgressIndicator, Span } from '@dnb/eufemia'`,`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`,`import { fish_medium } from '@dnb/eufemia/icons'`],__buildScope:{List:h,Accordion:x,NumberFormat:_,P:l,Code:i},children:`<List.Container>
...
`}),U=()=>(0,D.jsx)(T,{"data-visual-test":`list-overline`,stableName:`WithDateFormat`,sourceImports:[`import { Anchor, Avatar, Badge, Button, Code, DateFormat, Flex, Grid, Heading, List, NumberFormat, P, ProgressIndicator, Span } from '@dnb/eufemia'`,`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`,`import { fish_medium } from '@dnb/eufemia/icons'`],__buildScope:{List:h,DateFormat:m,Value:b,Accordion:x,P:l,Code:i},children:`<List.Container>
...
`}),G=()=>(0,D.jsx)(T,{scope:{fish_medium:a},stableName:`WithBadge`,sourceImports:[`import { Anchor, Avatar, Badge, Button, Code, DateFormat, Flex, Grid, Heading, List, NumberFormat, P, ProgressIndicator, Span } from '@dnb/eufemia'`,`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`,`import { fish_medium } from '@dnb/eufemia/icons'`],__buildScope:{List:h,Badge:w,Accordion:x,Flex:f,Value:b,P:l},children:`<List.Container>
...
`}),K=()=>(0,D.jsx)(T,{"data-visual-test":`list-form-elements`,stableName:`WithFormElements`,sourceImports:[`import { Anchor, Avatar, Badge, Button, Code, DateFormat, Flex, Grid, Heading, List, NumberFormat, P, ProgressIndicator, Span } from '@dnb/eufemia'`,`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`,`import { fish_medium } from '@dnb/eufemia/icons'`],__buildScope:{Form:v,Flex:f,Field:y,List:h,Value:b},noInline:!0,children:`render(
  <Form.Handler
    defaultData={{
      mySelection: 'bar',
...
`}),q=()=>(0,D.jsx)(T,{scope:{fish_medium:a},background:`plain`,stableName:`GridColumns`,sourceImports:[`import { Anchor, Avatar, Badge, Button, Code, DateFormat, Flex, Grid, Heading, List, NumberFormat, P, ProgressIndicator, Span } from '@dnb/eufemia'`,`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`,`import { fish_medium } from '@dnb/eufemia/icons'`],__buildScope:{Grid:g,List:h,NumberFormat:_,P:l},children:`<Grid.Container
  rowGap
  columnGap
  style={{
    marginInline: 'auto',
...
`}),J=()=>(0,D.jsx)(T,{"data-visual-test":`list-card`,scope:{fish_medium:a},stableName:`InsideCard`,sourceImports:[`import { Anchor, Avatar, Badge, Button, Code, DateFormat, Flex, Grid, Heading, List, NumberFormat, P, ProgressIndicator, Span } from '@dnb/eufemia'`,`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`,`import { fish_medium } from '@dnb/eufemia/icons'`],__buildScope:{List:h,Card:p,Heading:C,ScrollView:u,Value:b},children:`<List.Card>
...
`}),Y=()=>(0,D.jsx)(T,{"data-visual-test":`list-card-no-scroll-view`,scope:{fish_medium:a},stableName:`InsideCardWithoutScrollView`,sourceImports:[`import { Anchor, Avatar, Badge, Button, Code, DateFormat, Flex, Grid, Heading, List, NumberFormat, P, ProgressIndicator, Span } from '@dnb/eufemia'`,`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`,`import { fish_medium } from '@dnb/eufemia/icons'`],__buildScope:{List:h,Card:p,Value:b},children:`<List.Card innerSpace="x-small">
  <List.Container>
    <List.Item.Action
      icon={fish_medium}
...
`}),X=()=>(0,D.jsx)(T,{scope:{fish_medium:a},background:`plain`,stableName:`WithShowMoreButton`,sourceImports:[`import { Anchor, Avatar, Badge, Button, Code, DateFormat, Flex, Grid, Heading, List, NumberFormat, P, ProgressIndicator, Span } from '@dnb/eufemia'`,`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`,`import { fish_medium } from '@dnb/eufemia/icons'`],__buildScope:{Flex:f,Heading:C,List:h,Value:b,Accordion:x,P:l},children:`
