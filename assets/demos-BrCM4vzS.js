import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{it as r,j as i,v as a,w as o}from"./forms-Ce7VSRGW.js";import{U as s}from"./index-DHCu7dhB.js";import{t as c}from"./ComponentBox-CmvipvMU.js";var l=e({IteratePath:()=>f,Path:()=>d}),u=t(n()),d=()=>(0,u.jsx)(c,{scope:{DataContext:r},stableName:`Path`,sourceImports:[`import { Form, Field, Value, DataContext } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:o,DataContext:r,Field:i},children:`<Form.Handler
  data={{
    foo: {
      one: 1,
      two: 2,
