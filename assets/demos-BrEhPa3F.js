...
/>
`}),d=()=>(0,c.jsx)(s,{"data-visual-test":`step-indicator-loose`,stableName:`StepIndicatorLoose`,sourceImports:[`import { useEffect, useState } from 'react'`,`import { StepIndicator, Space, Button, Section } from '@dnb/eufemia'`],__buildScope:{Space:i,StepIndicator:n,Button:o},noInline:!0,children:`const InteractiveDemo = () => {
...
`}),f=()=>(0,c.jsx)(s,{stableName:`StepIndicatorCustomized`,sourceImports:[`import { useEffect, useState } from 'react'`,`import { StepIndicator, Space, Button, Section } from '@dnb/eufemia'`],__buildScope:{StepIndicator:n,Section:r},noInline:!0,children:`function CustomStepIndicator({ children, data, ...props }) {
...
/>
`});function _(e){let t={code:`code`,h2:`h2`,h3:`h3`,p:`p`,...a(),...e.components},{VisibleWhenVisualTest:n}=t;return n||y(`VisibleWhenVisualTest`,!0),(0,c.jsxs)(c.Fragment,{children:[(0,c.jsx)(t.h2,{children:`Demos`}),`
...
`,(0,c.jsx)(g,{}),`
`,(0,c.jsx)(n,{children:(0,c.jsx)(h,{})})]})}function v(e={}){let{wrapper:t}={...a(),...e.components};return t?(0,c.jsx)(t,{...e,children:(0,c.jsx)(_,{...e})}):_(e)}function y(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{v as default};