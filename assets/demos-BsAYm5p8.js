import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{c as r}from"./ToggleButton-D3NEk3jO.js";import{t as i}from"./Card-C6UABezd.js";import{t as a}from"./Form-C16rVaXm.js";import{t as o}from"./Field-B5trC2Cn.js";import{W as s}from"./index-BCXtuv-b.js";import{t as c}from"./ComponentBox-B2X8809Z.js";var l=e({MixedIndeterminateDependence:()=>d,NestedIndeterminateDependence:()=>p,PropagateIndeterminateDependence:()=>f}),u=t(n()),d=()=>(0,u.jsx)(c,{stableName:`MixedIndeterminateDependence`,sourceImports:[`import { Flex } from '@dnb/eufemia'`,`import { Field, Form } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:a,Card:i,Field:o},children:`<Form.Handler onChange={console.log}>
  <Form.Card>
    <Field.Indeterminate
      label="Indeterminate"
...
`}),f=()=>(0,u.jsx)(c,{stableName:`PropagateIndeterminateDependence`,sourceImports:[`import { Flex } from '@dnb/eufemia'`,`import { Field, Form } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:a,Card:i,Field:o},noInline:!0,children:`const MyFormContent = () => {
...
render(<MyForm />)
`}),p=()=>(0,u.jsx)(c,{stableName:`NestedIndeterminateDependence`,sourceImports:[`import { Flex } from '@dnb/eufemia'`,`import { Field, Form } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:a,Card:i,Field:o,Flex:r},children:`<Form.Handler onChange={console.log}>
  <Form.Card>
    <Field.Indeterminate
      label="1"
      path="/p1"
