import{a as e}from"./rolldown-runtime-BYbx6iT9.js";import{t}from"./jsx-runtime-BgMs7Gb-.js";import{t as n}from"./Link-BdzJ-zwi.js";import{t as r}from"./export-B-7Fh9Xt.js";import{Br as i,Dr as a,Er as o,Oi as s,Or as c,Rr as l,Tr as u,gr as d,kr as f}from"./index-mmuoVhax.js";import{t as p}from"./ComponentBox-XDAvsf_r.js";var m=e(t()),h=()=>(0,m.jsx)(p,{"data-visual-test":`form-status`,stableName:`FormStatusDefault`,sourceImports:[`import { useState } from 'react'`,`import { InfoIcon, WarnIcon, ErrorIcon, MarketingIcon } from '@dnb/eufemia/components/form-status/FormStatus'`,`import { FormStatus, Icon, Input, ToggleButton, Link, Grid, Anchor } from '@dnb/eufemia'`,`import { Provider } from '@dnb/eufemia/shared'`],__buildScope:{FormStatus:o},children:`<FormStatus text="Failure text" />
...
`}),S=()=>(0,m.jsx)(p,{stableName:`FormStatusLarge`,sourceImports:[`import { useState } from 'react'`,`import { InfoIcon, WarnIcon, ErrorIcon, MarketingIcon } from '@dnb/eufemia/components/form-status/FormStatus'`,`import { FormStatus, Icon, Input, ToggleButton, Link, Grid, Anchor } from '@dnb/eufemia'`,`import { Provider } from '@dnb/eufemia/shared'`],__buildScope:{FormStatus:o,Anchor:i},noInline:!0,children:`render(
...
`}),C=()=>(0,m.jsx)(p,{scope:{InfoIcon:a,WarnIcon:f,ErrorIcon:u,MarketingIcon:c},"data-visual-test":`form-status-icons`,stableName:`FormStatusWithIcons`,sourceImports:[`import { useState } from 'react'`,`import { InfoIcon, WarnIcon, ErrorIcon, MarketingIcon } from '@dnb/eufemia/components/form-status/FormStatus'`,`import { FormStatus, Icon, Input, ToggleButton, Link, Grid, Anchor } from '@dnb/eufemia'`,`import { Provider } from '@dnb/eufemia/shared'`],__buildScope:{Icon:s},children:`
<Icon
  icon={<InfoIcon />}
  size="medium"
  title="Some title"
...
`});function T(e){let t={code:`code`,h2:`h2`,h3:`h3`,p:`p`,strong:`strong`,...l(),...e.components},{VisibleWhenVisualTest:n}=t;return n||D(`VisibleWhenVisualTest`,!0),(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(t.h2,{children:`Demos`}),`
...
`,(0,m.jsx)(C,{}),`
`,(0,m.jsx)(n,{children:(0,m.jsx)(w,{})})]})}function E(e={}){let{wrapper:t}={...l(),...e.components};return t?(0,m.jsx)(t,{...e,children:(0,m.jsx)(T,{...e})}):T(e)}function D(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{E as default};