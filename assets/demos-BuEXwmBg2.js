...
`}),v=()=>(0,m.jsx)(f,{scope:{DataContext:o,Value:u,testData:g,TestDataSchema:h,ajv:c()},stableName:`ValidationWithJsonSchema`,sourceImports:[`import { Form, DataContext, Field, Value, JSONSchema, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`,`import { Flex } from '@dnb/eufemia'`],__buildScope:{DataContext:o,Provider:r,Flex:i,Form:s,Card:a,Field:l},children:`<DataContext.Provider
  data={testData}
