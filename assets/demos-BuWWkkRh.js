...
render(<Component />)
`})}function c(){return(0,o.jsx)(r,{stableName:`Update`,noInline:!0,children:`const existingData = {
  count: 1,
}
const Component = () => {
...
render(<Component />)
`})}function l(){return(0,o.jsx)(r,{stableName:`WithoutFormHandler`,noInline:!0,children:`const existingData = {
  count: 1,
}
const Component = () => {
...
`})}function u(){return(0,o.jsx)(r,{stableName:`FilterData`,noInline:!0,children:`const filterDataPaths = {
  '/isVisible': false,
...
render(<MyForm />)
`})}var d=()=>(0,o.jsx)(r,{stableName:`VisibleData`,noInline:!0,children:`const MyForm = () => {
