import{a as e,r as t}from"./rolldown-runtime-BYbx6iT9.js";import{t as n}from"./jsx-runtime-BgMs7Gb-.js";import{t as r}from"./Card-2G-TKpj3.js";import{t as i}from"./Form-PES0Uozy.js";import{t as a}from"./ajv-ilTijhKp.js";import{t as o}from"./Field-DrUGn0oz.js";import{t as s}from"./Iterate-OgeEKoj_.js";import{t as c}from"./Tools-p1RXalAh.js";import{Bn as l,Rr as u,ct as d,un as f}from"./index-BIrFyEEc.js";import{t as p}from"./ComponentBox-DFVIRw0w.js";var m=t({DataSetSchema:()=>_,DependentListSchema:()=>y,DependentSchemaValidation:()=>b,DependentSchemaValidationWithZod:()=>x,IfRuleSchema:()=>v,SingleFieldSchema:()=>g}),h=e(n()),g=()=>(0,h.jsx)(p,{scope:{makeAjvInstance:a},stableName:`SingleFieldSchema`,sourceImports:[`import { Flex, Section } from '@dnb/eufemia'`,`import { z, Form, Field, Iterate, Tools, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:i,Field:o},noInline:!0,children:`const ajv = makeAjvInstance()
const schema = {
  type: 'string',
  minLength: 5,
}
...
`}),_=()=>(0,h.jsx)(p,{scope:{makeAjvInstance:a},stableName:`DataSetSchema`,sourceImports:[`import { Flex, Section } from '@dnb/eufemia'`,`import { z, Form, Field, Iterate, Tools, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:i,Card:r,Field:o},noInline:!0,children:`const ajv = makeAjvInstance()
const schema = {
  type: 'object',
  properties: {
    name: {
...
`}),v=()=>(0,h.jsx)(p,{scope:{makeAjvInstance:a},stableName:`IfRuleSchema`,sourceImports:[`import { Flex, Section } from '@dnb/eufemia'`,`import { z, Form, Field, Iterate, Tools, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:i,Card:r,Field:o},noInline:!0,children:`const ajv = makeAjvInstance()
const schema = {
  type: 'object',
  properties: {
    name: {
...
`}),y=()=>(0,h.jsx)(p,{scope:{makeAjvInstance:a},stableName:`DependentListSchema`,sourceImports:[`import { Flex, Section } from '@dnb/eufemia'`,`import { z, Form, Field, Iterate, Tools, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:i,Flex:f,Card:r,Field:o,Iterate:s},noInline:!0,children:`const ajv = makeAjvInstance()
const schema = {
  type: 'object',
  definitions: {
    account: {
...
`}),b=()=>(0,h.jsx)(p,{scope:{makeAjvInstance:a,Tools:c},stableName:`DependentSchemaValidation`,sourceImports:[`import { Flex, Section } from '@dnb/eufemia'`,`import { z, Form, Field, Iterate, Tools, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:i,Flex:f,Card:r,Field:o,Iterate:s,Section:l,Tools:c},noInline:!0,children:`const ajv = makeAjvInstance()
const counts = [1, 2, 3]
const schema = {
  type: 'object',
  properties: {
...
`}),x=()=>(0,h.jsx)(p,{scope:{Tools:c,z:d},stableName:`DependentSchemaValidationWithZod`,sourceImports:[`import { Flex, Section } from '@dnb/eufemia'`,`import { z, Form, Field, Iterate, Tools, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:i,Flex:f,Card:r,Field:o,Iterate:s,Section:l,Tools:c},noInline:!0,children:`const counts = [1, 2, 3]
...
`,(0,h.jsx)(x,{})]})}function C(e={}){let{wrapper:t}={...u(),...e.components};return t?(0,h.jsx)(t,{...e,children:(0,h.jsx)(S,{...e})}):S(e)}function w(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{C as default};