import{a as e,r as t}from"./rolldown-runtime-BYbx6iT9.js";import{t as n}from"./jsx-runtime-BgMs7Gb-.js";import{t as r}from"./Card-2G-TKpj3.js";import{t as i}from"./Form-PES0Uozy.js";import{t as a}from"./Field-DrUGn0oz.js";import{t as o}from"./Value-BOhdc4cL.js";import{n as s}from"./Wizard-DlovE-XE.js";import{t as c}from"./Iterate-OgeEKoj_.js";import{t as l}from"./Tools-p1RXalAh.js";import{Ir as u,Rr as d,un as f}from"./index-BIrFyEEc.js";import{t as p}from"./ComponentBox-DFVIRw0w.js";import{b as m}from"./Examples-Bs9eDSu7.js";var h=t({InitiallyOpen:()=>_,IsolatedData:()=>v,PreventUncommittedChanges:()=>y,Variants:()=>b,ViewAndEditContainer:()=>m}),g=e(n()),_=()=>(0,g.jsx)(p,{stableName:`InitiallyOpen`,sourceImports:[`import { useLayoutEffect } from 'react'`,`import { Flex, HeightAnimation } from '@dnb/eufemia'`,`import { Field, Form, Iterate, Tools, Value, Wizard } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Field:a,Iterate:c,Value:o,Form:i,Flex:f,Card:r},noInline:!0,children:`const MyEditItemForm = () => {
  return (
    <Field.Composition>
...
render(<MyForm />)
`}),v=()=>(0,g.jsx)(p,{stableName:`IsolatedData`,sourceImports:[`import { useLayoutEffect } from 'react'`,`import { Flex, HeightAnimation } from '@dnb/eufemia'`,`import { Field, Form, Iterate, Tools, Value, Wizard } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Iterate:c,Value:o,Field:a,Form:i,Flex:f,HeightAnimation:u,Card:r,Tools:l},noInline:!0,children:`const formData = {
  persons: [
    {
      firstName: 'Ola',
      lastName: 'Nordmann',
...
`}),y=()=>(0,g.jsx)(p,{stableName:`PreventUncommittedChanges`,sourceImports:[`import { useLayoutEffect } from 'react'`,`import { Flex, HeightAnimation } from '@dnb/eufemia'`,`import { Field, Form, Iterate, Tools, Value, Wizard } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:i,Wizard:s,Card:r,Iterate:c,Value:o,Field:a},children:`<Form.Handler>
  <Wizard.Container>
...
`}),b=()=>(0,g.jsx)(p,{"data-visual-test":`push-container-variants`,stableName:`Variants`,sourceImports:[`import { useLayoutEffect } from 'react'`,`import { Flex, HeightAnimation } from '@dnb/eufemia'`,`import { Field, Form, Iterate, Tools, Value, Wizard } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:i,Wizard:s,Iterate:c,Value:o,Field:a},children:`<Form.Handler>
  <Wizard.Container>
    <Wizard.Step title="Step 1">
...
`,(0,g.jsx)(v,{}),`
`,(0,g.jsx)(n,{children:(0,g.jsx)(b,{})})]})}function S(e={}){let{wrapper:t}={...d(),...e.components};return t?(0,g.jsx)(t,{...e,children:(0,g.jsx)(x,{...e})}):x(e)}function C(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{S as default};