import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{s as n}from"./ToggleButton-DFl1k6dD.js";import{t as r}from"./P-CVJzad03.js";import{t as i}from"./Card-DLQPvlXB.js";import{A as a,E as o,M as s,N as c,O as l,P as u,U as d,j as f,k as p}from"./index-Ct8Ggqh9.js";import{t as m}from"./ComponentBox-41YKKsr3.js";var h=e(t());function g(e){switch(e?.name){case`sbanken`:return c;case`carnegie`:return p;case`eiendom`:return f;default:return a}}var _=()=>(0,h.jsx)(m,{scope:{DnbDefault:a,SbankenCompact:s,SbankenDefault:c,SbankenHorizontal:u,CarnegieDefault:p,EiendomDefault:f},"data-visual-test":`logo-all`,stableName:`LogoAllExample`,sourceImports:[`import { Card, Logo, Flex, P } from '@dnb/eufemia'`,`import { DnbDefault, SbankenCompact, SbankenDefault, SbankenHorizontal, CarnegieDefault, EiendomDefault } from '@dnb/eufemia/components/Logo'`,`import MyThemeSelector from '../../../../core/ChangeStyleTheme'`,`import { ThemeProps } from '@dnb/eufemia/shared/Theme'`],__buildScope:{Flex:n,Logo:l},children:`<Flex.Vertical>
...
`}),S=()=>(0,h.jsx)(m,{scope:{MyThemeSelector:o,myLogoSelector:g,SbankenDefault:c,CarnegieDefault:p,EiendomDefault:f,DnbDefault:a},"data-visual-test":`logo-theme-change`,stableName:`LogoChangeExample`,sourceImports:[`import { Card, Logo, Flex, P } from '@dnb/eufemia'`,`import { DnbDefault, SbankenCompact, SbankenDefault, SbankenHorizontal, CarnegieDefault, EiendomDefault } from '@dnb/eufemia/components/Logo'`,`import MyThemeSelector from '../../../../core/ChangeStyleTheme'`,`import { ThemeProps } from '@dnb/eufemia/shared/Theme'`],__buildScope:{Card:i,Logo:l},noInline:!0,children:`function myLogoSelector(theme: ThemeProps) {
  switch (theme?.name) {
    case 'sbanken':
...
`}),w=()=>(0,h.jsx)(m,{"data-visual-test":`logo-in-text`,scope:{myLogoSelector:g},stableName:`LogoInTextExample`,sourceImports:[`import { Card, Logo, Flex, P } from '@dnb/eufemia'`,`import { DnbDefault, SbankenCompact, SbankenDefault, SbankenHorizontal, CarnegieDefault, EiendomDefault } from '@dnb/eufemia/components/Logo'`,`import MyThemeSelector from '../../../../core/ChangeStyleTheme'`,`import { ThemeProps } from '@dnb/eufemia/shared/Theme'`],__buildScope:{P:r,Logo:l},children:`<P>
  This logo is in the middle <Logo svg={myLogoSelector} /> of some text.
</P>
`});function T(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,h4:`h4`,p:`p`,pre:`pre`,...d(),...e.components},{VisibleWhenVisualTest:n}=t;return n||D(`VisibleWhenVisualTest`,!0),(0,h.jsxs)(h.Fragment,{children:[(0,h.jsx)(t.h2,{children:`Demos`}),`
...
`,(0,h.jsxs)(t.p,{children:[`You can choose to let the height be set by the inherited `,(0,h.jsx)(t.code,{children:`height`}),` instead by setting the `,(0,h.jsx)(t.code,{children:`inheritSize`}),` property.`]}),`
`,(0,h.jsx)(b,{}),`
...
`,(0,h.jsx)(x,{}),`
`,(0,h.jsx)(n,{children:(0,h.jsx)(w,{})})]})}function E(e={}){let{wrapper:t}={...d(),...e.components};return t?(0,h.jsx)(t,{...e,children:(0,h.jsx)(T,{...e})}):T(e)}function D(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{E as default};