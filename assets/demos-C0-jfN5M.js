import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{Q as r}from"./Anchor-BPx9fjvj.js";import{s as i}from"./ToggleButton-DfKpi57X.js";import{it as a,j as o,v as s,w as c}from"./forms-D54jfDKN.js";import{t as l}from"./Card-BvVSLAbs.js";import{t as u}from"./ajv-C39zvwvV.js";import{U as d}from"./index-BsJ3GLEw.js";import{t as f}from"./ComponentBox-sLMgHvLi.js";var p=e({Default:()=>_,TestDataSchema:()=>h,ValidationWithJsonSchema:()=>v,testData:()=>g}),m=t(n()),h={type:`object`,properties:{requiredString:{type:`string`},string:{type:`string`,minLength:3},number:{type:`number`,minimum:42},boolean:{type:`boolean`},email:{type:`string`},nested:{type:`object`,properties:{nestedText:{type:`string`},nestedNumber:{type:`number`,minimum:50}}},list:{type:`array`,items:{type:`object`,properties:{itemText:{type:`string`},itemNumber:{type:`number`,minimum:50}}}}},required:[`requiredString`]},g={requiredString:`This is a text`,string:`String value`,number:123,boolean:!0,email:`m@il.com`,nested:{nestedText:`Nested text`,nestedNumber:42},list:[{itemText:`Item text`,itemNumber:1001},{itemText:`Item text 2`,itemNumber:1002}]},_=()=>(0,m.jsx)(f,{scope:{DataContext:a,Value:s,testData:g,TestDataSchema:h},stableName:`Default`,sourceImports:[`import { Form, DataContext, Field, Value, JSONSchema, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`,`import { Flex } from '@dnb/eufemia'`],__buildScope:{DataContext:a,Provider:r,Flex:i,Form:c,Card:l,Field:o},children:`<DataContext.Provider
...
`}),v=()=>(0,m.jsx)(f,{scope:{DataContext:a,Value:s,testData:g,TestDataSchema:h,ajv:u()},stableName:`ValidationWithJsonSchema`,sourceImports:[`import { Form, DataContext, Field, Value, JSONSchema, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`,`import { Flex } from '@dnb/eufemia'`],__buildScope:{DataContext:a,Provider:r,Flex:i,Form:c,Card:l,Field:o},children:`<DataContext.Provider
  data={testData}
