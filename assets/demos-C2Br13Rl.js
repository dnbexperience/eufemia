import{r as e}from"./rolldown-runtime-BYbx6iT9.js";import{t}from"./jsx-runtime-BgMs7Gb-.js";import{t as n}from"./fish_medium-VugI2tRm.js";import{t as r}from"./ComponentBox-geTEYZ7b.js";import{Rr as i}from"./index-CMgyXmp3.js";var a=e({Accordion:()=>b,BackgroundColor:()=>h,FooterWithButtons:()=>l,GridColumns:()=>T,InsideCard:()=>E,InsideCardWithoutScrollView:()=>D,ListSubline:()=>S,NavigableItem:()=>u,NavigableItemWithHref:()=>d,PendingState:()=>_,ProgressIndicatorRow:()=>v,RowsWithSlots:()=>c,SelectedState:()=>m,SeparatedLists:()=>y,SimpleRows:()=>s,SkeletonState:()=>g,WithAnchor:()=>f,WithAvatar:()=>p,WithBadge:()=>C,WithDateFormat:()=>x,WithFormElements:()=>w,WithShowMoreButton:()=>O}),o=t(),s=()=>(0,o.jsx)(r,{noInline:!0,children:`const myList = [
  {
    name: 'List item 1',
    amount: 10000,
  },
...
`}),f=()=>(0,o.jsx)(r,{scope:{fish_medium:n},children:`<List.Container>
...
`}),p=()=>(0,o.jsx)(r,{"data-visual-test":`list-avatar`,children:`<List.Container>
...
`}),m=()=>(0,o.jsx)(r,{children:`<List.Container>
...
`}),g=()=>(0,o.jsx)(r,{scope:{fish_medium:n},background:`plain`,children:`<List.Container>
...
`}),_=()=>(0,o.jsx)(r,{"data-visual-test":`list-pending`,scope:{fish_medium:n},children:`<List.Container>
...
`}),v=()=>(0,o.jsx)(r,{children:`<List.Container>
  <List.Item.Basic>
    <List.Cell.Start>
      <ProgressIndicator
        size="medium"
...
`}),y=()=>(0,o.jsx)(r,{"data-visual-test":`list-separated`,scope:{fish_medium:n},children:`<List.Container separated>
...
`}),b=()=>(0,o.jsx)(r,{"data-visual-test":`list-accordion`,scope:{fish_medium:n},children:`<List.Container>
...
`}),x=()=>(0,o.jsx)(r,{"data-visual-test":`list-overline`,children:`<List.Container>
...
`}),S=()=>(0,o.jsx)(r,{"data-visual-test":`list-subline`,scope:{fish_medium:n},children:`<List.Container>
...
`}),C=()=>(0,o.jsx)(r,{scope:{fish_medium:n},children:`<List.Container>
...
`}),w=()=>(0,o.jsx)(r,{"data-visual-test":`list-form-elements`,noInline:!0,children:`render(
  <Form.Handler
    defaultData={{
      mySelection: 'bar',
...
`}),T=()=>(0,o.jsx)(r,{scope:{fish_medium:n},background:`plain`,children:`<Grid.Container
  rowGap
  columnGap
  style={{
    marginInline: 'auto',
...
`}),E=()=>(0,o.jsx)(r,{"data-visual-test":`list-card`,scope:{fish_medium:n},children:`<List.Card>
...
`}),D=()=>(0,o.jsx)(r,{"data-visual-test":`list-card-no-scroll-view`,scope:{fish_medium:n},children:`<List.Card innerSpace="x-small">
  <List.Container>
    <List.Item.Action
      icon={fish_medium}
...
`}),O=()=>(0,o.jsx)(r,{scope:{fish_medium:n},background:`plain`,children:`
...
`});function k(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,h4:`h4`,p:`p`,strong:`strong`,...i(),...e.components};return a||j(`Examples`,!1),b||j(`Examples.Accordion`,!0),h||j(`Examples.BackgroundColor`,!0),l||j(`Examples.FooterWithButtons`,!0),T||j(`Examples.GridColumns`,!0),E||j(`Examples.InsideCard`,!0),D||j(`Examples.InsideCardWithoutScrollView`,!0),S||j(`Examples.ListSubline`,!0),u||j(`Examples.NavigableItem`,!0),d||j(`Examples.NavigableItemWithHref`,!0),_||j(`Examples.PendingState`,!0),v||j(`Examples.ProgressIndicatorRow`,!0),c||j(`Examples.RowsWithSlots`,!0),m||j(`Examples.SelectedState`,!0),y||j(`Examples.SeparatedLists`,!0),s||j(`Examples.SimpleRows`,!0),g||j(`Examples.SkeletonState`,!0),f||j(`Examples.WithAnchor`,!0),p||j(`Examples.WithAvatar`,!0),C||j(`Examples.WithBadge`,!0),x||j(`Examples.WithDateFormat`,!0),w||j(`Examples.WithFormElements`,!0),O||j(`Examples.WithShowMoreButton`,!0),(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(t.h2,{children:`Demos`}),`
...
`,(0,o.jsx)(O,{})]})}function A(e={}){let{wrapper:t}={...i(),...e.components};return t?(0,o.jsx)(t,{...e,children:(0,o.jsx)(k,{...e})}):k(e)}function j(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{A as default};