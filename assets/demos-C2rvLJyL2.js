import{t as e}from"./jsx-runtime-BgMs7Gb-.js";import{t}from"./ComponentBox-C64JNWnl.js";import{Gt as n,Jt as r,Kt as i,Lr as a,Xt as o,Yt as s,o as c,qt as l}from"./index-2AO2Cu5K.js";var u=e();function d(e){switch(e?.name){case`sbanken`:return s;case`carnegie`:return n;case`eiendom`:return l;default:return i}}var f=()=>(0,u.jsx)(t,{scope:{DnbDefault:i,SbankenCompact:r,SbankenDefault:s,SbankenHorizontal:o,CarnegieDefault:n,EiendomDefault:l},"data-visual-test":`logo-all`,children:`<Flex.Vertical>
...
`}),_=()=>(0,u.jsx)(t,{scope:{MyThemeSelector:c,myLogoSelector:d,SbankenDefault:s,CarnegieDefault:n,EiendomDefault:l,DnbDefault:i},"data-visual-test":`logo-theme-change`,noInline:!0,children:`function myLogoSelector(theme: ThemeProps) {
  switch (theme?.name) {
    case 'sbanken':
