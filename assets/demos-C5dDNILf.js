import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{s as n}from"./chunk-QUQL4437-CBr5Whxv.js";import{n as r}from"./portal-query-2jVhah92.js";import{M as i}from"./Autocomplete-NmPCgejB.js";import{t as a}from"./P-avM674pJ.js";import{t as o}from"./H2-dFBi5u0M.js";import{t as s}from"./Section-BidpVCcL.js";import{t as c}from"./ToggleButton-BtQrsiHY.js";import{H as l,W as u,_ as d,m as f}from"./index-D7e1avVt.js";import{t as p}from"./ComponentBox-CE7bpcJy.js";var m=e(t()),h=({children:e})=>(0,m.jsx)(m.Fragment,{children:e}),g=()=>(0,m.jsx)(O,{children:(0,m.jsx)(p,{stableName:`TabsExampleContentOutside`,sourceImports:[`import { Suspense, ReactNode } from 'react'`,`import Input from '@dnb/eufemia/components/input/Input'`,`import styled from '@emotion/styled'`,`import { useLocation } from 'react-router-dom'`,`import { navigate } from 'portal-query'`,`import { Tabs, Section, H2, P, ToggleButton, Badge } from '@dnb/eufemia'`],__buildScope:{Tabs:d,H2:o},children:`
<Tabs
  id="unique-linked-id"
  data={[
    {
...
/>
`})});function F(e){let t={code:`code`,h2:`h2`,h3:`h3`,p:`p`,pre:`pre`,strong:`strong`,...u(),...e.components},{VisibleWhenVisualTest:n}=t;return n||L(`VisibleWhenVisualTest`,!0),(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(t.h2,{children:`Demos`}),`
...
`,(0,m.jsx)(P,{}),`
`,(0,m.jsxs)(n,{children:[(0,m.jsx)(j,{}),(0,m.jsx)(M,{}),(0,m.jsx)(N,{})]})]})}function I(e={}){let{wrapper:t}={...u(),...e.components};return t?(0,m.jsx)(t,{...e,children:(0,m.jsx)(F,{...e})}):F(e)}function L(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{I as default};