import{a as e}from"./rolldown-runtime-BYbx6iT9.js";import{t}from"./jsx-runtime-BgMs7Gb-.js";import{t as n}from"./H2-DdnHe8Vl.js";import{t as r}from"./H3-CFXYs_Dv.js";import{An as i,Ft as a,Rr as o,en as s,y as c}from"./index-mmuoVhax.js";import{t as l}from"./ComponentBox-XDAvsf_r.js";var u=e(t()),d=c.div`
  .dnb-heading {
    display: block;
    margin: 0 !important;
  }
...
render(<App />)
`})}),h=()=>(0,u.jsx)(d,{children:(0,u.jsx)(l,{"data-visual-test":`heading-mixin`,stableName:`HeadingMix`,sourceImports:[`import { useState } from 'react'`,`import styled from '@emotion/styled'`,`import { Heading, H3, ToggleButton, H1, H2 } from '@dnb/eufemia'`],__buildScope:{Heading:s,H3:r},children:`<Heading.Level debug reset={1}>
  <Heading>h1</Heading>
  <Heading>h2</Heading>
...
`}),y=()=>(0,u.jsx)(l,{hidePreview:!0,stableName:`HeadingInfoBasic`,sourceImports:[`import { useState } from 'react'`,`import styled from '@emotion/styled'`,`import { Heading, H3, ToggleButton, H1, H2 } from '@dnb/eufemia'`],__buildScope:{H1:i,H2:n},children:`<article>
  <H1 size="large">h1</H1>
