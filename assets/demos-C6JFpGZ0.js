import{a as e,r as t}from"./rolldown-runtime-BYbx6iT9.js";import{n,t as r}from"./jsx-runtime-BgMs7Gb-.js";import{t as i}from"./compose-ZO1lxRHy.js";import{t as a}from"./copy-DpwG9VP-.js";import{n as o,r as s}from"./view_medium-BGCKigyJ.js";import{t as c}from"./stop-BL8y8gqU.js";import{C as l,k as u,t as d}from"./ComponentBox-a4aOn231.js";import{Bt as ee,Ca as f,Cn as p,Ei as m,Gi as h,Hr as te,Ki as ne,Vt as g,Wi as re,_n as _,fa as ie,qr as ae,vn as v,zi as oe,zr as y,zt as b}from"./index-DqqByKA2.js";import{t as x}from"./useHandleSortState-CqE8rRnK.js";var S=e(n()),C=e(r());function w(e){let{children:t,className:n,...r}=e;ie(e,r);let i=re(e,{className:h(`dnb-table__container`,n),...r}),a=g,o=Array.isArray(t)?t:[t];return o[0]?.type!==w.Head&&o.unshift((0,C.jsx)(w.Head,{},`head`)),o[2]?.type!==w.Foot&&o.push((0,C.jsx)(w.Foot,{},`foot`)),(0,C.jsx)(`section`,{...i,children:(0,C.jsx)(a,{children:o})})}function se(e){let{children:t,className:n,...r}=e;return(0,C.jsx)(`div`,{className:h(`dnb-table__container__body`,n),...r,children:t})}function ce(e){let{children:t,className:n,...r}=e;return(0,C.jsx)(`div`,{className:h(`dnb-table__container__head`,!t&&`dnb-table__container__head--empty`,n),...r,children:t})}function le(e){let{children:t,className:n,...r}=e;return(0,C.jsx)(`div`,{className:h(`dnb-table__container__foot`,!t&&`dnb-table__container__foot--empty`,n),...r,children:t})}w.Body=se,w.Head=ce,w.Foot=le,oe(w,{_supportsSpacingProps:!0});var ue=t({Accordion:()=>I,AccordionMixed:()=>L,AccordionRow:()=>R,ClassHelpers:()=>P,ClickableCells:()=>H,ClickableRows:()=>B,ColumnHighlight:()=>Z,ContainerEmptyHeaderFooter:()=>N,InCard:()=>Y,InOneContainer:()=>K,KeyboardNavigation:()=>z,LongHeader:()=>F,NavigationMixed:()=>V,PaginationTable:()=>G,ResponsiveInCard:()=>J,RowScopeOnly:()=>A,SizeMedium:()=>D,SizeSmall:()=>O,StackedContainer:()=>M,Sticky:()=>U,StickyMaxHeight:()=>W,TableInAccordionTable:()=>X,VariantBasic:()=>E,VariantCombinations:()=>q,VariantComplex:()=>k,VariantFixed:()=>j});function T(){let[e,t]=(0,S.useState)(!1),{NumberFormat:n}=ne(),r=(0,S.useRef)(void 0),i=(0,S.useCallback)(t=>(0,C.jsx)(ae,{open:e,targetElement:t,children:n.clipboardCopy}),[n.clipboardCopy,e]);return{copy:(0,S.useCallback)(e=>{f(e),t(!0),clearTimeout(r.current),r.current=setTimeout(()=>{t(!1)},1500)},[]),copyTooltip:i}}var E=()=>(0,C.jsx)(d,{hideCode:!0,"data-visual-test":`table-default`,scope:{useHandleSortState:x},stableName:`VariantBasic`,noInline:!0,children:`const BasicTable = () => {
...
render(<BasicTable />)
`}),D=()=>(0,C.jsx)(d,{hideCode:!0,"data-visual-test":`table-size-medium`,stableName:`SizeMedium`,children:`<Table.ScrollView>
  <Table size="medium">
    <caption className="dnb-sr-only">A Table Caption</caption>
    <thead>
      <Tr>
...
`}),O=()=>(0,C.jsx)(d,{hideCode:!0,"data-visual-test":`table-size-small`,stableName:`SizeSmall`,children:`<Table.ScrollView>
  <Table size="small">
    <caption className="dnb-sr-only">A Table Caption</caption>
    <thead>
      <Tr>
...
`}),k=()=>(0,C.jsx)(d,{hideCode:!0,"data-visual-test":`table-complex`,stableName:`VariantComplex`,children:`<Table.ScrollView>
...
`}),A=()=>(0,C.jsx)(d,{hideCode:!0,"data-visual-test":`table-row-scope-only`,stableName:`RowScopeOnly`,children:`<Table.ScrollView>
...
`}),j=()=>(0,C.jsx)(d,{hideCode:!0,"data-visual-test":`table-fixed`,stableName:`VariantFixed`,noInline:!0,children:`const FixedTable = styled(Table)\`
  min-width: 70rem;
...
`}),M=()=>(0,C.jsx)(d,{hideCode:!0,"data-visual-test":`table-container`,scope:{TableContainer:w,isFullscreen:/data-visual-test|fullscreen/.test(globalThis?.location?.href)},stableName:`StackedContainer`,noInline:!0,children:`const StyledContainer = styled(TableContainer)\`
  /* 
            Define the width of the THs so they are aligned across tables.
...
`}),N=()=>(0,C.jsx)(d,{hideCode:!0,"data-visual-test":`table-container-empty`,scope:{TableContainer:w},stableName:`ContainerEmptyHeaderFooter`,noInline:!0,children:`render(
...
`}),P=()=>(0,C.jsx)(d,{hideCode:!0,"data-visual-test":`table-classes`,stableName:`ClassHelpers`,children:`<Table.ScrollView>
...
`}),F=()=>(0,C.jsx)(d,{hideCode:!0,"data-visual-test":`table-header`,stableName:`LongHeader`,children:`<Table.ScrollView>
  <Table>
    <caption className="dnb-sr-only">A Table Caption</caption>
    <thead>
      <Tr>
...
`}),I=()=>(0,C.jsx)(d,{hideCode:!0,"data-visual-test":`table-accordion`,scope:{copyIcon:a,useCopyWithNotice:T},stableName:`Accordion`,noInline:!0,children:`const AccordionTable = ({ id, showCheckbox = false, ...props }) => {
  const TdCheckbox = () => {
...
`}),L=()=>(0,C.jsx)(d,{hideCode:!0,"data-visual-test":`table-accordion-mixed`,scope:{copyIcon:a,useCopyWithNotice:T},stableName:`AccordionMixed`,noInline:!0,children:`const AccordionTable = ({ id, showCheckbox = false, ...props }) => {
  const TdCheckbox = () => {
    return <Checkbox label="Select row" labelSrOnly />
  }
  const TdInput = () => {
...
`}),R=()=>(0,C.jsx)(d,{hideCode:!0,"data-visual-test":`table-accordion-rows`,stableName:`AccordionRow`,noInline:!0,children:`const firstRowContent = [
  {
    label: 'Expanded 1.1',
  },
  {
...
`}),z=()=>(0,C.jsx)(d,{scope:{useTableKeyboardNavigation:ee,trashIcon:s,Field:l},stableName:`KeyboardNavigation`,noInline:!0,children:`const KeyboardNavigationTable = () => {
...
`}),B=()=>(0,C.jsx)(d,{hideCode:!0,"data-visual-test":`table-navigation`,stableName:`ClickableRows`,noInline:!0,children:`const NavigationTable = ({ id, showCheckbox = false, ...props }) => {
  const TdCheckbox = () => {
    return <Checkbox label="Select row" labelSrOnly />
  }
  const TdInput = () => {
...
`}),V=()=>(0,C.jsx)(d,{hideCode:!0,"data-visual-test":`table-navigation-mixed`,stableName:`NavigationMixed`,noInline:!0,children:`const NavigationTable = ({ id, showCheckbox = false, ...props }) => {
  const TdCheckbox = () => {
    return <Checkbox label="Select row" labelSrOnly />
  }
  const TdInput = () => {
...
`}),H=()=>(0,C.jsx)(d,{hideCode:!0,"data-visual-test":`table-navigation-cell`,scope:{eyeIcon:o,launchIcon:te},stableName:`ClickableCells`,noInline:!0,children:`const handleClick = (event, { trElement, thElement }) => {
  console.log(
...
`}),U=()=>{let e=/data-visual-test|fullscreen/.test(globalThis?.location?.href),t=globalThis.IS_TEST;return(0,C.jsx)(d,{hideCode:!0,scope:{isFullscreen:e,isVisibleWhenVisualTest:t},stableName:`Sticky`,children:`<Table.ScrollView>
  <Table
...
`})},W=()=>(0,C.jsx)(d,{hideCode:!0,"data-visual-test":`table-sticky`,stableName:`StickyMaxHeight`,children:`<Table.ScrollView
  style={{
    maxHeight: '18rem',
  }}
>
...
`});function G(){return(0,C.jsx)(d,{hideCode:!0,stableName:`PaginationTable`,noInline:!0,children:`const TablePagination = () => {
...
`})}var K=()=>(0,C.jsx)(d,{hideToolbar:!0,hidePreview:!0,scope:{TableContainer:w},stableName:`InOneContainer`,children:`<TableContainer>
  <TableContainer.Head>
    <H2>Heading</H2>
  </TableContainer.Head>
...
`}),q=()=>{let e=()=>(0,C.jsxs)(C.Fragment,{children:[(0,C.jsx)(`div`,{"data-visual-test":`table-combinations-default`,children:(0,C.jsx)(t,{title:`Regular content: `,children:(0,C.jsx)(r,{})})}),(0,C.jsx)(`div`,{"data-visual-test":`table-combinations-no-header`,children:(0,C.jsx)(t,{title:`No header: `,children:(0,C.jsx)(i,{})})}),(0,C.jsx)(`div`,{"data-visual-test":`table-combinations-row-header`,children:(0,C.jsx)(t,{title:`Row headers: `,children:(0,C.jsx)(a,{})})}),(0,C.jsx)(`div`,{"data-visual-test":`table-combinations-spanning`,children:(0,C.jsx)(t,{title:`Spanning: `,children:(0,C.jsx)(o,{})})}),(0,C.jsx)(`div`,{"data-visual-test":`table-combinations-row-header-spanning`,children:(0,C.jsx)(t,{title:`Row headers spanning: `,children:(0,C.jsx)(s,{})})})]}),t=({title:e,children:t})=>(0,C.jsxs)(C.Fragment,{children:[(0,C.jsxs)(n,{title:e+`With caption: `,children:[(0,C.jsx)(`caption`,{children:`Caption`}),t]}),(0,C.jsx)(n,{title:e+`No caption: `,children:t})]}),n=({title:e,children:t})=>(0,C.jsxs)(C.Fragment,{children:[e+`Basic`,(0,C.jsx)(u,{children:t}),e+`Border`,(0,C.jsx)(u,{border:!0,children:t}),e+`Outline`,(0,C.jsx)(u,{outline:!0,children:t}),e+`Border and outline`,(0,C.jsx)(u,{border:!0,outline:!0,children:t})]}),r=()=>(0,C.jsxs)(C.Fragment,{children:[(0,C.jsx)(`thead`,{children:(0,C.jsxs)(_,{children:[(0,C.jsx)(v,{children:`Th A`}),(0,C.jsx)(v,{children:`Th B`}),(0,C.jsx)(v,{children:`Th C`})]})}),(0,C.jsxs)(`tbody`,{children:[(0,C.jsxs)(_,{children:[(0,C.jsx)(p,{children:`Td 1`}),(0,C.jsx)(p,{children:`Td 1`}),(0,C.jsx)(p,{children:`Td 1`})]}),(0,C.jsxs)(_,{children:[(0,C.jsx)(p,{children:`Td 2`}),(0,C.jsx)(p,{children:`Td 2`}),(0,C.jsx)(p,{children:`Td 2`})]}),(0,C.jsxs)(_,{children:[(0,C.jsx)(p,{children:`Td 3`}),(0,C.jsx)(p,{children:`Td 3`}),(0,C.jsx)(p,{children:`Td 3`})]})]})]}),i=()=>(0,C.jsx)(C.Fragment,{children:(0,C.jsxs)(`tbody`,{children:[(0,C.jsxs)(_,{children:[(0,C.jsx)(p,{children:`Td 1`}),(0,C.jsx)(p,{children:`Td 1`}),(0,C.jsx)(p,{children:`Td 1`})]}),(0,C.jsxs)(_,{children:[(0,C.jsx)(p,{children:`Td 2`}),(0,C.jsx)(p,{children:`Td 2`}),(0,C.jsx)(p,{children:`Td 2`})]}),(0,C.jsxs)(_,{children:[(0,C.jsx)(p,{children:`Td 3`}),(0,C.jsx)(p,{children:`Td 3`}),(0,C.jsx)(p,{children:`Td 3`})]})]})}),a=()=>(0,C.jsx)(C.Fragment,{children:(0,C.jsxs)(`tbody`,{children:[(0,C.jsxs)(_,{children:[(0,C.jsx)(v,{children:`Th 1`}),(0,C.jsx)(p,{children:`Td 1`}),(0,C.jsx)(p,{children:`Td 1`})]}),(0,C.jsxs)(_,{children:[(0,C.jsx)(v,{children:`Th 2`}),(0,C.jsx)(p,{children:`Td 2`}),(0,C.jsx)(p,{children:`Td 2`})]}),(0,C.jsxs)(_,{children:[(0,C.jsx)(v,{children:`Th 3`}),(0,C.jsx)(p,{children:`Td 3`}),(0,C.jsx)(p,{children:`Td 3`})]})]})}),o=()=>(0,C.jsxs)(C.Fragment,{children:[(0,C.jsx)(`thead`,{children:(0,C.jsxs)(_,{children:[(0,C.jsx)(v,{colSpan:2,children:`Th A`}),(0,C.jsx)(v,{children:`Th B`})]})}),(0,C.jsxs)(`tbody`,{children:[(0,C.jsxs)(_,{children:[(0,C.jsx)(p,{children:`Td 1`}),(0,C.jsx)(p,{children:`Td 1`}),(0,C.jsx)(p,{rowSpan:2,children:`Td 1`})]}),(0,C.jsxs)(_,{children:[(0,C.jsx)(p,{rowSpan:2,children:`Td 2`}),(0,C.jsx)(p,{children:`Td 2`})]}),(0,C.jsxs)(_,{children:[(0,C.jsx)(p,{children:`Td 3`}),(0,C.jsx)(p,{children:`Td 3`})]})]})]}),s=()=>(0,C.jsx)(C.Fragment,{children:(0,C.jsxs)(`tbody`,{children:[(0,C.jsxs)(_,{children:[(0,C.jsx)(v,{rowSpan:2,children:`Th 1`}),(0,C.jsx)(p,{children:`Td 1`}),(0,C.jsx)(p,{children:`Td 1`})]}),(0,C.jsxs)(_,{children:[(0,C.jsx)(p,{children:`Td 2`}),(0,C.jsx)(p,{children:`Td 2`})]}),(0,C.jsxs)(_,{children:[(0,C.jsx)(v,{colSpan:2,children:`Th 3`}),(0,C.jsx)(p,{children:`Td 3`})]})]})});return(0,C.jsx)(d,{scope:{ContentVariants:e},stableName:`VariantCombinations`,children:`<ContentVariants />
`})},J=()=>(0,C.jsx)(d,{scope:{useMedia:m,composeIcon:i,stopIcon:c},hideCode:!0,"data-visual-test":`table-one-td`,stableName:`ResponsiveInCard`,noInline:!0,children:`const Example = () => {
...
render(<Example />)
`}),Y=()=>(0,C.jsx)(d,{scope:{composeIcon:i,stopIcon:c,eyeIcon:o,trashIcon:s},hideCode:!0,"data-visual-test":`table-in-card`,stableName:`InCard`,noInline:!0,children:`const MyTable = () => {
  const rows = [
    {
...
`}),X=()=>(0,C.jsx)(d,{hideCode:!0,"data-visual-test":`table-inside-of-accordion-table`,stableName:`TableInAccordionTable`,noInline:!0,children:`const AccordionTable = ({ id, showCheckbox = false, ...props }) => {
  const TdCheckbox = () => {
    return <Checkbox label="Select row" labelSrOnly />
  }
  const TdInput = () => {
...
`}),Z=()=>(0,C.jsx)(d,{hideCode:!0,"data-visual-test":`table-column-highlight`,scope:{useTableHighlight:b},stableName:`ColumnHighlight`,noInline:!0,children:`const ColumnHighlightTable = () => {
...
`});function Q(e){let t={code:`code`,h2:`h2`,h3:`h3`,h4:`h4`,h5:`h5`,p:`p`,pre:`pre`,strong:`strong`,...y(),...e.components},{Details:n,Summary:r,VisibilityByTheme:i,VisibleWhenVisualTest:a}=t;return n||$(`Details`,!0),ue||$(`Examples`,!1),I||$(`Examples.Accordion`,!0),L||$(`Examples.AccordionMixed`,!0),R||$(`Examples.AccordionRow`,!0),P||$(`Examples.ClassHelpers`,!0),H||$(`Examples.ClickableCells`,!0),B||$(`Examples.ClickableRows`,!0),Z||$(`Examples.ColumnHighlight`,!0),N||$(`Examples.ContainerEmptyHeaderFooter`,!0),Y||$(`Examples.InCard`,!0),K||$(`Examples.InOneContainer`,!0),z||$(`Examples.KeyboardNavigation`,!0),F||$(`Examples.LongHeader`,!0),V||$(`Examples.NavigationMixed`,!0),G||$(`Examples.PaginationTable`,!0),J||$(`Examples.ResponsiveInCard`,!0),A||$(`Examples.RowScopeOnly`,!0),D||$(`Examples.SizeMedium`,!0),O||$(`Examples.SizeSmall`,!0),M||$(`Examples.StackedContainer`,!0),U||$(`Examples.Sticky`,!0),W||$(`Examples.StickyMaxHeight`,!0),X||$(`Examples.TableInAccordionTable`,!0),E||$(`Examples.VariantBasic`,!0),q||$(`Examples.VariantCombinations`,!0),k||$(`Examples.VariantComplex`,!0),j||$(`Examples.VariantFixed`,!0),r||$(`Summary`,!0),i||$(`VisibilityByTheme`,!0),a||$(`VisibleWhenVisualTest`,!0),(0,C.jsxs)(C.Fragment,{children:[(0,C.jsx)(t.h2,{children:`Demos`}),`
...
`,(0,C.jsx)(J,{}),`
`,(0,C.jsx)(t.h3,{children:`Column highlight`}),`
...
`})}),`
`,(0,C.jsx)(Z,{}),`
`,(0,C.jsx)(t.h3,{children:`Example usage without and with classes`}),`
`,(0,C.jsx)(P,{}),`
`,(0,C.jsx)(a,{children:(0,C.jsx)(q,{})}),`
`,(0,C.jsxs)(a,{children:[(0,C.jsx)(L,{}),(0,C.jsx)(V,{}),(0,C.jsx)(X,{})]})]})}function de(e={}){let{wrapper:t}={...y(),...e.components};return t?(0,C.jsx)(t,{...e,children:(0,C.jsx)(Q,{...e})}):Q(e)}function $(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{de as default};