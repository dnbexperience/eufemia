import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{j as r,w as i}from"./forms-D__hPZDv.js";import{t as a}from"./Card-DZd-xLSg.js";import{t as o}from"./Currency-aR-bHmFX.js";import{U as s}from"./index-CGxQ8PRe.js";import{t as c}from"./ComponentBox-DOwlXUSS.js";var l=e({Basic:()=>d,Disabled:()=>b,VariantInline:()=>C,WithConfirmCancel:()=>h,WithDataPath:()=>y,WithDisabledItems:()=>v,WithError:()=>x,WithManySelectedItems:()=>S,WithNestedItems:()=>_,WithSearch:()=>m,WithSelectAll:()=>f,WithSelectedItems:()=>g}),u=t(n()),d=()=>(0,u.jsx)(c,{"data-visual-test":`multi-selection-basic`,stableName:`Basic`,sourceImports:[`import { Form, Field } from '@dnb/eufemia/extensions/forms'`,`import { NumberFormat } from '@dnb/eufemia'`],__buildScope:{Field:r},noInline:!0,children:`const cities = [
  {
    value: 'oslo',
    title: 'Oslo',
