import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{$ as r}from"./Anchor-DN_sG59G.js";import{s as i}from"./ToggleButton-Bh3Eln0h.js";import{j as a,l as o,v as s,w as c}from"./forms-Ce7VSRGW.js";import{u as l}from"./FormStatus-DffxfanV.js";import{t as u}from"./P-CX3-UwOl.js";import{t as d}from"./Card-C4jdcnXT.js";import{t as f}from"./TestElement-gVat8efE.js";import{U as p}from"./index-DHCu7dhB.js";import{t as m}from"./ComponentBox-CmvipvMU.js";var h=e({BasedOnBooleanTrue:()=>b,BasedOnContext:()=>x,BooleanExample:()=>_,FilterData:()=>C,InferData:()=>y,InheritVisibility:()=>w,NestedExample:()=>S,PathValue:()=>v,VisibilityOnValidation:()=>T}),g=t(n()),_=()=>(0,g.jsx)(m,{scope:{TestElement:f},stableName:`BooleanExample`,sourceImports:[`import { useCallback } from 'react'`,`import { Flex, HeightAnimation, P } from '@dnb/eufemia'`,`import { Field, Form, TestElement, Tools, Value } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:c,Flex:i,Field:a},children:`<Form.Handler>
  <Flex.Stack>
    <Field.Boolean
      label="Show content"
      variant="buttons"
