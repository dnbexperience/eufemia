import{a as e,r as t}from"./rolldown-runtime-BYbx6iT9.js";import{t as n}from"./jsx-runtime-BgMs7Gb-.js";import{t as r}from"./ComponentBox-a4aOn231.js";import{Pt as i,o as a,zr as o}from"./index-DqqByKA2.js";var s=t({Alignment:()=>_,AllowNegative:()=>C,ConditionalInfo:()=>j,Disabled:()=>b,DisallowLeadingZeroes:()=>w,ExclusiveMinMax:()=>h,HorizontalLayout:()=>m,LabelAndDescription:()=>f,LabelAndValue:()=>u,Percentage:()=>T,Placeholder:()=>l,PrefixAndSuffix:()=>g,ValidateMaximumCustomError:()=>E,ValidateMinimum:()=>S,ValidateRequired:()=>x,Widths:()=>y,WithCustomMask:()=>d,WithHelp:()=>v,WithSlider:()=>A,WithStatus:()=>p,WithStepControls:()=>D,WithStepControlsDisabled:()=>k,WithStepControlsError:()=>O}),c=e(n()),l=()=>(0,c.jsx)(r,{stableName:`Placeholder`,children:`<Field.Number
  label="Label text"
  placeholder="Enter a number..."
  onChange={(value) => console.log('onChange', value)}
/>
`}),u=()=>(0,c.jsx)(r,{stableName:`LabelAndValue`,children:`<Field.Number
  label="Label text"
  defaultValue={420000.25}
  onChange={(value) => console.log('onChange', value)}
/>
`}),d=()=>(0,c.jsx)(r,{stableName:`WithCustomMask`,children:`<Field.Number
  label="Label text"
  defaultValue={1234}
  mask={Array(4).fill(/\\d/)}
  onChange={(value) => console.log('onChange', value)}
/>
`}),f=()=>(0,c.jsx)(r,{"data-visual-test":`number-label-description`,stableName:`LabelAndDescription`,children:`<Form.Card>
  <Field.Number
    label="Label text"
...
`}),p=()=>(0,c.jsx)(r,{"data-visual-test":`number-status`,stableName:`WithStatus`,children:`<Form.Card>
  <Field.Number
    label="Label text"
    placeholder="Enter a number..."
    width="large"
...
`}),m=()=>(0,c.jsx)(r,{"data-visual-test":`number-horizontal-layout`,stableName:`HorizontalLayout`,children:`<Form.Card>
  <Field.Provider
    layout="horizontal"
    layoutOptions={{
...
`}),h=()=>(0,c.jsx)(r,{stableName:`ExclusiveMinMax`,children:`<Field.Number
  defaultValue={1000}
  label="Label text"
  allowNegative={false}
  required
  ...
  validateInitially
/>
`}),g=()=>(0,c.jsx)(r,{stableName:`PrefixAndSuffix`,children:`<Flex.Stack>
  <Field.Number
    defaultValue={1234}
    label="With prefix"
    prefix="prefix "
...
`}),_=()=>(0,c.jsx)(r,{stableName:`Alignment`,children:`<Flex.Stack>
  <Field.Number
    align="center"
...
`}),v=()=>(0,c.jsx)(r,{stableName:`WithHelp`,children:`<Field.Number
  defaultValue={12345}
  label="Label text"
  help={{
  ...
  onChange={(value) => console.log('onChange', value)}
/>
`}),y=()=>(0,c.jsx)(r,{hideCode:!0,"data-visual-test":`number-widths`,stableName:`Widths`,children:`<Flex.Stack>
...
`}),b=()=>(0,c.jsx)(r,{stableName:`Disabled`,children:`<Field.Number
  defaultValue={135}
  label="Label text"
  onChange={(value) => console.log('onChange', value)}
  disabled
/>
`}),x=()=>(0,c.jsx)(r,{stableName:`ValidateRequired`,children:`<Field.Number
  defaultValue={123}
  label="Label text"
  onChange={(value) => console.log('onChange', value)}
  required
/>
`}),S=()=>(0,c.jsx)(r,{stableName:`ValidateMinimum`,children:`<Field.Number
  defaultValue={300}
  label="Enter a number below 250 and blur to trigger error"
  onChange={(value) => console.log('onChange', value)}
  minimum={250}
/>
`}),C=()=>(0,c.jsx)(r,{stableName:`AllowNegative`,children:`<Field.Number allowNegative={false} />
`}),w=()=>(0,c.jsx)(r,{stableName:`DisallowLeadingZeroes`,children:`<Field.Number disallowLeadingZeroes />
`}),T=()=>(0,c.jsx)(r,{stableName:`Percentage`,children:`<Field.Number
  percent
  defaultValue={80}
  label="Percentage"
  onChange={(value) => console.log('onChange', value)}
  minimum={90}
/>
`}),E=()=>(0,c.jsx)(r,{stableName:`ValidateMaximumCustomError`,children:`<Field.Number
  ...
  onChange={(value) => console.log('onChange', value)}
/>
`}),D=()=>(0,c.jsx)(r,{"data-visual-test":`number-input-step-controls`,stableName:`WithStepControls`,children:`<Field.Number
  label="Label text"
  showStepControls
  minimum={0}
  maximum={100}
  ...
  defaultValue={50}
/>
`}),O=()=>(0,c.jsx)(r,{"data-visual-test":`number-input-step-controls-error`,stableName:`WithStepControlsError`,children:`<Field.Number
  label="Label text"
  showStepControls
  maximum={100}
  defaultValue={150}
...
/>
`}),k=()=>(0,c.jsx)(r,{"data-visual-test":`number-input-step-controls-disabled`,stableName:`WithStepControlsDisabled`,children:`<Field.Number label="Label text" showStepControls disabled />
`}),A=()=>(0,c.jsx)(r,{hideCode:!0,stableName:`WithSlider`,noInline:!0,children:`const Component = () => {
...
render(<Component />)
`}),j=()=>(0,c.jsx)(r,{scope:{FormError:i},stableName:`ConditionalInfo`,noInline:!0,children:`render(
  <Form.Handler
    defaultData={{
      maximum: 4,
      amount: 5,
...
`,(0,c.jsx)(y,{}),`
`,(0,c.jsxs)(n,{children:[(0,c.jsx)(O,{}),(0,c.jsx)(k,{})]})]})}function N(e={}){let{wrapper:t}={...o(),...e.components};return t?(0,c.jsx)(t,{...e,children:(0,c.jsx)(M,{...e})}):M(e)}function P(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{N as default};