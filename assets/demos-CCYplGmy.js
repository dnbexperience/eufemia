import{n as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{it as r}from"./SpacingUtils-DdCLj9fe.js";import{H as i}from"./forms-D__hPZDv.js";import{t as a}from"./Space-BTDd9blr.js";import{t as o}from"./Button-CmA8Qaoz.js";import{t as s}from"./P-DSNzygKs.js";import{y as c}from"./Table-DacTQdxx.js";import{t as l}from"./Ul-80bgMsZv.js";import{t as u}from"./Section-Ba8Ez2kR.js";import{n as d,t as f}from"./Pagination-0ElIPKD_.js";import{U as p,w as m}from"./index-CGxQ8PRe.js";import{t as h}from"./ComponentBox-DOwlXUSS.js";var g=t(e()),_=t(n()),v=m.div`
...
`});function w(){return(0,_.jsxs)(N,{className:`dnb-core-style`,innerSpace:{block:`large`},children:[(0,_.jsxs)(a,{left:!0,children:[(0,_.jsx)(c,{size:`small`,children:`Infinity Table`}),(0,_.jsx)(s,{bottom:!0,children:`This is a semantic correct table using infinity scrolling. It also has a sticky header.`}),(0,_.jsxs)(l,{bottom:!0,children:[(0,_.jsx)(`li`,{children:`The startup page number is set to 3.`}),(0,_.jsx)(`li`,{children:`And per page we show 10 items.`}),(0,_.jsx)(`li`,{children:`A random delay is added to simulate asynchronous interaction.`})]})]}),(0,_.jsx)(E,{tableItems:T})]})}var T=[];for(let e=1;e<=300;e++)T.push({ssn:e,text:String(e),expanded:!1});var E=({tableItems:e,...t})=>{let n=Math.floor(e?.length/10),[{Pagination:r,setContent:i,resetContent:a,resetInfinity:s,endInfinity:c}]=(0,g.useState)(d),[l,u]=(0,g.useState)(`asc`),[f,p]=(0,g.useState)(null),[,m]=(0,g.useState)(null);(0,g.useEffect)(()=>{p(3)},[]),e=M(e,l),i(f,(0,_.jsx)(D,{items:e,perPageCount:10,currentPage:f,onToggleExpanded:({ssn:t},{pageNumber:n,element:r=null,onExpanded:i=null})=>{let a=e.findIndex(({ssn:e})=>e===t);if(a>-1){let t=e[a];e[a]={...t,expanded:!t.expanded},p(n),m(new Date().getTime()),r&&j({element:r,expanded:!t.expanded}),setTimeout(i,10)}},onMounted:e=>{e.forEach(({element:{current:e},expanded:t})=>j({element:e,expanded:t,animation:!1}))},endInfinity:c}));let h;(0,g.useEffect)(()=>()=>clearTimeout(h));let v=({pageNumber:e})=>{console.log(`onChange: with page`,e),clearTimeout(h),h=setTimeout(()=>{e===f?m(new Date().getTime()):p(e)},Math.ceil(Math.random()*1e3))};return(0,_.jsxs)(O,{sticky:!0,children:[(0,_.jsx)(`thead`,{children:(0,_.jsxs)(`tr`,{children:[(0,_.jsx)(`th`,{scope:`col`,children:(0,_.jsx)(o,{size:`small`,icon:`reset`,iconPosition:`left`,variant:`secondary`,onClick:()=>{clearTimeout(h),s(),a(),u(`asc`),m(new Date().getTime())},children:`Reset everything`})}),(0,_.jsx)(`th`,{scope:`col`,className:`dnb-table--sortable dnb-table--active ${l===`desc`?` dnb-table--reversed`:``}`,children:(0,_.jsx)(o,{variant:`tertiary`,icon:`arrow-down`,text:`Sortable`,title:`Sort table row`,onClick:()=>{a(),u(e=>e===`asc`?`desc`:`asc`)}})})]})}),(0,_.jsx)(`tbody`,{children:(0,_.jsx)(r,{mode:`infinity`,markerElement:`tr`,fallbackElement:({className:e,...t})=>(0,_.jsx)(k,{className:e,children:(0,_.jsx)(A,{colSpan:2,...t})}),currentPage:f,pageCount:n,...t,onStartup:v,onChange:v})})]})},D=({children:e=null,items:t,currentPage:n,perPageCount:i,onToggleExpanded:a,onMounted:c,endInfinity:l,...u})=>{let d=[];return c&&(0,g.useEffect)(()=>c&&c(d),[]),t=t.filter((e,t)=>{let r=(n-1)*i,a=r+i;return t>=r&&t<a}),t.length===0?(l(),null):t.map((t,i)=>{let c={onClick:e=>{if(!r()||/button/.test(document.activeElement.tagName)){let r=e.currentTarget;a(t,{pageNumber:n,onExpanded:()=>{try{r=r.nextElementSibling,j({element:r,expanded:!t.expanded}),r.focus()}catch{}}})}}},l={current:null};return d.push({...t,element:l}),(0,_.jsxs)(g.Fragment,{children:[(0,_.jsxs)(k,{...u,...c,className:`dnb-table--${i%2?`even`:`odd`} ${t.expanded?`expanded`:``}`,ref:l,children:[(0,_.jsx)(A,{children:(0,_.jsx)(o,{title:t.expanded?`Hide details`:`Show more details`,icon:`chevron_down`,size:`small`,right:`large`})}),(0,_.jsx)(A,{children:(0,_.jsxs)(s,{children:[t.text,` `,e]})})]}),(0,_.jsx)(k,{className:`expanded-content dnb-no-focus ${t.expanded?`expanded`:``}`,tabIndex:-1,children:(0,_.jsx)(A,{colSpan:2,children:t.expanded&&(0,_.jsx)(`div`,{className:`expanded-content__outer`,children:(0,_.jsxs)(`div`,{className:`expanded-content__inner`,children:[(0,_.jsx)(s,{children:`What ever content ...`}),(0,_.jsx)(o,{variant:`secondary`,top:!0,children:`🔥`})]})})})})]},t.ssn)})},O=m(i)`
  table-layout: fixed;
`,k=m.tr`
