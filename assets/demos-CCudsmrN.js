import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{j as r}from"./forms-CsJzlVUF.js";import{B as i}from"./index-DdG6L_K8.js";import{t as a}from"./ComponentBox-q_23Ylzi.js";var o=e({Disabled:()=>m,EmptyPostal:()=>c,EmptyStreet:()=>l,Label:()=>d,LabelAndValue:()=>f,Placeholder:()=>u,ValidationRequired:()=>g,WithError:()=>h,WithHelp:()=>p}),s=t(n()),c=()=>(0,s.jsx)(a,{stableName:`EmptyPostal`,sourceImports:[`import { Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Field:r},children:`<Field.Address.Postal
