import{a as e,r as t}from"./rolldown-runtime-BYbx6iT9.js";import{t as n}from"./jsx-runtime-BgMs7Gb-.js";import{t as r}from"./Field-B1tS3XXm.js";import{Rr as i}from"./index-mmuoVhax.js";import{t as a}from"./ComponentBox-XDAvsf_r.js";var o=t({ButtonDisabled:()=>y,ButtonError:()=>b,ButtonFalse:()=>_,ButtonRequired:()=>v,ButtonTrue:()=>g,ButtonsDisabled:()=>A,ButtonsError:()=>j,ButtonsFalse:()=>D,ButtonsRequired:()=>k,ButtonsTrue:()=>E,ButtonsUndefined:()=>O,CheckboxButtonDisabled:()=>w,CheckboxButtonError:()=>T,CheckboxButtonFalse:()=>S,CheckboxButtonRequired:()=>C,CheckboxButtonTrue:()=>x,CheckboxDisabled:()=>f,CheckboxError:()=>m,CheckboxFalse:()=>u,CheckboxPreventDefault:()=>p,CheckboxRequired:()=>d,CheckboxTrue:()=>l,Default:()=>c,RadioDisabled:()=>L,RadioError:()=>R,RadioFalse:()=>P,RadioRequired:()=>I,RadioTrue:()=>N,RadioUndefined:()=>F,VariantButtonsWithHelp:()=>M,VariantCheckboxWithHelp:()=>h,VariantRadioWithHelp:()=>z,VariantSwitchWithHelp:()=>B}),s=e(n()),c=()=>(0,s.jsx)(a,{stableName:`Default`,sourceImports:[`import { Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Field:r},children:`<Field.Boolean onChange={(value) => console.log('onChange', value)} />
