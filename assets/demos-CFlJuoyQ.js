import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{t as n}from"./P-C9wBv35m.js";import{c as r}from"./ToggleButton-_NsXxiTa.js";import{t as i}from"./Card-ChPhpBPz.js";import{C as a,D as o,E as s,K as c,O as l,T as u,g as d,k as f,w as p}from"./index-ppRu2ktv.js";import{t as m}from"./ComponentBox-R2c6Bo76.js";var h=e(t());function g(e){switch(e?.name){case`sbanken`:return l;case`carnegie`:return p;case`eiendom`:return s;default:return u}}var _=()=>(0,h.jsx)(m,{scope:{DnbDefault:u,SbankenCompact:o,SbankenDefault:l,SbankenHorizontal:f,CarnegieDefault:p,EiendomDefault:s},"data-visual-test":`logo-all`,stableName:`LogoAllExample`,sourceImports:[`import { Card, Logo, Flex, P } from '@dnb/eufemia'`,`import { DnbDefault, SbankenCompact, SbankenDefault, SbankenHorizontal, CarnegieDefault, EiendomDefault } from '@dnb/eufemia/components/Logo'`,`import MyThemeSelector from '../../../../core/ChangeStyleTheme'`,`import { ThemeProps } from '@dnb/eufemia/shared/Theme'`],__buildScope:{Flex:r,Logo:a},children:`<Flex.Vertical>
