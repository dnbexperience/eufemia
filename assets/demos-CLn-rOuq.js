import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{$ as r,H as i,U as a}from"./Anchor-DN_sG59G.js";import{mt as o}from"./forms-Ce7VSRGW.js";import{t as s}from"./P-CX3-UwOl.js";import{U as c}from"./index-DHCu7dhB.js";import{t as l}from"./ComponentBox-CmvipvMU.js";var u=t(n());function d({off:e,children:t}){return e?(0,u.jsx)(r,{formElement:{translate:`no`},children:(0,u.jsx)(a,{translate:`no`,children:t})}):(0,u.jsx)(u.Fragment,{children:t})}var f=e({BrowserTranslateExample:()=>m,PortalRootExample:()=>p}),p=()=>(0,u.jsx)(l,{stableName:`PortalRootExample`,sourceImports:[`import { P, PortalRoot, Dropdown } from '@dnb/eufemia'`,`import { BrowserTranslate } from '@dnb/eufemia/shared'`],__buildScope:{PortalRoot:i,P:s},children:`
<PortalRoot>
  <div
    style={{
      position: 'fixed',
