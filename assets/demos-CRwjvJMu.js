import{n as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{F as r,a as i,c as a,l as o,z as s}from"./SpacingUtils-DdCLj9fe.js";import{$ as c,g as l}from"./Anchor-CUnuD5Cj.js";import{t as u}from"./withComponentMarkers-w3ZImJI6.js";import{n as d,t as f}from"./lightbulb_medium-BWzJf7M2.js";import{t as p}from"./Space-BTDd9blr.js";import{t as m}from"./Button-CmA8Qaoz.js";import{t as h}from"./Img-CNnEt4YC.js";import{t as g}from"./P-DSNzygKs.js";import{n as _,t as v}from"./Ul-80bgMsZv.js";import{U as y}from"./index-CGxQ8PRe.js";import{t as b}from"./ComponentBox-DOwlXUSS.js";var x=t(e()),S=t(n()),C={centered:!1,dropShadow:!0,skeleton:!1,icon:f},w=e=>{let t=(0,x.useContext)(o),n=s(e,C,{skeleton:t?.skeleton},t?.InfoCard),{alt:u,centered:d,dropShadow:f,title:_,skeleton:v,stretch:y,className:b,icon:w,src:T,imgProps:E,text:D,children:O,onClose:k,onAccept:A,closeButtonText:j,acceptButtonText:M,closeButtonProps:N,closeButtonAttributes:P,acceptButtonProps:F,acceptButtonAttributes:I,...L}=n,R=N||P,z=F||I,B=!k&&!j,V=!A&&!M;r(n,L);let H=i(n,{...L,className:a(`dnb-info-card`,d&&`dnb-info-card--centered`,y&&`dnb-info-card--stretch`,f&&`dnb-info-card--shadow`,b)}),U=(0,x.useCallback)(()=>B&&V?null:(0,S.jsxs)(`div`,{className:`dnb-info-card__buttons`,children:[!V&&(0,S.jsx)(m,{top:d?`medium`:`small`,type:`button`,className:`dnb-info-card__buttons__accept-button`,variant:`secondary`,right:d?`zero`:`small`,onClick:A,text:M,...z}),!B&&(0,S.jsx)(m,{type:`button`,className:`dnb-info-card__buttons__close-button`,variant:`tertiary`,top:`small`,onClick:k,icon:`close`,iconPosition:`left`,text:j,...R})]}),[z,V,M,d,R,B,j,A,k]),W=(0,x.useCallback)(()=>T||E?(0,S.jsx)(h,{className:`dnb-info-card__image`,src:T,alt:u,...E}):(0,S.jsx)(l,{size:`medium`,className:`dnb-info-card__icon`,icon:w}),[u,w,E,T]);return(0,S.jsx)(`div`,{...H,children:(0,S.jsxs)(c,{skeleton:v,children:[(0,S.jsx)(p,{right:d?!1:`small`,bottom:d?`small`:!1,children:W()}),(0,S.jsxs)(`div`,{className:`dnb-info-card__content`,children:[_&&(0,S.jsx)(g,{className:`dnb-info-card__title`,size:`small`,weight:`medium`,bottom:`x-small`,children:_}),D&&(0,S.jsx)(g,{size:`small`,className:`dnb-info-card__text`,bottom:`0`,children:D}),O,U()]})]})})};u(w,{_supportsSpacingProps:!0});var T=()=>(0,S.jsx)(b,{"data-visual-test":`info-card-basic`,stableName:`InfoCardBasic`,sourceImports:[`import { card_medium as Card } from '@dnb/eufemia/icons'`,`import InfoCard from '@dnb/eufemia/components/info-card/InfoCard'`,`import Li from '@dnb/eufemia/elements/Li'`,`import Ul from '@dnb/eufemia/elements/Ul'`,`import P from '@dnb/eufemia/elements/P'`],__buildScope:{InfoCard:w},children:`<InfoCard text="This is a description of some information or a tip that will inform the user of something that will help them." />
