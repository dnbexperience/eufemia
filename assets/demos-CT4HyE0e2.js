import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{j as r,l as i,w as a}from"./forms-D54jfDKN.js";import{t as o}from"./Card-BvVSLAbs.js";import{U as s}from"./index-BsJ3GLEw.js";import{t as c}from"./ComponentBox-sLMgHvLi.js";var l=e({Disabled:()=>g,Empty:()=>d,FilterCountries:()=>C,InCard:()=>S,Label:()=>p,LabelAndValue:()=>m,LongLabel:()=>x,Placeholder:()=>f,TransformInAndOut:()=>T,ValidationPattern:()=>y,ValidationRequired:()=>v,Width:()=>w,WithError:()=>_,WithFieldBlockLabel:()=>E,WithFilter:()=>b,WithHelp:()=>h}),u=t(n()),d=()=>(0,u.jsx)(c,{stableName:`Empty`,sourceImports:[`import { Field, Form, Tools } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Field:r},children:`<Field.PhoneNumber
...
/>
`}),f=()=>(0,u.jsx)(c,{stableName:`Placeholder`,sourceImports:[`import { Field, Form, Tools } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Field:r},children:`<Field.PhoneNumber
...
/>
`}),p=()=>(0,u.jsx)(c,{stableName:`Label`,sourceImports:[`import { Field, Form, Tools } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Field:r},children:`<Field.PhoneNumber
...
/>
`}),m=()=>(0,u.jsx)(c,{"data-visual-test":`phone-number-label`,stableName:`LabelAndValue`,sourceImports:[`import { Field, Form, Tools } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Field:r},children:`<Field.PhoneNumber
  numberLabel="Label text"
  value="+4798765432"
  onChange={(value, { countryCode, phoneNumber, iso }) =>
    console.log('onChange', value, {
...
/>
`}),h=()=>(0,u.jsx)(c,{stableName:`WithHelp`,sourceImports:[`import { Field, Form, Tools } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Field:r},children:`<Field.PhoneNumber
  onChange={(value, { countryCode, phoneNumber, iso }) =>
    console.log('onChange', value, {
      countryCode,
      phoneNumber,
...
/>
`}),g=()=>(0,u.jsx)(c,{stableName:`Disabled`,sourceImports:[`import { Field, Form, Tools } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Field:r},children:`<Field.PhoneNumber
  value="+4712345678"
  numberLabel="Label text"
  onChange={(value, { countryCode, phoneNumber, iso }) =>
    console.log('onChange', value, {
  ...
  disabled
/>
`}),_=()=>(0,u.jsx)(c,{"data-visual-test":`phone-number-error`,stableName:`WithError`,sourceImports:[`import { Field, Form, Tools } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Field:r},children:`<Field.PhoneNumber
  value="007"
  numberLabel="Label text"
  onChange={(value, { countryCode, phoneNumber, iso }) =>
    console.log('onChange', value, {
...
/>
`}),v=()=>(0,u.jsx)(c,{stableName:`ValidationRequired`,sourceImports:[`import { Field, Form, Tools } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Field:r},children:`<Field.PhoneNumber
  numberLabel="Label text"
  onChange={(value, { countryCode, phoneNumber, iso }) =>
    console.log('onChange', value, {
      countryCode,
  ...
  validateInitially
/>
`}),y=()=>(0,u.jsx)(c,{stableName:`ValidationPattern`,sourceImports:[`import { Field, Form, Tools } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Field:r},children:`<Field.PhoneNumber
  value="+41123"
  numberLabel="Label text"
  onChange={(value, { countryCode, phoneNumber, iso }) =>
    console.log('onChange', value, {
  ...
  pattern="^\\+41[1]\\d{2}$"
/>
`}),b=()=>(0,u.jsx)(c,{stableName:`WithFilter`,sourceImports:[`import { Field, Form, Tools } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Field:r},children:`<Field.PhoneNumber
  numberLabel="Label text"
  onChange={(value, { countryCode, phoneNumber, iso }) =>
    console.log('onChange', value, {
      countryCode,
...
/>
`}),x=()=>(0,u.jsx)(c,{"data-visual-test":`phone-number-long-label`,stableName:`LongLabel`,sourceImports:[`import { Field, Form, Tools } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Field:r},children:`<Field.PhoneNumber
  numberLabel="Telefon/mobilnummer with long label"
  required={false}
/>
`}),S=()=>(0,u.jsx)(c,{"data-visual-test":`phone-number-in-card`,stableName:`InCard`,sourceImports:[`import { Field, Form, Tools } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:a,Card:o,Field:r},children:`<Form.Card>
  <Field.PhoneNumber />
</Form.Card>
`});function C(){return(0,u.jsx)(c,{stableName:`FilterCountries`,sourceImports:[`import { Field, Form, Tools } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Field:r},children:`<Field.PhoneNumber
  countries="Scandinavia"
  filterCountries={({ iso }) => iso !== 'DK'}
/>
`})}var w=()=>(0,u.jsx)(c,{"data-visual-test":`phone-number-width`,stableName:`Width`,sourceImports:[`import { Field, Form, Tools } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:a,Card:o,Field:r},children:`<Form.Card>
...
`}),T=()=>(0,u.jsx)(c,{stableName:`TransformInAndOut`,sourceImports:[`import { Field, Form, Tools } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:a,Card:o,Field:r,Tools:i},noInline:!0,children:`const transformOut = (internalArgs, additionalArgs) => {
  return {
...
`}),E=()=>(0,u.jsx)(c,{stableName:`WithFieldBlockLabel`,sourceImports:[`import { Field, Form, Tools } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Field:r},children:`<Field.PhoneNumber
