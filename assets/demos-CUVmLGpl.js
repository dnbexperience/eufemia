import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{H as r,Q as i,U as a}from"./Anchor-C8qEa0kQ.js";import{mt as o}from"./forms-So8FhW-K.js";import{t as s}from"./P-DNdAYmtx.js";import{U as c}from"./index-GbBmkyvI.js";import{t as l}from"./ComponentBox-Brk_-GCP.js";var u=t(n());function d({off:e,children:t}){return e?(0,u.jsx)(i,{formElement:{translate:`no`},children:(0,u.jsx)(a,{translate:`no`,children:t})}):(0,u.jsx)(u.Fragment,{children:t})}var f=e({BrowserTranslateExample:()=>m,PortalRootExample:()=>p}),p=()=>(0,u.jsx)(l,{stableName:`PortalRootExample`,sourceImports:[`import { P, PortalRoot, Dropdown } from '@dnb/eufemia'`,`import { BrowserTranslate } from '@dnb/eufemia/shared'`],__buildScope:{PortalRoot:r,P:s},children:`
<PortalRoot>
  <div
    style={{
      position: 'fixed',
