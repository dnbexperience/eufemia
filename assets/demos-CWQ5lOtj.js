import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{t as n}from"./Avatar-GYlYNtYC.js";import{t as r}from"./P-avM674pJ.js";import{c as i}from"./ToggleButton-BtQrsiHY.js";import{t as a}from"./Card--_AKADDp.js";import{t as o}from"./export-BnZzhjZv.js";import{t as s}from"./Form-913YPZs6.js";import{t as c}from"./Field-CbVmykdw.js";import{H as l,W as u}from"./index-D7e1avVt.js";import{t as d}from"./ComponentBox-CE7bpcJy.js";var f=e(t()),p=()=>(0,f.jsx)(d,{hideCode:!0,"data-visual-test":`badge-variant-notification`,stableName:`BadgeNotification`,sourceImports:[`import { Badge, Avatar, Grid, Flex, P } from '@dnb/eufemia'`,`import { Field, Form } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Badge:l},children:`<Badge content={1} label="Notifications" variant="notification" />
`}),m=()=>(0,f.jsx)(d,{hideCode:!0,"data-visual-test":`badge-variant-notification-inline`,stableName:`BadgeNotificationInline`,sourceImports:[`import { Badge, Avatar, Grid, Flex, P } from '@dnb/eufemia'`,`import { Field, Form } from '@dnb/eufemia/extensions/forms'`],__buildScope:{P:r,Badge:l},children:`<P>
  Text{' '}
  <Badge content={1234} label="Notifications" variant="notification" />{' '}
  Text
</P>
`}),h=()=>(0,f.jsx)(d,{hideCode:!0,"data-visual-test":`badge-variant-notification-avatar`,stableName:`BadgeNotificationAvatar`,sourceImports:[`import { Badge, Avatar, Grid, Flex, P } from '@dnb/eufemia'`,`import { Field, Form } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Badge:l,Avatar:n},children:`<Badge content={1234} label="Notifications" variant="notification">
...
`}),_=()=>(0,f.jsx)(d,{hideCode:!0,"data-visual-test":`badge-variant-information-inline`,stableName:`BadgeInformationInline`,sourceImports:[`import { Badge, Avatar, Grid, Flex, P } from '@dnb/eufemia'`,`import { Field, Form } from '@dnb/eufemia/extensions/forms'`],__buildScope:{P:r,Badge:l},children:`<P>
  Text <Badge content="Info" variant="information" /> Text
</P>
`}),v=()=>(0,f.jsx)(d,{hideCode:!0,"data-visual-test":`badge-variant-information-avatar`,stableName:`BadgeInformationAvatar`,sourceImports:[`import { Badge, Avatar, Grid, Flex, P } from '@dnb/eufemia'`,`import { Field, Form } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Badge:l,Avatar:n},children:`<Badge content="Ny" variant="information">
  <Avatar.Group label="Persons">
...
`}),y=()=>(0,f.jsx)(d,{hideCode:!0,"data-visual-test":`badge-corner-position`,stableName:`BadgeCornerPosition`,sourceImports:[`import { Badge, Avatar, Grid, Flex, P } from '@dnb/eufemia'`,`import { Field, Form } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Flex:i,Badge:l,Avatar:n},children:`<Flex.Container>
  <Badge
    content={66}
    label="Notifications"
    vertical="top"
...
`}),b=()=>(0,f.jsx)(d,{hideCode:!0,"data-visual-test":`badge-status`,stableName:`BadgeStatus`,sourceImports:[`import { Badge, Avatar, Grid, Flex, P } from '@dnb/eufemia'`,`import { Field, Form } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Grid:o,Badge:l},children:`<Grid.Container
  rowGap
  columnGap
  style={{
    display: 'inline-grid',
...
`}),x=()=>(0,f.jsx)(d,{hideCode:!0,stableName:`BadgeHide`,sourceImports:[`import { Badge, Avatar, Grid, Flex, P } from '@dnb/eufemia'`,`import { Field, Form } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:s,Card:a,Badge:l,Avatar:n,Field:c},noInline:!0,children:`const Example = () => {
  type Data = {
