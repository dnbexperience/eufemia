import{a as e,r as t}from"./rolldown-runtime-BYbx6iT9.js";import{t as n}from"./jsx-runtime-BgMs7Gb-.js";import{Bn as r,Br as i,In as a,Rr as o}from"./index-BIrFyEEc.js";import{t as s}from"./ComponentBox-DFVIRw0w.js";var c=t({DarkSurface:()=>f,Default:()=>u,Divider:()=>g,Info:()=>v,NoBreakout:()=>d,ResponsiveAppearance:()=>p,ResponsiveInnerSpace:()=>m,SectionZIndex:()=>_,Spacing:()=>h,Success:()=>x,Warning:()=>b,WithError:()=>y}),l=e(n()),u=()=>(0,l.jsx)(s,{hideCode:!0,"data-visual-test":`section-default`,stableName:`Default`,sourceImports:[`import { Section, P, Anchor } from '@dnb/eufemia'`],__buildScope:{Section:r,P:a,Anchor:i},children:`<Section>
  <P space={0}>
    Visual Section: <Anchor href="#">default</Anchor>
  </P>
</Section>
`}),d=()=>(0,l.jsx)(s,{hideCode:!0,"data-visual-test":`section-no-breakout`,stableName:`NoBreakout`,sourceImports:[`import { Section, P, Anchor } from '@dnb/eufemia'`],__buildScope:{Section:r,P:a},children:`<Section
  breakout={false}
  backgroundColor="var(--token-color-background-neutral-subtle)"
>
  <P space={0}>No breakout</P>
</Section>
`}),f=()=>(0,l.jsx)(s,{hideCode:!0,stableName:`DarkSurface`,sourceImports:[`import { Section, P, Anchor } from '@dnb/eufemia'`],__buildScope:{Section:r,P:a,Anchor:i},children:`<Section
  innerSpace={{
    top: 'large',
    bottom: 'large',
  }}
...
`}),p=()=>(0,l.jsx)(s,{hideCode:!0,"data-visual-test":`section-responsive-appearance`,stableName:`ResponsiveAppearance`,sourceImports:[`import { Section, P, Anchor } from '@dnb/eufemia'`],__buildScope:{Section:r,P:a},children:`<Section
  breakout={{
    small: true,
    medium: false,
    large: false,
...
`}),m=()=>(0,l.jsx)(s,{hideCode:!0,stableName:`ResponsiveInnerSpace`,sourceImports:[`import { Section, P, Anchor } from '@dnb/eufemia'`],__buildScope:{Section:r,P:a},children:`<Section
  innerSpace={{
    small: {
      block: 'small',
      inline: 'x-small',
...
`}),h=()=>(0,l.jsx)(s,{hideCode:!0,stableName:`Spacing`,sourceImports:[`import { Section, P, Anchor } from '@dnb/eufemia'`],__buildScope:{Section:r,P:a,Anchor:i},children:`<Section
  innerSpace={{
    top: 'large',
    bottom: 'large',
    left: 'small',
...
`}),g=()=>(0,l.jsx)(s,{hideCode:!0,"data-visual-test":`section-divider`,stableName:`Divider`,sourceImports:[`import { Section, P, Anchor } from '@dnb/eufemia'`],__buildScope:{Section:r,P:a,Anchor:i},children:`<Section
  innerSpace={{
    top: 'medium',
    bottom: 'medium',
  }}
...
`}),_=()=>(0,l.jsx)(s,{hideCode:!0,"data-visual-test":`section-z-index`,stableName:`SectionZIndex`,sourceImports:[`import { Section, P, Anchor } from '@dnb/eufemia'`],__buildScope:{Section:r},children:`<Section
  innerSpace={{
    top: 'large',
    bottom: 'large',
  }}
...
`}),v=()=>(0,l.jsx)(s,{hideCode:!0,"data-visual-test":`section-information`,stableName:`Info`,sourceImports:[`import { Section, P, Anchor } from '@dnb/eufemia'`],__buildScope:{Section:r,P:a,Anchor:i},children:`<Section
  innerSpace={{
    top: 'large',
    bottom: 'large',
  }}
...
`}),y=()=>(0,l.jsx)(s,{hideCode:!0,"data-visual-test":`section-error`,stableName:`WithError`,sourceImports:[`import { Section, P, Anchor } from '@dnb/eufemia'`],__buildScope:{Section:r,P:a,Anchor:i},children:`<Section
  innerSpace={{
    top: 'large',
    bottom: 'large',
  }}
...
`}),b=()=>(0,l.jsx)(s,{hideCode:!0,"data-visual-test":`section-warning`,stableName:`Warning`,sourceImports:[`import { Section, P, Anchor } from '@dnb/eufemia'`],__buildScope:{Section:r,P:a,Anchor:i},children:`<Section
  innerSpace={{
    top: 'large',
    bottom: 'large',
  }}
...
`}),x=()=>(0,l.jsx)(s,{hideCode:!0,"data-visual-test":`section-success`,stableName:`Success`,sourceImports:[`import { Section, P, Anchor } from '@dnb/eufemia'`],__buildScope:{Section:r,P:a,Anchor:i},children:`<Section
  innerSpace={{
    top: 'large',
    bottom: 'large',
  }}
