...
`}),S=()=>(0,g.jsx)(m,{scope:{TestElement:c},hideCode:!0,"data-visual-test":`forms-field-block-widths`,stableName:`Widths`,sourceImports:[`import { FieldBlock, Field, TestElement, Form } from '@dnb/eufemia/extensions/forms'`,`import { Anchor, Flex, Slider } from '@dnb/eufemia'`],__buildScope:{Flex:a,FieldBlock:s},children:`<Flex.Stack>
...
`}),T=()=>(0,g.jsx)(m,{stableName:`HorizontalAutoSize`,sourceImports:[`import { FieldBlock, Field, TestElement, Form } from '@dnb/eufemia/extensions/forms'`,`import { Anchor, Flex, Slider } from '@dnb/eufemia'`],__buildScope:{FieldBlock:s,Flex:a,Field:d,Slider:l},children:`<FieldBlock label="Label">
  <Flex.Container>
    <Flex.Item
      span={{
        small: 12,
...
`}),E=()=>(0,g.jsx)(m,{"data-visual-test":`forms-field-block-label-size`,stableName:`LabelSize`,sourceImports:[`import { FieldBlock, Field, TestElement, Form } from '@dnb/eufemia/extensions/forms'`,`import { Anchor, Flex, Slider } from '@dnb/eufemia'`],__buildScope:{Form:u,Flex:a,Heading:p,FieldBlock:s,Field:d},children:`<Form.Handler>
  <Flex.Stack>
...
`}),N=()=>(0,g.jsx)(m,{"data-visual-test":`forms-field-block-help-button-vertical-label-description`,stableName:`InlineHelpButtonVerticalLabelDescription`,sourceImports:[`import { FieldBlock, Field, TestElement, Form } from '@dnb/eufemia/extensions/forms'`,`import { Anchor, Flex, Slider } from '@dnb/eufemia'`],__buildScope:{Form:u,Card:o,Field:d},children:`<Form.Card>
  <Field.String
    label="Ønsket lånebeløp"
    labelDescription="Description"
    help={{
