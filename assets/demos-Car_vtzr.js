import{a as e}from"./rolldown-runtime-BYbx6iT9.js";import{t}from"./jsx-runtime-BgMs7Gb-.js";import{n,r,t as i}from"./trash_medium-B-PAv1zt.js";import{t as a}from"./edit-DjxtiiWv.js";import{t as o}from"./Card-2G-TKpj3.js";import{t as s}from"./Form-PES0Uozy.js";import{t as c}from"./Field-DrUGn0oz.js";import{Br as l,Cn as u,Er as d,Fn as f,In as p,Rr as m,Xn as h,gr as g,ui as _,un as v,wr as y,xn as b}from"./index-BIrFyEEc.js";import{t as x}from"./ComponentBox-DFVIRw0w.js";var S=e(t()),C=()=>(0,S.jsx)(x,{"data-visual-test":`dialog-default`,stableName:`DialogExampleDefault`,sourceImports:[`import { useRef, useState } from 'react'`,`import { trash_medium, log_out_medium, cookie_medium, bell_medium, edit } from '@dnb/eufemia/icons'`,`import { Anchor, Button, Dialog, Flex, ProgressIndicator, FormStatus, Breadcrumb, P, Input } from '@dnb/eufemia'`,`import { Form, Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Dialog:b,P:p,Modal:u,Button:y},children:`<Dialog title="What is a Dialog?">
  <P>
...
`}),w=()=>(0,S.jsx)(x,{"data-visual-test":`dialog-help-button`,stableName:`DialogExampleHelpButton`,sourceImports:[`import { useRef, useState } from 'react'`,`import { trash_medium, log_out_medium, cookie_medium, bell_medium, edit } from '@dnb/eufemia/icons'`,`import { Anchor, Button, Dialog, Flex, ProgressIndicator, FormStatus, Breadcrumb, P, Input } from '@dnb/eufemia'`,`import { Form, Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Input:g,Dialog:b,P:p},children:`<Input
  label="Input"
...
`}),A=()=>(0,S.jsx)(x,{"data-visual-test":`dialog-progress-indicator`,stableName:`DialogExampleProgressIndicator`,sourceImports:[`import { useRef, useState } from 'react'`,`import { trash_medium, log_out_medium, cookie_medium, bell_medium, edit } from '@dnb/eufemia/icons'`,`import { Anchor, Button, Dialog, Flex, ProgressIndicator, FormStatus, Breadcrumb, P, Input } from '@dnb/eufemia'`,`import { Form, Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Dialog:b,ProgressIndicator:h},children:`<Dialog
  spacing={false}
  fullscreen={false}
...
`}),j=()=>(0,S.jsx)(x,{"data-visual-test":`dialog-confirm-default`,scope:{bell_medium:_},stableName:`DialogConfirmDefault`,sourceImports:[`import { useRef, useState } from 'react'`,`import { trash_medium, log_out_medium, cookie_medium, bell_medium, edit } from '@dnb/eufemia/icons'`,`import { Anchor, Button, Dialog, Flex, ProgressIndicator, FormStatus, Breadcrumb, P, Input } from '@dnb/eufemia'`,`import { Form, Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Dialog:b},children:`<Dialog
...
/>
`}),M=()=>(0,S.jsx)(x,{"data-visual-test":`dialog-confirm-delete`,scope:{trash_medium:i},stableName:`DialogConfirmDelete`,sourceImports:[`import { useRef, useState } from 'react'`,`import { trash_medium, log_out_medium, cookie_medium, bell_medium, edit } from '@dnb/eufemia/icons'`,`import { Anchor, Button, Dialog, Flex, ProgressIndicator, FormStatus, Breadcrumb, P, Input } from '@dnb/eufemia'`,`import { Form, Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Dialog:b},children:`<Dialog
  variant="confirmation"
  confirmType="warning"
...
/>
`}),N=()=>(0,S.jsx)(x,{"data-visual-test":`dialog-confirm-loggedout`,scope:{log_out_medium:n},stableName:`DialogConfirmLoggedOut`,sourceImports:[`import { useRef, useState } from 'react'`,`import { trash_medium, log_out_medium, cookie_medium, bell_medium, edit } from '@dnb/eufemia/icons'`,`import { Anchor, Button, Dialog, Flex, ProgressIndicator, FormStatus, Breadcrumb, P, Input } from '@dnb/eufemia'`,`import { Form, Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Button:y,Dialog:b},noInline:!0,children:`const DemoComponent = () => {
...
`}),P=()=>(0,S.jsx)(x,{"data-visual-test":`dialog-confirm-cookie`,scope:{cookie_medium:r,edit:a},stableName:`DialogConfirmCookies`,sourceImports:[`import { useRef, useState } from 'react'`,`import { trash_medium, log_out_medium, cookie_medium, bell_medium, edit } from '@dnb/eufemia/icons'`,`import { Anchor, Button, Dialog, Flex, ProgressIndicator, FormStatus, Breadcrumb, P, Input } from '@dnb/eufemia'`,`import { Form, Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Dialog:b,Anchor:l,Button:y},children:`<Dialog
  triggerProps={{
...
`}),F=()=>(0,S.jsx)(x,{"data-visual-test":`dialog-scroll-content`,stableName:`DialogConfirmScrollableContent`,sourceImports:[`import { useRef, useState } from 'react'`,`import { trash_medium, log_out_medium, cookie_medium, bell_medium, edit } from '@dnb/eufemia/icons'`,`import { Anchor, Button, Dialog, Flex, ProgressIndicator, FormStatus, Breadcrumb, P, Input } from '@dnb/eufemia'`,`import { Form, Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Dialog:b,Anchor:l,Button:y},noInline:!0,children:`const MockComponent = () => {
...
`}),I=()=>(0,S.jsx)(x,{"data-visual-test":`dialog-scroll-content-info`,stableName:`DialogInformationScrollableContent`,sourceImports:[`import { useRef, useState } from 'react'`,`import { trash_medium, log_out_medium, cookie_medium, bell_medium, edit } from '@dnb/eufemia/icons'`,`import { Anchor, Button, Dialog, Flex, ProgressIndicator, FormStatus, Breadcrumb, P, Input } from '@dnb/eufemia'`,`import { Form, Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Dialog:b,Form:s,Flex:v,P:p,Card:o,Field:c},noInline:!0,children:`const MockComponent = () => {
  const scrollRef = useRef(null)
  return (
    <Dialog
      triggerProps={{
...
render(<MockComponent />)
`});function L(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,li:`li`,ol:`ol`,p:`p`,...m(),...e.components},{VisibleWhenVisualTest:n}=t;return n||z(`VisibleWhenVisualTest`,!0),(0,S.jsxs)(S.Fragment,{children:[(0,S.jsx)(t.h2,{children:`Table of contents`}),`
...
`,(0,S.jsx)(P,{}),`
`,(0,S.jsxs)(n,{children:[(0,S.jsx)(F,{}),(0,S.jsx)(I,{})]})]})}function R(e={}){let{wrapper:t}={...m(),...e.components};return t?(0,S.jsx)(t,{...e,children:(0,S.jsx)(L,{...e})}):L(e)}function z(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{R as default};