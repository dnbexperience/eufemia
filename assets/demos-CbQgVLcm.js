import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{s as r}from"./ToggleButton-DfKpi57X.js";import{m as i}from"./forms-D54jfDKN.js";import{t as a}from"./Button-kSqfAUVR.js";import{U as o}from"./index-BsJ3GLEw.js";import{t as s}from"./ComponentBox-sLMgHvLi.js";var c=e({Default:()=>u,OnStepChange:()=>d,OutsideOfContext:()=>f}),l=t(n()),u=()=>(0,l.jsx)(s,{stableName:`Default`,sourceImports:[`import { Button, Flex } from '@dnb/eufemia'`,`import { Wizard } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Wizard:i,Button:a},noInline:!0,children:`const Step1 = () => {
...
`}),d=()=>(0,l.jsx)(s,{stableName:`OnStepChange`,sourceImports:[`import { Button, Flex } from '@dnb/eufemia'`,`import { Wizard } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Wizard:i},noInline:!0,children:`const onStepChange1 = (index, mode, { preventNavigation }) => {
  console.log(
...
`}),f=()=>(0,l.jsx)(s,{stableName:`OutsideOfContext`,sourceImports:[`import { Button, Flex } from '@dnb/eufemia'`,`import { Wizard } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Wizard:i,Button:a,Flex:r},noInline:!0,children:`const RenderBefore = () => {
