import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{S as r,Vt as i,nt as a,w as o}from"./forms-Ce7VSRGW.js";import{U as s}from"./index-DHCu7dhB.js";import{t as c}from"./ComponentBox-CmvipvMU.js";var l=e({CustomComponentExample:()=>d}),u=t(n()),d=()=>(0,u.jsx)(c,{scope:{useValueProps:a,ValueBlock:r,formatCurrency:i},stableName:`CustomComponentExample`,sourceImports:[`import { ValueBlock, Form, useValueProps } from '@dnb/eufemia/extensions/forms'`,`import { formatCurrency } from '@dnb/eufemia/components/number-format/NumberUtils'`],__buildScope:{ValueBlock:r,Form:o},noInline:!0,children:`const MyValueComponent = (props) => {
  const preparedProps = {
    label: 'Default Label',
    ...props,
