import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{t as n}from"./P-DtVKLSL-.js";import{c as r}from"./ToggleButton-D3NEk3jO.js";import{t as i}from"./Card-C6UABezd.js";import{C as a,D as o,E as s,O as c,T as l,W as u,g as d,k as f,w as p}from"./index-BCXtuv-b.js";import{t as m}from"./ComponentBox-B2X8809Z.js";var h=e(t());function g(e){switch(e?.name){case`sbanken`:return c;case`carnegie`:return p;case`eiendom`:return s;default:return l}}var _=()=>(0,h.jsx)(m,{scope:{DnbDefault:l,SbankenCompact:o,SbankenDefault:c,SbankenHorizontal:f,CarnegieDefault:p,EiendomDefault:s},"data-visual-test":`logo-all`,stableName:`LogoAllExample`,sourceImports:[`import { Card, Logo, Flex, P } from '@dnb/eufemia'`,`import { DnbDefault, SbankenCompact, SbankenDefault, SbankenHorizontal, CarnegieDefault, EiendomDefault } from '@dnb/eufemia/components/Logo'`,`import MyThemeSelector from '../../../../core/ChangeStyleTheme'`,`import { ThemeProps } from '@dnb/eufemia/shared/Theme'`],__buildScope:{Flex:r,Logo:a},children:`<Flex.Vertical>
...
`}),S=()=>(0,h.jsx)(m,{scope:{MyThemeSelector:d,myLogoSelector:g,SbankenDefault:c,CarnegieDefault:p,EiendomDefault:s,DnbDefault:l},"data-visual-test":`logo-theme-change`,stableName:`LogoChangeExample`,sourceImports:[`import { Card, Logo, Flex, P } from '@dnb/eufemia'`,`import { DnbDefault, SbankenCompact, SbankenDefault, SbankenHorizontal, CarnegieDefault, EiendomDefault } from '@dnb/eufemia/components/Logo'`,`import MyThemeSelector from '../../../../core/ChangeStyleTheme'`,`import { ThemeProps } from '@dnb/eufemia/shared/Theme'`],__buildScope:{Card:i,Logo:a},noInline:!0,children:`function myLogoSelector(theme: ThemeProps) {
  switch (theme?.name) {
    case 'sbanken':
...
`});function T(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,h4:`h4`,p:`p`,pre:`pre`,...u(),...e.components},{VisibleWhenVisualTest:n}=t;return n||D(`VisibleWhenVisualTest`,!0),(0,h.jsxs)(h.Fragment,{children:[(0,h.jsx)(t.h2,{children:`Demos`}),`
...
`,(0,h.jsx)(x,{}),`
`,(0,h.jsx)(n,{children:(0,h.jsx)(w,{})})]})}function E(e={}){let{wrapper:t}={...u(),...e.components};return t?(0,h.jsx)(t,{...e,children:(0,h.jsx)(T,{...e})}):T(e)}function D(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{E as default};