import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{s as n}from"./chunk-QUQL4437-CBr5Whxv.js";import{t as r}from"./ToggleButton-Cp78oGqp.js";import{n as i}from"./portal-query-B_Ssgp7u.js";import{F as a}from"./Autocomplete-C26sQSmj.js";import{t as o}from"./P-DNdAYmtx.js";import{t as s}from"./H2-YCxFbvtu.js";import{t as c}from"./Section-84TIytH1.js";import{D as l,H as u,U as d,w as f}from"./index-GbBmkyvI.js";import{t as p}from"./ComponentBox-Brk_-GCP.js";var m=e(t()),h=({children:e})=>(0,m.jsx)(m.Fragment,{children:e}),g=()=>(0,m.jsx)(O,{children:(0,m.jsx)(p,{stableName:`TabsExampleContentOutside`,sourceImports:[`import { Suspense, ReactNode } from 'react'`,`import Input from '@dnb/eufemia/components/input/Input'`,`import styled from '@emotion/styled'`,`import { useLocation } from 'react-router-dom'`,`import { navigate } from 'portal-query'`,`import { Tabs, Section, H2, P, ToggleButton, Badge } from '@dnb/eufemia'`],__buildScope:{Tabs:l,H2:s},children:`
<Tabs
  id="unique-linked-id"
  data={[
    {
