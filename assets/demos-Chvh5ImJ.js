import{a as e}from"./rolldown-runtime-BYbx6iT9.js";import{n as t,t as n}from"./jsx-runtime-BgMs7Gb-.js";import{N as r,k as i,t as a}from"./ComponentBox-geTEYZ7b.js";import{Er as o,Ir as s,Rr as c,Zn as l,a as u,cr as d,pr as f,wa as p,wr as m}from"./index-CMgyXmp3.js";var h=e(t()),g=n(),_=u.div`
...
`});function C(){return(0,g.jsxs)(M,{className:`dnb-core-style`,innerSpace:{block:`large`},children:[(0,g.jsxs)(s,{left:!0,children:[(0,g.jsx)(f,{size:`small`,children:`Infinity Table`}),(0,g.jsx)(d,{bottom:!0,children:`This is a semantic correct table using infinity scrolling. It also has a sticky header.`}),(0,g.jsxs)(l,{bottom:!0,children:[(0,g.jsx)(`li`,{children:`The startup page number is set to 3.`}),(0,g.jsx)(`li`,{children:`And per page we show 10 items.`}),(0,g.jsx)(`li`,{children:`A random delay is added to simulate asynchronous interaction.`})]})]}),(0,g.jsx)(T,{tableItems:w})]})}var w=[];for(let e=1;e<=300;e++)w.push({ssn:e,text:String(e),expanded:!1});var T=({tableItems:e,...t})=>{let n=Math.floor(e?.length/10),[{Pagination:i,setContent:a,resetContent:o,resetInfinity:s,endInfinity:c}]=h.useState(r),[l,u]=h.useState(`asc`),[d,f]=h.useState(null),[p,_]=h.useState(null);h.useEffect(()=>{f(3)},[]),e=j(e,l),a(d,(0,g.jsx)(E,{items:e,perPageCount:10,currentPage:d,onToggleExpanded:({ssn:t},{pageNumber:n,element:r=null,onExpanded:i=null})=>{let a=e.findIndex(({ssn:e})=>e===t);if(a>-1){let t=e[a];e[a]={...t,expanded:!t.expanded},f(n),_(new Date().getTime()),r&&A({element:r,expanded:!t.expanded}),setTimeout(i,10)}},onMounted:e=>{e.forEach(({element:{current:e},expanded:t})=>A({element:e,expanded:t,animation:!1}))},endInfinity:c}));let v;h.useEffect(()=>()=>clearTimeout(v));let y=({pageNumber:e})=>{console.log(`onChange: with page`,e),clearTimeout(v),v=setTimeout(()=>{e===d?_(new Date().getTime()):f(e)},Math.ceil(Math.random()*1e3))};return(0,g.jsxs)(D,{sticky:!0,children:[(0,g.jsx)(`thead`,{children:(0,g.jsxs)(`tr`,{children:[(0,g.jsx)(`th`,{scope:`col`,children:(0,g.jsx)(m,{size:`small`,icon:`reset`,iconPosition:`left`,variant:`secondary`,onClick:()=>{clearTimeout(v),s(),o(),u(`asc`),_(new Date().getTime())},children:`Reset everything`})}),(0,g.jsx)(`th`,{scope:`col`,className:`dnb-table--sortable dnb-table--active ${l===`desc`?` dnb-table--reversed`:``}`,children:(0,g.jsx)(m,{variant:`tertiary`,icon:`arrow-down`,text:`Sortable`,title:`Sort table row`,onClick:()=>{o(),u(e=>e===`asc`?`desc`:`asc`)}})})]})}),(0,g.jsx)(`tbody`,{children:(0,g.jsx)(i,{mode:`infinity`,markerElement:`tr`,fallbackElement:({className:e,...t})=>(0,g.jsx)(O,{className:e,children:(0,g.jsx)(k,{colSpan:2,...t})}),currentPage:d,pageCount:n,...t,onStartup:y,onChange:y})})]})},E=({children:e=null,items:t,currentPage:n,perPageCount:r,onToggleExpanded:i,onMounted:a,endInfinity:o,...s})=>{let c=[];return a&&h.useEffect(()=>a&&a(c),[]),t=t.filter((e,t)=>{let i=(n-1)*r,a=i+r;return t>=i&&t<a}),t.length===0?(o(),null):t.map((t,r)=>{let a={onClick:e=>{if(!p()||/button/.test(document.activeElement.tagName)){let r=e.currentTarget;i(t,{pageNumber:n,onExpanded:()=>{try{r=r.nextElementSibling,A({element:r,expanded:!t.expanded}),r.focus()}catch{}}})}}},o={current:null};return c.push({...t,element:o}),(0,g.jsxs)(h.Fragment,{children:[(0,g.jsxs)(O,{...s,...a,className:`dnb-table--${r%2?`even`:`odd`} ${t.expanded?`expanded`:``}`,ref:o,children:[(0,g.jsx)(k,{children:(0,g.jsx)(m,{title:t.expanded?`Hide details`:`Show more details`,icon:`chevron_down`,size:`small`,right:`large`})}),(0,g.jsx)(k,{children:(0,g.jsxs)(d,{children:[t.text,` `,e]})})]}),(0,g.jsx)(O,{className:`expanded-content dnb-no-focus ${t.expanded?`expanded`:``}`,tabIndex:-1,children:(0,g.jsx)(k,{colSpan:2,children:t.expanded&&(0,g.jsx)(`div`,{className:`expanded-content__outer`,children:(0,g.jsxs)(`div`,{className:`expanded-content__inner`,children:[(0,g.jsx)(d,{children:`What ever content ...`}),(0,g.jsx)(m,{variant:`secondary`,top:!0,children:`🔥`})]})})})})]},t.ssn)})},D=u(i)`
  table-layout: fixed;
`,O=u.tr`
...
`,(0,g.jsx)(S,{})]})}function P(e={}){let{wrapper:t}={...c(),...e.components};return t?(0,g.jsx)(t,{...e,children:(0,g.jsx)(N,{...e})}):N(e)}export{P as default};