...
`}),R=()=>(0,g.jsx)(m,{hideCode:!0,stableName:`WithSlider`,sourceImports:[`import { useState } from 'react'`,`import { Slider, Grid, Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Grid:d,Field:o,Slider:s},noInline:!0,children:`const Component = () => {
...
render(<Component />)
`}),z=()=>(0,g.jsx)(m,{scope:{FormError:c},stableName:`ConditionalInfo`,sourceImports:[`import { useState } from 'react'`,`import { Slider, Grid, Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:l,Card:u,Field:o,Anchor:i},noInline:!0,children:`render(
  <Form.Handler
    defaultData={{
      maximum: 4,
      amount: 5,
