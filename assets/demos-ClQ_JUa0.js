...
render(<Example />)
`}),Be=()=>(0,W.jsx)(z,{hideCode:!0,stableName:`CustomFilter`,sourceImports:[`import { useCallback, useEffect, useMemo, useRef, useState } from 'react'`,`import { Button, Filter, Grid, Heading, List, P, ToggleButton } from '@dnb/eufemia'`,`import { Value } from '@dnb/eufemia/extensions/forms'`,`import { download as downloadIcon, table as tableIcon } from '@dnb/eufemia/icons'`],__buildScope:{Filter:Q,ToggleButton:_,List:I},noInline:!0,children:`function ToggleFilter({ label, filterKey }) {
...
render(<Example />)
`}),Ge=()=>(0,W.jsx)(z,{hideCode:!0,stableName:`QuickFilters`,sourceImports:[`import { useCallback, useEffect, useMemo, useRef, useState } from 'react'`,`import { Button, Filter, Grid, Heading, List, P, ToggleButton } from '@dnb/eufemia'`,`import { Value } from '@dnb/eufemia/extensions/forms'`,`import { download as downloadIcon, table as tableIcon } from '@dnb/eufemia/icons'`],__buildScope:{Filter:Q,ToggleButton:_,List:I,Value:E},noInline:!0,children:`function QuickFilter({ label, filterKey }) {
  const { setFilter, getFilter } = Filter.useFilterContext()
  const isActive = !!getFilter(filterKey)
  return (
    <ToggleButton
