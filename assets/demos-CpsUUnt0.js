import{a as e}from"./rolldown-runtime-BYbx6iT9.js";import{t}from"./jsx-runtime-BgMs7Gb-.js";import{t as n}from"./H2-BeLNZ3dn.js";import{t as r}from"./Skeleton-BJ4flETQ.js";import{Bn as i,Br as a,Fi as o,In as s,Rr as c,ri as l,wr as u,y as d}from"./index-Da-r8F54.js";import{t as f}from"./ComponentBox-DXeEXSK2.js";var p=e(t()),m=d.div`
...
`,g=()=>(0,p.jsx)(m,{children:(0,p.jsx)(f,{"data-visual-test":`anchor-basic`,stableName:`AnchorBasicUse`,sourceImports:[`import styled from '@emotion/styled'`,`import { Section, Anchor, IconPrimary, H2, P } from '@dnb/eufemia'`,`import { Theme } from '@dnb/eufemia/shared'`],__buildScope:{P:s,Anchor:a},children:`<P>
  This is a regular paragraph with a{' '}
  <Anchor href="https://dnb.no/">link to a website</Anchor> in the middle
  of some text.
</P>
`})}),_=()=>(0,p.jsx)(m,{children:(0,p.jsx)(f,{"data-visual-test":`anchor-in-section`,stableName:`AnchorExampleInSection`,sourceImports:[`import styled from '@emotion/styled'`,`import { Section, Anchor, IconPrimary, H2, P } from '@dnb/eufemia'`,`import { Theme } from '@dnb/eufemia/shared'`],__buildScope:{Section:i,Anchor:a},children:`<Section
  innerSpace={{
    block: 'large',
  }}
>
...
`})}),v=()=>(0,p.jsx)(m,{children:(0,p.jsx)(f,{hideCode:!0,scope:{Example:h},stableName:`AnchorDarkSurfaceExample`,sourceImports:[`import styled from '@emotion/styled'`,`import { Section, Anchor, IconPrimary, H2, P } from '@dnb/eufemia'`,`import { Theme } from '@dnb/eufemia/shared'`],__buildScope:{Section:i,Anchor:a},children:`<Section surface="dark" innerSpace data-visual-test="anchor-surface-dark">
  <Anchor href="/uilib/components/anchor">Dark surface style</Anchor>
</Section>
`})}),y=()=>(0,p.jsx)(m,{children:(0,p.jsx)(f,{scope:{Example:h},"data-visual-test":`anchor-states`,hideCode:!0,stableName:`AnchorExampleStates`,sourceImports:[`import styled from '@emotion/styled'`,`import { Section, Anchor, IconPrimary, H2, P } from '@dnb/eufemia'`,`import { Theme } from '@dnb/eufemia/shared'`],__buildScope:{Anchor:a},children:`
<Example>
...
`})}),b=()=>(0,p.jsx)(m,{children:(0,p.jsx)(f,{hideCode:!0,scope:{Example:h},stableName:`AnchorExampleHelperClasses`,sourceImports:[`import styled from '@emotion/styled'`,`import { Section, Anchor, IconPrimary, H2, P } from '@dnb/eufemia'`,`import { Theme } from '@dnb/eufemia/shared'`],__buildScope:{Anchor:a,Button:u,Skeleton:r},children:`
<Example>
  <Anchor
...
`})}),x=()=>(0,p.jsx)(m,{children:(0,p.jsx)(f,{"data-visual-test":`anchor-disabled`,stableName:`AnchorExampleDisabled`,sourceImports:[`import styled from '@emotion/styled'`,`import { Section, Anchor, IconPrimary, H2, P } from '@dnb/eufemia'`,`import { Theme } from '@dnb/eufemia/shared'`],__buildScope:{Anchor:a},children:`<Anchor
  href="/uilib/components/anchor"
  disabled
...
`})}),C=()=>(0,p.jsx)(m,{children:(0,p.jsx)(f,{hideCode:!0,scope:{Example:h},stableName:`AnchorExampleIcons`,sourceImports:[`import styled from '@emotion/styled'`,`import { Section, Anchor, IconPrimary, H2, P } from '@dnb/eufemia'`,`import { Theme } from '@dnb/eufemia/shared'`],__buildScope:{Anchor:a,IconPrimary:l,P:s},children:`
...
`})}),w=()=>(0,p.jsx)(m,{children:(0,p.jsx)(f,{hideCode:!0,scope:{Example:h},stableName:`AnchorTargetBlank`,sourceImports:[`import styled from '@emotion/styled'`,`import { Section, Anchor, IconPrimary, H2, P } from '@dnb/eufemia'`,`import { Theme } from '@dnb/eufemia/shared'`],__buildScope:{Anchor:a},children:`
...
`})}),T=()=>(0,p.jsx)(m,{children:(0,p.jsx)(f,{hideCode:!0,scope:{Example:h},"data-visual-test":`anchor-protocol`,stableName:`AnchorProtocol`,sourceImports:[`import styled from '@emotion/styled'`,`import { Section, Anchor, IconPrimary, H2, P } from '@dnb/eufemia'`,`import { Theme } from '@dnb/eufemia/shared'`],__buildScope:{Anchor:a},children:`
<Example>
...
`})}),E=()=>(0,p.jsx)(m,{children:(0,p.jsx)(f,{hideCode:!0,scope:{Example:h},stableName:`AnchorExampleHeadings`,sourceImports:[`import styled from '@emotion/styled'`,`import { Section, Anchor, IconPrimary, H2, P } from '@dnb/eufemia'`,`import { Theme } from '@dnb/eufemia/shared'`],__buildScope:{H2:n,Anchor:a},children:`
...
`})}),k=()=>(0,p.jsx)(m,{children:(0,p.jsx)(f,{hideCode:!0,scope:{Example:h},stableName:`AnchorNoIconAndNoLaunchIcon`,sourceImports:[`import styled from '@emotion/styled'`,`import { Section, Anchor, IconPrimary, H2, P } from '@dnb/eufemia'`,`import { Theme } from '@dnb/eufemia/shared'`],__buildScope:{Anchor:a},children:`
...
`})});function A(e){let t={code:`code`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,ul:`ul`,...c(),...e.components},{VisibilityByTheme:n,VisibleWhenVisualTest:r}=t;return n||M(`VisibilityByTheme`,!0),r||M(`VisibleWhenVisualTest`,!0),(0,p.jsxs)(p.Fragment,{children:[(0,p.jsx)(t.h2,{children:`Demos`}),`
...
`,(0,p.jsx)(_,{}),`
`,(0,p.jsxs)(r,{children:[(0,p.jsx)(y,{}),(0,p.jsx)(S,{}),(0,p.jsx)(O,{}),(0,p.jsx)(k,{}),(0,p.jsx)(x,{})]})]})}function j(e={}){let{wrapper:t}={...c(),...e.components};return t?(0,p.jsx)(t,{...e,children:(0,p.jsx)(A,{...e})}):A(e)}function M(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{j as default};