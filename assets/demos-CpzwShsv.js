import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{$ as r}from"./Anchor-ntifJ4U1.js";import{s as i}from"./ToggleButton-Bom-ZokA.js";import{j as a,l as o,v as s,w as c}from"./forms-QYD2kahG.js";import{u as l}from"./FormStatus-CJfQ1nLc.js";import{t as u}from"./P-CfFm60MO.js";import{t as d}from"./Card-DXi3If40.js";import{t as f}from"./TestElement-8Pci0d3B.js";import{U as p}from"./index-D1L5wabr.js";import{t as m}from"./ComponentBox-B6YSImfw.js";var h=e({BasedOnBooleanTrue:()=>b,BasedOnContext:()=>x,BooleanExample:()=>_,FilterData:()=>C,InferData:()=>y,InheritVisibility:()=>w,NestedExample:()=>S,PathValue:()=>v,VisibilityOnValidation:()=>T}),g=t(n()),_=()=>(0,g.jsx)(m,{scope:{TestElement:f},stableName:`BooleanExample`,sourceImports:[`import { useCallback } from 'react'`,`import { Flex, HeightAnimation, P } from '@dnb/eufemia'`,`import { Field, Form, TestElement, Tools, Value } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:c,Flex:i,Field:a},children:`<Form.Handler>
  <Flex.Stack>
    <Field.Boolean
      label="Show content"
      variant="buttons"
...
`}),v=()=>(0,g.jsx)(m,{stableName:`PathValue`,sourceImports:[`import { useCallback } from 'react'`,`import { Flex, HeightAnimation, P } from '@dnb/eufemia'`,`import { Field, Form, TestElement, Tools, Value } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:c,Field:a,P:u},children:`<Form.Handler>
  <Field.Toggle
    label="Show content"
    valueOn="checked"
    valueOff="unchecked"
...
`}),y=()=>(0,g.jsx)(m,{stableName:`InferData`,sourceImports:[`import { useCallback } from 'react'`,`import { Flex, HeightAnimation, P } from '@dnb/eufemia'`,`import { Field, Form, TestElement, Tools, Value } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:c,Flex:i,Field:a,P:u},noInline:!0,children:`const MyComponent = () => {
...
render(<MyComponent />)
`}),b=()=>(0,g.jsx)(m,{stableName:`BasedOnBooleanTrue`,sourceImports:[`import { useCallback } from 'react'`,`import { Flex, HeightAnimation, P } from '@dnb/eufemia'`,`import { Field, Form, TestElement, Tools, Value } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:c,P:u},children:`<Form.Visibility visible={true}>
  <P>This is visible</P>
</Form.Visibility>
`}),x=()=>(0,g.jsx)(m,{stableName:`BasedOnContext`,sourceImports:[`import { useCallback } from 'react'`,`import { Flex, HeightAnimation, P } from '@dnb/eufemia'`,`import { Field, Form, TestElement, Tools, Value } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:c,P:u},children:`<Form.Handler
  data={{
    toBe: true,
    notToBe: false,
  }}
...
`}),S=()=>(0,g.jsx)(m,{stableName:`NestedExample`,sourceImports:[`import { useCallback } from 'react'`,`import { Flex, HeightAnimation, P } from '@dnb/eufemia'`,`import { Field, Form, TestElement, Tools, Value } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:c,Flex:i,Field:a,Tools:o},noInline:!0,children:`const filterDataHandler = ({ props }) => !props['data-exclude-field']
const MyForm = () => {
  return (
    <Form.Handler
      defaultData={{
...
render(<MyForm />)
`}),C=()=>(0,g.jsx)(m,{stableName:`FilterData`,sourceImports:[`import { useCallback } from 'react'`,`import { Flex, HeightAnimation, P } from '@dnb/eufemia'`,`import { Field, Form, TestElement, Tools, Value } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:c,Flex:i,Field:a,Card:d,P:u,Value:s,Tools:o},noInline:!0,children:`const filterDataPaths = {
  '/isVisible': false,
...
render(<MyForm />)
`});function w(){return(0,g.jsx)(m,{stableName:`InheritVisibility`,sourceImports:[`import { useCallback } from 'react'`,`import { Flex, HeightAnimation, P } from '@dnb/eufemia'`,`import { Field, Form, TestElement, Tools, Value } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:c,Card:d,Field:a,Value:s,Provider:r,HeightAnimation:l},children:`<Form.Handler>
  <Form.Card>
    <Field.Boolean
      variant="button"
      path="/isVisible"
...
`})}function T(){return(0,g.jsx)(m,{stableName:`VisibilityOnValidation`,sourceImports:[`import { useCallback } from 'react'`,`import { Flex, HeightAnimation, P } from '@dnb/eufemia'`,`import { Field, Form, TestElement, Tools, Value } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:c,Card:d,Field:a,Value:s},children:`<Form.Handler>
  <Form.Card>
