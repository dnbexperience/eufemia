import{a as e,r as t}from"./rolldown-runtime-BYbx6iT9.js";import{t as n}from"./jsx-runtime-BgMs7Gb-.js";import{t as r}from"./Card-2G-TKpj3.js";import{f as i}from"./Upload-wCwPmFtt.js";import{t as a}from"./Form-PES0Uozy.js";import{t as o}from"./Field-DrUGn0oz.js";import{t as s}from"./Value-BOhdc4cL.js";import{t as c}from"./Iterate-OgeEKoj_.js";import{t as l}from"./Tools-p1RXalAh.js";import{Br as u,Pt as d,Rr as f,un as p}from"./index-BIrFyEEc.js";import{t as m}from"./ComponentBox-DFVIRw0w.js";import{s as h}from"./Examples-B7kvkkZk.js";import{T as g}from"./Examples-CqF5E29q.js";var _=t({BasicUsage:()=>y,CompactVariant:()=>b,CompactVariantHelpButton:()=>x,Customized:()=>T,Required:()=>S,SessionStorage:()=>j,Width:()=>P,WithAsyncFileHandler:()=>D,WithAsyncOnFileClick:()=>A,WithAsyncOnFileDelete:()=>k,WithFileItemOptions:()=>M,WithFileSizeValidation:()=>N,WithHelp:()=>C,WithHelpWithoutLabelDescription:()=>w,WithIterateArray:()=>I,WithOnValidationError:()=>F,WithPath:()=>E,WithSyncFileHandler:()=>O}),v=e(n()),y=()=>(0,v.jsx)(m,{stableName:`BasicUsage`,sourceImports:[`import { Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError, Iterate, Tools, Value } from '@dnb/eufemia/extensions/forms'`,`import { createMockFile } from '../../../../../../docs/uilib/components/upload/Examples'`,`import { UploadFile, UploadValue } from '@dnb/eufemia/extensions/forms/Field/Upload'`,`import { createRequest } from '../../Form/SubmitIndicator/Examples'`],__buildScope:{Form:a,Field:o,Upload:i},children:`<Form.Handler>
  <Field.Upload
...
`}),x=()=>(0,v.jsx)(m,{"data-visual-test":`upload-field-compact-help-button`,stableName:`CompactVariantHelpButton`,sourceImports:[`import { Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError, Iterate, Tools, Value } from '@dnb/eufemia/extensions/forms'`,`import { createMockFile } from '../../../../../../docs/uilib/components/upload/Examples'`,`import { UploadFile, UploadValue } from '@dnb/eufemia/extensions/forms/Field/Upload'`,`import { createRequest } from '../../Form/SubmitIndicator/Examples'`],__buildScope:{Form:a,Field:o,Upload:i,Anchor:u},children:`<Form.Handler>
  <Field.Upload
    help={{
      open: true,
...
`}),S=()=>(0,v.jsx)(m,{stableName:`Required`,sourceImports:[`import { Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError, Iterate, Tools, Value } from '@dnb/eufemia/extensions/forms'`,`import { createMockFile } from '../../../../../../docs/uilib/components/upload/Examples'`,`import { UploadFile, UploadValue } from '@dnb/eufemia/extensions/forms/Field/Upload'`,`import { createRequest } from '../../Form/SubmitIndicator/Examples'`],__buildScope:{Form:a,Flex:p,Field:o,Upload:i},children:`<Form.Handler onSubmit={(data) => console.log('onSubmit', data)}>
  <Flex.Stack>
    <Field.Upload path="/myFiles" required />
    <Form.SubmitButton />
  </Flex.Stack>
</Form.Handler>
`}),C=()=>(0,v.jsx)(m,{"data-visual-test":`upload-field-help-button`,stableName:`WithHelp`,sourceImports:[`import { Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError, Iterate, Tools, Value } from '@dnb/eufemia/extensions/forms'`,`import { createMockFile } from '../../../../../../docs/uilib/components/upload/Examples'`,`import { UploadFile, UploadValue } from '@dnb/eufemia/extensions/forms/Field/Upload'`,`import { createRequest } from '../../Form/SubmitIndicator/Examples'`],__buildScope:{Field:o,Upload:i},children:`<Field.Upload
  help={{
    open: true,
    title: 'Help title',
...
`}),D=()=>(0,v.jsx)(m,{scope:{createRequest:h},stableName:`WithAsyncFileHandler`,sourceImports:[`import { Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError, Iterate, Tools, Value } from '@dnb/eufemia/extensions/forms'`,`import { createMockFile } from '../../../../../../docs/uilib/components/upload/Examples'`,`import { UploadFile, UploadValue } from '@dnb/eufemia/extensions/forms/Field/Upload'`,`import { createRequest } from '../../Form/SubmitIndicator/Examples'`],__buildScope:{Form:a,Flex:p,Field:o,Upload:i,Tools:l},noInline:!0,children:`const MyForm = () => {
  return (
...
render(<MyForm />)
`}),k=()=>(0,v.jsx)(m,{scope:{createRequest:h},stableName:`WithAsyncOnFileDelete`,sourceImports:[`import { Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError, Iterate, Tools, Value } from '@dnb/eufemia/extensions/forms'`,`import { createMockFile } from '../../../../../../docs/uilib/components/upload/Examples'`,`import { UploadFile, UploadValue } from '@dnb/eufemia/extensions/forms/Field/Upload'`,`import { createRequest } from '../../Form/SubmitIndicator/Examples'`],__buildScope:{Field:o,Upload:i},noInline:!0,children:`async function mockAsyncFileRemoval({ fileItem }) {
  const request = createRequest()
...
`}),A=()=>(0,v.jsx)(m,{scope:{createRequest:h,createMockFile:g},stableName:`WithAsyncOnFileClick`,sourceImports:[`import { Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError, Iterate, Tools, Value } from '@dnb/eufemia/extensions/forms'`,`import { createMockFile } from '../../../../../../docs/uilib/components/upload/Examples'`,`import { UploadFile, UploadValue } from '@dnb/eufemia/extensions/forms/Field/Upload'`,`import { createRequest } from '../../Form/SubmitIndicator/Examples'`],__buildScope:{Form:a,Field:o,Upload:i},noInline:!0,children:`async function mockAsyncFileClick({ fileItem }) {
  const request = createRequest()
  console.log(
...
`});function j(){return(0,v.jsx)(m,{stableName:`SessionStorage`,sourceImports:[`import { Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError, Iterate, Tools, Value } from '@dnb/eufemia/extensions/forms'`,`import { createMockFile } from '../../../../../../docs/uilib/components/upload/Examples'`,`import { UploadFile, UploadValue } from '@dnb/eufemia/extensions/forms/Field/Upload'`,`import { createRequest } from '../../Form/SubmitIndicator/Examples'`],__buildScope:{Form:a,Flex:p,Card:r,Field:o,Upload:i,Value:s,Tools:l},children:`<Form.Handler sessionStorageId="documents">
  <Flex.Stack>
    <Form.Card>
...
`})}var M=()=>(0,v.jsx)(m,{scope:{createMockFile:g},stableName:`WithFileItemOptions`,sourceImports:[`import { Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError, Iterate, Tools, Value } from '@dnb/eufemia/extensions/forms'`,`import { createMockFile } from '../../../../../../docs/uilib/components/upload/Examples'`,`import { UploadFile, UploadValue } from '@dnb/eufemia/extensions/forms/Field/Upload'`,`import { createRequest } from '../../Form/SubmitIndicator/Examples'`],__buildScope:{Form:a,Field:o,Upload:i},noInline:!0,children:`const MyForm = () => {
  return (
    <Form.Handler
      data={{
        myFiles: [
...
render(<MyForm />)
`}),N=()=>(0,v.jsx)(m,{scope:{FormError:d},stableName:`WithFileSizeValidation`,sourceImports:[`import { Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError, Iterate, Tools, Value } from '@dnb/eufemia/extensions/forms'`,`import { createMockFile } from '../../../../../../docs/uilib/components/upload/Examples'`,`import { UploadFile, UploadValue } from '@dnb/eufemia/extensions/forms/Field/Upload'`,`import { createRequest } from '../../Form/SubmitIndicator/Examples'`],__buildScope:{Form:a,Field:o,Upload:i,Card:r},noInline:!0,children:`const MAX_SIZE = 500 * 1024 // 500 KB
...
`}),P=()=>(0,v.jsx)(m,{scope:{createMockFile:g},"data-visual-test":`upload-field-width`,stableName:`Width`,sourceImports:[`import { Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError, Iterate, Tools, Value } from '@dnb/eufemia/extensions/forms'`,`import { createMockFile } from '../../../../../../docs/uilib/components/upload/Examples'`,`import { UploadFile, UploadValue } from '@dnb/eufemia/extensions/forms/Field/Upload'`,`import { createRequest } from '../../Form/SubmitIndicator/Examples'`],__buildScope:{Form:a,Card:r,Field:o,Upload:i},children:`<Form.Handler
  data={{
    myFiles: [
      {
        file: createMockFile('fileName-1.png', 100, 'image/png'),
...
`}),F=()=>(0,v.jsx)(m,{scope:{createRequest:h},stableName:`WithOnValidationError`,sourceImports:[`import { Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError, Iterate, Tools, Value } from '@dnb/eufemia/extensions/forms'`,`import { createMockFile } from '../../../../../../docs/uilib/components/upload/Examples'`,`import { UploadFile, UploadValue } from '@dnb/eufemia/extensions/forms/Field/Upload'`,`import { createRequest } from '../../Form/SubmitIndicator/Examples'`],__buildScope:{Form:a,Flex:p,Field:o,Upload:i,Tools:l},noInline:!0,children:`function validationErrorHandler(invalidFiles: UploadValue): UploadValue {
...
`}),I=()=>(0,v.jsx)(m,{scope:{createRequest:h},stableName:`WithIterateArray`,sourceImports:[`import { Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError, Iterate, Tools, Value } from '@dnb/eufemia/extensions/forms'`,`import { createMockFile } from '../../../../../../docs/uilib/components/upload/Examples'`,`import { UploadFile, UploadValue } from '@dnb/eufemia/extensions/forms/Field/Upload'`,`import { createRequest } from '../../Form/SubmitIndicator/Examples'`],__buildScope:{Form:a,Iterate:c,Field:o,Upload:i,Tools:l},noInline:!0,children:`async function mockAsyncFileUpload(
  newFiles: UploadFile[]
): Promise<UploadFile[]> {
...
`,(0,v.jsx)(I,{}),`
`,(0,v.jsxs)(n,{children:[(0,v.jsx)(P,{}),(0,v.jsx)(w,{}),(0,v.jsx)(x,{})]})]})}function R(e={}){let{wrapper:t}={...f(),...e.components};return t?(0,v.jsx)(t,{...e,children:(0,v.jsx)(L,{...e})}):L(e)}function z(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{R as default};