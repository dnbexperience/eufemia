import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{s as r}from"./ToggleButton-Cp78oGqp.js";import{j as i,m as a,v as o,w as s}from"./forms-So8FhW-K.js";import{t as c}from"./P-DNdAYmtx.js";import{t as l}from"./Card-28qGdlRB.js";import{t as u}from"./Section-84TIytH1.js";import{U as d}from"./index-GbBmkyvI.js";import{t as f}from"./ComponentBox-Brk_-GCP.js";var p=e({BasicUsage:()=>h,UsageInWizard:()=>g}),m=t(n()),h=()=>(0,m.jsx)(f,{"data-visual-test":`forms-card`,stableName:`BasicUsage`,sourceImports:[`import { Flex, P } from '@dnb/eufemia'`,`import { Form, Field, Wizard, Value } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Flex:r,Form:s,Card:l,Field:i,P:c},children:`<Flex.Stack>
...
`}),g=()=>(0,m.jsx)(f,{"data-visual-test":`forms-card-in-wizard`,stableName:`UsageInWizard`,sourceImports:[`import { Flex, P } from '@dnb/eufemia'`,`import { Form, Field, Wizard, Value } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:s,Wizard:a,Card:l,Section:u,Value:o,Field:i},children:`<Form.Handler>
  <Wizard.Container>
    <Wizard.Step>
      <Form.Card>
        <Form.Section>
