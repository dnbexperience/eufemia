import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{Q as r,t as i}from"./Anchor-BPx9fjvj.js";import{Q as a,Z as o}from"./forms-D54jfDKN.js";import{t as s}from"./P-CVKBz4XO.js";import{t as c}from"./Link-DsLLxgOh.js";import{t as l}from"./ListExport-BvrqCQ3d.js";import{H as u,U as d}from"./index-BsJ3GLEw.js";import{t as f}from"./ComponentBox-sLMgHvLi.js";var p=e({Inline:()=>y,ListTypes:()=>x,ListVariants:()=>b,UsingListFormatFunction:()=>h,WithChildren:()=>_,WithCustomFormat:()=>v,WithValue:()=>g}),m=t(n()),h=()=>(0,m.jsx)(f,{"data-visual-test":`list-format-function`,scope:{listFormat:a},stableName:`UsingListFormatFunction`,sourceImports:[`import { Fragment } from 'react'`,`import { Provider } from '@dnb/eufemia/shared'`,`import { ListFormat, P, Badge, Anchor } from '@dnb/eufemia'`,`import { listFormat } from '@dnb/eufemia/components/list-format/ListFormat'`],__buildScope:{Anchor:i,Link:c,Badge:u},children:`{
  listFormat(
    [
...
`,(0,m.jsx)(h,{})]})}function C(e={}){let{wrapper:t}={...d(),...e.components};return t?(0,m.jsx)(t,{...e,children:(0,m.jsx)(S,{...e})}):S(e)}function w(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{C as default};