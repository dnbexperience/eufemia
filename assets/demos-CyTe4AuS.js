import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{o as r}from"./ToggleButton-Cp78oGqp.js";import{G as i}from"./forms-So8FhW-K.js";import{t as a}from"./FormLabel-MIyYR1Vm.js";import{U as o}from"./index-GbBmkyvI.js";import{t as s}from"./ComponentBox-Brk_-GCP.js";var c=e({Default:()=>u,Horizontal:()=>d,LinkedLabel:()=>p,NoForId:()=>f}),l=t(n()),u=()=>(0,l.jsx)(s,{"data-visual-test":`form-label-default`,stableName:`Default`,sourceImports:[`import { FormLabel, Checkbox, Switch } from '@dnb/eufemia'`],__buildScope:{FormLabel:a,Checkbox:r},children:`
<FormLabel forId="alone-1">Default vertical FormLabel</FormLabel>
<Checkbox id="alone-1" label="Checkbox" />

`}),d=()=>(0,l.jsx)(s,{"data-visual-test":`form-label-horizontal`,stableName:`Horizontal`,sourceImports:[`import { FormLabel, Checkbox, Switch } from '@dnb/eufemia'`],__buildScope:{FormLabel:a,Checkbox:r},children:`
<FormLabel forId="alone-2" vertical={false}>
  Horizontal FormLabel
</FormLabel>
<Checkbox id="alone-2" label="Checkbox" />

`}),f=()=>(0,l.jsx)(s,{stableName:`NoForId`,sourceImports:[`import { FormLabel, Checkbox, Switch } from '@dnb/eufemia'`],__buildScope:{FormLabel:a,Checkbox:r},children:`
<FormLabel element="span">Without forId (select me)</FormLabel>
<Checkbox label="Checkbox" />

`}),p=()=>(0,l.jsx)(s,{stableName:`LinkedLabel`,sourceImports:[`import { FormLabel, Checkbox, Switch } from '@dnb/eufemia'`],__buildScope:{FormLabel:a,Switch:i},children:`<form>
  <div>
    <div>
