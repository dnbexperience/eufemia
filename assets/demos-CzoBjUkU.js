import{a as e,r as t}from"./rolldown-runtime-BYbx6iT9.js";import{t as n}from"./jsx-runtime-BgMs7Gb-.js";import{n as r,t as i}from"./ComponentBox-a4aOn231.js";import{t as a}from"./ajv-Cz96LLhY.js";import{ct as o,zr as s}from"./index-DqqByKA2.js";var c=t({DataSetSchema:()=>d,DependentListSchema:()=>p,DependentSchemaValidation:()=>m,DependentSchemaValidationWithZod:()=>h,IfRuleSchema:()=>f,SingleFieldSchema:()=>u}),l=e(n()),u=()=>(0,l.jsx)(i,{scope:{makeAjvInstance:a},stableName:`SingleFieldSchema`,noInline:!0,children:`const ajv = makeAjvInstance()
const schema = {
  type: 'string',
  minLength: 5,
}
...
`}),d=()=>(0,l.jsx)(i,{scope:{makeAjvInstance:a},stableName:`DataSetSchema`,noInline:!0,children:`const ajv = makeAjvInstance()
const schema = {
  type: 'object',
  properties: {
    name: {
...
`}),f=()=>(0,l.jsx)(i,{scope:{makeAjvInstance:a},stableName:`IfRuleSchema`,noInline:!0,children:`const ajv = makeAjvInstance()
const schema = {
  type: 'object',
  properties: {
    name: {
...
`}),p=()=>(0,l.jsx)(i,{scope:{makeAjvInstance:a},stableName:`DependentListSchema`,noInline:!0,children:`const ajv = makeAjvInstance()
const schema = {
  type: 'object',
  definitions: {
    account: {
...
`}),m=()=>(0,l.jsx)(i,{scope:{makeAjvInstance:a,Tools:r},stableName:`DependentSchemaValidation`,noInline:!0,children:`const ajv = makeAjvInstance()
const counts = [1, 2, 3]
const schema = {
  type: 'object',
  properties: {
...
`}),h=()=>(0,l.jsx)(i,{scope:{Tools:r,z:o},stableName:`DependentSchemaValidationWithZod`,noInline:!0,children:`const counts = [1, 2, 3]
...
`});function g(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,ul:`ul`,...s(),...e.components};return c||v(`Examples`,!1),d||v(`Examples.DataSetSchema`,!0),p||v(`Examples.DependentListSchema`,!0),m||v(`Examples.DependentSchemaValidation`,!0),h||v(`Examples.DependentSchemaValidationWithZod`,!0),f||v(`Examples.IfRuleSchema`,!0),u||v(`Examples.SingleFieldSchema`,!0),(0,l.jsxs)(l.Fragment,{children:[(0,l.jsxs)(t.ul,{children:[`
`,(0,l.jsxs)(t.li,{children:[(0,l.jsx)(t.a,{href:`#demos`,children:`Demos`}),`
`,(0,l.jsxs)(t.ul,{children:[`
`,(0,l.jsx)(t.li,{children:(0,l.jsx)(t.a,{href:`#schema-for-single-field`,children:`Schema for single field`})}),`
`,(0,l.jsx)(t.li,{children:(0,l.jsx)(t.a,{href:`#schema-for-a-whole-data-set`,children:`Schema for a whole data set`})}),`
`,(0,l.jsx)(t.li,{children:(0,l.jsx)(t.a,{href:`#schema-with-if-rule`,children:`Schema with if-rule`})}),`
`,(0,l.jsx)(t.li,{children:(0,l.jsx)(t.a,{href:`#dependent-list-schema`,children:`Dependent list schema`})}),`
`,(0,l.jsx)(t.li,{children:(0,l.jsx)(t.a,{href:`#dependent-schema-across-sections`,children:`Dependent schema across sections`})}),`
`,(0,l.jsx)(t.li,{children:(0,l.jsx)(t.a,{href:`#dependent-schema-using-zod`,children:`Dependent schema using Zod`})}),`
`]}),`
`]}),`
`]}),`
`,(0,l.jsx)(t.h2,{children:`Demos`}),`
`,(0,l.jsx)(t.h3,{children:`Schema for single field`}),`
`,(0,l.jsx)(u,{}),`
`,(0,l.jsx)(t.h3,{children:`Schema for a whole data set`}),`
`,(0,l.jsx)(d,{}),`
`,(0,l.jsx)(t.h3,{children:`Schema with if-rule`}),`
`,(0,l.jsx)(f,{}),`
`,(0,l.jsx)(t.h3,{children:`Dependent list schema`}),`
`,(0,l.jsx)(t.p,{children:`Becoming a new customer, this form requires at least one normal account
to be added, unless the customer opens a BSU account, then normal
accounts can still be added, but is optional.`}),`
`,(0,l.jsx)(p,{}),`
`,(0,l.jsx)(t.h3,{children:`Dependent schema across sections`}),`
`,(0,l.jsx)(t.p,{children:`This schema validates fields across different sections based on the value of
another field.`}),`
`,(0,l.jsx)(m,{}),`
`,(0,l.jsx)(t.h3,{children:`Dependent schema using Zod`}),`
`,(0,l.jsxs)(t.p,{children:[`This schema is using `,(0,l.jsx)(t.code,{children:`Zod`}),` for validation, and validates fields across different sections based on the value of another field.`]}),`
`,(0,l.jsx)(h,{})]})}function _(e={}){let{wrapper:t}={...s(),...e.components};return t?(0,l.jsx)(t,{...e,children:(0,l.jsx)(g,{...e})}):g(e)}function v(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{_ as default};