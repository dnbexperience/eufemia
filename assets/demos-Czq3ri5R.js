...
`}),A=()=>(0,w.jsx)(S,{hidePreview:!0,hideToolbar:!0,stableName:`SkipContentInfo2`,sourceImports:[`import { SkipContent, Button, Table, Td, Tr, Th, Checkbox, Input, Section, H4, Dl, Dd, Dt, H2 } from '@dnb/eufemia'`],__buildScope:{SkipContent:T,Table:b},children:`<section aria-labelledby="table-id">
