import{a as e,r as t}from"./rolldown-runtime-BYbx6iT9.js";import{t as n}from"./jsx-runtime-BgMs7Gb-.js";import{t as r}from"./H4-BsPJGGSo.js";import{t as i}from"./DateFormat-CSFLI-4Z.js";import{In as a,Rr as o,kn as s,o as c,y as l}from"./index-BIrFyEEc.js";import{t as u}from"./ComponentBox-DFVIRw0w.js";var d=t({DateAndTime:()=>S,DateFormatInline:()=>_,DateStyles:()=>h,DurationFormatting:()=>b,DurationWithStyles:()=>x,HideCurrentYear:()=>g,RelativeTime:()=>v,RelativeTimeWithStyles:()=>y,SupportedFormats:()=>m}),f=e(n()),p=l.div`
  p > .dnb-date-format {
    display: block;
    width: fit-content;
  }
`,m=()=>(0,f.jsx)(p,{children:(0,f.jsx)(u,{stableName:`SupportedFormats`,sourceImports:[`import styled from '@emotion/styled'`,`import { DateFormat, H4, Hr, P } from '@dnb/eufemia'`],__buildScope:{P:a,DateFormat:i},children:`<P>
  <DateFormat>2025-08-01</DateFormat>
  <DateFormat>01.08.2025</DateFormat>
  <DateFormat>01/08/2025</DateFormat>
  <DateFormat value={new Date('2025-08-01')} />
</P>
`})}),h=()=>(0,f.jsx)(p,{children:(0,f.jsx)(u,{"data-visual-test":`date-format-date-styles`,stableName:`DateStyles`,sourceImports:[`import styled from '@emotion/styled'`,`import { DateFormat, H4, Hr, P } from '@dnb/eufemia'`],__buildScope:{P:a,DateFormat:i},children:`<P>
...
`})}),g=()=>(0,f.jsx)(p,{children:(0,f.jsx)(u,{stableName:`HideCurrentYear`,sourceImports:[`import styled from '@emotion/styled'`,`import { DateFormat, H4, Hr, P } from '@dnb/eufemia'`],__buildScope:{P:a,DateFormat:i,Hr:s},noInline:!0,children:`const currentYear = new Date().getFullYear()
...
`})}),_=()=>(0,f.jsx)(u,{"data-visual-test":`date-format-date-inline`,stableName:`DateFormatInline`,sourceImports:[`import styled from '@emotion/styled'`,`import { DateFormat, H4, Hr, P } from '@dnb/eufemia'`],__buildScope:{P:a,DateFormat:i},children:`<P>
  Payment due <DateFormat>2025-08-01</DateFormat>. Please make sure you
  have sufficient funds available.
</P>
`}),v=()=>(0,f.jsx)(p,{children:(0,f.jsx)(u,{stableName:`RelativeTime`,sourceImports:[`import styled from '@emotion/styled'`,`import { DateFormat, H4, Hr, P } from '@dnb/eufemia'`],__buildScope:{P:a,DateFormat:i},noInline:!0,children:`const referenceDate = new Date('2025-06-01T12:00:00')
render(
  <P>
    <DateFormat
...
`})}),b=()=>(0,f.jsx)(p,{children:(0,f.jsx)(u,{stableName:`DurationFormatting`,sourceImports:[`import styled from '@emotion/styled'`,`import { DateFormat, H4, Hr, P } from '@dnb/eufemia'`],__buildScope:{H4:r,P:a,DateFormat:i},children:`
...
`})}),x=()=>(0,f.jsx)(p,{children:(0,f.jsx)(u,{stableName:`DurationWithStyles`,sourceImports:[`import styled from '@emotion/styled'`,`import { DateFormat, H4, Hr, P } from '@dnb/eufemia'`],__buildScope:{H4:r,P:a,DateFormat:i},children:`
<H4>Short:</H4>
<P>
...
`})}),S=()=>(0,f.jsx)(u,{stableName:`DateAndTime`,sourceImports:[`import styled from '@emotion/styled'`,`import { DateFormat, H4, Hr, P } from '@dnb/eufemia'`],__buildScope:{P:a,DateFormat:i},children:`<P>
  Updated at{' '}
  <DateFormat
...
`,(0,f.jsx)(x,{})]})}function w(e={}){let{wrapper:t}={...o(),...e.components};return t?(0,f.jsx)(t,{...e,children:(0,f.jsx)(C,{...e})}):C(e)}function T(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{w as default};