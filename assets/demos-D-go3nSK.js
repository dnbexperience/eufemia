import{n as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{F as r,a as i,c as a,l as o,z as s}from"./SpacingUtils-DdCLj9fe.js";import{F as c,g as l,m as u}from"./Anchor-CUnuD5Cj.js";import{n as d,t as f}from"./withComponentMarkers-w3ZImJI6.js";import{t as p}from"./check-BJWc8kYn.js";import{i as m,n as h,r as g,t as _}from"./pin-B2XklJ1a.js";import{n as v}from"./FormStatus-BfZTTzoK.js";import{U as y}from"./index-CGxQ8PRe.js";import{t as b}from"./ComponentBox-DOwlXUSS.js";var x=t(e()),S=t(n()),C=p,w=c,T=_,E=(0,x.createContext)(null),D={skeleton:!1},O=e=>{let t=(0,x.useContext)(o),n=(0,x.useContext)(E),{icon:r,iconAlt:i,title:c,subtitle:l,infoMessage:u,state:f,skeleton:p,...m}=s(e,D,t?.TimelineItem,{skeleton:t?.skeleton},n);return(0,S.jsxs)(`li`,{className:a(`dnb-timeline__item`,d(`font`,p,t),`dnb-timeline__item--${f}`),"aria-current":f===`current`?`step`:void 0,...m,children:[(0,S.jsx)(k,{state:f,title:c,icon:r,iconAlt:i,skeleton:p,translations:t.translation.TimelineItem}),(0,S.jsx)(M,{subtitle:l,infoMessage:u})]})},k=({title:e,...t})=>(0,S.jsxs)(`span`,{className:`dnb-timeline__item__label`,children:[(0,S.jsx)(A,{...t}),(0,S.jsx)(j,{title:e})]}),A=({icon:e,state:t,iconAlt:n,skeleton:r,translations:i})=>{let{altLabelCompleted:a,altLabelCurrent:o,altLabelUpcoming:s}=i,c={completed:C,current:T,upcoming:w},d={completed:a,current:o,upcoming:s},f=e||c[t],p=n||d[t];return(0,S.jsxs)(`span`,{className:`dnb-timeline__item__label__icon`,children:[(0,S.jsx)(u,{pseudoElementOnly:!0}),!r&&f&&(0,S.jsx)(l,{icon:f,alt:p,size:t===`current`?void 0:`small`})]})},j=({title:e})=>(0,S.jsx)(`span`,{className:`dnb-timeline__item__label__title`,children:e}),M=({subtitle:e,infoMessage:t})=>(0,S.jsxs)(`div`,{className:`dnb-timeline__item__content`,children:[e?Array.isArray(e)?e.map((e,t)=>(0,S.jsx)(N,{subtitle:e},t)):(0,S.jsx)(N,{subtitle:e}):null,t&&(0,S.jsx)(v,{text:t,state:`information`,className:`dnb-timeline__item__content__info`,stretch:!0})]}),N=({subtitle:e})=>(0,S.jsx)(`div`,{className:`dnb-timeline__item__content__subtitle`,children:e}),P={skeleton:!1},F=e=>{let t=(0,x.useContext)(o),n=s(e,P,t?.Timeline,{skeleton:t?.skeleton}),{className:c,skeleton:l,data:u,children:d,...f}=n;r(n,f);let p=i(n,{...f,className:a(`dnb-timeline`,`dnb-space__reset`,c)});return(0,S.jsx)(E,{value:{skeleton:l},children:(0,S.jsxs)(`ol`,{...p,children:[u?.map((e,t)=>(0,S.jsx)(O,{skeleton:l,...e},t)),d]})})};F.Item=O,f(F,{_supportsSpacingProps:!0});var I=()=>(0,S.jsx)(b,{"data-visual-test":`timeline-single-completed`,hideCode:!0,stableName:`TimelineSingleCompleted`,sourceImports:[`import { card as Card, account_card as AccountCard, confetti as Confetti } from '@dnb/eufemia/icons'`,`import Timeline from '@dnb/eufemia/components/timeline/Timeline'`],__buildScope:{Timeline:F},children:`<Timeline
  data={[
    {
