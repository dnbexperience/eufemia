import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{a as r,t as i}from"./HelpButton-sV5p6bwJ.js";import{c as a}from"./ToggleButton-D3NEk3jO.js";import{t as o}from"./Card-C6UABezd.js";import{g as s}from"./Upload-_FypiXDK.js";import{t as c}from"./Form-C16rVaXm.js";import{t as l}from"./Field-B5trC2Cn.js";import{W as u,m as d}from"./index-BCXtuv-b.js";import{t as f}from"./ComponentBox-B2X8809Z.js";var p=e({Autoresize:()=>b,CharacterCounter:()=>v,Disabled:()=>S,FormStatus:()=>x,MaxLength:()=>T,Placeholder:()=>g,RowsCols:()=>h,Sizes:()=>w,Stretched:()=>y,Suffix:()=>C,Vertical:()=>_}),m=t(n()),h=()=>(0,m.jsx)(E,{children:(0,m.jsx)(f,{"data-visual-test":`textarea-default`,stableName:`RowsCols`,sourceImports:[`import styled from '@emotion/styled'`,`import { Textarea, HelpButton, Flex } from '@dnb/eufemia'`,`import { Field, Form } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Textarea:s},children:`<Textarea
  label="Default"
  rows="2"
  cols="20"
