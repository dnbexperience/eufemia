import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{t as r}from"./Anchor-9saPtqqX.js";import{c as i}from"./ToggleButton-BMi2PwcS.js";import{t as a}from"./Card-ClZNWqpG.js";import{pt as o}from"./Selection-ZMzbWBRf.js";import{f as s}from"./Upload-CRTXkC-C.js";import{t as c}from"./Form-C8lTzZqR.js";import{t as l}from"./Field-neGd0eKd.js";import{t as u}from"./Value-Cjs3mKU7.js";import{t as d}from"./Iterate-BRZybbeZ.js";import{t as f}from"./Tools-B6PN-yHu.js";import{K as p}from"./index-Bx3ttow-.js";import{t as m}from"./ComponentBox-CG7uqrFy.js";import{s as h}from"./Examples-EQB1Vv56.js";import{T as g}from"./Examples-XP5BDow0.js";var _=e({BasicUsage:()=>y,CompactVariant:()=>b,CompactVariantHelpButton:()=>x,Customized:()=>T,Required:()=>S,SessionStorage:()=>j,Width:()=>P,WithAsyncFileHandler:()=>D,WithAsyncOnFileClick:()=>A,WithAsyncOnFileDelete:()=>k,WithFileItemOptions:()=>M,WithFileSizeValidation:()=>N,WithHelp:()=>C,WithHelpWithoutLabelDescription:()=>w,WithIterateArray:()=>I,WithOnValidationError:()=>F,WithPath:()=>E,WithSyncFileHandler:()=>O}),v=t(n()),y=()=>(0,v.jsx)(m,{stableName:`BasicUsage`,sourceImports:[`import { Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError, Iterate, Tools, Value } from '@dnb/eufemia/extensions/forms'`,`import { createMockFile } from '../../../../../../docs/uilib/components/upload/Examples'`,`import { UploadFile, UploadValue } from '@dnb/eufemia/extensions/forms/Field/Upload'`,`import { createRequest } from '../../Form/SubmitIndicator/Examples'`],__buildScope:{Form:c,Field:l,Upload:s},children:`<Form.Handler>
  <Field.Upload
...
`}),x=()=>(0,v.jsx)(m,{"data-visual-test":`upload-field-compact-help-button`,stableName:`CompactVariantHelpButton`,sourceImports:[`import { Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError, Iterate, Tools, Value } from '@dnb/eufemia/extensions/forms'`,`import { createMockFile } from '../../../../../../docs/uilib/components/upload/Examples'`,`import { UploadFile, UploadValue } from '@dnb/eufemia/extensions/forms/Field/Upload'`,`import { createRequest } from '../../Form/SubmitIndicator/Examples'`],__buildScope:{Form:c,Field:l,Upload:s,Anchor:r},children:`<Form.Handler>
  <Field.Upload
    help={{
      open: true,
...
`}),S=()=>(0,v.jsx)(m,{stableName:`Required`,sourceImports:[`import { Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError, Iterate, Tools, Value } from '@dnb/eufemia/extensions/forms'`,`import { createMockFile } from '../../../../../../docs/uilib/components/upload/Examples'`,`import { UploadFile, UploadValue } from '@dnb/eufemia/extensions/forms/Field/Upload'`,`import { createRequest } from '../../Form/SubmitIndicator/Examples'`],__buildScope:{Form:c,Flex:i,Field:l,Upload:s},children:`<Form.Handler onSubmit={(data) => console.log('onSubmit', data)}>
  <Flex.Stack>
    <Field.Upload path="/myFiles" required />
    <Form.SubmitButton />
  </Flex.Stack>
</Form.Handler>
`}),C=()=>(0,v.jsx)(m,{"data-visual-test":`upload-field-help-button`,stableName:`WithHelp`,sourceImports:[`import { Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError, Iterate, Tools, Value } from '@dnb/eufemia/extensions/forms'`,`import { createMockFile } from '../../../../../../docs/uilib/components/upload/Examples'`,`import { UploadFile, UploadValue } from '@dnb/eufemia/extensions/forms/Field/Upload'`,`import { createRequest } from '../../Form/SubmitIndicator/Examples'`],__buildScope:{Field:l,Upload:s},children:`<Field.Upload
  help={{
    open: true,
    title: 'Help title',
...
render(<MyForm />)
`}),k=()=>(0,v.jsx)(m,{scope:{createRequest:h},stableName:`WithAsyncOnFileDelete`,sourceImports:[`import { Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError, Iterate, Tools, Value } from '@dnb/eufemia/extensions/forms'`,`import { createMockFile } from '../../../../../../docs/uilib/components/upload/Examples'`,`import { UploadFile, UploadValue } from '@dnb/eufemia/extensions/forms/Field/Upload'`,`import { createRequest } from '../../Form/SubmitIndicator/Examples'`],__buildScope:{Field:l,Upload:s},noInline:!0,children:`async function mockAsyncFileRemoval({ fileItem }) {
  const request = createRequest()
...
`}),A=()=>(0,v.jsx)(m,{scope:{createRequest:h,createMockFile:g},stableName:`WithAsyncOnFileClick`,sourceImports:[`import { Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError, Iterate, Tools, Value } from '@dnb/eufemia/extensions/forms'`,`import { createMockFile } from '../../../../../../docs/uilib/components/upload/Examples'`,`import { UploadFile, UploadValue } from '@dnb/eufemia/extensions/forms/Field/Upload'`,`import { createRequest } from '../../Form/SubmitIndicator/Examples'`],__buildScope:{Form:c,Field:l,Upload:s},noInline:!0,children:`async function mockAsyncFileClick({ fileItem }) {
  const request = createRequest()
  console.log(
...
`});function j(){return(0,v.jsx)(m,{stableName:`SessionStorage`,sourceImports:[`import { Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError, Iterate, Tools, Value } from '@dnb/eufemia/extensions/forms'`,`import { createMockFile } from '../../../../../../docs/uilib/components/upload/Examples'`,`import { UploadFile, UploadValue } from '@dnb/eufemia/extensions/forms/Field/Upload'`,`import { createRequest } from '../../Form/SubmitIndicator/Examples'`],__buildScope:{Form:c,Flex:i,Card:a,Field:l,Upload:s,Value:u,Tools:f},children:`<Form.Handler sessionStorageId="documents">
  <Flex.Stack>
    <Form.Card>
...
`})}var M=()=>(0,v.jsx)(m,{scope:{createMockFile:g},stableName:`WithFileItemOptions`,sourceImports:[`import { Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError, Iterate, Tools, Value } from '@dnb/eufemia/extensions/forms'`,`import { createMockFile } from '../../../../../../docs/uilib/components/upload/Examples'`,`import { UploadFile, UploadValue } from '@dnb/eufemia/extensions/forms/Field/Upload'`,`import { createRequest } from '../../Form/SubmitIndicator/Examples'`],__buildScope:{Form:c,Field:l,Upload:s},noInline:!0,children:`const MyForm = () => {
  return (
    <Form.Handler
      data={{
        myFiles: [
...
render(<MyForm />)
`}),N=()=>(0,v.jsx)(m,{scope:{FormError:o},stableName:`WithFileSizeValidation`,sourceImports:[`import { Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError, Iterate, Tools, Value } from '@dnb/eufemia/extensions/forms'`,`import { createMockFile } from '../../../../../../docs/uilib/components/upload/Examples'`,`import { UploadFile, UploadValue } from '@dnb/eufemia/extensions/forms/Field/Upload'`,`import { createRequest } from '../../Form/SubmitIndicator/Examples'`],__buildScope:{Form:c,Field:l,Upload:s,Card:a},noInline:!0,children:`const MAX_SIZE = 500 * 1024 // 500 KB
...
`}),P=()=>(0,v.jsx)(m,{scope:{createMockFile:g},"data-visual-test":`upload-field-width`,stableName:`Width`,sourceImports:[`import { Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError, Iterate, Tools, Value } from '@dnb/eufemia/extensions/forms'`,`import { createMockFile } from '../../../../../../docs/uilib/components/upload/Examples'`,`import { UploadFile, UploadValue } from '@dnb/eufemia/extensions/forms/Field/Upload'`,`import { createRequest } from '../../Form/SubmitIndicator/Examples'`],__buildScope:{Form:c,Card:a,Field:l,Upload:s},children:`<Form.Handler
  data={{
    myFiles: [
      {
        file: createMockFile('fileName-1.png', 100, 'image/png'),
...
`}),F=()=>(0,v.jsx)(m,{scope:{createRequest:h},stableName:`WithOnValidationError`,sourceImports:[`import { Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError, Iterate, Tools, Value } from '@dnb/eufemia/extensions/forms'`,`import { createMockFile } from '../../../../../../docs/uilib/components/upload/Examples'`,`import { UploadFile, UploadValue } from '@dnb/eufemia/extensions/forms/Field/Upload'`,`import { createRequest } from '../../Form/SubmitIndicator/Examples'`],__buildScope:{Form:c,Flex:i,Field:l,Upload:s,Tools:f},noInline:!0,children:`function validationErrorHandler(invalidFiles: UploadValue): UploadValue {
...
`}),I=()=>(0,v.jsx)(m,{scope:{createRequest:h},stableName:`WithIterateArray`,sourceImports:[`import { Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError, Iterate, Tools, Value } from '@dnb/eufemia/extensions/forms'`,`import { createMockFile } from '../../../../../../docs/uilib/components/upload/Examples'`,`import { UploadFile, UploadValue } from '@dnb/eufemia/extensions/forms/Field/Upload'`,`import { createRequest } from '../../Form/SubmitIndicator/Examples'`],__buildScope:{Form:c,Iterate:d,Field:l,Upload:s,Tools:f},noInline:!0,children:`async function mockAsyncFileUpload(
  newFiles: UploadFile[]
): Promise<UploadFile[]> {
