import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{s as r}from"./ToggleButton-DfKpi57X.js";import{g as i,j as a,l as o,ut as s,w as c}from"./forms-D54jfDKN.js";import{t as l}from"./Card-BvVSLAbs.js";import{t as u}from"./Section-_oyssAWe.js";import{t as d}from"./ajv-C39zvwvV.js";import{U as f}from"./index-BsJ3GLEw.js";import{t as p}from"./ComponentBox-sLMgHvLi.js";var m=e({DataSetSchema:()=>_,DependentListSchema:()=>y,DependentSchemaValidation:()=>b,DependentSchemaValidationWithZod:()=>x,IfRuleSchema:()=>v,SingleFieldSchema:()=>g}),h=t(n()),g=()=>(0,h.jsx)(p,{scope:{makeAjvInstance:d},stableName:`SingleFieldSchema`,sourceImports:[`import { Flex, Section } from '@dnb/eufemia'`,`import { z, Form, Field, Iterate, Tools, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:c,Field:a},noInline:!0,children:`const ajv = makeAjvInstance()
const schema = {
  type: 'string',
  minLength: 5,
}
...
`}),_=()=>(0,h.jsx)(p,{scope:{makeAjvInstance:d},stableName:`DataSetSchema`,sourceImports:[`import { Flex, Section } from '@dnb/eufemia'`,`import { z, Form, Field, Iterate, Tools, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:c,Card:l,Field:a},noInline:!0,children:`const ajv = makeAjvInstance()
const schema = {
  type: 'object',
  properties: {
    name: {
...
`}),v=()=>(0,h.jsx)(p,{scope:{makeAjvInstance:d},stableName:`IfRuleSchema`,sourceImports:[`import { Flex, Section } from '@dnb/eufemia'`,`import { z, Form, Field, Iterate, Tools, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:c,Card:l,Field:a},noInline:!0,children:`const ajv = makeAjvInstance()
const schema = {
  type: 'object',
  properties: {
    name: {
...
`}),y=()=>(0,h.jsx)(p,{scope:{makeAjvInstance:d},stableName:`DependentListSchema`,sourceImports:[`import { Flex, Section } from '@dnb/eufemia'`,`import { z, Form, Field, Iterate, Tools, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:c,Flex:r,Card:l,Field:a,Iterate:i},noInline:!0,children:`const ajv = makeAjvInstance()
const schema = {
  type: 'object',
  definitions: {
    account: {
...
`}),b=()=>(0,h.jsx)(p,{scope:{makeAjvInstance:d,Tools:o},stableName:`DependentSchemaValidation`,sourceImports:[`import { Flex, Section } from '@dnb/eufemia'`,`import { z, Form, Field, Iterate, Tools, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:c,Flex:r,Card:l,Field:a,Iterate:i,Section:u,Tools:o},noInline:!0,children:`const ajv = makeAjvInstance()
const counts = [1, 2, 3]
const schema = {
  type: 'object',
  properties: {
...
`}),x=()=>(0,h.jsx)(p,{scope:{Tools:o,z:s},stableName:`DependentSchemaValidationWithZod`,sourceImports:[`import { Flex, Section } from '@dnb/eufemia'`,`import { z, Form, Field, Iterate, Tools, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:c,Flex:r,Card:l,Field:a,Iterate:i,Section:u,Tools:o},noInline:!0,children:`const counts = [1, 2, 3]
