import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{s as r}from"./ToggleButton-EPOyxk36.js";import{dt as i,g as a,j as o,l as s,w as c}from"./forms-D__hPZDv.js";import{t as l}from"./Card-DZd-xLSg.js";import{t as u}from"./Section-Ba8Ez2kR.js";import{t as d}from"./ajv-BfmpA-JI.js";import{U as f}from"./index-CGxQ8PRe.js";import{t as p}from"./ComponentBox-DOwlXUSS.js";var m=e({DataSetSchema:()=>_,DependentListSchema:()=>y,DependentSchemaValidation:()=>b,DependentSchemaValidationWithZod:()=>x,IfRuleSchema:()=>v,SingleFieldSchema:()=>g}),h=t(n()),g=()=>(0,h.jsx)(p,{scope:{makeAjvInstance:d},stableName:`SingleFieldSchema`,sourceImports:[`import { Flex, Section } from '@dnb/eufemia'`,`import { z, Form, Field, Iterate, Tools, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:c,Field:o},noInline:!0,children:`const ajv = makeAjvInstance()
const schema = {
  type: 'string',
  minLength: 5,
}
