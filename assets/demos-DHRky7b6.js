import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{$ as n,tt as r}from"./Anchor-BqZ7Pm7_.js";import{r as i}from"./P-CahmqB7x.js";import{t as a}from"./P-D0SeNBSG.js";import{t as o}from"./Link-BWr1lrzo.js";import{t as s}from"./Section-BV74bciL.js";import{c}from"./ToggleButton-T4E3Coih.js";import{K as l,M as u,m as d,q as f}from"./index-CsG353ar.js";import{t as p}from"./ComponentBox-Cb1rLw_D.js";var m=e(t()),h=d.span`
  display: block;
  padding: 0.25rem 0;
...
`})}function T(){return(0,m.jsx)(p,{hideCode:!0,scope:{Typography:i},stableName:`ParagraphProseMaxWidthProvider`,sourceImports:[`import styled from '@emotion/styled'`,`import Anchor from '@dnb/eufemia/components/Anchor'`,`import P from '@dnb/eufemia/elements/P'`,`import Typography from '@dnb/eufemia/elements/typography/Typography'`,`import { Flex, Section } from '@dnb/eufemia'`],__buildScope:{Flex:c,Provider:n,P:a},children:`<Flex.Stack>
...
`})}function k(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,h4:`h4`,h5:`h5`,li:`li`,p:`p`,ul:`ul`,...l(),...e.components},{VisibleWhenVisualTest:n}=t;return n||j(`VisibleWhenVisualTest`,!0),(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(t.h2,{children:`Demos`}),`
...
`,(0,m.jsx)(O,{}),`
`,(0,m.jsx)(n,{children:(0,m.jsx)(D,{})})]})}function A(e={}){let{wrapper:t}={...l(),...e.components};return t?(0,m.jsx)(t,{...e,children:(0,m.jsx)(k,{...e})}):k(e)}function j(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{A as default};