import{n as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{c as r,s as i}from"./SpacingUtils-C2Ry62fw.js";import{$ as a}from"./Anchor-ntifJ4U1.js";import{n as o,r as s,t as c}from"./withComponentMarkers-COR4bBOT.js";import{t as l}from"./Element-49LTt7Eb.js";import{t as u}from"./ToggleButton-Bom-ZokA.js";import{t as d}from"./Space-DVeGblOo.js";import{t as f}from"./Button-U6duHosb.js";import{F as p}from"./Autocomplete-Ufk0jtry.js";import{t as m}from"./P-CfFm60MO.js";import{t as h}from"./H2-DrmJA_qJ.js";import{t as g}from"./Paragraph-MUS4iWjP.js";import{t as _}from"./Heading-3hHaA9oD.js";import{L as v,U as y,m as b}from"./index-D1L5wabr.js";import{t as x}from"./ComponentBox-B6YSImfw.js";import{n as S,t as C}from"./Examples-DNLMMEqC.js";var w=t(n());function T({ref:e,...t}){return(0,w.jsx)(l,{as:`div`,skeletonMethod:`shape`,ref:e,...t})}c(T,{_supportsSpacingProps:!0});var E=T,D=t(e());function O({rows:e=3,children:t=null,...n}){let r=(0,D.useMemo)(()=>{let t=[70,80,60,40,50,20,0];return Array.from({length:Number(e)},(e,n)=>{let r=n%t.length;return r===t.length-1&&t.reverse(),t[r]})},[e]);return(0,w.jsxs)(`div`,{className:i(`dnb-skeleton__figure`,`dnb-skeleton__figure--show`),"aria-busy":!0,...n,children:[(0,w.jsx)(d,{element:`div`,bottom:`large`,className:i(`dnb-h--xx-large`,`dnb-skeleton`,`dnb-skeleton--shape`),"aria-hidden":!0,style:{width:`50%`},children:`‌`}),r.map((e,t)=>(0,w.jsx)(d,{element:`div`,top:`x-small`,className:i(`dnb-p`,`dnb-skeleton`,`dnb-skeleton--shape`),style:{width:`${e}%`},children:`‌`},t)),typeof t==`function`?t():t]})}var k=()=>(0,w.jsx)(x,{stableName:`SkeletonInputExample`,sourceImports:[`import { Suspense, useContext, useState } from 'react'`,`import Context from '@dnb/eufemia/shared/Context'`,`import { Input, H2, P, Button, Skeleton, ToggleButton, Div } from '@dnb/eufemia'`,`import { AllComponentsHorizontalTestCase, AllComponentsVerticalLabelsTestCase } from '../../layout/Examples'`,`import Provider from '@dnb/eufemia/shared/Provider'`,`import { Article } from '@dnb/eufemia/components/skeleton/figures'`,`import { createSkeletonClass, skeletonDOMAttributes } from '@dnb/eufemia/components/skeleton/SkeletonHelper'`],__buildScope:{Input:p},children:`<Input label="Input" skeleton />
...
`}),P=()=>(0,w.jsxs)(w.Fragment,{children:[(0,w.jsx)(v,{show:!0,noAnimation:!0,children:(0,w.jsx)(C,{"data-visual-test":`skeleton-all-horizontal`})}),(0,w.jsx)(v,{show:!0,noAnimation:!0,children:(0,w.jsx)(S,{"data-visual-test":`skeleton-all-vertical`})})]}),F=()=>(0,w.jsx)(x,{hidePreview:!0,stableName:`SkeletonInfoProvider`,sourceImports:[`import { Suspense, useContext, useState } from 'react'`,`import Context from '@dnb/eufemia/shared/Context'`,`import { Input, H2, P, Button, Skeleton, ToggleButton, Div } from '@dnb/eufemia'`,`import { AllComponentsHorizontalTestCase, AllComponentsVerticalLabelsTestCase } from '../../layout/Examples'`,`import Provider from '@dnb/eufemia/shared/Provider'`,`import { Article } from '@dnb/eufemia/components/skeleton/figures'`,`import { createSkeletonClass, skeletonDOMAttributes } from '@dnb/eufemia/components/skeleton/SkeletonHelper'`],__buildScope:{Div:E,Skeleton:v,Input:p},children:`<Div id="your-app">
  <Skeleton show={true}>
