import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{j as r,w as i}from"./forms-CsJzlVUF.js";import{t as a}from"./Card-DP9KYSzC.js";import{t as o}from"./Currency-CrzMMiUd.js";import{B as s}from"./index-DdG6L_K8.js";import{t as c}from"./ComponentBox-q_23Ylzi.js";var l=e({Basic:()=>d,Disabled:()=>b,VariantInline:()=>C,WithConfirmCancel:()=>h,WithDataPath:()=>y,WithDisabledItems:()=>v,WithError:()=>x,WithManySelectedItems:()=>S,WithNestedItems:()=>_,WithSearch:()=>m,WithSelectAll:()=>f,WithSelectedItems:()=>g}),u=t(n()),d=()=>(0,u.jsx)(c,{"data-visual-test":`multi-selection-basic`,stableName:`Basic`,sourceImports:[`import { Form, Field } from '@dnb/eufemia/extensions/forms'`,`import { NumberFormat } from '@dnb/eufemia'`],__buildScope:{Field:r},noInline:!0,children:`const cities = [
  {
    value: 'oslo',
    title: 'Oslo',
...
`}),f=()=>(0,u.jsx)(c,{stableName:`WithSelectAll`,sourceImports:[`import { Form, Field } from '@dnb/eufemia/extensions/forms'`,`import { NumberFormat } from '@dnb/eufemia'`],__buildScope:{Field:r},noInline:!0,children:`const cities = [
  {
    value: 'oslo',
    title: 'Oslo',
...
`}),h=()=>(0,u.jsx)(c,{stableName:`WithConfirmCancel`,sourceImports:[`import { Form, Field } from '@dnb/eufemia/extensions/forms'`,`import { NumberFormat } from '@dnb/eufemia'`],__buildScope:{Field:r},noInline:!0,children:`const cities = [
  {
    value: 'oslo',
    title: 'Oslo',
    text: 'Capital of Norway',
...
`}),g=()=>(0,u.jsx)(c,{stableName:`WithSelectedItems`,sourceImports:[`import { Form, Field } from '@dnb/eufemia/extensions/forms'`,`import { NumberFormat } from '@dnb/eufemia'`],__buildScope:{Field:r},noInline:!0,children:`const cities = [
  {
    value: 'oslo',
    title: 'Oslo',
    text: 'Capital of Norway',
...
`}),_=()=>(0,u.jsx)(c,{stableName:`WithNestedItems`,sourceImports:[`import { Form, Field } from '@dnb/eufemia/extensions/forms'`,`import { NumberFormat } from '@dnb/eufemia'`],__buildScope:{Field:r},children:`<Field.MultiSelection
...
/>
`}),v=()=>(0,u.jsx)(c,{stableName:`WithDisabledItems`,sourceImports:[`import { Form, Field } from '@dnb/eufemia/extensions/forms'`,`import { NumberFormat } from '@dnb/eufemia'`],__buildScope:{Field:r},children:`<Field.MultiSelection
...
/>
`}),y=()=>(0,u.jsx)(c,{stableName:`WithDataPath`,sourceImports:[`import { Form, Field } from '@dnb/eufemia/extensions/forms'`,`import { NumberFormat } from '@dnb/eufemia'`],__buildScope:{Form:i,Field:r},children:`<Form.Handler
  data={{
    colors: [
      {
        value: 'red',
...
`}),b=()=>(0,u.jsx)(c,{stableName:`Disabled`,sourceImports:[`import { Form, Field } from '@dnb/eufemia/extensions/forms'`,`import { NumberFormat } from '@dnb/eufemia'`],__buildScope:{Field:r},noInline:!0,children:`const cities = [
  {
    value: 'oslo',
    title: 'Oslo',
    text: 'Capital of Norway',
...
`}),x=()=>(0,u.jsx)(c,{stableName:`WithError`,sourceImports:[`import { Form, Field } from '@dnb/eufemia/extensions/forms'`,`import { NumberFormat } from '@dnb/eufemia'`],__buildScope:{Form:i,Card:a,Field:r},noInline:!0,children:`const cities = [
  {
    value: 'oslo',
    title: 'Oslo',
    text: 'Capital of Norway',
...
`}),S=()=>(0,u.jsx)(c,{stableName:`WithManySelectedItems`,sourceImports:[`import { Form, Field } from '@dnb/eufemia/extensions/forms'`,`import { NumberFormat } from '@dnb/eufemia'`],__buildScope:{Field:r},noInline:!0,children:`const items = Array.from(
  {
    length: 30,
  },
  (_, i) => ({
...
`}),C=()=>(0,u.jsx)(c,{"data-visual-test":`multi-selection-variant-inline`,stableName:`VariantInline`,sourceImports:[`import { Form, Field } from '@dnb/eufemia/extensions/forms'`,`import { NumberFormat } from '@dnb/eufemia'`],__buildScope:{Field:r},noInline:!0,children:`const cities = [
  {
    value: 'oslo',
    title: 'Oslo',
  },
