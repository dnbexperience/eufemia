import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{t as n}from"./P-BqMs-VnB.js";import{c as r}from"./ToggleButton-BMi2PwcS.js";import{t as i}from"./Card-ClZNWqpG.js";import{C as a,D as o,E as s,K as c,O as l,T as u,g as d,k as f,w as p}from"./index-Bx3ttow-.js";import{t as m}from"./ComponentBox-CG7uqrFy.js";var h=e(t());function g(e){switch(e?.name){case`sbanken`:return l;case`carnegie`:return p;case`eiendom`:return s;default:return u}}var _=()=>(0,h.jsx)(m,{scope:{DnbDefault:u,SbankenCompact:o,SbankenDefault:l,SbankenHorizontal:f,CarnegieDefault:p,EiendomDefault:s},"data-visual-test":`logo-all`,stableName:`LogoAllExample`,sourceImports:[`import { Card, Logo, Flex, P } from '@dnb/eufemia'`,`import { DnbDefault, SbankenCompact, SbankenDefault, SbankenHorizontal, CarnegieDefault, EiendomDefault } from '@dnb/eufemia/components/Logo'`,`import MyThemeSelector from '../../../../core/ChangeStyleTheme'`,`import { ThemeProps } from '@dnb/eufemia/shared/Theme'`],__buildScope:{Flex:r,Logo:a},children:`<Flex.Vertical>
