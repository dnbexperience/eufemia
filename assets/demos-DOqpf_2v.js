import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{Q as r}from"./Anchor-CDwNjfi4.js";import{c as i}from"./ToggleButton-DoxBGtHF.js";import{j as a,l as o,v as s,w as c}from"./forms-CsJzlVUF.js";import{u as l}from"./FormStatus-Doht5UQ9.js";import{t as u}from"./P-CbimSwQH.js";import{t as d}from"./Card-DP9KYSzC.js";import{t as f}from"./TestElement-D-t3kpSj.js";import{B as p}from"./index-DdG6L_K8.js";import{t as m}from"./ComponentBox-q_23Ylzi.js";var h=e({BasedOnBooleanTrue:()=>b,BasedOnContext:()=>x,BooleanExample:()=>_,FilterData:()=>C,InferData:()=>y,InheritVisibility:()=>w,NestedExample:()=>S,PathValue:()=>v,VisibilityOnValidation:()=>T}),g=t(n()),_=()=>(0,g.jsx)(m,{scope:{TestElement:f},stableName:`BooleanExample`,sourceImports:[`import { useCallback } from 'react'`,`import { Flex, HeightAnimation, P } from '@dnb/eufemia'`,`import { Field, Form, TestElement, Tools, Value } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:c,Flex:i,Field:a},children:`<Form.Handler>
  <Flex.Stack>
    <Field.Boolean
      label="Show content"
      variant="buttons"
