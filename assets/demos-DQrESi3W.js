import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{it as r,j as i,v as a,w as o}from"./forms-CsJzlVUF.js";import{B as s}from"./index-DdG6L_K8.js";import{t as c}from"./ComponentBox-q_23Ylzi.js";var l=e({IteratePath:()=>f,Path:()=>d}),u=t(n()),d=()=>(0,u.jsx)(c,{scope:{DataContext:r},stableName:`Path`,sourceImports:[`import { Form, Field, Value, DataContext } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:o,DataContext:r,Field:i},children:`<Form.Handler
  data={{
    foo: {
      one: 1,
      two: 2,
...
`}),f=()=>(0,u.jsx)(c,{scope:{DataContext:r},stableName:`IteratePath`,sourceImports:[`import { Form, Field, Value, DataContext } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:o,DataContext:r,Value:a,Field:i},children:`<Form.Handler
  data={{
    list: [
      {
        title: 'Object 1',
