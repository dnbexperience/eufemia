import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{et as r,t as i}from"./Anchor-oyitbGgC.js";import{s as a}from"./ToggleButton-DFl1k6dD.js";import{t as o}from"./fish_medium-CF1gHfUZ.js";import{j as s,v as c,w as ee}from"./forms-DuwGqcp3.js";import{t as l}from"./Accordion-CpgAv5mW.js";import{t as u}from"./Button-DLh19lOb.js";import{f as d}from"./Autocomplete-BkdRYvuo.js";import{t as f}from"./Span-D0Ykr8nF.js";import{t as p}from"./Avatar-CakRQhhD.js";import{t as m}from"./P-CVJzad03.js";import{u as h}from"./Table-L2SFy5VR.js";import{t as g}from"./Card-DLQPvlXB.js";import{t as _}from"./Link-CjLXEB-S.js";import{t as v}from"./DateFormat-BeEZ-TkZ.js";import{t as y}from"./ListExport-DPwcEB8n.js";import{t as b}from"./Heading-M5ntQRjT.js";import{t as x}from"./export-CZ5HKYX8.js";import{t as S}from"./NumberFormatExport-bkzn-eJi.js";import{H as C,U as w}from"./index-Ct8Ggqh9.js";import{t as T}from"./ComponentBox-41YKKsr3.js";var E=e({Accordion:()=>U,BackgroundColor:()=>L,DisabledState:()=>B,FooterWithButtons:()=>A,GridColumns:()=>J,InsideCard:()=>Y,InsideCardWithoutScrollView:()=>X,ListSubline:()=>G,NavigableItem:()=>j,NavigableItemWithCustomElement:()=>N,NavigableItemWithHref:()=>M,PendingState:()=>z,ProgressIndicatorRow:()=>V,RowsWithSlots:()=>k,SelectedState:()=>I,SeparatedLists:()=>H,SimpleRows:()=>O,SkeletonState:()=>R,WithAnchor:()=>P,WithAvatar:()=>F,WithBadge:()=>K,WithDateFormat:()=>W,WithFormElements:()=>q,WithShowMoreButton:()=>Z}),D=t(n()),O=()=>(0,D.jsx)(T,{stableName:`SimpleRows`,sourceImports:[`import { Anchor, Avatar, Badge, Button, Code, DateFormat, Flex, Grid, Heading, List, NumberFormat, P, ProgressIndicator, Span } from '@dnb/eufemia'`,`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`,`import { fish_medium } from '@dnb/eufemia/icons'`],__buildScope:{List:y,Value:c},noInline:!0,children:`const myList = [
  {
    name: 'List item 1',
    amount: 10000,
  },
...
`}),k=()=>(0,D.jsx)(T,{"data-visual-test":`list-slots`,scope:{fish_medium:o},stableName:`RowsWithSlots`,sourceImports:[`import { Anchor, Avatar, Badge, Button, Code, DateFormat, Flex, Grid, Heading, List, NumberFormat, P, ProgressIndicator, Span } from '@dnb/eufemia'`,`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`,`import { fish_medium } from '@dnb/eufemia/icons'`],__buildScope:{List:y,P:m},children:`<List.Container>
  <List.Item.Basic>
...
`}),A=()=>(0,D.jsx)(T,{"data-visual-test":`list-footer`,scope:{fish_medium:o},stableName:`FooterWithButtons`,sourceImports:[`import { Anchor, Avatar, Badge, Button, Code, DateFormat, Flex, Grid, Heading, List, NumberFormat, P, ProgressIndicator, Span } from '@dnb/eufemia'`,`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`,`import { fish_medium } from '@dnb/eufemia/icons'`],__buildScope:{List:y,NumberFormat:S,Flex:a,Button:u,Value:c,Span:f,Accordion:l,P:m},children:`<List.Container>
...
`}),j=()=>(0,D.jsx)(T,{"data-visual-test":`list-action`,scope:{fish_medium:o},stableName:`NavigableItem`,sourceImports:[`import { Anchor, Avatar, Badge, Button, Code, DateFormat, Flex, Grid, Heading, List, NumberFormat, P, ProgressIndicator, Span } from '@dnb/eufemia'`,`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`,`import { fish_medium } from '@dnb/eufemia/icons'`],__buildScope:{List:y,NumberFormat:S},children:`<List.Container>
  <List.Item.Action
    icon={fish_medium}
...
`}),M=()=>(0,D.jsx)(T,{"data-visual-test":`list-action-href`,scope:{fish_medium:o},stableName:`NavigableItemWithHref`,sourceImports:[`import { Anchor, Avatar, Badge, Button, Code, DateFormat, Flex, Grid, Heading, List, NumberFormat, P, ProgressIndicator, Span } from '@dnb/eufemia'`,`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`,`import { fish_medium } from '@dnb/eufemia/icons'`],__buildScope:{List:y,NumberFormat:S},children:`<List.Container>
  <List.Item.Action
    icon={fish_medium}
...
`}),N=()=>(0,D.jsx)(T,{scope:{fish_medium:o},stableName:`NavigableItemWithCustomElement`,sourceImports:[`import { Anchor, Avatar, Badge, Button, Code, DateFormat, Flex, Grid, Heading, List, NumberFormat, P, ProgressIndicator, Span } from '@dnb/eufemia'`,`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`,`import { fish_medium } from '@dnb/eufemia/icons'`],__buildScope:{List:y,NumberFormat:S},noInline:!0,children:`// Example using a custom link component (e.g. React Router's Link).
...
`}),P=()=>(0,D.jsx)(T,{scope:{fish_medium:o},stableName:`WithAnchor`,sourceImports:[`import { Anchor, Avatar, Badge, Button, Code, DateFormat, Flex, Grid, Heading, List, NumberFormat, P, ProgressIndicator, Span } from '@dnb/eufemia'`,`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`,`import { fish_medium } from '@dnb/eufemia/icons'`],__buildScope:{List:y,Anchor:i,Link:_,NumberFormat:S},children:`<List.Container>
...
`}),F=()=>(0,D.jsx)(T,{"data-visual-test":`list-avatar`,stableName:`WithAvatar`,sourceImports:[`import { Anchor, Avatar, Badge, Button, Code, DateFormat, Flex, Grid, Heading, List, NumberFormat, P, ProgressIndicator, Span } from '@dnb/eufemia'`,`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`,`import { fish_medium } from '@dnb/eufemia/icons'`],__buildScope:{List:y,Avatar:p,NumberFormat:S,Value:c,Accordion:l,P:m},children:`<List.Container>
...
`}),I=()=>(0,D.jsx)(T,{stableName:`SelectedState`,sourceImports:[`import { Anchor, Avatar, Badge, Button, Code, DateFormat, Flex, Grid, Heading, List, NumberFormat, P, ProgressIndicator, Span } from '@dnb/eufemia'`,`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`,`import { fish_medium } from '@dnb/eufemia/icons'`],__buildScope:{List:y},children:`<List.Container>
...
`}),R=()=>(0,D.jsx)(T,{scope:{fish_medium:o},background:`plain`,stableName:`SkeletonState`,sourceImports:[`import { Anchor, Avatar, Badge, Button, Code, DateFormat, Flex, Grid, Heading, List, NumberFormat, P, ProgressIndicator, Span } from '@dnb/eufemia'`,`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`,`import { fish_medium } from '@dnb/eufemia/icons'`],__buildScope:{List:y,NumberFormat:S},children:`<List.Container>
...
`}),z=()=>(0,D.jsx)(T,{"data-visual-test":`list-pending`,scope:{fish_medium:o},stableName:`PendingState`,sourceImports:[`import { Anchor, Avatar, Badge, Button, Code, DateFormat, Flex, Grid, Heading, List, NumberFormat, P, ProgressIndicator, Span } from '@dnb/eufemia'`,`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`,`import { fish_medium } from '@dnb/eufemia/icons'`],__buildScope:{List:y,NumberFormat:S},children:`<List.Container>
...
`}),B=()=>(0,D.jsx)(T,{"data-visual-test":`list-disabled`,scope:{fish_medium:o},stableName:`DisabledState`,sourceImports:[`import { Anchor, Avatar, Badge, Button, Code, DateFormat, Flex, Grid, Heading, List, NumberFormat, P, ProgressIndicator, Span } from '@dnb/eufemia'`,`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`,`import { fish_medium } from '@dnb/eufemia/icons'`],__buildScope:{List:y,NumberFormat:S},children:`<List.Container>
  <List.Item.Action
    icon={fish_medium}
...
`}),V=()=>(0,D.jsx)(T,{stableName:`ProgressIndicatorRow`,sourceImports:[`import { Anchor, Avatar, Badge, Button, Code, DateFormat, Flex, Grid, Heading, List, NumberFormat, P, ProgressIndicator, Span } from '@dnb/eufemia'`,`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`,`import { fish_medium } from '@dnb/eufemia/icons'`],__buildScope:{List:y,ProgressIndicator:d},children:`<List.Container>
  <List.Item.Basic>
    <List.Cell.Start>
      <ProgressIndicator
        size="medium"
...
`}),H=()=>(0,D.jsx)(T,{"data-visual-test":`list-separated`,scope:{fish_medium:o},stableName:`SeparatedLists`,sourceImports:[`import { Anchor, Avatar, Badge, Button, Code, DateFormat, Flex, Grid, Heading, List, NumberFormat, P, ProgressIndicator, Span } from '@dnb/eufemia'`,`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`,`import { fish_medium } from '@dnb/eufemia/icons'`],__buildScope:{List:y,Value:c},children:`<List.Container separated>
...
`}),U=()=>(0,D.jsx)(T,{"data-visual-test":`list-accordion`,scope:{fish_medium:o},stableName:`Accordion`,sourceImports:[`import { Anchor, Avatar, Badge, Button, Code, DateFormat, Flex, Grid, Heading, List, NumberFormat, P, ProgressIndicator, Span } from '@dnb/eufemia'`,`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`,`import { fish_medium } from '@dnb/eufemia/icons'`],__buildScope:{List:y,Accordion:l,NumberFormat:S,P:m,Code:r},children:`<List.Container>
...
`}),W=()=>(0,D.jsx)(T,{"data-visual-test":`list-overline`,stableName:`WithDateFormat`,sourceImports:[`import { Anchor, Avatar, Badge, Button, Code, DateFormat, Flex, Grid, Heading, List, NumberFormat, P, ProgressIndicator, Span } from '@dnb/eufemia'`,`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`,`import { fish_medium } from '@dnb/eufemia/icons'`],__buildScope:{List:y,DateFormat:v,Value:c,Accordion:l,P:m,Code:r},children:`<List.Container>
...
`}),G=()=>(0,D.jsx)(T,{"data-visual-test":`list-subline`,scope:{fish_medium:o},stableName:`ListSubline`,sourceImports:[`import { Anchor, Avatar, Badge, Button, Code, DateFormat, Flex, Grid, Heading, List, NumberFormat, P, ProgressIndicator, Span } from '@dnb/eufemia'`,`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`,`import { fish_medium } from '@dnb/eufemia/icons'`],__buildScope:{List:y,DateFormat:v,Value:c,Accordion:l,Flex:a,Badge:C,P:m},children:`<List.Container>
...
`}),K=()=>(0,D.jsx)(T,{scope:{fish_medium:o},stableName:`WithBadge`,sourceImports:[`import { Anchor, Avatar, Badge, Button, Code, DateFormat, Flex, Grid, Heading, List, NumberFormat, P, ProgressIndicator, Span } from '@dnb/eufemia'`,`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`,`import { fish_medium } from '@dnb/eufemia/icons'`],__buildScope:{List:y,Badge:C,Accordion:l,Flex:a,Value:c,P:m},children:`<List.Container>
...
`}),J=()=>(0,D.jsx)(T,{scope:{fish_medium:o},background:`plain`,stableName:`GridColumns`,sourceImports:[`import { Anchor, Avatar, Badge, Button, Code, DateFormat, Flex, Grid, Heading, List, NumberFormat, P, ProgressIndicator, Span } from '@dnb/eufemia'`,`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`,`import { fish_medium } from '@dnb/eufemia/icons'`],__buildScope:{Grid:x,List:y,NumberFormat:S,P:m},children:`<Grid.Container
  rowGap
  columnGap
  style={{
    marginInline: 'auto',
...
`}),Y=()=>(0,D.jsx)(T,{"data-visual-test":`list-card`,scope:{fish_medium:o},stableName:`InsideCard`,sourceImports:[`import { Anchor, Avatar, Badge, Button, Code, DateFormat, Flex, Grid, Heading, List, NumberFormat, P, ProgressIndicator, Span } from '@dnb/eufemia'`,`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`,`import { fish_medium } from '@dnb/eufemia/icons'`],__buildScope:{List:y,Card:g,Heading:b,ScrollView:h,Value:c},children:`<List.Card>
...
`}),X=()=>(0,D.jsx)(T,{"data-visual-test":`list-card-no-scroll-view`,scope:{fish_medium:o},stableName:`InsideCardWithoutScrollView`,sourceImports:[`import { Anchor, Avatar, Badge, Button, Code, DateFormat, Flex, Grid, Heading, List, NumberFormat, P, ProgressIndicator, Span } from '@dnb/eufemia'`,`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`,`import { fish_medium } from '@dnb/eufemia/icons'`],__buildScope:{List:y,Card:g,Value:c},children:`<List.Card innerSpace="x-small">
  <List.Container>
    <List.Item.Action
      icon={fish_medium}
...
`}),Z=()=>(0,D.jsx)(T,{scope:{fish_medium:o},background:`plain`,stableName:`WithShowMoreButton`,sourceImports:[`import { Anchor, Avatar, Badge, Button, Code, DateFormat, Flex, Grid, Heading, List, NumberFormat, P, ProgressIndicator, Span } from '@dnb/eufemia'`,`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`,`import { fish_medium } from '@dnb/eufemia/icons'`],__buildScope:{Flex:a,Heading:b,List:y,Value:c,Accordion:l,P:m},children:`
...
`});function Q(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,h4:`h4`,p:`p`,strong:`strong`,...w(),...e.components};return E||$(`Examples`,!1),U||$(`Examples.Accordion`,!0),L||$(`Examples.BackgroundColor`,!0),B||$(`Examples.DisabledState`,!0),A||$(`Examples.FooterWithButtons`,!0),J||$(`Examples.GridColumns`,!0),Y||$(`Examples.InsideCard`,!0),X||$(`Examples.InsideCardWithoutScrollView`,!0),G||$(`Examples.ListSubline`,!0),j||$(`Examples.NavigableItem`,!0),N||$(`Examples.NavigableItemWithCustomElement`,!0),M||$(`Examples.NavigableItemWithHref`,!0),z||$(`Examples.PendingState`,!0),V||$(`Examples.ProgressIndicatorRow`,!0),k||$(`Examples.RowsWithSlots`,!0),I||$(`Examples.SelectedState`,!0),H||$(`Examples.SeparatedLists`,!0),O||$(`Examples.SimpleRows`,!0),R||$(`Examples.SkeletonState`,!0),P||$(`Examples.WithAnchor`,!0),F||$(`Examples.WithAvatar`,!0),K||$(`Examples.WithBadge`,!0),W||$(`Examples.WithDateFormat`,!0),q||$(`Examples.WithFormElements`,!0),Z||$(`Examples.WithShowMoreButton`,!0),(0,D.jsxs)(D.Fragment,{children:[(0,D.jsx)(t.h2,{children:`Demos`}),`
...
`,(0,D.jsx)(z,{}),`
`,(0,D.jsx)(t.h3,{children:`Disabled state`}),`
`,(0,D.jsxs)(t.p,{children:[`Use the `,(0,D.jsx)(t.code,{children:`disabled`}),` property on `,(0,D.jsx)(t.code,{children:`List.Item.Action`}),` to dim the row and prevent interaction. Set it on `,(0,D.jsx)(t.code,{children:`List.Container`}),` to disable every item at once.`]}),`
`,(0,D.jsx)(B,{}),`
...
`,(0,D.jsx)(Z,{})]})}function te(e={}){let{wrapper:t}={...w(),...e.components};return t?(0,D.jsx)(t,{...e,children:(0,D.jsx)(Q,{...e})}):Q(e)}function $(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{te as default};