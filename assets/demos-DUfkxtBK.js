import{a as e}from"./rolldown-runtime-BYbx6iT9.js";import{t}from"./jsx-runtime-BgMs7Gb-.js";import{t as n}from"./ComponentBox-a4aOn231.js";import{_r as r,d as i,y as a,za as o,zr as s}from"./index-DqqByKA2.js";var c=e(t()),l=({children:e})=>(0,c.jsx)(c.Fragment,{children:e}),u=()=>(0,c.jsx)(S,{children:(0,c.jsx)(n,{stableName:`TabsExampleContentOutside`,children:`
<Tabs
  id="unique-linked-id"
  data={[
    {
...
`})}),d=()=>(0,c.jsx)(S,{children:(0,c.jsx)(n,{scope:{exampleContent:y},"data-visual-test":`tabs-tablist`,stableName:`TabsExampleContentObject`,children:`<Tabs
  data={[
    {
      title: 'First',
      key: 'first',
...
`})}),f=()=>(0,c.jsx)(S,{children:(0,c.jsx)(n,{stableName:`TabsExampleKeepInDOM`,children:`<>
...
`})}),p=()=>(0,c.jsx)(S,{children:(0,c.jsx)(n,{"data-visual-test":`tabs-clickhandler`,scope:{exampleContent:y},stableName:`TabsExampleUsingData`,children:`<Tabs
  data={{
    first: {
      title: 'First',
...
/>
`})}),m=()=>(0,c.jsx)(S,{children:(0,c.jsx)(n,{"data-visual-test":`tabs-tablist-scrollable`,scope:{manyTabs:b,manyTabsContent:x},stableName:`TabsExampleScrollable`,children:`<Tabs selectedKey="second" data={manyTabs}>
  {manyTabsContent}
</Tabs>
`})}),h=()=>(0,c.jsx)(S,{children:(0,c.jsx)(n,{"data-visual-test":`tabs-section-styles`,stableName:`TabsExampleLeftAligned`,children:`<Tabs tabsStyle="information" contentStyle="information">
...
`})}),g=()=>(0,c.jsx)(n,{"data-visual-test":`tabs-horizontally-aligned`,scope:{manyTabs:b},stableName:`TabsExampleHorizontallyAligned`,noInline:!0,children:`const FlexWrapper = styled.div\`
  display: flex;
  flex-direction: row;
\`
...
`}),_=()=>(0,c.jsx)(n,{"data-visual-test":`tabs-max-width`,scope:{manyTabs:b},stableName:`TabsExampleMaxWidth`,noInline:!0,children:`const MaxWidthWrapper = styled.div\`
  max-width: 30rem;
...
render(<TabsMaxWidth />)
`}),v=()=>(0,c.jsx)(S,{children:(0,c.jsx)(n,{scope:{useLocation:o,Router:l,navigate:i},stableName:`TabsExampleReachRouterNavigation`,noInline:!0,children:`const Home = ({ path, default: d }) => <H2>Home</H2>
...
`,C=()=>(0,c.jsx)(S,{children:(0,c.jsx)(n,{"data-visual-test":`tabs-no-border`,stableName:`TabsNoBorder`,children:`<Tabs noBorder={true}>
  <Tabs.Content title="First" key="first">
    <H2 top={0} bottom>
      First
    </H2>
...
`})}),w=()=>(0,c.jsx)(S,{children:(0,c.jsx)(n,{"data-visual-test":`tabs-no-breakout`,stableName:`TabsNoBreakout`,children:`<Tabs breakout={false}>
  <Tabs.Content title="First" key="first">
    <H2 top={0} bottom>
      First
    </H2>
...
`})}),T=()=>(0,c.jsx)(S,{children:(0,c.jsx)(n,{"data-visual-test":`tabs-single-children-react-element`,stableName:`TabsSingleChildrenReactElement`,children:`<Tabs>
  <Tabs.Content title="First" key="first">
    <div>hello1</div>
  </Tabs.Content>
</Tabs>
`})}),E=()=>(0,c.jsx)(S,{children:(0,c.jsx)(n,{"data-visual-test":`tabs-single-element-data`,stableName:`TabsSingleElementData`,children:`<Tabs
  data={[
    {
      title: 'First',
      key: 1,
...
/>
`})}),D=()=>(0,c.jsx)(S,{children:(0,c.jsx)(n,{"data-visual-test":`tabs-align-property`,stableName:`TabsAlignProperty`,children:`
<Tabs
  align="left"
  data={[
    {
...
`})}),O=()=>(0,c.jsx)(S,{children:(0,c.jsx)(n,{"data-visual-test":`tabs-badge-notification`,stableName:`TabsExampleWithBadgeNotification`,children:`<Tabs
  data={[
    {
      title: (
        <>
...
/>
`})});function k(e){let t={code:`code`,h2:`h2`,h3:`h3`,p:`p`,pre:`pre`,strong:`strong`,...s(),...e.components},{VisibleWhenVisualTest:n}=t;return n||j(`VisibleWhenVisualTest`,!0),(0,c.jsxs)(c.Fragment,{children:[(0,c.jsx)(t.h2,{children:`Demos`}),`
...
`,(0,c.jsx)(t.p,{children:`This demo uses a Reach Router compatible API for tab navigation.`}),`
`,(0,c.jsx)(v,{}),`
...
`,(0,c.jsx)(O,{}),`
`,(0,c.jsxs)(n,{children:[(0,c.jsx)(T,{}),(0,c.jsx)(E,{}),(0,c.jsx)(D,{})]})]})}function A(e={}){let{wrapper:t}={...s(),...e.components};return t?(0,c.jsx)(t,{...e,children:(0,c.jsx)(k,{...e})}):k(e)}function j(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{A as default};