import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{H as r,Q as i,U as a}from"./Anchor-Djq5YQEM.js";import{t as o}from"./P-C9wBv35m.js";import{mt as s}from"./Selection-DWa_5MEy.js";import{K as c}from"./index-ppRu2ktv.js";import{t as l}from"./ComponentBox-R2c6Bo76.js";var u=t(n());function d({off:e,children:t}){return e?(0,u.jsx)(i,{formElement:{translate:`no`},children:(0,u.jsx)(a,{translate:`no`,children:t})}):(0,u.jsx)(u.Fragment,{children:t})}var f=e({BrowserTranslateExample:()=>m,PortalRootExample:()=>p}),p=()=>(0,u.jsx)(l,{stableName:`PortalRootExample`,sourceImports:[`import { P, PortalRoot, Dropdown } from '@dnb/eufemia'`,`import { BrowserTranslate } from '@dnb/eufemia/shared'`],__buildScope:{PortalRoot:r,P:o},children:`
<PortalRoot>
  <div
    style={{
      position: 'fixed',
