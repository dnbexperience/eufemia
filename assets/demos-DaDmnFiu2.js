import{a as e}from"./rolldown-runtime-BYbx6iT9.js";import{t}from"./jsx-runtime-BgMs7Gb-.js";import{t as n}from"./Card-M3YCnXL2.js";import{In as r,Jt as i,Kt as a,Qt as o,Rr as s,Xt as c,Yt as l,Zt as u,qt as d,un as f,x as p}from"./index-mmuoVhax.js";import{t as m}from"./ComponentBox-XDAvsf_r.js";var h=e(t());function g(e){switch(e?.name){case`sbanken`:return u;case`carnegie`:return d;case`eiendom`:return l;default:return i}}var _=()=>(0,h.jsx)(m,{scope:{DnbDefault:i,SbankenCompact:c,SbankenDefault:u,SbankenHorizontal:o,CarnegieDefault:d,EiendomDefault:l},"data-visual-test":`logo-all`,stableName:`LogoAllExample`,sourceImports:[`import { Card, Logo, Flex, P } from '@dnb/eufemia'`,`import { DnbDefault, SbankenCompact, SbankenDefault, SbankenHorizontal, CarnegieDefault, EiendomDefault } from '@dnb/eufemia/components/Logo'`,`import MyThemeSelector from '../../../../core/ChangeStyleTheme'`,`import { ThemeProps } from '@dnb/eufemia/shared/Theme'`],__buildScope:{Flex:f,Logo:a},children:`<Flex.Vertical>
...
`}),S=()=>(0,h.jsx)(m,{scope:{MyThemeSelector:p,myLogoSelector:g,SbankenDefault:u,CarnegieDefault:d,EiendomDefault:l,DnbDefault:i},"data-visual-test":`logo-theme-change`,stableName:`LogoChangeExample`,sourceImports:[`import { Card, Logo, Flex, P } from '@dnb/eufemia'`,`import { DnbDefault, SbankenCompact, SbankenDefault, SbankenHorizontal, CarnegieDefault, EiendomDefault } from '@dnb/eufemia/components/Logo'`,`import MyThemeSelector from '../../../../core/ChangeStyleTheme'`,`import { ThemeProps } from '@dnb/eufemia/shared/Theme'`],__buildScope:{Card:n,Logo:a},noInline:!0,children:`function myLogoSelector(theme: ThemeProps) {
  switch (theme?.name) {
    case 'sbanken':
...
`}),w=()=>(0,h.jsx)(m,{"data-visual-test":`logo-in-text`,scope:{myLogoSelector:g},stableName:`LogoInTextExample`,sourceImports:[`import { Card, Logo, Flex, P } from '@dnb/eufemia'`,`import { DnbDefault, SbankenCompact, SbankenDefault, SbankenHorizontal, CarnegieDefault, EiendomDefault } from '@dnb/eufemia/components/Logo'`,`import MyThemeSelector from '../../../../core/ChangeStyleTheme'`,`import { ThemeProps } from '@dnb/eufemia/shared/Theme'`],__buildScope:{P:r,Logo:a},children:`<P>
  This logo is in the middle <Logo svg={myLogoSelector} /> of some text.
</P>
`});function T(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,h4:`h4`,p:`p`,pre:`pre`,...s(),...e.components},{VisibleWhenVisualTest:n}=t;return n||D(`VisibleWhenVisualTest`,!0),(0,h.jsxs)(h.Fragment,{children:[(0,h.jsx)(t.h2,{children:`Demos`}),`
...
`,(0,h.jsx)(x,{}),`
`,(0,h.jsx)(n,{children:(0,h.jsx)(w,{})})]})}function E(e={}){let{wrapper:t}={...s(),...e.components};return t?(0,h.jsx)(t,{...e,children:(0,h.jsx)(T,{...e})}):T(e)}function D(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{E as default};