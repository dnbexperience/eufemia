import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{s as n}from"./chunk-QUQL4437-CBr5Whxv.js";import{n as r}from"./portal-query-T23qDpBh.js";import{M as i}from"./Autocomplete-6fC_p2_U.js";import{t as a}from"./P-D0SeNBSG.js";import{t as o}from"./H2-pfxMU0zE.js";import{t as s}from"./Section-BV74bciL.js";import{t as c}from"./ToggleButton-T4E3Coih.js";import{K as l,W as u,_ as d,m as f}from"./index-CsG353ar.js";import{t as p}from"./ComponentBox-Cb1rLw_D.js";var m=e(t()),h=({children:e})=>(0,m.jsx)(m.Fragment,{children:e}),g=()=>(0,m.jsx)(O,{children:(0,m.jsx)(p,{stableName:`TabsExampleContentOutside`,sourceImports:[`import { Suspense, ReactNode } from 'react'`,`import Input from '@dnb/eufemia/components/input/Input'`,`import styled from '@emotion/styled'`,`import { useLocation } from 'react-router-dom'`,`import { navigate } from 'portal-query'`,`import { Tabs, Section, H2, P, ToggleButton, Badge } from '@dnb/eufemia'`],__buildScope:{Tabs:d,H2:o},children:`
<Tabs
  id="unique-linked-id"
  data={[
    {
