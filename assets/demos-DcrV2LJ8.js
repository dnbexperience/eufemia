import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{$ as r,t as i}from"./Anchor-CUnuD5Cj.js";import{Q as a,Z as o}from"./forms-D__hPZDv.js";import{t as s}from"./P-DSNzygKs.js";import{t as c}from"./Link-DXYLsiUB.js";import{t as l}from"./ListExport-CJ2CSgFQ.js";import{H as u,U as d}from"./index-CGxQ8PRe.js";import{t as f}from"./ComponentBox-DOwlXUSS.js";var p=e({Inline:()=>y,ListTypes:()=>x,ListVariants:()=>b,UsingListFormatFunction:()=>h,WithChildren:()=>_,WithCustomFormat:()=>v,WithValue:()=>g}),m=t(n()),h=()=>(0,m.jsx)(f,{"data-visual-test":`list-format-function`,scope:{listFormat:a},stableName:`UsingListFormatFunction`,sourceImports:[`import { Fragment } from 'react'`,`import { Provider } from '@dnb/eufemia/shared'`,`import { ListFormat, P, Badge, Anchor } from '@dnb/eufemia'`,`import { listFormat } from '@dnb/eufemia/components/list-format/ListFormat'`],__buildScope:{Anchor:i,Link:c,Badge:u},children:`{
  listFormat(
    [
