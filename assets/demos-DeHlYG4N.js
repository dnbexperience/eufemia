import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{Q as n,et as r}from"./Anchor-CDwNjfi4.js";import{c as i}from"./ToggleButton-DoxBGtHF.js";import{Ut as a}from"./forms-CsJzlVUF.js";import{r as o}from"./P-CDsgVQgI.js";import{t as s}from"./P-CbimSwQH.js";import{t as c}from"./Link-BTXci22s.js";import{t as l}from"./Section-DfvD9Xmd.js";import{t as u}from"./Heading-CDZ3ehTc.js";import{B as d,x as f}from"./index-DdG6L_K8.js";import{t as p}from"./ComponentBox-q_23Ylzi.js";var m=e(t()),h=f.span`
  display: block;
  padding: 0.25rem 0;
`;function g(){return(0,m.jsx)(p,{hideCode:!0,"data-visual-test":`paragraph-modifiers-weight`,stableName:`ParagraphWeightModifiers`,sourceImports:[`import styled from '@emotion/styled'`,`import Anchor from '@dnb/eufemia/components/Anchor'`,`import P from '@dnb/eufemia/elements/P'`,`import Typography from '@dnb/eufemia/elements/typography/Typography'`,`import { Flex, Section } from '@dnb/eufemia'`],__buildScope:{P:s},children:`
...
`})}function w(){return(0,m.jsx)(p,{hideCode:!0,"data-visual-test":`paragraph-prose-max-width`,stableName:`ParagraphProseMaxWidth`,sourceImports:[`import styled from '@emotion/styled'`,`import Anchor from '@dnb/eufemia/components/Anchor'`,`import P from '@dnb/eufemia/elements/P'`,`import Typography from '@dnb/eufemia/elements/typography/Typography'`,`import { Flex, Section } from '@dnb/eufemia'`],__buildScope:{Flex:i,P:s},children:`<Flex.Stack>
  <P>
...
`})}function T(){return(0,m.jsx)(p,{hideCode:!0,scope:{Typography:o},stableName:`ParagraphProseMaxWidthProvider`,sourceImports:[`import styled from '@emotion/styled'`,`import Anchor from '@dnb/eufemia/components/Anchor'`,`import P from '@dnb/eufemia/elements/P'`,`import Typography from '@dnb/eufemia/elements/typography/Typography'`,`import { Flex, Section } from '@dnb/eufemia'`],__buildScope:{Flex:i,Provider:n,P:s},children:`<Flex.Stack>
...
`})}function D(){return(0,m.jsx)(p,{scope:{PWrap:({customSize:e=null,...t})=>{let n=t.size||e;return(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(s,{...t,children:(0,m.jsx)(h,{children:n})}),(0,m.jsx)(s,{weight:`medium`,...t,children:(0,m.jsxs)(h,{children:[n,` - Weight medium`]})}),(0,m.jsx)(s,{weight:`bold`,...t,children:(0,m.jsxs)(h,{children:[n,` - Weight bold`]})})]})}},"data-visual-test":`paragraph-sizes`,stableName:`ParagraphRegressionTests`,sourceImports:[`import styled from '@emotion/styled'`,`import Anchor from '@dnb/eufemia/components/Anchor'`,`import P from '@dnb/eufemia/elements/P'`,`import Typography from '@dnb/eufemia/elements/typography/Typography'`,`import { Flex, Section } from '@dnb/eufemia'`],children:`
...
`})}function O(){return(0,m.jsx)(p,{stableName:`ParagraphDarkSurface`,sourceImports:[`import styled from '@emotion/styled'`,`import Anchor from '@dnb/eufemia/components/Anchor'`,`import P from '@dnb/eufemia/elements/P'`,`import Typography from '@dnb/eufemia/elements/typography/Typography'`,`import { Flex, Section } from '@dnb/eufemia'`],__buildScope:{Section:l,P:s},children:`<Section
  innerSpace={{
    block: true,
  }}
  surface="dark"
