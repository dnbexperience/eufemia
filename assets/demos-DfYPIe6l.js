import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{Q as n,et as r}from"./Anchor-BPx9fjvj.js";import{s as i}from"./ToggleButton-DfKpi57X.js";import{Ut as a}from"./forms-D54jfDKN.js";import{t as o}from"./P-CVKBz4XO.js";import{t as s}from"./Link-DsLLxgOh.js";import{t as c}from"./Section-_oyssAWe.js";import{t as l}from"./Typography-DYDVxSBE.js";import{t as u}from"./Heading-OwOHsD1e.js";import{U as d,w as f}from"./index-BsJ3GLEw.js";import{t as p}from"./ComponentBox-sLMgHvLi.js";var m=e(t()),h=f.span`
  display: block;
  padding: 0.25rem 0;
`;function g(){return(0,m.jsx)(p,{hideCode:!0,"data-visual-test":`paragraph-modifiers-weight`,stableName:`ParagraphWeightModifiers`,sourceImports:[`import styled from '@emotion/styled'`,`import Anchor from '@dnb/eufemia/components/Anchor'`,`import P from '@dnb/eufemia/elements/P'`,`import { Typography } from '@dnb/eufemia/elements'`,`import { Flex, Section } from '@dnb/eufemia'`],__buildScope:{P:o},children:`
...
`})}function w(){return(0,m.jsx)(p,{hideCode:!0,"data-visual-test":`paragraph-prose-max-width`,stableName:`ParagraphProseMaxWidth`,sourceImports:[`import styled from '@emotion/styled'`,`import Anchor from '@dnb/eufemia/components/Anchor'`,`import P from '@dnb/eufemia/elements/P'`,`import { Typography } from '@dnb/eufemia/elements'`,`import { Flex, Section } from '@dnb/eufemia'`],__buildScope:{Flex:i,P:o},children:`<Flex.Stack>
  <P>
...
`})}function T(){return(0,m.jsx)(p,{hideCode:!0,scope:{Typography:l},stableName:`ParagraphProseMaxWidthProvider`,sourceImports:[`import styled from '@emotion/styled'`,`import Anchor from '@dnb/eufemia/components/Anchor'`,`import P from '@dnb/eufemia/elements/P'`,`import { Typography } from '@dnb/eufemia/elements'`,`import { Flex, Section } from '@dnb/eufemia'`],__buildScope:{Flex:i,Typography:l,P:o,Provider:n},children:`<Flex.Stack>
  <Typography.Context proseMaxWidth={60}>
    <P>
      This paragraph is inside a Typography.Context with proseMaxWidth={60}
    </P>
    <P>
...
`})}function D(){return(0,m.jsx)(p,{scope:{PWrap:({customSize:e=null,...t})=>{let n=t.size||e;return(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(o,{...t,children:(0,m.jsx)(h,{children:n})}),(0,m.jsx)(o,{weight:`medium`,...t,children:(0,m.jsxs)(h,{children:[n,` - Weight medium`]})}),(0,m.jsx)(o,{weight:`bold`,...t,children:(0,m.jsxs)(h,{children:[n,` - Weight bold`]})})]})}},"data-visual-test":`paragraph-sizes`,stableName:`ParagraphRegressionTests`,sourceImports:[`import styled from '@emotion/styled'`,`import Anchor from '@dnb/eufemia/components/Anchor'`,`import P from '@dnb/eufemia/elements/P'`,`import { Typography } from '@dnb/eufemia/elements'`,`import { Flex, Section } from '@dnb/eufemia'`],children:`
...
`})}function O(){return(0,m.jsx)(p,{stableName:`ParagraphDarkSurface`,sourceImports:[`import styled from '@emotion/styled'`,`import Anchor from '@dnb/eufemia/components/Anchor'`,`import P from '@dnb/eufemia/elements/P'`,`import { Typography } from '@dnb/eufemia/elements'`,`import { Flex, Section } from '@dnb/eufemia'`],__buildScope:{Section:c,P:o},children:`<Section
  innerSpace={{
    block: true,
  }}
  surface="dark"
...
`})}function k(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,h4:`h4`,h5:`h5`,li:`li`,p:`p`,ul:`ul`,...d(),...e.components},{VisibleWhenVisualTest:n}=t;return n||j(`VisibleWhenVisualTest`,!0),(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(t.h2,{children:`Demos`}),`
...
`,(0,m.jsx)(w,{}),`
`,(0,m.jsx)(t.h4,{children:`Using Typography.Context`}),`
`,(0,m.jsxs)(t.p,{children:[`Use `,(0,m.jsx)(t.code,{children:`Typography.Context`}),` to apply `,(0,m.jsx)(t.code,{children:`proseMaxWidth`}),` to multiple paragraphs at once:`]}),`
`,(0,m.jsx)(T,{}),`
...
`,(0,m.jsxs)(t.p,{children:[`Use `,(0,m.jsx)(t.a,{href:`/uilib/components/section/demos/#dark-surface`,children:`Section`}),` or `,(0,m.jsx)(t.a,{href:`/uilib/usage/customisation/theming/theme#surface-property`,children:`Theme.Context`}),` with `,(0,m.jsx)(t.code,{children:`surface="dark"`}),` to provide dark surface context to supporting components.`]}),`
`,(0,m.jsx)(t.p,{children:`Paragraphs automatically adapt their color when rendered on a dark surface:`}),`
`,(0,m.jsx)(O,{}),`
`,(0,m.jsx)(n,{children:(0,m.jsx)(D,{})})]})}function A(e={}){let{wrapper:t}={...d(),...e.components};return t?(0,m.jsx)(t,{...e,children:(0,m.jsx)(k,{...e})}):k(e)}function j(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{A as default};