import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{s as r}from"./ToggleButton-Bh3Eln0h.js";import{j as i,l as a,w as o}from"./forms-Ce7VSRGW.js";import{u as s}from"./FormStatus-DffxfanV.js";import{t as c}from"./Card-C4jdcnXT.js";import{t as l}from"./Section-CEKACurl.js";import{U as u}from"./index-DHCu7dhB.js";import{t as d}from"./ComponentBox-CmvipvMU.js";var f=e({CommitHandleRef:()=>h,InsideSection:()=>_,PreventUncommittedChanges:()=>v,TransformCommitData:()=>g,UpdateDataReference:()=>y,UsingCommitButton:()=>m}),p=t(n()),m=()=>(0,p.jsx)(d,{stableName:`UsingCommitButton`,sourceImports:[`import { useEffect, useRef } from 'react'`,`import { Flex, HeightAnimation } from '@dnb/eufemia'`,`import { Field, Form, Tools } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:o,Flex:r,Field:i},children:`<Form.Handler
...
`}),h=()=>(0,p.jsx)(d,{stableName:`CommitHandleRef`,sourceImports:[`import { useEffect, useRef } from 'react'`,`import { Flex, HeightAnimation } from '@dnb/eufemia'`,`import { Field, Form, Tools } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:o,Card:c,HeightAnimation:s,Field:i,Flex:r,Section:l,Tools:a},noInline:!0,children:`const MyForm = () => {
...
render(<MyForm />)
`}),g=()=>(0,p.jsx)(d,{stableName:`TransformCommitData`,sourceImports:[`import { useEffect, useRef } from 'react'`,`import { Flex, HeightAnimation } from '@dnb/eufemia'`,`import { Field, Form, Tools } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:o,Card:c,HeightAnimation:s,Field:i,Flex:r,Section:l},noInline:!0,children:`const MyForm = () => {
  return (
    <Form.Handler
...
render(<MyForm />)
`}),_=()=>(0,p.jsx)(d,{stableName:`InsideSection`,sourceImports:[`import { useEffect, useRef } from 'react'`,`import { Flex, HeightAnimation } from '@dnb/eufemia'`,`import { Field, Form, Tools } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:o,Section:l,Flex:r,Field:i},children:`<Form.Handler
  defaultData={{
    mySection: {
...
`}),v=()=>(0,p.jsx)(d,{stableName:`PreventUncommittedChanges`,sourceImports:[`import { useEffect, useRef } from 'react'`,`import { Flex, HeightAnimation } from '@dnb/eufemia'`,`import { Field, Form, Tools } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:o,Flex:r,Field:i,Tools:a},children:`<Form.Handler onSubmit={async (data) => console.log('onSubmit', data)}>
  <Flex.Stack>
...
`}),y=()=>(0,p.jsx)(d,{stableName:`UpdateDataReference`,sourceImports:[`import { useEffect, useRef } from 'react'`,`import { Flex, HeightAnimation } from '@dnb/eufemia'`,`import { Field, Form, Tools } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:o,Flex:r,Field:i,Tools:a},noInline:!0,children:`const dataReference = Form.Isolation.createDataReference()
