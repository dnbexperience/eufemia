import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{c as r}from"./ToggleButton-BtQrsiHY.js";import{V as i,_ as a,a as o}from"./Selection-BFV7H91n.js";import{t as s}from"./Slider-Dt3PM3V4.js";import{t as c}from"./Form-913YPZs6.js";import{t as l}from"./ajv-Bv3qqkgD.js";import{t as u}from"./Field-CbVmykdw.js";import{W as d}from"./index-D7e1avVt.js";import{t as f}from"./ComponentBox-CE7bpcJy.js";var p=e({CustomComponentWithAjvSchemaExample:()=>h,CustomComponentWithJsonSchema:()=>_,CustomComponentWithZodSchemaExample:()=>g}),m=t(n()),h=()=>(0,m.jsx)(f,{scope:{useFieldProps:a},stableName:`CustomComponentWithAjvSchemaExample`,sourceImports:[`import { useCallback, useMemo } from 'react'`,`import { Field, FieldBlock, Form, useFieldProps, z, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`,`import { Flex, Slider } from '@dnb/eufemia'`],__buildScope:{FieldBlock:o,Flex:r,Field:u,Slider:s,Form:c},noInline:!0,children:`const MySliderComponent = (props) => {
...
`}),g=()=>(0,m.jsx)(f,{scope:{useFieldProps:a,z:i},stableName:`CustomComponentWithZodSchemaExample`,sourceImports:[`import { useCallback, useMemo } from 'react'`,`import { Field, FieldBlock, Form, useFieldProps, z, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`,`import { Flex, Slider } from '@dnb/eufemia'`],__buildScope:{FieldBlock:o,Flex:r,Field:u,Slider:s,Form:c},noInline:!0,children:`const MySliderComponent = (props) => {
  const fromInput = useCallback(
    (event) => (typeof event === 'number' ? event : event?.value || 0),
    []
  )
...
`}),_=()=>(0,m.jsx)(f,{scope:{useFieldProps:a,makeAjvInstance:l},stableName:`CustomComponentWithJsonSchema`,sourceImports:[`import { useCallback, useMemo } from 'react'`,`import { Field, FieldBlock, Form, useFieldProps, z, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`,`import { Flex, Slider } from '@dnb/eufemia'`],__buildScope:{FieldBlock:o,Flex:r,Field:u,Slider:s,Form:c},noInline:!0,children:`const MySliderComponent = (props) => {
  const fromInput = useCallback(
    (event) => (typeof event === 'number' ? event : event?.value || 0),
    []
  )
