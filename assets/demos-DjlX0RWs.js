import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{s as r}from"./ToggleButton-Bom-ZokA.js";import{dt as i,j as a,q as o,rt as s,tt as c,w as l}from"./forms-QYD2kahG.js";import{t as u}from"./ajv-pP82bCzq.js";import{U as d}from"./index-D1L5wabr.js";import{t as f}from"./ComponentBox-B6YSImfw.js";var p=e({CustomComponentWithAjvSchemaExample:()=>h,CustomComponentWithJsonSchema:()=>_,CustomComponentWithZodSchemaExample:()=>g}),m=t(n()),h=()=>(0,m.jsx)(f,{scope:{useFieldProps:s},stableName:`CustomComponentWithAjvSchemaExample`,sourceImports:[`import { useCallback, useMemo } from 'react'`,`import { Field, FieldBlock, Form, useFieldProps, z, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`,`import { Flex, Slider } from '@dnb/eufemia'`],__buildScope:{FieldBlock:c,Flex:r,Field:a,Slider:o,Form:l},noInline:!0,children:`const MySliderComponent = (props) => {
...
`}),g=()=>(0,m.jsx)(f,{scope:{useFieldProps:s,z:i},stableName:`CustomComponentWithZodSchemaExample`,sourceImports:[`import { useCallback, useMemo } from 'react'`,`import { Field, FieldBlock, Form, useFieldProps, z, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`,`import { Flex, Slider } from '@dnb/eufemia'`],__buildScope:{FieldBlock:c,Flex:r,Field:a,Slider:o,Form:l},noInline:!0,children:`const MySliderComponent = (props) => {
  const fromInput = useCallback(
    (event) => (typeof event === 'number' ? event : event?.value || 0),
    []
  )
...
`}),_=()=>(0,m.jsx)(f,{scope:{useFieldProps:s,makeAjvInstance:u},stableName:`CustomComponentWithJsonSchema`,sourceImports:[`import { useCallback, useMemo } from 'react'`,`import { Field, FieldBlock, Form, useFieldProps, z, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`,`import { Flex, Slider } from '@dnb/eufemia'`],__buildScope:{FieldBlock:c,Flex:r,Field:a,Slider:o,Form:l},noInline:!0,children:`const MySliderComponent = (props) => {
  const fromInput = useCallback(
    (event) => (typeof event === 'number' ? event : event?.value || 0),
    []
  )
