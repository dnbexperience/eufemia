import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{s as r}from"./ToggleButton-DFl1k6dD.js";import{dt as i,g as a,j as o,l as s,w as c}from"./forms-DuwGqcp3.js";import{t as l}from"./Card-DLQPvlXB.js";import{t as u}from"./Section-D1rn7dEf.js";import{t as d}from"./ajv-BZhR-Vcu.js";import{U as f}from"./index-Ct8Ggqh9.js";import{t as p}from"./ComponentBox-41YKKsr3.js";var m=e({DataSetSchema:()=>_,DependentListSchema:()=>y,DependentSchemaValidation:()=>b,DependentSchemaValidationWithZod:()=>x,IfRuleSchema:()=>v,SingleFieldSchema:()=>g}),h=t(n()),g=()=>(0,h.jsx)(p,{scope:{makeAjvInstance:d},stableName:`SingleFieldSchema`,sourceImports:[`import { Flex, Section } from '@dnb/eufemia'`,`import { z, Form, Field, Iterate, Tools, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:c,Field:o},noInline:!0,children:`const ajv = makeAjvInstance()
const schema = {
  type: 'string',
  minLength: 5,
}
...
`}),_=()=>(0,h.jsx)(p,{scope:{makeAjvInstance:d},stableName:`DataSetSchema`,sourceImports:[`import { Flex, Section } from '@dnb/eufemia'`,`import { z, Form, Field, Iterate, Tools, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:c,Card:l,Field:o},noInline:!0,children:`const ajv = makeAjvInstance()
const schema = {
  type: 'object',
  properties: {
    name: {
...
`}),v=()=>(0,h.jsx)(p,{scope:{makeAjvInstance:d},stableName:`IfRuleSchema`,sourceImports:[`import { Flex, Section } from '@dnb/eufemia'`,`import { z, Form, Field, Iterate, Tools, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:c,Card:l,Field:o},noInline:!0,children:`const ajv = makeAjvInstance()
const schema = {
  type: 'object',
  properties: {
    name: {
...
`}),y=()=>(0,h.jsx)(p,{scope:{makeAjvInstance:d},stableName:`DependentListSchema`,sourceImports:[`import { Flex, Section } from '@dnb/eufemia'`,`import { z, Form, Field, Iterate, Tools, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:c,Flex:r,Card:l,Field:o,Iterate:a},noInline:!0,children:`const ajv = makeAjvInstance()
const schema = {
  type: 'object',
  definitions: {
    account: {
...
`}),b=()=>(0,h.jsx)(p,{scope:{makeAjvInstance:d,Tools:s},stableName:`DependentSchemaValidation`,sourceImports:[`import { Flex, Section } from '@dnb/eufemia'`,`import { z, Form, Field, Iterate, Tools, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:c,Flex:r,Card:l,Field:o,Iterate:a,Section:u,Tools:s},noInline:!0,children:`const ajv = makeAjvInstance()
const counts = [1, 2, 3]
const schema = {
  type: 'object',
  properties: {
...
`}),x=()=>(0,h.jsx)(p,{scope:{Tools:s,z:i},stableName:`DependentSchemaValidationWithZod`,sourceImports:[`import { Flex, Section } from '@dnb/eufemia'`,`import { z, Form, Field, Iterate, Tools, makeAjvInstance } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:c,Flex:r,Card:l,Field:o,Iterate:a,Section:u,Tools:s},noInline:!0,children:`const counts = [1, 2, 3]
