...
`}),x=()=>(0,_.jsx)(o,{scope:{colors:y,TestElement:c,Field:a,defaultBreakpoints:l,defaultQueries:p},noInline:!0,children:`const breakpoints = {
  ...defaultBreakpoints,
  xsmall: '30em',
}
const queries = {
...
`}),S=()=>(0,_.jsx)(o,{scope:{Field:a,FieldBlock:m},hideCode:!0,children:`<FieldBlock label="Label">
  <Flex.Container>
    <Flex.Item
      span={{
        small: 12,
...
`}),C=()=>{let[e,t]=g.useState(typeof window<`u`?window.innerWidth:0);return g.useEffect(()=>{let e=()=>{t(window.innerWidth)};return window.addEventListener(`resize`,e),()=>window.removeEventListener(`resize`,e)},[]),{innerWidth:e}},w=()=>(0,_.jsx)(o,{scope:{useMedia:d,useWindowWidth:C},hideCode:!0,noInline:!0,children:`const Playground = () => {
