import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{c as r}from"./Anchor-CUnuD5Cj.js";import{s as i}from"./ToggleButton-EPOyxk36.js";import{j as a,tt as o,w as s}from"./forms-D__hPZDv.js";import{t as c}from"./Button-CmA8Qaoz.js";import{t as l}from"./P-DSNzygKs.js";import{U as u}from"./index-CGxQ8PRe.js";import{t as d}from"./ComponentBox-DOwlXUSS.js";var f=e({AriaLiveAdditions:()=>h,AriaLivePlayground:()=>m}),p=t(n()),m=()=>(0,p.jsx)(d,{hideCode:!0,stableName:`AriaLivePlayground`,sourceImports:[`import { Field, FieldBlock, Form } from '@dnb/eufemia/extensions/forms'`,`import { AriaLive, Button, Flex, P } from '@dnb/eufemia'`],__buildScope:{Form:s,Flex:i,Field:a,AriaLive:r},noInline:!0,children:`const priorities = ['low', 'high']
const contents = {
...
`}),h=()=>(0,p.jsx)(d,{hideCode:!0,stableName:`AriaLiveAdditions`,sourceImports:[`import { Field, FieldBlock, Form } from '@dnb/eufemia/extensions/forms'`,`import { AriaLive, Button, Flex, P } from '@dnb/eufemia'`],__buildScope:{Form:s,Flex:i,Field:a,FieldBlock:o,Button:c,AriaLive:r,P:l},noInline:!0,children:`const defaultData = {
  enabled: false,
  content: ['Line 1'],
}
function AriaLiveExample() {
