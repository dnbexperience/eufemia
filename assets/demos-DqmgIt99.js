import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{t as n}from"./withComponentMarkers-MtpU7Mly.js";import{t as r}from"./P-C9wBv35m.js";import{d as i,f as a}from"./HelpButton-C7xeEDxM.js";import{t as o}from"./H2-Dw1W-git.js";import{t as s}from"./H3-BONyL4Vo.js";import{t as c}from"./H4-CrhL04WO.js";import{t as l}from"./Section-BtXmNREe.js";import{K as u,M as d,m as f}from"./index-ppRu2ktv.js";import{t as p}from"./ComponentBox-R2c6Bo76.js";var m=a,h=e(t()),g=({size:e,...t})=>(0,h.jsx)(a,{element:`h5`,size:e||`auto`,...t});n(g,{_isHeadingElement:!0,_supportsSpacingProps:!0});var _=g,v=({size:e,...t})=>(0,h.jsx)(a,{element:`h6`,size:e||`auto`,...t});n(v,{_isHeadingElement:!0,_supportsSpacingProps:!0});var y=v,b=()=>(0,h.jsx)(p,{"data-visual-test":`heading-basics`,stableName:`HeadingBasicsExample`,sourceImports:[`import { H, H1, H2, H3, H4, H5, H6, P, Section } from '@dnb/eufemia'`,`import styled from '@emotion/styled'`],__buildScope:{H1:i,Heading:d,H2:o,H3:s,H4:c,H5:_,H6:y,P:r},children:`
<H1>Heading 1</H1>
<H2>Heading 2</H2>
<H3>Heading 3</H3>
<H4>Heading 4</H4>
...
`});function k(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,p:`p`,...u(),...e.components},{VisibleWhenVisualTest:n}=t;return n||j(`VisibleWhenVisualTest`,!0),(0,h.jsxs)(h.Fragment,{children:[(0,h.jsx)(t.h2,{children:`Demos`}),`
...
`,(0,h.jsxs)(t.p,{children:[`Use `,(0,h.jsx)(t.a,{href:`/uilib/components/section/demos/#dark-surface`,children:`Section`}),` or `,(0,h.jsx)(t.a,{href:`/uilib/usage/customisation/theming/theme#surface-property`,children:`Theme.Context`}),` with `,(0,h.jsx)(t.code,{children:`surface="dark"`}),` to provide dark surface context to supporting components.`]}),`
