import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{D as r,a as i}from"./Anchor-CDwNjfi4.js";import{r as a}from"./layout_grid-7sVq7Has.js";import{A as o,v as s}from"./ToggleButton-DoxBGtHF.js";import{a as c,i as l,n as u,o as d,r as f,t as p}from"./scissors-CeWuMPXy.js";import{t as m}from"./Accordion-DzX2kVRX.js";import{t as h}from"./Button-QIkiaQEp.js";import{t as g}from"./ListExport-nQm1fxNF.js";import{t as _}from"./MenuExport-B2p86ZkR.js";import{B as v,H as y}from"./index-DdG6L_K8.js";import{t as b}from"./ComponentBox-q_23Ylzi.js";var x=e({MenuExampleAccordion:()=>E,MenuExampleDefault:()=>C,MenuExampleMaxVisibleListItems:()=>O,MenuExampleNested:()=>T,MenuExampleWithHeader:()=>D,MenuExampleWithLinks:()=>w}),S=t(n());function C(){return(0,S.jsx)(b,{stableName:`MenuExampleDefault`,sourceImports:[`import { Menu } from '@dnb/eufemia'`,`import { copy, edit, file, file_add, file_pdf, file_png, folder, home, launch, layout_card, save, scissors } from '@dnb/eufemia/icons'`],__buildScope:{Menu:_,Button:h,List:g},children:`<Menu.Root>
  <Menu.Button />
  <Menu.List>
...
`})}function w(){return(0,S.jsx)(b,{scope:{home:y,layout_card:u,launch:i},stableName:`MenuExampleWithLinks`,sourceImports:[`import { Menu } from '@dnb/eufemia'`,`import { copy, edit, file, file_add, file_pdf, file_png, folder, home, launch, layout_card, save, scissors } from '@dnb/eufemia/icons'`],__buildScope:{Menu:_,Button:h,List:g},children:`<Menu.Root>
...
`})}function T(){return(0,S.jsx)(b,{scope:{file_add:c,folder:s,file_pdf:l,file_png:f,file:d},"data-visual-test":`menu-accordion`,stableName:`MenuExampleNested`,sourceImports:[`import { Menu } from '@dnb/eufemia'`,`import { copy, edit, file, file_add, file_pdf, file_png, folder, home, launch, layout_card, save, scissors } from '@dnb/eufemia/icons'`],__buildScope:{Menu:_,Button:h,List:g},children:`<Menu.Root arrowPosition="left">
...
`})}function E(){return(0,S.jsx)(b,{scope:{file_add:c,folder:s,file_pdf:l,file_png:f,save:r},stableName:`MenuExampleAccordion`,sourceImports:[`import { Menu } from '@dnb/eufemia'`,`import { copy, edit, file, file_add, file_pdf, file_png, folder, home, launch, layout_card, save, scissors } from '@dnb/eufemia/icons'`],__buildScope:{Menu:_,Button:h,List:g,Accordion:m},children:`<Menu.Root>
  <Menu.Button text="File" icon="chevron_down" />
  <Menu.List>
    <Menu.Action
      icon={file_add}
