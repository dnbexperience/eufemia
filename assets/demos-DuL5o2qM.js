import{a as e,r as t}from"./rolldown-runtime-BYbx6iT9.js";import{n,t as r}from"./jsx-runtime-BgMs7Gb-.js";import{t as i}from"./MediaQuery-C144dv8B.js";import{C as a,t as o,u as s}from"./ComponentBox-xW2kV1s2.js";import{t as c}from"./TestElement-cTsZrWus.js";import{Ci as l,E as u,Lr as d,Oi as f,ji as p,wi as m}from"./index-DVm0MbGb.js";var h=t({HorizontalAutoSize:()=>S,HorizontalFlexItemResponsiveSize:()=>b,HorizontalFlexItemResponsiveSizeCustomColumns:()=>x,LayoutComponents:()=>v,MediaQueryLiveExample:()=>T,MediaQueryUseMedia:()=>w,colors:()=>y}),g=e(n()),_=r(),v=()=>(0,_.jsx)(o,{scope:{Field:a,Form:s},children:`<Flex.Stack>
...
`}),x=()=>(0,_.jsx)(o,{scope:{colors:y,TestElement:c,Field:a,defaultBreakpoints:p,defaultQueries:l},noInline:!0,children:`const breakpoints = {
  ...defaultBreakpoints,
  xsmall: '30em',
}
const queries = {
...
`}),S=()=>(0,_.jsx)(o,{scope:{Field:a,FieldBlock:u},hideCode:!0,children:`<FieldBlock label="Label">
  <Flex.Container>
    <Flex.Item
      span={{
        small: 12,
...
render(<Playground />)
`}),T=()=>(0,_.jsx)(o,{scope:{MediaQuery:i,useMediaQuery:f},hideCode:!0,noInline:!0,children:`const Playground = () => {
...
render(<Playground />)
`});function E(e){let t={code:`code`,h2:`h2`,h3:`h3`,p:`p`,...d(),...e.components};return h||O(`Examples`,!1),b||O(`Examples.HorizontalFlexItemResponsiveSize`,!0),x||O(`Examples.HorizontalFlexItemResponsiveSizeCustomColumns`,!0),v||O(`Examples.LayoutComponents`,!0),(0,_.jsxs)(_.Fragment,{children:[(0,_.jsx)(t.h2,{children:`Demos`}),`
...
`,(0,_.jsx)(x,{})]})}function D(e={}){let{wrapper:t}={...d(),...e.components};return t?(0,_.jsx)(t,{...e,children:(0,_.jsx)(E,{...e})}):E(e)}function O(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{D as default};