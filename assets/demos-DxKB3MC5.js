...
`}),J=()=>(0,F.jsx)(v,{"data-visual-test":`children-with-age-summary-multiple-no-answers`,scope:{Blocks:V,multipleChildrenNoJointAndDaycare:{hasChildren:!0,hasJointResponsibility:!1,usesDaycare:!1,countChildren:2,children:[{age:0},{age:0}]}},stableName:`ChildrenWithAgeSummaryMultipleNoAnswers`,children:`
<Blocks.ChildrenWithAge
...
`}),Y=()=>(0,F.jsx)(v,{"data-visual-test":`children-with-age-summary-multiple-children`,scope:{Blocks:V,multipleChildren:{hasChildren:!0,usesDaycare:!0,hasJointResponsibility:!0,daycareExpenses:4001,jointResponsibilityExpenses:1004,countChildren:2,children:[{age:1},{age:2}]}},stableName:`ChildrenWithAgeSummaryMultipleChildren`,children:`
<Blocks.ChildrenWithAge
...
`}),X=()=>(0,F.jsx)(v,{"data-visual-test":`children-with-age-summary-no-children`,scope:{Blocks:V,noChildren:{hasChildren:!1}},stableName:`ChildrenWithAgeSummaryNoChildren`,children:`
<Blocks.ChildrenWithAge data={noChildren} />
<Blocks.ChildrenWithAge mode="summary" data={noChildren} />

`}),Z=()=>(0,F.jsx)(v,{"data-visual-test":`children-with-age-summary-previously-filled-out-data`,scope:{Blocks:V,noChildren:{hasChildren:!1,countChildren:3,usesDaycare:!0,hasJointResponsibility:!0,daycareExpenses:4001,jointResponsibilityExpenses:1004,children:[{age:1},{age:2},{age:3}]}},stableName:`ChildrenWithAgeSummaryNoChildrenAfterFilledOutData`,children:`
<Blocks.ChildrenWithAge
  data={noChildren}
  enableAdditionalQuestions={['joint-responsibility', 'daycare']}
/>
...
`,(0,F.jsxs)(n,{children:[(0,F.jsx)(q,{}),(0,F.jsx)(X,{}),(0,F.jsx)(Y,{}),(0,F.jsx)(J,{}),(0,F.jsx)(Z,{})]})]})}function te(e={}){let{wrapper:t}={...N(),...e.components};return t?(0,F.jsx)(t,{...e,children:(0,F.jsx)(Q,{...e})}):Q(e)}function $(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{te as default};