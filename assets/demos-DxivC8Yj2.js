import{a as e,r as t}from"./rolldown-runtime-BYbx6iT9.js";import{t as n}from"./jsx-runtime-BgMs7Gb-.js";import{t as r}from"./ComponentBox-a4aOn231.js";import{t as i}from"./ajv-Cz96LLhY.js";import{R as a,ct as o,zr as s}from"./index-DqqByKA2.js";var c=t({CustomComponentWithAjvSchemaExample:()=>u,CustomComponentWithJsonSchema:()=>f,CustomComponentWithZodSchemaExample:()=>d}),l=e(n()),u=()=>(0,l.jsx)(r,{scope:{useFieldProps:a},stableName:`CustomComponentWithAjvSchemaExample`,noInline:!0,children:`const MySliderComponent = (props) => {
...
`}),d=()=>(0,l.jsx)(r,{scope:{useFieldProps:a,z:o},stableName:`CustomComponentWithZodSchemaExample`,noInline:!0,children:`const MySliderComponent = (props) => {
  const fromInput = useCallback(
    (event) => (typeof event === 'number' ? event : event?.value || 0),
    []
  )
...
`}),f=()=>(0,l.jsx)(r,{scope:{useFieldProps:a,makeAjvInstance:i},stableName:`CustomComponentWithJsonSchema`,noInline:!0,children:`const MySliderComponent = (props) => {
  const fromInput = useCallback(
    (event) => (typeof event === 'number' ? event : event?.value || 0),
    []
  )
...
`});function p(e){let t={code:`code`,h2:`h2`,h3:`h3`,p:`p`,pre:`pre`,...s(),...e.components};return c||h(`Examples`,!1),u||h(`Examples.CustomComponentWithAjvSchemaExample`,!0),d||h(`Examples.CustomComponentWithZodSchemaExample`,!0),(0,l.jsxs)(l.Fragment,{children:[(0,l.jsx)(t.h2,{children:`Demos`}),`
...
`,(0,l.jsx)(u,{})]})}function m(e={}){let{wrapper:t}={...s(),...e.components};return t?(0,l.jsx)(t,{...e,children:(0,l.jsx)(p,{...e})}):p(e)}function h(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{m as default};