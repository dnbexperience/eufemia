import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{j as r,m as i,w as a}from"./forms-So8FhW-K.js";import{t as o}from"./Button-ByGMDXzI.js";import{t as s}from"./Card-28qGdlRB.js";import{U as c}from"./index-GbBmkyvI.js";import{t as l}from"./ComponentBox-Brk_-GCP.js";import{s as u}from"./Examples-CRj3_DO2.js";var d=e({ErrorMessage:()=>m,SuccessMessage:()=>h,WithAWizard:()=>g}),f=t(n()),p=u(),m=()=>(0,f.jsx)(l,{scope:{request:p},stableName:`ErrorMessage`,sourceImports:[`import { createRequest } from '../SubmitIndicator/Examples'`,`import { Field, Form, Wizard } from '@dnb/eufemia/extensions/forms'`,`import { Button } from '@dnb/eufemia'`],__buildScope:{Form:a,Card:s,Field:r,Button:o},noInline:!0,children:`// myFormId can be anything, as long as it's a unique instance
const myFormId = () => null
render(
  <Form.Handler
    id={myFormId}
