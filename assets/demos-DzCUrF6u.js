import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{j as r,w as i}from"./forms-D54jfDKN.js";import{t as a}from"./Card-BvVSLAbs.js";import{U as o,f as s}from"./index-BsJ3GLEw.js";import{t as c}from"./ComponentBox-sLMgHvLi.js";var l=e({AutoClose:()=>v,DatePickerDateLimitValidation:()=>y,Disabled:()=>m,HorizontalLayout:()=>f,LabelAndValue:()=>d,Range:()=>_,ValidationExtendValidator:()=>b,ValidationRequired:()=>g,Width:()=>x,WithError:()=>h,WithHelp:()=>p}),u=t(n()),d=()=>(0,u.jsx)(c,{"data-visual-test":`date-label`,stableName:`LabelAndValue`,sourceImports:[`import { Field, Form } from '@dnb/eufemia/extensions/forms'`,`import { DateValidator } from '@dnb/eufemia/extensions/forms/Field/Date'`],__buildScope:{Field:r},children:`<Field.Date
  label="Label text"
  value="2023-01-16"
  onChange={(value) => console.log('onChange', value)}
/>
`}),f=()=>(0,u.jsx)(c,{"data-visual-test":`date-horizontal-layout`,stableName:`HorizontalLayout`,sourceImports:[`import { Field, Form } from '@dnb/eufemia/extensions/forms'`,`import { DateValidator } from '@dnb/eufemia/extensions/forms/Field/Date'`],__buildScope:{Field:r},children:`<Field.Date
...
/>
`}),p=()=>(0,u.jsx)(c,{stableName:`WithHelp`,sourceImports:[`import { Field, Form } from '@dnb/eufemia/extensions/forms'`,`import { DateValidator } from '@dnb/eufemia/extensions/forms/Field/Date'`],__buildScope:{Field:r},children:`<Field.Date
  label="Label text"
  value="2023-01-16"
  help={{
  ...
  onChange={(value) => console.log('onChange', value)}
/>
`}),m=()=>(0,u.jsx)(c,{stableName:`Disabled`,sourceImports:[`import { Field, Form } from '@dnb/eufemia/extensions/forms'`,`import { DateValidator } from '@dnb/eufemia/extensions/forms/Field/Date'`],__buildScope:{Field:r},children:`<Field.Date
  label="Label text"
  value="2023-01-16"
  onChange={(value) => console.log('onChange', value)}
  disabled
/>
`}),h=()=>(0,u.jsx)(c,{"data-visual-test":`date-error`,stableName:`WithError`,sourceImports:[`import { Field, Form } from '@dnb/eufemia/extensions/forms'`,`import { DateValidator } from '@dnb/eufemia/extensions/forms/Field/Date'`],__buildScope:{Field:r},children:`<Field.Date
  value="2023-01-16"
  label="Label text"
  onChange={(value) => console.log('onChange', value)}
  error={new Error('This is what is wrong...')}
/>
`}),g=()=>(0,u.jsx)(c,{stableName:`ValidationRequired`,sourceImports:[`import { Field, Form } from '@dnb/eufemia/extensions/forms'`,`import { DateValidator } from '@dnb/eufemia/extensions/forms/Field/Date'`],__buildScope:{Field:r},children:`<Field.Date
  label="Label text"
  onChange={(value) => console.log('onChange', value)}
  required
  validateInitially
/>
`}),_=()=>(0,u.jsx)(c,{stableName:`Range`,sourceImports:[`import { Field, Form } from '@dnb/eufemia/extensions/forms'`,`import { DateValidator } from '@dnb/eufemia/extensions/forms/Field/Date'`],__buildScope:{Field:r},children:`<Field.Date label="Label text" value="2023-01-16|2023-04-01" range />
`}),v=()=>(0,u.jsx)(c,{stableName:`AutoClose`,sourceImports:[`import { Field, Form } from '@dnb/eufemia/extensions/forms'`,`import { DateValidator } from '@dnb/eufemia/extensions/forms/Field/Date'`],__buildScope:{Field:r},children:`<Field.Date label="Automatically Close" showCancelButton={false} />
`}),y=()=>(0,u.jsx)(c,{stableName:`DatePickerDateLimitValidation`,sourceImports:[`import { Field, Form } from '@dnb/eufemia/extensions/forms'`,`import { DateValidator } from '@dnb/eufemia/extensions/forms/Field/Date'`],__buildScope:{Field:r},children:`<Field.Date
  value="2024-12-31|2025-02-01"
  minDate="2025-01-01"
  maxDate="2025-01-31"
  range
/>
`}),b=()=>(0,u.jsx)(c,{stableName:`ValidationExtendValidator`,sourceImports:[`import { Field, Form } from '@dnb/eufemia/extensions/forms'`,`import { DateValidator } from '@dnb/eufemia/extensions/forms/Field/Date'`],__buildScope:{Field:r},noInline:!0,children:`const myDateValidator = (value: string) => {
  if (value === '2025-01-01') {
...
`}),x=()=>(0,u.jsx)(c,{"data-visual-test":`date-width`,stableName:`Width`,sourceImports:[`import { Field, Form } from '@dnb/eufemia/extensions/forms'`,`import { DateValidator } from '@dnb/eufemia/extensions/forms/Field/Date'`],__buildScope:{Form:i,Card:a,Field:r},children:`<Form.Card>
