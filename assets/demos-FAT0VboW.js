import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{s as r}from"./ToggleButton-EPOyxk36.js";import{j as i,w as a}from"./forms-D__hPZDv.js";import{t as o}from"./Button-CmA8Qaoz.js";import{t as s}from"./Card-DZd-xLSg.js";import{U as c}from"./index-CGxQ8PRe.js";import{t as l}from"./ComponentBox-DOwlXUSS.js";var u=e({AsyncSubmit:()=>p,SubmitOutsideForm:()=>f}),d=t(n());function f(){return(0,d.jsx)(l,{stableName:`SubmitOutsideForm`,sourceImports:[`import { useState } from 'react'`,`import { Button, Flex } from '@dnb/eufemia'`,`import { Form, Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:a,Button:o,Flex:r,Card:s,Field:i},noInline:!0,children:`const formId = 'my-form'
...
`})}function p(){return(0,d.jsx)(l,{stableName:`AsyncSubmit`,sourceImports:[`import { useState } from 'react'`,`import { Button, Flex } from '@dnb/eufemia'`,`import { Form, Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:a,Button:o,Flex:r,Card:s,Field:i},noInline:!0,children:`const formId = 'my-form-async'
const ExternalSubmitButton = () => {
  const { submit } = Form.useSubmit(formId)
