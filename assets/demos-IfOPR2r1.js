import{a as e}from"./rolldown-runtime-BYbx6iT9.js";import{t}from"./jsx-runtime-BgMs7Gb-.js";import{t as n}from"./Link-BdzJ-zwi.js";import{Bn as r,Hi as i,In as a,Rn as o,Rr as s,Wi as c,en as l,un as u,y as d,zr as f}from"./index-mmuoVhax.js";import{t as p}from"./ComponentBox-XDAvsf_r.js";var m=e(t()),h=d.span`
  display: block;
  padding: 0.25rem 0;
...
`})}function w(){return(0,m.jsx)(p,{hideCode:!0,"data-visual-test":`paragraph-prose-max-width`,stableName:`ParagraphProseMaxWidth`,sourceImports:[`import styled from '@emotion/styled'`,`import Anchor from '@dnb/eufemia/components/Anchor'`,`import P from '@dnb/eufemia/elements/P'`,`import Typography from '@dnb/eufemia/elements/typography/Typography'`,`import { Flex, Section } from '@dnb/eufemia'`],__buildScope:{Flex:u,P:a},children:`<Flex.Stack>
  <P>
...
`})}function T(){return(0,m.jsx)(p,{hideCode:!0,scope:{Typography:o},stableName:`ParagraphProseMaxWidthProvider`,sourceImports:[`import styled from '@emotion/styled'`,`import Anchor from '@dnb/eufemia/components/Anchor'`,`import P from '@dnb/eufemia/elements/P'`,`import Typography from '@dnb/eufemia/elements/typography/Typography'`,`import { Flex, Section } from '@dnb/eufemia'`],__buildScope:{Flex:u,Provider:i,P:a},children:`<Flex.Stack>
...
`})}function O(){return(0,m.jsx)(p,{stableName:`ParagraphDarkSurface`,sourceImports:[`import styled from '@emotion/styled'`,`import Anchor from '@dnb/eufemia/components/Anchor'`,`import P from '@dnb/eufemia/elements/P'`,`import Typography from '@dnb/eufemia/elements/typography/Typography'`,`import { Flex, Section } from '@dnb/eufemia'`],__buildScope:{Section:r,P:a},children:`<Section
  innerSpace={{
    block: true,
  }}
  surface="dark"
...
`})}function k(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,h4:`h4`,h5:`h5`,li:`li`,p:`p`,ul:`ul`,...s(),...e.components},{VisibleWhenVisualTest:n}=t;return n||j(`VisibleWhenVisualTest`,!0),(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(t.h2,{children:`Demos`}),`
...
`,(0,m.jsx)(O,{}),`
`,(0,m.jsx)(n,{children:(0,m.jsx)(D,{})})]})}function A(e={}){let{wrapper:t}={...s(),...e.components};return t?(0,m.jsx)(t,{...e,children:(0,m.jsx)(k,{...e})}):k(e)}function j(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{A as default};