import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{$ as r}from"./Anchor-BqZ7Pm7_.js";import{u as i}from"./FormStatus-DiAc_h6C.js";import{t as a}from"./P-D0SeNBSG.js";import{c as o}from"./ToggleButton-T4E3Coih.js";import{t as s}from"./Card-Dsou21Li.js";import{t as c}from"./TestElement-DZzGdrQR.js";import{t as l}from"./Form-B9l6EvGx.js";import{t as u}from"./Field-DHicZJEj.js";import{t as d}from"./Value-whMgauSk.js";import{t as f}from"./Tools-DabwYqKy.js";import{K as p}from"./index-CsG353ar.js";import{t as m}from"./ComponentBox-Cb1rLw_D.js";var h=e({BasedOnBooleanTrue:()=>b,BasedOnContext:()=>x,BooleanExample:()=>_,FilterData:()=>C,InferData:()=>y,InheritVisibility:()=>w,NestedExample:()=>S,PathValue:()=>v,VisibilityOnValidation:()=>T}),g=t(n()),_=()=>(0,g.jsx)(m,{scope:{TestElement:c},stableName:`BooleanExample`,sourceImports:[`import { useCallback } from 'react'`,`import { Flex, HeightAnimation, P } from '@dnb/eufemia'`,`import { Field, Form, TestElement, Tools, Value } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:l,Flex:o,Field:u},children:`<Form.Handler>
  <Flex.Stack>
    <Field.Boolean
      label="Show content"
      variant="buttons"
...
`}),v=()=>(0,g.jsx)(m,{stableName:`PathValue`,sourceImports:[`import { useCallback } from 'react'`,`import { Flex, HeightAnimation, P } from '@dnb/eufemia'`,`import { Field, Form, TestElement, Tools, Value } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:l,Field:u,P:a},children:`<Form.Handler>
  <Field.Toggle
    label="Show content"
    valueOn="checked"
    valueOff="unchecked"
...
`}),y=()=>(0,g.jsx)(m,{stableName:`InferData`,sourceImports:[`import { useCallback } from 'react'`,`import { Flex, HeightAnimation, P } from '@dnb/eufemia'`,`import { Field, Form, TestElement, Tools, Value } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:l,Flex:o,Field:u,P:a},noInline:!0,children:`const MyComponent = () => {
...
render(<MyComponent />)
`}),b=()=>(0,g.jsx)(m,{stableName:`BasedOnBooleanTrue`,sourceImports:[`import { useCallback } from 'react'`,`import { Flex, HeightAnimation, P } from '@dnb/eufemia'`,`import { Field, Form, TestElement, Tools, Value } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:l,P:a},children:`<Form.Visibility visible={true}>
  <P>This is visible</P>
</Form.Visibility>
`}),x=()=>(0,g.jsx)(m,{stableName:`BasedOnContext`,sourceImports:[`import { useCallback } from 'react'`,`import { Flex, HeightAnimation, P } from '@dnb/eufemia'`,`import { Field, Form, TestElement, Tools, Value } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:l,P:a},children:`<Form.Handler
  data={{
    toBe: true,
    notToBe: false,
  }}
...
`}),S=()=>(0,g.jsx)(m,{stableName:`NestedExample`,sourceImports:[`import { useCallback } from 'react'`,`import { Flex, HeightAnimation, P } from '@dnb/eufemia'`,`import { Field, Form, TestElement, Tools, Value } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:l,Flex:o,Field:u,Tools:f},noInline:!0,children:`const filterDataHandler = ({ props }) => !props['data-exclude-field']
const MyForm = () => {
  return (
    <Form.Handler
      defaultData={{
...
render(<MyForm />)
`}),C=()=>(0,g.jsx)(m,{stableName:`FilterData`,sourceImports:[`import { useCallback } from 'react'`,`import { Flex, HeightAnimation, P } from '@dnb/eufemia'`,`import { Field, Form, TestElement, Tools, Value } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:l,Flex:o,Field:u,Card:s,P:a,Value:d,Tools:f},noInline:!0,children:`const filterDataPaths = {
  '/isVisible': false,
...
render(<MyForm />)
`});function w(){return(0,g.jsx)(m,{stableName:`InheritVisibility`,sourceImports:[`import { useCallback } from 'react'`,`import { Flex, HeightAnimation, P } from '@dnb/eufemia'`,`import { Field, Form, TestElement, Tools, Value } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:l,Card:s,Field:u,Value:d,Provider:r,HeightAnimation:i},children:`<Form.Handler>
  <Form.Card>
    <Field.Boolean
      variant="button"
      path="/isVisible"
...
`})}function T(){return(0,g.jsx)(m,{stableName:`VisibilityOnValidation`,sourceImports:[`import { useCallback } from 'react'`,`import { Flex, HeightAnimation, P } from '@dnb/eufemia'`,`import { Field, Form, TestElement, Tools, Value } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:l,Card:s,Field:u,Value:d},children:`<Form.Handler>
  <Form.Card>
