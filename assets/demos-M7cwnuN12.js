import{a as e}from"./rolldown-runtime-BYbx6iT9.js";import{t}from"./jsx-runtime-BgMs7Gb-.js";import{t as n}from"./ComponentBox-a4aOn231.js";import{zr as r}from"./index-DqqByKA2.js";var i=e(t()),a=()=>(0,i.jsx)(n,{"data-visual-test":`simple-drawer`,stableName:`SimpleDrawerExample`,children:`<Drawer
  title="Drawer title"
  triggerAttributes={{
    text: 'Open drawer',
  }}
...
`}),o=()=>(0,i.jsx)(n,{"data-visual-test":`large-content-drawer`,stableName:`LargeContentExample`,noInline:!0,children:`const MockComponent = () => {
...
`}),s=()=>(0,i.jsx)(n,{"data-visual-test":`left-placement-drawer`,stableName:`LeftPlacementDrawerExample`,children:`<Drawer title="Drawer title" containerPlacement="left">
  <P top>Some informational content</P>
  <P top>
    Elementum eu suspendisse sit platea elit porttitor magna laoreet ad
    ultrices tempus urna curae parturient conubia quisque viverra eget
...
`}),c=()=>(0,i.jsx)(n,{"data-visual-test":`top-placement-drawer`,stableName:`TopPlacementDrawerExample`,children:`<Drawer title="Drawer title" containerPlacement="top">
  <P top>Some informational content</P>
  <P top>
    Elementum eu suspendisse sit platea elit porttitor magna laoreet ad
    ultrices tempus urna curae parturient conubia quisque viverra eget
...
`}),l=()=>(0,i.jsx)(n,{"data-visual-test":`bottom-placement-drawer`,stableName:`BottomPlacementDrawerExample`,children:`<Drawer title="Drawer title" containerPlacement="bottom">
  <P top>Some informational content</P>
  <P top>
    Elementum eu suspendisse sit platea elit porttitor magna laoreet ad
    ultrices tempus urna curae parturient conubia quisque viverra eget
...
`}),u=()=>(0,i.jsx)(n,{"data-visual-test":`fullscreen-drawer`,stableName:`FullscreenDrawerExample`,children:`<Drawer
  fullscreen
  title="Drawer title"
  triggerAttributes={{
    text: 'Open drawer',
...
`}),d=()=>{},f=()=>(0,i.jsx)(n,{"data-visual-test":`full-drawer`,scope:{handleBack:d},stableName:`FullDrawerExample`,children:`<Drawer title="Custom title">
  <Drawer.Navigation>
...
`}),p=()=>(0,i.jsx)(n,{"data-visual-test":`drawer-custom-trigger`,stableName:`DrawerCustomTriggerExample`,children:`<Drawer
...
`}),m=()=>(0,i.jsx)(n,{"data-visual-test":`callback-drawer`,stableName:`DrawerCallbackExample`,children:`<Drawer
  title="Drawer title"
  triggerAttributes={{
    text: 'Open drawer',
  }}
...
`}),h=()=>(0,i.jsx)(n,{"data-visual-test":`drawer-no-animation`,stableName:`DrawerNoAnimationNoSpacing`,children:`<Drawer
...
`}),g=()=>(0,i.jsx)(n,{"data-visual-test":`drawer-scroll-view`,stableName:`DrawerScrollViewSetup`,noInline:!0,children:`const DrawerMock = () => {
  const scrollRef = useRef(null)
...
render(<DrawerMock />)
`}),_=()=>(0,i.jsx)(n,{"data-visual-test":`update-navigation-header-example`,stableName:`UpdateNavigationHeaderExample`,noInline:!0,children:`const MockComponent = () => {
