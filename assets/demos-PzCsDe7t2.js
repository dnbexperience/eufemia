import{a as e}from"./rolldown-runtime-BYbx6iT9.js";import{t}from"./jsx-runtime-BgMs7Gb-.js";import{t as n}from"./H2-cbOI7K3x.js";import{t as r}from"./H3-64m6NOiJ.js";import{t as i}from"./H4-BsPJGGSo.js";import{An as a,Bn as o,Gi as s,In as c,Rr as l,en as u,jn as d,y as f}from"./index-BIrFyEEc.js";import{t as p}from"./ComponentBox-DFVIRw0w.js";var m=d,h=e(t()),g=({size:e,...t})=>(0,h.jsx)(d,{element:`h5`,size:e||`auto`,...t});s(g,{_isHeadingElement:!0,_supportsSpacingProps:!0});var _=g,v=({size:e,...t})=>(0,h.jsx)(d,{element:`h6`,size:e||`auto`,...t});s(v,{_isHeadingElement:!0,_supportsSpacingProps:!0});var y=v,b=()=>(0,h.jsx)(p,{"data-visual-test":`heading-basics`,stableName:`HeadingBasicsExample`,sourceImports:[`import { H, H1, H2, H3, H4, H5, H6, P, Section } from '@dnb/eufemia'`,`import styled from '@emotion/styled'`],__buildScope:{H1:a,Heading:u,H2:n,H3:r,H4:i,H5:_,H6:y,P:c},children:`
<H1>Heading 1</H1>
<H2>Heading 2</H2>
<H3>Heading 3</H3>
<H4>Heading 4</H4>
...
`}),x=()=>(0,h.jsx)(p,{stableName:`HeadingTypographyExample`,sourceImports:[`import { H, H1, H2, H3, H4, H5, H6, P, Section } from '@dnb/eufemia'`,`import styled from '@emotion/styled'`],__buildScope:{H1:a,Heading:u},children:`
<H1>Heading 1 (default size 'xx-large')</H1>
<H1 size="x-large">Heading 1 style 'x-large'</H1>
<H1 size="small">Heading 1 style small</H1>

`}),S=()=>(0,h.jsx)(p,{stableName:`HeadingTypographyXLargeExample`,sourceImports:[`import { H, H1, H2, H3, H4, H5, H6, P, Section } from '@dnb/eufemia'`,`import styled from '@emotion/styled'`],__buildScope:{H1:a,Heading:u},children:`
<H1 size="x-large">Heading style x-large (using 'size')</H1>
<H1>
  <small>Heading style x-large (using &lt;small&gt;)</small>
</H1>

`}),C=()=>(0,h.jsx)(p,{hideCode:!0,"data-visual-test":`heading-default`,stableName:`HeadingVanillaHTMLExample`,sourceImports:[`import { H, H1, H2, H3, H4, H5, H6, P, Section } from '@dnb/eufemia'`,`import styled from '@emotion/styled'`],__buildScope:{Heading:u},children:`
...
`}),T=()=>(0,h.jsx)(p,{"data-visual-test":`heading-prose-max-width`,stableName:`HeadingProseMaxWidthExample`,sourceImports:[`import { H, H1, H2, H3, H4, H5, H6, P, Section } from '@dnb/eufemia'`,`import styled from '@emotion/styled'`],__buildScope:{H2:n},children:`
<H2>
...
`}),E=()=>(0,h.jsx)(p,{stableName:`HeadingMarginCollapsingExample`,sourceImports:[`import { H, H1, H2, H3, H4, H5, H6, P, Section } from '@dnb/eufemia'`,`import styled from '@emotion/styled'`],__buildScope:{H1:a,P:c},children:`
...
`}),D=()=>{let e=f.div`
  ...
  `,t=({...t})=>(0,h.jsxs)(h.Fragment,{children:[(0,h.jsx)(e,{children:(0,h.jsx)(a,{...t,children:t.size})}),(0,h.jsx)(e,{children:(0,h.jsx)(n,{...t,children:(0,h.jsxs)(`small`,{children:[`<small>`,` `,t.size,` `,`</small>`]})})}),(0,h.jsx)(e,{children:(0,h.jsxs)(r,{...t,children:[(0,h.jsx)(h.Fragment,{children:`Text `}),(0,h.jsxs)(`small`,{children:[`<small>`,` `,t.size,` `,`</small>`]})]})}),(0,h.jsx)(`hr`,{})]});return(0,h.jsxs)(h.Fragment,{children:[(0,h.jsx)(p,{scope:{HWrap:t},"data-visual-test":`heading-sizes`,stableName:`HeadingRegressionTest`,sourceImports:[`import { H, H1, H2, H3, H4, H5, H6, P, Section } from '@dnb/eufemia'`,`import styled from '@emotion/styled'`],children:`
<HWrap size="xx-large" />
<HWrap size="x-large" />
<HWrap size="large" />
<HWrap size="medium" />
...
`})]})},O=()=>(0,h.jsx)(p,{stableName:`HeadingDarkSurfaceExample`,sourceImports:[`import { H, H1, H2, H3, H4, H5, H6, P, Section } from '@dnb/eufemia'`,`import styled from '@emotion/styled'`],__buildScope:{Section:o,H1:a,Heading:u},children:`<Section
  innerSpace={{
    block: true,
  }}
  surface="dark"
...
`});function k(e){let t={code:`code`,h2:`h2`,h3:`h3`,p:`p`,...l(),...e.components},{VisibleWhenVisualTest:n}=t;return n||j(`VisibleWhenVisualTest`,!0),(0,h.jsxs)(h.Fragment,{children:[(0,h.jsx)(t.h2,{children:`Demos`}),`
...
`,(0,h.jsx)(O,{}),`
`,(0,h.jsx)(n,{children:(0,h.jsx)(D,{})})]})}function A(e={}){let{wrapper:t}={...l(),...e.components};return t?(0,h.jsx)(t,{...e,children:(0,h.jsx)(k,{...e})}):k(e)}function j(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{A as default};