import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{t as n,w as r}from"./Anchor-ywdvt45E.js";import{n as i,r as a,t as o}from"./trash_medium-DeUVERHS.js";import{t as s}from"./edit-CICWQHAi.js";import{n as c}from"./FormStatus-DZA_llyZ.js";import{t as l}from"./Button-2YHZk8Pc.js";import{M as u,f as d}from"./Autocomplete-DM3xptYi.js";import{t as f}from"./P-DtVKLSL-.js";import{a as p,n as m}from"./HelpButton-sV5p6bwJ.js";import{c as h}from"./ToggleButton-D3NEk3jO.js";import{t as g}from"./Card-C6UABezd.js";import{t as _}from"./Form-C16rVaXm.js";import{t as v}from"./Field-B5trC2Cn.js";import{V as y,W as b}from"./index-BCXtuv-b.js";import{t as x}from"./ComponentBox-B2X8809Z.js";var S=e(t()),C=()=>(0,S.jsx)(x,{"data-visual-test":`dialog-default`,stableName:`DialogExampleDefault`,sourceImports:[`import { useRef, useState } from 'react'`,`import { trash_medium, log_out_medium, cookie_medium, bell_medium, edit } from '@dnb/eufemia/icons'`,`import { Anchor, Button, Dialog, Flex, ProgressIndicator, FormStatus, Breadcrumb, P, Input } from '@dnb/eufemia'`,`import { Form, Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Dialog:m,P:f,Modal:p,Button:l},children:`<Dialog title="What is a Dialog?">
  <P>
...
`}),k=()=>(0,S.jsx)(x,{"data-visual-test":`full-dialog`,stableName:`FullDialogExample`,sourceImports:[`import { useRef, useState } from 'react'`,`import { trash_medium, log_out_medium, cookie_medium, bell_medium, edit } from '@dnb/eufemia/icons'`,`import { Anchor, Button, Dialog, Flex, ProgressIndicator, FormStatus, Breadcrumb, P, Input } from '@dnb/eufemia'`,`import { Form, Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Dialog:m,Breadcrumb:y,P:f,Button:l,FormStatus:c},noInline:!0,children:`const handleBack = () => null
render(
  <>
...
`}),j=()=>(0,S.jsx)(x,{"data-visual-test":`dialog-confirm-default`,scope:{bell_medium:r},stableName:`DialogConfirmDefault`,sourceImports:[`import { useRef, useState } from 'react'`,`import { trash_medium, log_out_medium, cookie_medium, bell_medium, edit } from '@dnb/eufemia/icons'`,`import { Anchor, Button, Dialog, Flex, ProgressIndicator, FormStatus, Breadcrumb, P, Input } from '@dnb/eufemia'`,`import { Form, Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Dialog:m},children:`<Dialog
...
/>
`}),M=()=>(0,S.jsx)(x,{"data-visual-test":`dialog-confirm-delete`,scope:{trash_medium:o},stableName:`DialogConfirmDelete`,sourceImports:[`import { useRef, useState } from 'react'`,`import { trash_medium, log_out_medium, cookie_medium, bell_medium, edit } from '@dnb/eufemia/icons'`,`import { Anchor, Button, Dialog, Flex, ProgressIndicator, FormStatus, Breadcrumb, P, Input } from '@dnb/eufemia'`,`import { Form, Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Dialog:m},children:`<Dialog
  variant="confirmation"
  confirmType="warning"
...
/>
`}),N=()=>(0,S.jsx)(x,{"data-visual-test":`dialog-confirm-loggedout`,scope:{log_out_medium:i},stableName:`DialogConfirmLoggedOut`,sourceImports:[`import { useRef, useState } from 'react'`,`import { trash_medium, log_out_medium, cookie_medium, bell_medium, edit } from '@dnb/eufemia/icons'`,`import { Anchor, Button, Dialog, Flex, ProgressIndicator, FormStatus, Breadcrumb, P, Input } from '@dnb/eufemia'`,`import { Form, Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Button:l,Dialog:m},noInline:!0,children:`const DemoComponent = () => {
...
`}),P=()=>(0,S.jsx)(x,{"data-visual-test":`dialog-confirm-cookie`,scope:{cookie_medium:a,edit:s},stableName:`DialogConfirmCookies`,sourceImports:[`import { useRef, useState } from 'react'`,`import { trash_medium, log_out_medium, cookie_medium, bell_medium, edit } from '@dnb/eufemia/icons'`,`import { Anchor, Button, Dialog, Flex, ProgressIndicator, FormStatus, Breadcrumb, P, Input } from '@dnb/eufemia'`,`import { Form, Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Dialog:m,Anchor:n,Button:l},children:`<Dialog
  triggerProps={{
...
render(<MockComponent />)
`});function L(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,li:`li`,ol:`ol`,p:`p`,...b(),...e.components},{VisibleWhenVisualTest:n}=t;return n||z(`VisibleWhenVisualTest`,!0),(0,S.jsxs)(S.Fragment,{children:[(0,S.jsx)(t.h2,{children:`Table of contents`}),`
...
`,(0,S.jsx)(P,{}),`
`,(0,S.jsxs)(n,{children:[(0,S.jsx)(F,{}),(0,S.jsx)(I,{})]})]})}function R(e={}){let{wrapper:t}={...b(),...e.components};return t?(0,S.jsx)(t,{...e,children:(0,S.jsx)(L,{...e})}):L(e)}function z(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{R as default};