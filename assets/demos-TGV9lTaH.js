import{r as e}from"./rolldown-runtime-BYbx6iT9.js";import{t}from"./jsx-runtime-BgMs7Gb-.js";import{t as n}from"./ComponentBox-xW2kV1s2.js";import{Lr as r}from"./index-DVm0MbGb.js";var i=e({Empty:()=>o,Inline:()=>d,Label:()=>l,LabelAndValue:()=>u,Placeholder:()=>s,WithValue:()=>c}),a=t(),o=()=>(0,a.jsx)(n,{children:`<Value.Email showEmpty />
`}),s=()=>(0,a.jsx)(n,{children:`<Value.Email placeholder="The value was not filled in" />
`}),c=()=>(0,a.jsx)(n,{children:`<Value.Email value="firstname.lastname@domain.com" />
`}),l=()=>(0,a.jsx)(n,{children:`<Value.Email label="Label text" showEmpty />
`}),u=()=>(0,a.jsx)(n,{children:`<Value.Email label="Label text" value="firstname.lastname@domain.com" />
