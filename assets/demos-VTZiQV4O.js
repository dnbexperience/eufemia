import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{M as n,p as r}from"./Autocomplete-DM3xptYi.js";import{t as i}from"./formatCurrency-CwzLldbq.js";import{a,t as o}from"./HelpButton-sV5p6bwJ.js";import{c as s}from"./ToggleButton-D3NEk3jO.js";import{n as c,t as l}from"./Slider-lEY9INSg.js";import{W as u}from"./index-BCXtuv-b.js";import{t as d}from"./ComponentBox-B2X8809Z.js";var f=e(t()),p=()=>(0,f.jsx)(d,{"data-visual-test":`slider-default`,stableName:`SliderExampleDefault`,sourceImports:[`import styled from '@emotion/styled'`,`import { useState } from 'react'`,`import { formatCurrency, formatPercent } from '@dnb/eufemia/components/number-format/NumberUtils'`,`import { Slider, HelpButton, Input, Flex } from '@dnb/eufemia'`,`import { SliderMarker } from '@dnb/eufemia/components/slider/Slider'`],__buildScope:{Slider:l},children:`<Slider
  min={0}
  max={100}
  value={70}
...
/>
`}),m=()=>(0,f.jsx)(d,{"data-visual-test":`slider-multi`,scope:{formatPercent:r},stableName:`SliderExampleMultiButtons`,sourceImports:[`import styled from '@emotion/styled'`,`import { useState } from 'react'`,`import { formatCurrency, formatPercent } from '@dnb/eufemia/components/number-format/NumberUtils'`,`import { Slider, HelpButton, Input, Flex } from '@dnb/eufemia'`,`import { SliderMarker } from '@dnb/eufemia/components/slider/Slider'`],__buildScope:{Flex:s,Slider:l},children:`<Flex.Vertical align="stretch">
  <Slider
    min={0}
    max={100}
    value={[30, 70]}
...
\`
render(<Component />)
`}),_=()=>(0,f.jsx)(d,{stableName:`SliderExampleSuffix`,sourceImports:[`import styled from '@emotion/styled'`,`import { useState } from 'react'`,`import { formatCurrency, formatPercent } from '@dnb/eufemia/components/number-format/NumberUtils'`,`import { Slider, HelpButton, Input, Flex } from '@dnb/eufemia'`,`import { SliderMarker } from '@dnb/eufemia/components/slider/Slider'`],__buildScope:{Slider:l,HelpButton:o,Modal:a},children:`<Slider
  min={0}
  max={100}
  value={70}
