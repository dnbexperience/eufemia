import{a as e}from"./rolldown-runtime-BYbx6iT9.js";import{t}from"./jsx-runtime-BgMs7Gb-.js";import{t as n}from"./ComponentBox-a4aOn231.js";import{Fn as r,Ln as i,y as a,zr as o}from"./index-DqqByKA2.js";var s=e(t()),c=a.span`
  display: block;
  padding: 0.25rem 0;
`;function l(){return(0,s.jsx)(n,{hideCode:!0,"data-visual-test":`paragraph-modifiers-weight`,stableName:`ParagraphWeightModifiers`,children:`
<P>Default paragraph</P>
<P weight="regular">Regular weight paragraph (same as default)</P>
<P weight="medium">Medium weight paragraph</P>

`})}function u(){return(0,s.jsx)(n,{hideCode:!0,"data-visual-test":`paragraph-modifiers-size`,stableName:`ParagraphSizeModifiers`,children:`
...
`})}function d(){return(0,s.jsx)(n,{hideCode:!0,"data-visual-test":`paragraph-modifiers-align`,stableName:`ParagraphAlignmentModifiers`,children:`
<P align="right">Right aligned paragraph</P>
<P align="center">Center aligned paragraph</P>
<P align="left">Left aligned paragraph</P>

`})}function f(){return(0,s.jsx)(n,{hideCode:!0,"data-visual-test":`paragraph-modifiers-family`,stableName:`ParagraphFamilyModifiers`,children:`
...
`})}function p(){return(0,s.jsx)(n,{hideCode:!0,"data-visual-test":`paragraph-modifiers-line`,stableName:`ParagraphLineHeightModifiers`,children:`
...
`})}function m(){return(0,s.jsx)(n,{hideCode:!0,"data-visual-test":`paragraph-modifiers-other`,stableName:`ParagraphAdditionalModifiers`,children:`<article>
  <P weight="bold">Bold weight paragraph</P>
  <P decoration="underline">Underline paragraph</P>
  <P slant="italic">Italic paragraph</P>
</article>
`})}function h(){return(0,s.jsx)(n,{scope:{Case:c},hideCode:!0,"data-visual-test":`paragraph-default`,stableName:`ParagraphDefault`,children:`<P>
...
`})}function g(){return(0,s.jsx)(n,{scope:{Case:c},hideCode:!0,"data-visual-test":`paragraph-small`,stableName:`ParagraphSmall`,children:`<article>
  <P size="small">
...
`})}function _(){return(0,s.jsx)(n,{hideCode:!0,"data-visual-test":`paragraph-prose-max-width`,stableName:`ParagraphProseMaxWidth`,children:`<Flex.Stack>
  <P>
...
`})}function v(){return(0,s.jsx)(n,{hideCode:!0,scope:{Typography:i},stableName:`ParagraphProseMaxWidthProvider`,children:`<Flex.Stack>
...
`})}function y(){return(0,s.jsx)(n,{scope:{Case:c},hideCode:!0,"data-visual-test":`paragraph-additional`,stableName:`ParagraphAdditional`,children:`<P>
  <Case>
...
`})}function b(){return(0,s.jsx)(n,{scope:{PWrap:({customSize:e=null,...t})=>{let n=t.size||e;return(0,s.jsxs)(s.Fragment,{children:[(0,s.jsx)(r,{...t,children:(0,s.jsx)(c,{children:n})}),(0,s.jsx)(r,{weight:`medium`,...t,children:(0,s.jsxs)(c,{children:[n,` - Weight medium`]})}),(0,s.jsx)(r,{weight:`bold`,...t,children:(0,s.jsxs)(c,{children:[n,` - Weight bold`]})})]})}},"data-visual-test":`paragraph-sizes`,stableName:`ParagraphRegressionTests`,children:`
...
`})}function x(){return(0,s.jsx)(n,{stableName:`ParagraphDarkSurface`,children:`<Section
  innerSpace={{
    block: true,
  }}
  surface="dark"
...
`})}function S(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,h4:`h4`,h5:`h5`,li:`li`,p:`p`,ul:`ul`,...o(),...e.components},{VisibleWhenVisualTest:n}=t;return n||w(`VisibleWhenVisualTest`,!0),(0,s.jsxs)(s.Fragment,{children:[(0,s.jsx)(t.h2,{children:`Demos`}),`
...
`,(0,s.jsx)(x,{}),`
`,(0,s.jsx)(n,{children:(0,s.jsx)(b,{})})]})}function C(e={}){let{wrapper:t}={...o(),...e.components};return t?(0,s.jsx)(t,{...e,children:(0,s.jsx)(S,{...e})}):S(e)}function w(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{C as default};