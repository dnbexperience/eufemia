import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{s as r}from"./ToggleButton-DFl1k6dD.js";import{j as i,l as a,v as o,w as s}from"./forms-DuwGqcp3.js";import{t as c}from"./Button-DLh19lOb.js";import{U as l}from"./index-Ct8Ggqh9.js";import{t as u}from"./ComponentBox-41YKKsr3.js";var d=e({Default:()=>p,FilterData:()=>g,Update:()=>m,VisibleData:()=>_,WithoutFormHandler:()=>h}),f=t(n());function p(){return(0,f.jsx)(u,{stableName:`Default`,sourceImports:[`import { useCallback, useEffect } from 'react'`,`import { Button, Flex } from '@dnb/eufemia'`,`import { Form, Field, Value, Tools } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:s,Field:i},noInline:!0,children:`const existingData = {
  foo: 'bar',
}
const Component = () => {
...
render(<Component />)
`})}function m(){return(0,f.jsx)(u,{stableName:`Update`,sourceImports:[`import { useCallback, useEffect } from 'react'`,`import { Button, Flex } from '@dnb/eufemia'`,`import { Form, Field, Value, Tools } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:s,Flex:r,Field:i},noInline:!0,children:`const existingData = {
  count: 1,
}
const Component = () => {
...
render(<Component />)
`})}function h(){return(0,f.jsx)(u,{stableName:`WithoutFormHandler`,sourceImports:[`import { useCallback, useEffect } from 'react'`,`import { Button, Flex } from '@dnb/eufemia'`,`import { Form, Field, Value, Tools } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:s,Button:c,Flex:r},noInline:!0,children:`const existingData = {
  count: 1,
}
const Component = () => {
...
`})}function g(){return(0,f.jsx)(u,{stableName:`FilterData`,sourceImports:[`import { useCallback, useEffect } from 'react'`,`import { Button, Flex } from '@dnb/eufemia'`,`import { Form, Field, Value, Tools } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:s,Flex:r,Field:i,Tools:a},noInline:!0,children:`const filterDataPaths = {
  '/isVisible': false,
...
render(<MyForm />)
`})}var _=()=>(0,f.jsx)(u,{stableName:`VisibleData`,sourceImports:[`import { useCallback, useEffect } from 'react'`,`import { Button, Flex } from '@dnb/eufemia'`,`import { Form, Field, Value, Tools } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:s,Flex:r,Field:i,Value:o},noInline:!0,children:`const MyForm = () => {
