import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{j as r,l as i,m as a,w as o}from"./forms-CsJzlVUF.js";import{t as s}from"./Button-QIkiaQEp.js";import{t as c}from"./Card-DP9KYSzC.js";import{B as l}from"./index-DdG6L_K8.js";import{t as u}from"./ComponentBox-q_23Ylzi.js";var d=e({InWizard:()=>p,UndoRedo:()=>m}),f=t(n()),p=()=>(0,f.jsx)(u,{stableName:`InWizard`,sourceImports:[`import { useCallback, useEffect, useRef } from 'react'`,`import { Button } from '@dnb/eufemia'`,`import { Field, Form, Tools, Wizard } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:o,Wizard:a,Field:r},noInline:!0,children:`const MyForm = () => {
...
render(<MyForm />)
`}),m=()=>(0,f.jsx)(u,{stableName:`UndoRedo`,sourceImports:[`import { useCallback, useEffect, useRef } from 'react'`,`import { Button } from '@dnb/eufemia'`,`import { Field, Form, Tools, Wizard } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:o,Card:c,Field:r,Button:s,Tools:i},noInline:!0,children:`const MyComponent = () => {
