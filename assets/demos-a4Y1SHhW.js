import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{j as r,l as i,w as a}from"./forms-CsJzlVUF.js";import{t as o}from"./Card-DP9KYSzC.js";import{B as s,f as c}from"./index-DdG6L_K8.js";import{t as l}from"./ComponentBox-q_23Ylzi.js";var u=e({Disabled:()=>g,Empty:()=>f,HorizontalLayout:()=>m,Label:()=>p,TransformInAndOut:()=>y,ValidationExtendValidator:()=>b,ValidationRequired:()=>v,WithError:()=>_,WithHelp:()=>h}),d=t(n()),f=()=>(0,d.jsx)(l,{"data-visual-test":`expiry-empty`,stableName:`Empty`,sourceImports:[`import { Field, Form, Tools } from '@dnb/eufemia/extensions/forms'`,`import { ExpiryValidator } from '@dnb/eufemia/extensions/forms/Field/Expiry'`],__buildScope:{Field:r},children:`<Field.Expiry onChange={(expiry) => console.log('onChange', expiry)} />
`}),p=()=>(0,d.jsx)(l,{"data-visual-test":`expiry-with-value`,stableName:`Label`,sourceImports:[`import { Field, Form, Tools } from '@dnb/eufemia/extensions/forms'`,`import { ExpiryValidator } from '@dnb/eufemia/extensions/forms/Field/Expiry'`],__buildScope:{Field:r},children:`<Field.Expiry
  value="0835"
  label="Label text"
  onChange={(expiry) => console.log('onChange', expiry)}
/>
`}),m=()=>(0,d.jsx)(l,{"data-visual-test":`expiry-horizontal-layout`,stableName:`HorizontalLayout`,sourceImports:[`import { Field, Form, Tools } from '@dnb/eufemia/extensions/forms'`,`import { ExpiryValidator } from '@dnb/eufemia/extensions/forms/Field/Expiry'`],__buildScope:{Field:r},children:`<Field.Expiry
  value="0835"
  layout="horizontal"
  layoutOptions={{
...
/>
`}),h=()=>(0,d.jsx)(l,{"data-visual-test":`expiry-with-help`,stableName:`WithHelp`,sourceImports:[`import { Field, Form, Tools } from '@dnb/eufemia/extensions/forms'`,`import { ExpiryValidator } from '@dnb/eufemia/extensions/forms/Field/Expiry'`],__buildScope:{Field:r},children:`<Field.Expiry
  label="Label text"
  help={{
  ...
  onChange={(expiry) => console.log('onChange', expiry)}
/>
`}),g=()=>(0,d.jsx)(l,{"data-visual-test":`expiry-disabled`,stableName:`Disabled`,sourceImports:[`import { Field, Form, Tools } from '@dnb/eufemia/extensions/forms'`,`import { ExpiryValidator } from '@dnb/eufemia/extensions/forms/Field/Expiry'`],__buildScope:{Field:r},children:`<Field.Expiry
  value="0826"
  label="Label text"
  onChange={(expiry) => console.log('onChange', expiry)}
  disabled
/>
`}),_=()=>(0,d.jsx)(l,{"data-visual-test":`expiry-error`,stableName:`WithError`,sourceImports:[`import { Field, Form, Tools } from '@dnb/eufemia/extensions/forms'`,`import { ExpiryValidator } from '@dnb/eufemia/extensions/forms/Field/Expiry'`],__buildScope:{Field:r},children:`<Field.Expiry
  value="0326"
  label="Label text"
  onChange={(expiry) => console.log('onChange', expiry)}
  error={new Error('This is what is wrong...')}
/>
`}),v=()=>(0,d.jsx)(l,{stableName:`ValidationRequired`,sourceImports:[`import { Field, Form, Tools } from '@dnb/eufemia/extensions/forms'`,`import { ExpiryValidator } from '@dnb/eufemia/extensions/forms/Field/Expiry'`],__buildScope:{Field:r},children:`<Field.Expiry
  label="Label text"
  onChange={(expiry) => console.log('onChange', expiry)}
  required
  validateInitially
/>
`}),y=()=>(0,d.jsx)(l,{stableName:`TransformInAndOut`,sourceImports:[`import { Field, Form, Tools } from '@dnb/eufemia/extensions/forms'`,`import { ExpiryValidator } from '@dnb/eufemia/extensions/forms/Field/Expiry'`],__buildScope:{Form:a,Card:o,Field:r,Tools:i},noInline:!0,children:`const transformOut = (internal, additionalArgs) => {
...
`}),b=()=>(0,d.jsx)(l,{stableName:`ValidationExtendValidator`,sourceImports:[`import { Field, Form, Tools } from '@dnb/eufemia/extensions/forms'`,`import { ExpiryValidator } from '@dnb/eufemia/extensions/forms/Field/Expiry'`],__buildScope:{Field:r},noInline:!0,children:`const myExpiryValidator = (value: string) => {
