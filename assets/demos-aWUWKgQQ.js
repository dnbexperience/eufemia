import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{t as r}from"./P-avM674pJ.js";import{c as i}from"./ToggleButton-BtQrsiHY.js";import{t as a}from"./Form-913YPZs6.js";import{t as o}from"./Field-CbVmykdw.js";import{t as s}from"./Value-C2hl5_67.js";import{W as c}from"./index-D7e1avVt.js";import{t as l}from"./ComponentBox-CE7bpcJy.js";var u=e({DifferentLocale:()=>m,Inline:()=>_,Label:()=>h,LabelAndValue:()=>g,Placeholder:()=>f,WithFieldAndValue:()=>v,WithValue:()=>p}),d=t(n()),f=()=>(0,d.jsx)(l,{stableName:`Placeholder`,sourceImports:[`import { Flex, P } from '@dnb/eufemia'`,`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Value:s},children:`<Value.SelectCountry placeholder="No value given" />
`}),p=()=>(0,d.jsx)(l,{stableName:`WithValue`,sourceImports:[`import { Flex, P } from '@dnb/eufemia'`,`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Value:s},children:`<Value.SelectCountry value="NO" />
...
`}),h=()=>(0,d.jsx)(l,{stableName:`Label`,sourceImports:[`import { Flex, P } from '@dnb/eufemia'`,`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Value:s},children:`<Value.SelectCountry label="Label text" showEmpty />
`}),g=()=>(0,d.jsx)(l,{stableName:`LabelAndValue`,sourceImports:[`import { Flex, P } from '@dnb/eufemia'`,`import { Field, Form, Value } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Value:s},children:`<Value.SelectCountry label="Label text" value="NO" />
