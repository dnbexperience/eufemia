import{a as e}from"./rolldown-runtime-BYbx6iT9.js";import{t}from"./jsx-runtime-BgMs7Gb-.js";import{t as n}from"./ComponentBox-a4aOn231.js";import{zr as r}from"./index-DqqByKA2.js";var i=e(t()),a=()=>(0,i.jsx)(n,{"data-visual-test":`step-indicator-static`,stableName:`StepIndicatorStatic`,children:`<StepIndicator
  mode="static"
  currentStep={1}
...
/>
`}),o=()=>(0,i.jsx)(n,{"data-visual-test":`step-indicator-strict`,stableName:`StepIndicatorStrict`,children:`<StepIndicator
  mode="strict"
  currentStep={1}
  onChange={({ currentStep }) => {
    console.log('onChange', currentStep)
...
/>
`}),s=()=>(0,i.jsx)(n,{"data-visual-test":`step-indicator-loose`,stableName:`StepIndicatorLoose`,noInline:!0,children:`const InteractiveDemo = () => {
...
`}),c=()=>(0,i.jsx)(n,{stableName:`StepIndicatorCustomized`,noInline:!0,children:`function CustomStepIndicator({ children, data, ...props }) {
...
`}),l=()=>(0,i.jsx)(n,{"data-visual-test":`step-indicator-expanded`,stableName:`StepIndicatorTextOnly`,children:`<StepIndicator
  expandedInitially
  mode="static"
  currentStep={1}
  data={['Om din nye bolig', 'Ditt lån og egenkapital', 'Oppsummering']}
/>
`}),u=()=>(0,i.jsx)(n,{stableName:`StepIndicatorRouter`,noInline:!0,children:`const StepIndicatorWithRouter = () => {
...
`}),d=()=>(0,i.jsx)(n,{"data-visual-test":`step-indicator-statuses`,stableName:`StepIndicatorStatuses`,children:`<StepIndicator
  mode="loose"
  currentStep={0}
  data={[
    {
...
/>
`}),f=()=>(0,i.jsx)(n,{"data-visual-test":`step-indicator-skeleton`,stableName:`StepIndicatorSkeleton`,children:`<StepIndicator
  mode="static"
  skeleton
  currentStep={1}
  expandedInitially
