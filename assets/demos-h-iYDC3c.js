import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{a as r,t as i}from"./HelpButton-C7xeEDxM.js";import{c as a}from"./ToggleButton-_NsXxiTa.js";import{t as o}from"./Card-ChPhpBPz.js";import{g as s}from"./Upload-CSUC0Eyp.js";import{t as c}from"./Form-JTiJXf2d.js";import{t as l}from"./Field-DqRpWyNm.js";import{K as u,m as d}from"./index-ppRu2ktv.js";import{t as f}from"./ComponentBox-R2c6Bo76.js";var p=e({Autoresize:()=>b,CharacterCounter:()=>v,Disabled:()=>S,FormStatus:()=>x,MaxLength:()=>T,Placeholder:()=>g,RowsCols:()=>h,Sizes:()=>w,Stretched:()=>y,Suffix:()=>C,Vertical:()=>_}),m=t(n()),h=()=>(0,m.jsx)(E,{children:(0,m.jsx)(f,{"data-visual-test":`textarea-default`,stableName:`RowsCols`,sourceImports:[`import styled from '@emotion/styled'`,`import { Textarea, HelpButton, Flex } from '@dnb/eufemia'`,`import { Field, Form } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Textarea:s},children:`<Textarea
  label="Default"
  rows="2"
  cols="20"
