import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{j as r,w as i}from"./forms-CsJzlVUF.js";import{t as a}from"./Button-QIkiaQEp.js";import{t as o}from"./Card-DP9KYSzC.js";import{B as s}from"./index-DdG6L_K8.js";import{t as c}from"./ComponentBox-q_23Ylzi.js";var l=e({AfterFirstRender:()=>f,Default:()=>d,UpdateValue:()=>p}),u=t(n());function d(){return(0,u.jsx)(c,{stableName:`Default`,sourceImports:[`import { Button } from '@dnb/eufemia'`,`import { Form, Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:i,Field:r},noInline:!0,children:`Form.setData('default-id', {
  foo: 'bar',
})
const Component = () => {
  return (
...
render(<Component />)
`})}function f(){return(0,u.jsx)(c,{stableName:`AfterFirstRender`,sourceImports:[`import { Button } from '@dnb/eufemia'`,`import { Form, Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:i,Field:r},noInline:!0,children:`const Component = () => {
  return (
...
render(<Component />)
`})}function p(){return(0,u.jsx)(c,{stableName:`UpdateValue`,sourceImports:[`import { Button } from '@dnb/eufemia'`,`import { Form, Field } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:i,Card:o,Field:r,Button:a},noInline:!0,children:`const myFormId = {}
