import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{$ as r}from"./Anchor-CUnuD5Cj.js";import{s as i}from"./ToggleButton-EPOyxk36.js";import{j as a,l as o,v as s,w as c}from"./forms-D__hPZDv.js";import{u as l}from"./FormStatus-BfZTTzoK.js";import{t as u}from"./P-DSNzygKs.js";import{t as d}from"./Card-DZd-xLSg.js";import{t as f}from"./TestElement-B-MJGTyS.js";import{U as p}from"./index-CGxQ8PRe.js";import{t as m}from"./ComponentBox-DOwlXUSS.js";var h=e({BasedOnBooleanTrue:()=>b,BasedOnContext:()=>x,BooleanExample:()=>_,FilterData:()=>C,InferData:()=>y,InheritVisibility:()=>w,NestedExample:()=>S,PathValue:()=>v,VisibilityOnValidation:()=>T}),g=t(n()),_=()=>(0,g.jsx)(m,{scope:{TestElement:f},stableName:`BooleanExample`,sourceImports:[`import { useCallback } from 'react'`,`import { Flex, HeightAnimation, P } from '@dnb/eufemia'`,`import { Field, Form, TestElement, Tools, Value } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:c,Flex:i,Field:a},children:`<Form.Handler>
  <Flex.Stack>
    <Field.Boolean
      label="Show content"
      variant="buttons"
