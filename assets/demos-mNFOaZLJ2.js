import{a as e}from"./rolldown-runtime-BYbx6iT9.js";import{n as t,t as n}from"./jsx-runtime-BgMs7Gb-.js";import{t as r}from"./ComponentBox-geTEYZ7b.js";import{n as i}from"./GlobalError-D6QkGc_J.js";import{Bi as a,Dt as o,Ir as s,Rr as c,Vi as l,Wi as u,qi as d}from"./index-CMgyXmp3.js";import{n as f,t as p}from"./Examples-oXTN84qZ.js";var m=e(t()),h=n();function g({rows:e=3,children:t=null,...n}){let r=(0,m.useMemo)(()=>{let t=[70,80,60,40,50,20,0];return Array(Number(e)).fill(!0).map((e,n)=>{let r=n%t.length;return r===t.length-1&&t.concat(t.reverse()),t[r]})},[e]);return(0,h.jsxs)(`div`,{className:u(`dnb-skeleton__figure`,`dnb-skeleton__figure--show`),"aria-busy":!0,...n,children:[(0,h.jsx)(s,{element:`div`,bottom:`large`,className:u(`dnb-h--xx-large`,`dnb-skeleton`,`dnb-skeleton--shape`),"aria-hidden":!0,style:{width:`50%`},children:`‌`}),r.map((e,t)=>(0,h.jsx)(s,{element:`div`,top:`x-small`,className:u(`dnb-p`,`dnb-skeleton`,`dnb-skeleton--shape`),style:{width:`${e}%`},children:`‌`},t)),typeof t==`function`?t():t]})}var _=()=>(0,h.jsx)(r,{children:`<Input label="Input" skeleton />
...
`}),D=()=>(0,h.jsx)(r,{hidePreview:!0,hideToolbar:!0,scope:{skeletonDOMAttributes:l,createSkeletonClass:a,Context:d},noInline:!0,children:`function Component({ skeleton = false, ...params } = {}) {
