import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{t as n}from"./Anchor-DN_sG59G.js";import{t as r}from"./Icon-D6Afic1o.js";import{a as i,i as a,n as o,r as s,t as c}from"./FormStatus-DffxfanV.js";import{F as l}from"./Autocomplete-BMBTNqbT.js";import{t as u}from"./Link-DZngENmp.js";import{t as d}from"./export-IdSV5k_-.js";import{U as f}from"./index-DHCu7dhB.js";import{t as p}from"./ComponentBox-CmvipvMU.js";var m=e(t()),h=()=>(0,m.jsx)(p,{"data-visual-test":`form-status`,stableName:`FormStatusDefault`,sourceImports:[`import { useState } from 'react'`,`import { InfoIcon, WarnIcon, ErrorIcon, MarketingIcon } from '@dnb/eufemia/components/form-status/FormStatus'`,`import { FormStatus, Icon, Input, ToggleButton, Link, Grid, Anchor } from '@dnb/eufemia'`,`import { Provider } from '@dnb/eufemia/shared'`],__buildScope:{FormStatus:o},children:`<FormStatus text="Failure text" />
`}),g=()=>(0,m.jsx)(p,{"data-visual-test":`form-status-refresh`,stableName:`FormStatusWithRefresh`,sourceImports:[`import { useState } from 'react'`,`import { InfoIcon, WarnIcon, ErrorIcon, MarketingIcon } from '@dnb/eufemia/components/form-status/FormStatus'`,`import { FormStatus, Icon, Input, ToggleButton, Link, Grid, Anchor } from '@dnb/eufemia'`,`import { Provider } from '@dnb/eufemia/shared'`],__buildScope:{FormStatus:o,Anchor:n},children:`<FormStatus>
  An error occurred while loading content.{' '}
  <Anchor href="">Try again</Anchor>
</FormStatus>
`}),_=()=>(0,m.jsx)(p,{"data-visual-test":`form-status-information`,stableName:`FormStatusWithInformation`,sourceImports:[`import { useState } from 'react'`,`import { InfoIcon, WarnIcon, ErrorIcon, MarketingIcon } from '@dnb/eufemia/components/form-status/FormStatus'`,`import { FormStatus, Icon, Input, ToggleButton, Link, Grid, Anchor } from '@dnb/eufemia'`,`import { Provider } from '@dnb/eufemia/shared'`],__buildScope:{FormStatus:o},children:`<FormStatus
  title="Hover title"
  text="Long info nisl tempus hendrerit tortor dapibus nascetur taciti porta risus cursus fusce platea enim curabitur proin nibh ut luctus magnis metus"
  state="information"
/>
`}),v=()=>(0,m.jsx)(p,{"data-visual-test":`form-status-stretch`,stableName:`FormStatusWithStretch`,sourceImports:[`import { useState } from 'react'`,`import { InfoIcon, WarnIcon, ErrorIcon, MarketingIcon } from '@dnb/eufemia/components/form-status/FormStatus'`,`import { FormStatus, Icon, Input, ToggleButton, Link, Grid, Anchor } from '@dnb/eufemia'`,`import { Provider } from '@dnb/eufemia/shared'`],__buildScope:{FormStatus:o},children:`<FormStatus
  stretch={true}
  text="Long info nisl tempus hendrerit tortor dapibus nascetur taciti porta risus cursus fusce platea enim curabitur proin nibh ut luctus magnis metus"
  state="warning"
/>
`}),y=()=>(0,m.jsx)(p,{"data-visual-test":`form-status-warning`,stableName:`FormStatusWithWarning`,sourceImports:[`import { useState } from 'react'`,`import { InfoIcon, WarnIcon, ErrorIcon, MarketingIcon } from '@dnb/eufemia/components/form-status/FormStatus'`,`import { FormStatus, Icon, Input, ToggleButton, Link, Grid, Anchor } from '@dnb/eufemia'`,`import { Provider } from '@dnb/eufemia/shared'`],__buildScope:{FormStatus:o},children:`<FormStatus state="warning" variant="outlined">
  Warningmessage. Take notice!
</FormStatus>
`}),b=()=>(0,m.jsx)(p,{"data-visual-test":`form-status-marketing`,stableName:`FormStatusWithMarketing`,sourceImports:[`import { useState } from 'react'`,`import { InfoIcon, WarnIcon, ErrorIcon, MarketingIcon } from '@dnb/eufemia/components/form-status/FormStatus'`,`import { FormStatus, Icon, Input, ToggleButton, Link, Grid, Anchor } from '@dnb/eufemia'`,`import { Provider } from '@dnb/eufemia/shared'`],__buildScope:{FormStatus:o},children:`<FormStatus state="marketing" variant="outlined">
  Marketingmessage. What a deal!
</FormStatus>
`}),x=()=>(0,m.jsx)(p,{stableName:`FormStatusInput`,sourceImports:[`import { useState } from 'react'`,`import { InfoIcon, WarnIcon, ErrorIcon, MarketingIcon } from '@dnb/eufemia/components/form-status/FormStatus'`,`import { FormStatus, Icon, Input, ToggleButton, Link, Grid, Anchor } from '@dnb/eufemia'`,`import { Provider } from '@dnb/eufemia/shared'`],__buildScope:{Input:l},children:`<Input
  label="Input with status"
  status="You have to fill in this field"
  value="Input value"
/>
`}),S=()=>(0,m.jsx)(p,{"data-visual-test":`form-status-custom`,stableName:`FormStatusCustom`,sourceImports:[`import { useState } from 'react'`,`import { InfoIcon, WarnIcon, ErrorIcon, MarketingIcon } from '@dnb/eufemia/components/form-status/FormStatus'`,`import { FormStatus, Icon, Input, ToggleButton, Link, Grid, Anchor } from '@dnb/eufemia'`,`import { Provider } from '@dnb/eufemia/shared'`],__buildScope:{Link:u,Input:l},noInline:!0,children:`const CustomStatus = () => (
  <>
...
`}),w=()=>(0,m.jsx)(p,{scope:{InfoIcon:s,WarnIcon:i,ErrorIcon:c,MarketingIcon:a},"data-visual-test":`form-status-icons`,stableName:`FormStatusWithIcons`,sourceImports:[`import { useState } from 'react'`,`import { InfoIcon, WarnIcon, ErrorIcon, MarketingIcon } from '@dnb/eufemia/components/form-status/FormStatus'`,`import { FormStatus, Icon, Input, ToggleButton, Link, Grid, Anchor } from '@dnb/eufemia'`,`import { Provider } from '@dnb/eufemia/shared'`],__buildScope:{Icon:r},children:`
<Icon
  icon={<InfoIcon />}
  size="medium"
  title="Some title"
...
`});function E(e){let t={code:`code`,h2:`h2`,h3:`h3`,p:`p`,strong:`strong`,...f(),...e.components},{VisibleWhenVisualTest:n}=t;return n||O(`VisibleWhenVisualTest`,!0),(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(t.h2,{children:`Demos`}),`
`,(0,m.jsx)(t.h3,{children:`Displaying error status`}),`
`,(0,m.jsx)(h,{}),`
`,(0,m.jsx)(t.h3,{children:`With a refresh action`}),`
`,(0,m.jsx)(g,{}),`
...
`,(0,m.jsx)(w,{}),`
`,(0,m.jsx)(n,{children:(0,m.jsx)(T,{})})]})}function D(e={}){let{wrapper:t}={...f(),...e.components};return t?(0,m.jsx)(t,{...e,children:(0,m.jsx)(E,{...e})}):E(e)}function O(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{D as default};