import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{Ht as r,S as i,nt as a,w as o}from"./forms-So8FhW-K.js";import{U as s}from"./index-GbBmkyvI.js";import{t as c}from"./ComponentBox-Brk_-GCP.js";var l=e({CustomComponentExample:()=>d}),u=t(n()),d=()=>(0,u.jsx)(c,{scope:{useValueProps:a,ValueBlock:i,formatCurrency:r},stableName:`CustomComponentExample`,sourceImports:[`import { ValueBlock, Form, useValueProps } from '@dnb/eufemia/extensions/forms'`,`import { formatCurrency } from '@dnb/eufemia/components/number-format/NumberUtils'`],__buildScope:{ValueBlock:i,Form:o},noInline:!0,children:`const MyValueComponent = (props) => {
  const preparedProps = {
    label: 'Default Label',
    ...props,
