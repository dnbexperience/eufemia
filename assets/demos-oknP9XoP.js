import{a as e,r as t}from"./rolldown-runtime-BYbx6iT9.js";import{t as n}from"./jsx-runtime-BgMs7Gb-.js";import{t as r}from"./Card-2G-TKpj3.js";import{t as i}from"./Form-PES0Uozy.js";import{t as a}from"./Field-DrUGn0oz.js";import{t as o}from"./Tools-p1RXalAh.js";import{Bn as s,Ir as c,Rr as l,un as u}from"./index-BIrFyEEc.js";import{t as d}from"./ComponentBox-DFVIRw0w.js";var f=t({CommitHandleRef:()=>h,InsideSection:()=>_,PreventUncommittedChanges:()=>v,TransformCommitData:()=>g,UpdateDataReference:()=>y,UsingCommitButton:()=>m}),p=e(n()),m=()=>(0,p.jsx)(d,{stableName:`UsingCommitButton`,sourceImports:[`import { useEffect, useRef } from 'react'`,`import { Flex, HeightAnimation } from '@dnb/eufemia'`,`import { Field, Form, Tools } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:i,Flex:u,Field:a},children:`<Form.Handler
...
`}),h=()=>(0,p.jsx)(d,{stableName:`CommitHandleRef`,sourceImports:[`import { useEffect, useRef } from 'react'`,`import { Flex, HeightAnimation } from '@dnb/eufemia'`,`import { Field, Form, Tools } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:i,Card:r,HeightAnimation:c,Field:a,Flex:u,Section:s,Tools:o},noInline:!0,children:`const MyForm = () => {
...
render(<MyForm />)
`}),g=()=>(0,p.jsx)(d,{stableName:`TransformCommitData`,sourceImports:[`import { useEffect, useRef } from 'react'`,`import { Flex, HeightAnimation } from '@dnb/eufemia'`,`import { Field, Form, Tools } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:i,Card:r,HeightAnimation:c,Field:a,Flex:u,Section:s},noInline:!0,children:`const MyForm = () => {
  return (
    <Form.Handler
...
render(<MyForm />)
`}),_=()=>(0,p.jsx)(d,{stableName:`InsideSection`,sourceImports:[`import { useEffect, useRef } from 'react'`,`import { Flex, HeightAnimation } from '@dnb/eufemia'`,`import { Field, Form, Tools } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:i,Section:s,Flex:u,Field:a},children:`<Form.Handler
  defaultData={{
    mySection: {
...
`}),v=()=>(0,p.jsx)(d,{stableName:`PreventUncommittedChanges`,sourceImports:[`import { useEffect, useRef } from 'react'`,`import { Flex, HeightAnimation } from '@dnb/eufemia'`,`import { Field, Form, Tools } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:i,Flex:u,Field:a,Tools:o},children:`<Form.Handler onSubmit={async (data) => console.log('onSubmit', data)}>
  <Flex.Stack>
...
`}),y=()=>(0,p.jsx)(d,{stableName:`UpdateDataReference`,sourceImports:[`import { useEffect, useRef } from 'react'`,`import { Flex, HeightAnimation } from '@dnb/eufemia'`,`import { Field, Form, Tools } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:i,Flex:u,Field:a,Tools:o},noInline:!0,children:`const dataReference = Form.Isolation.createDataReference()
...
`,(0,p.jsx)(y,{})]})}function x(e={}){let{wrapper:t}={...l(),...e.components};return t?(0,p.jsx)(t,{...e,children:(0,p.jsx)(b,{...e})}):b(e)}function S(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{x as default};