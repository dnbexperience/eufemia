import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{Q as r,t as i}from"./Anchor-BPx9fjvj.js";import{s as a}from"./ToggleButton-DfKpi57X.js";import{j as o,ot as s,q as c,w as l}from"./forms-D54jfDKN.js";import{t as u}from"./Card-BvVSLAbs.js";import{t as d}from"./export-D2BP5X_D.js";import{U as f,f as p}from"./index-BsJ3GLEw.js";import{t as m}from"./ComponentBox-sLMgHvLi.js";var h=e({Alignment:()=>T,AllowNegative:()=>j,ConditionalInfo:()=>z,Disabled:()=>O,DisallowLeadingZeroes:()=>M,ExclusiveMinMax:()=>C,HorizontalLayout:()=>S,LabelAndDescription:()=>b,LabelAndValue:()=>v,Percentage:()=>N,Placeholder:()=>_,PrefixAndSuffix:()=>w,ValidateMaximumCustomError:()=>P,ValidateMinimum:()=>A,ValidateRequired:()=>k,Widths:()=>D,WithCustomMask:()=>y,WithHelp:()=>E,WithSlider:()=>R,WithStatus:()=>x,WithStepControls:()=>F,WithStepControlsDisabled:()=>L,WithStepControlsError:()=>I}),g=t(n()),_=()=>(0,g.jsx)(m,{stableName:`Placeholder`,sourceImports:[`import { useState } from 'react'`,`import { Slider, Grid, Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Field:o},children:`<Field.Number
  label="Label text"
  placeholder="Enter a number..."
  onChange={(value) => console.log('onChange', value)}
/>
`}),v=()=>(0,g.jsx)(m,{stableName:`LabelAndValue`,sourceImports:[`import { useState } from 'react'`,`import { Slider, Grid, Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Field:o},children:`<Field.Number
  label="Label text"
  defaultValue={420000.25}
  onChange={(value) => console.log('onChange', value)}
/>
`}),y=()=>(0,g.jsx)(m,{stableName:`WithCustomMask`,sourceImports:[`import { useState } from 'react'`,`import { Slider, Grid, Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Field:o},children:`<Field.Number
  label="Label text"
  defaultValue={1234}
  mask={Array(4).fill(/\\d/)}
  onChange={(value) => console.log('onChange', value)}
/>
`}),b=()=>(0,g.jsx)(m,{"data-visual-test":`number-label-description`,stableName:`LabelAndDescription`,sourceImports:[`import { useState } from 'react'`,`import { Slider, Grid, Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:l,Card:u,Field:o},children:`<Form.Card>
  <Field.Number
    label="Label text"
...
`}),x=()=>(0,g.jsx)(m,{"data-visual-test":`number-status`,stableName:`WithStatus`,sourceImports:[`import { useState } from 'react'`,`import { Slider, Grid, Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:l,Card:u,Field:o},children:`<Form.Card>
  <Field.Number
    label="Label text"
    placeholder="Enter a number..."
    width="large"
...
`}),S=()=>(0,g.jsx)(m,{"data-visual-test":`number-horizontal-layout`,stableName:`HorizontalLayout`,sourceImports:[`import { useState } from 'react'`,`import { Slider, Grid, Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:l,Card:u,Field:o,Provider:r},children:`<Form.Card>
  <Field.Provider
    layout="horizontal"
    layoutOptions={{
...
`}),C=()=>(0,g.jsx)(m,{stableName:`ExclusiveMinMax`,sourceImports:[`import { useState } from 'react'`,`import { Slider, Grid, Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Field:o},children:`<Field.Number
  defaultValue={1000}
  label="Label text"
  allowNegative={false}
  required
  ...
  validateInitially
/>
`}),w=()=>(0,g.jsx)(m,{stableName:`PrefixAndSuffix`,sourceImports:[`import { useState } from 'react'`,`import { Slider, Grid, Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Flex:a,Field:o},children:`<Flex.Stack>
  <Field.Number
    defaultValue={1234}
    label="With prefix"
    prefix="prefix "
...
`}),T=()=>(0,g.jsx)(m,{stableName:`Alignment`,sourceImports:[`import { useState } from 'react'`,`import { Slider, Grid, Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Flex:a,Field:o},children:`<Flex.Stack>
  <Field.Number
    align="center"
...
`}),E=()=>(0,g.jsx)(m,{stableName:`WithHelp`,sourceImports:[`import { useState } from 'react'`,`import { Slider, Grid, Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Field:o},children:`<Field.Number
  defaultValue={12345}
  label="Label text"
  help={{
  ...
  onChange={(value) => console.log('onChange', value)}
/>
`}),D=()=>(0,g.jsx)(m,{hideCode:!0,"data-visual-test":`number-widths`,stableName:`Widths`,sourceImports:[`import { useState } from 'react'`,`import { Slider, Grid, Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Flex:a,Form:l,Field:o},children:`<Flex.Stack>
...
`}),O=()=>(0,g.jsx)(m,{stableName:`Disabled`,sourceImports:[`import { useState } from 'react'`,`import { Slider, Grid, Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Field:o},children:`<Field.Number
  defaultValue={135}
  label="Label text"
  onChange={(value) => console.log('onChange', value)}
  disabled
/>
`}),k=()=>(0,g.jsx)(m,{stableName:`ValidateRequired`,sourceImports:[`import { useState } from 'react'`,`import { Slider, Grid, Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Field:o},children:`<Field.Number
  defaultValue={123}
  label="Label text"
  onChange={(value) => console.log('onChange', value)}
  required
/>
`}),A=()=>(0,g.jsx)(m,{stableName:`ValidateMinimum`,sourceImports:[`import { useState } from 'react'`,`import { Slider, Grid, Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Field:o},children:`<Field.Number
  defaultValue={300}
  label="Enter a number below 250 and blur to trigger error"
  onChange={(value) => console.log('onChange', value)}
  minimum={250}
/>
`}),j=()=>(0,g.jsx)(m,{stableName:`AllowNegative`,sourceImports:[`import { useState } from 'react'`,`import { Slider, Grid, Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Field:o},children:`<Field.Number allowNegative={false} />
`}),M=()=>(0,g.jsx)(m,{stableName:`DisallowLeadingZeroes`,sourceImports:[`import { useState } from 'react'`,`import { Slider, Grid, Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Field:o},children:`<Field.Number disallowLeadingZeroes />
`}),N=()=>(0,g.jsx)(m,{stableName:`Percentage`,sourceImports:[`import { useState } from 'react'`,`import { Slider, Grid, Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Field:o},children:`<Field.Number
  percent
  defaultValue={80}
  label="Percentage"
  onChange={(value) => console.log('onChange', value)}
  minimum={90}
/>
`}),P=()=>(0,g.jsx)(m,{stableName:`ValidateMaximumCustomError`,sourceImports:[`import { useState } from 'react'`,`import { Slider, Grid, Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Field:o},children:`<Field.Number
  ...
  onChange={(value) => console.log('onChange', value)}
/>
`}),F=()=>(0,g.jsx)(m,{"data-visual-test":`number-input-step-controls`,stableName:`WithStepControls`,sourceImports:[`import { useState } from 'react'`,`import { Slider, Grid, Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Field:o},children:`<Field.Number
  label="Label text"
  showStepControls
  minimum={0}
  maximum={100}
  ...
  defaultValue={50}
/>
`}),I=()=>(0,g.jsx)(m,{"data-visual-test":`number-input-step-controls-error`,stableName:`WithStepControlsError`,sourceImports:[`import { useState } from 'react'`,`import { Slider, Grid, Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Field:o},children:`<Field.Number
  label="Label text"
  showStepControls
  maximum={100}
  defaultValue={150}
...
/>
`}),L=()=>(0,g.jsx)(m,{"data-visual-test":`number-input-step-controls-disabled`,stableName:`WithStepControlsDisabled`,sourceImports:[`import { useState } from 'react'`,`import { Slider, Grid, Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Field:o},children:`<Field.Number label="Label text" showStepControls disabled />
`}),R=()=>(0,g.jsx)(m,{hideCode:!0,stableName:`WithSlider`,sourceImports:[`import { useState } from 'react'`,`import { Slider, Grid, Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Grid:d,Field:o,Slider:c},noInline:!0,children:`const Component = () => {
...
render(<Component />)
`}),z=()=>(0,g.jsx)(m,{scope:{FormError:s},stableName:`ConditionalInfo`,sourceImports:[`import { useState } from 'react'`,`import { Slider, Grid, Flex, Anchor } from '@dnb/eufemia'`,`import { Field, Form, FormError } from '@dnb/eufemia/extensions/forms'`],__buildScope:{Form:l,Card:u,Field:o,Anchor:i},noInline:!0,children:`render(
  <Form.Handler
    defaultData={{
      maximum: 4,
      amount: 5,
