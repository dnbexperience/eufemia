import{t as e}from"./jsx-runtime-BgMs7Gb-.js";import{t}from"./ComponentBox-geTEYZ7b.js";import{Gt as n,Jt as r,Kt as i,Rr as a,Ut as o,Wt as s,f as c,qt as l}from"./index-CMgyXmp3.js";var u=e();function d(e){switch(e?.name){case`sbanken`:return l;case`carnegie`:return o;case`eiendom`:return n;default:return s}}var f=()=>(0,u.jsx)(t,{scope:{DnbDefault:s,SbankenCompact:i,SbankenDefault:l,SbankenHorizontal:r,CarnegieDefault:o,EiendomDefault:n},"data-visual-test":`logo-all`,children:`<Flex.Vertical>
...
`}),_=()=>(0,u.jsx)(t,{scope:{MyThemeSelector:c,myLogoSelector:d,SbankenDefault:l,CarnegieDefault:o,EiendomDefault:n,DnbDefault:s},"data-visual-test":`logo-theme-change`,noInline:!0,children:`function myLogoSelector(theme: ThemeProps) {
  switch (theme?.name) {
    case 'sbanken':
