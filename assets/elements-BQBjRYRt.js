import{a as e}from"./rolldown-runtime-BYbx6iT9.js";import{t}from"./jsx-runtime-BgMs7Gb-.js";import{$ as n,t as r}from"./ComponentBox-a4aOn231.js";import{f as i,u as a,zr as o}from"./index-DqqByKA2.js";import{t as s}from"./ListSummaryFromEdges-Bleb9dZo.js";var c=e(t());function l(){let{allMdx:{edges:e}}=i(a`
    {
      allMdx(
        filter: {
          frontmatter: {
  ...
  `);return(0,c.jsx)(s,{edges:e,returnListItems:!0})}var u=()=>(0,c.jsx)(r,{scope:{Link:n},stableName:`StyledComponentsExample`,noInline:!0,children:`const StyledLink = styled(Link)\`
...
`}),d=()=>(0,c.jsx)(r,{"data-visual-test":`span-skeleton`,stableName:`UnstyledExample`,noInline:!0,children:`const Box = styled.div\`
  display: grid;
  place-items: center;
  width: 12rem;
  height: 4rem;
...
render(<CustomImage />)
`});function f(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,h4:`h4`,hr:`hr`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...o(),...e.components};return(0,c.jsxs)(c.Fragment,{children:[(0,c.jsx)(t.h1,{children:`HTML Elements`}),`
...
`]})]})}function p(e={}){let{wrapper:t}={...o(),...e.components};return t?(0,c.jsx)(t,{...e,children:(0,c.jsx)(f,{...e})}):f(e)}export{p as default};