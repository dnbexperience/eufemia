import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{g as n}from"./Anchor-CDwNjfi4.js";import{t as r}from"./ToggleButton-DoxBGtHF.js";import{i,t as a}from"./portal-query-66iyRONR.js";import{t as o}from"./Span-D-ZXYX7F.js";import{t as s}from"./Link-BTXci22s.js";import{B as c,P as l}from"./index-DdG6L_K8.js";import{t as u}from"./ListSummaryFromEdges-CFpSEgZ8.js";import{t as d}from"./ComponentBox-q_23Ylzi.js";var f=e(t());function p(){let{allMdx:{edges:e}}=i(a`
    {
      allMdx(
        filter: {
          frontmatter: {
  ...
  `);return(0,f.jsx)(u,{edges:e,returnListItems:!0})}var m=()=>(0,f.jsx)(d,{scope:{Link:s},stableName:`StyledComponentsExample`,sourceImports:[`import styled from '@emotion/styled'`,`import { Link } from '@dnb/eufemia'`],__buildScope:{Link:s},noInline:!0,children:`const StyledLink = styled(Link)\`
...
`}),h=()=>(0,f.jsx)(d,{"data-visual-test":`span-skeleton`,stableName:`UnstyledExample`,sourceImports:[`import { useState } from 'react'`,`import { Skeleton, Span, IconPrimary, ToggleButton } from '@dnb/eufemia'`,`import styled from '@emotion/styled'`],__buildScope:{Skeleton:l,Span:o,IconPrimary:n,ToggleButton:r},noInline:!0,children:`const Box = styled.div\`
  display: grid;
  place-items: center;
  width: 12rem;
  height: 4rem;
...
render(<CustomImage />)
`});function g(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,h4:`h4`,hr:`hr`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...c(),...e.components};return(0,f.jsxs)(f.Fragment,{children:[(0,f.jsx)(t.h1,{children:`HTML Elements`}),`
...
`]})]})}function _(e={}){let{wrapper:t}={...c(),...e.components};return t?(0,f.jsx)(t,{...e,children:(0,f.jsx)(g,{...e})}):g(e)}export{_ as default};