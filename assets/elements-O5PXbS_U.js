import{a as e}from"./rolldown-runtime-BYbx6iT9.js";import{t}from"./jsx-runtime-BgMs7Gb-.js";import{t as n}from"./Link-C9xoHIzR.js";import{t as r}from"./Skeleton-BJ4flETQ.js";import{En as i,Ft as a,Rr as o,f as s,ri as c,u as l}from"./index-Da-r8F54.js";import{t as u}from"./ListSummaryFromEdges-BwYCpbHL.js";import{t as d}from"./ComponentBox-DXeEXSK2.js";var f=e(t());function p(){let{allMdx:{edges:e}}=s(l`
    {
      allMdx(
        filter: {
          frontmatter: {
  ...
  `);return(0,f.jsx)(u,{edges:e,returnListItems:!0})}var m=()=>(0,f.jsx)(d,{scope:{Link:n},stableName:`StyledComponentsExample`,sourceImports:[`import styled from '@emotion/styled'`,`import { Link } from '@dnb/eufemia'`],__buildScope:{Link:n},noInline:!0,children:`const StyledLink = styled(Link)\`
...
`}),h=()=>(0,f.jsx)(d,{"data-visual-test":`span-skeleton`,stableName:`UnstyledExample`,sourceImports:[`import { useState } from 'react'`,`import { Skeleton, Span, IconPrimary, ToggleButton } from '@dnb/eufemia'`,`import styled from '@emotion/styled'`],__buildScope:{Skeleton:r,Span:i,IconPrimary:c,ToggleButton:a},noInline:!0,children:`const Box = styled.div\`
  display: grid;
  place-items: center;
  width: 12rem;
  height: 4rem;
...
render(<CustomImage />)
`});function g(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,h4:`h4`,hr:`hr`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...o(),...e.components};return(0,f.jsxs)(f.Fragment,{children:[(0,f.jsx)(t.h1,{children:`HTML Elements`}),`
...
`]})]})}function _(e={}){let{wrapper:t}={...o(),...e.components};return t?(0,f.jsx)(t,{...e,children:(0,f.jsx)(g,{...e})}):g(e)}export{_ as default};