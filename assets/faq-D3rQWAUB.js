...
`,(0,r.jsxs)(t.h3,{children:[`What dies `,(0,r.jsx)(t.code,{children:`build:mini`}),` do?`]}),`
`,(0,r.jsxs)(t.p,{children:[`When running `,(0,r.jsx)(t.code,{children:`build:mini`}),` scripts, the build will be faster and the output will be smaller. It's used for the CI/CD pipeline to build the package for the Sandbox or documentation preview.`]}),`
...
`]}),`
`,(0,r.jsx)(t.h3,{children:`Jest`}),`
`,(0,r.jsxs)(t.ul,{children:[`
`,(0,r.jsxs)(t.li,{children:[`jsdom `,(0,r.jsx)(t.a,{href:`https://github.com/jsdom/jsdom/releases/tag/21.0.0`,children:`v21`}),` changed `,(0,r.jsx)(t.code,{children:`window`}),`, `,(0,r.jsx)(t.code,{children:`document`}),`, `,(0,r.jsx)(t.code,{children:`location`}),`, and top properties of Window to be non-configurable, which made it impossible to mock `,(0,r.jsx)(t.code,{children:`window.location`}),` via `,(0,r.jsx)(t.code,{children:`Object.defineProperty`}),` in Jest. Jest 30 with `,(0,r.jsx)(t.code,{children:`jest-environment-jsdom`}),` bundles jsdom v26. Tests that need to manipulate the URL now use `,(0,r.jsx)(t.code,{children:`window.history.replaceState`}),` instead of overriding `,(0,r.jsx)(t.code,{children:`window.location`}),`.`]}),`
`]}),`
