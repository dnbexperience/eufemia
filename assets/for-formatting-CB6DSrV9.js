import{a as e,s as t,t as n}from"./jsx-runtime-DnlWeMvz.js";import{tt as r}from"./Anchor-ntifJ4U1.js";import{t as i,u as a}from"./Table-v8T3COIV.js";import{n as o,t as s}from"./Ul-CCaoMTnZ.js";import{n as c,r as l,t as u}from"./Tr-PlqmYndS.js";import{t as d}from"./DateFormat-pUe_t63Z.js";import{t as f}from"./NumberFormatExport-Gdk4Ewzj.js";import{U as p}from"./index-D1L5wabr.js";import{t as m}from"./ComponentBox-B6YSImfw.js";var h=e({AmountAndCurrency:()=>w,BankAccountNumber:()=>v,DateAndTime:()=>E,DateStyles:()=>T,DateWithoutYear:()=>D,DateWithoutYearAndTime:()=>O,DurationStrings:()=>A,NationalIdentificationNumber:()=>y,Numbers:()=>x,NumbersCompact:()=>S,OrganizationNumber:()=>b,Percentage:()=>C,PhoneNumber:()=>_,RelativeTime:()=>k}),g=t(n()),_=()=>(0,g.jsx)(m,{hideCode:!0,omitWrapper:!0,scope:{Table:i},stableName:`PhoneNumber`,sourceImports:[`import { DateFormat, Li, NumberFormat, Table, Td, Th, Tr, Ul } from '@dnb/eufemia'`],__buildScope:{Ul:s,Li:o,NumberFormat:f},children:`<Ul>
  <Li>
...
`}),v=()=>(0,g.jsx)(m,{hideCode:!0,omitWrapper:!0,scope:{Table:i},stableName:`BankAccountNumber`,sourceImports:[`import { DateFormat, Li, NumberFormat, Table, Td, Th, Tr, Ul } from '@dnb/eufemia'`],__buildScope:{Ul:s,Li:o,NumberFormat:f},children:`<Ul>
  <Li>
    <NumberFormat.BankAccountNumber value="12340001358" />
  </Li>
</Ul>
`}),y=()=>(0,g.jsx)(m,{hideCode:!0,omitWrapper:!0,scope:{Table:i},stableName:`NationalIdentificationNumber`,sourceImports:[`import { DateFormat, Li, NumberFormat, Table, Td, Th, Tr, Ul } from '@dnb/eufemia'`],__buildScope:{Ul:s,Li:o,NumberFormat:f},children:`<Ul>
  <Li>
    <NumberFormat.NationalIdentityNumber value="18089212345" />
  </Li>
</Ul>
`}),b=()=>(0,g.jsx)(m,{hideCode:!0,omitWrapper:!0,scope:{Table:i},stableName:`OrganizationNumber`,sourceImports:[`import { DateFormat, Li, NumberFormat, Table, Td, Th, Tr, Ul } from '@dnb/eufemia'`],__buildScope:{Ul:s,Li:o,NumberFormat:f},children:`<Ul>
  <Li>
    <NumberFormat.OrganizationNumber value="123456789" />
  </Li>
</Ul>
`}),x=()=>(0,g.jsx)(m,{hideCode:!0,omitWrapper:!0,stableName:`Numbers`,sourceImports:[`import { DateFormat, Li, NumberFormat, Table, Td, Th, Tr, Ul } from '@dnb/eufemia'`],__buildScope:{Table:i,ScrollView:a,Tr:u,Th:c,Td:l,NumberFormat:f},children:`<Table.ScrollView>
...
`}),S=()=>(0,g.jsx)(m,{hideCode:!0,omitWrapper:!0,scope:{Table:i},stableName:`NumbersCompact`,sourceImports:[`import { DateFormat, Li, NumberFormat, Table, Td, Th, Tr, Ul } from '@dnb/eufemia'`],__buildScope:{Table:i,ScrollView:a,Tr:u,Th:c,Td:l,NumberFormat:f},children:`<Table.ScrollView>
  <Table border outline>
    <thead>
      <Tr noWrap>
        <Th>Style</Th>
...
`}),C=()=>(0,g.jsx)(m,{hideCode:!0,omitWrapper:!0,scope:{Table:i},stableName:`Percentage`,sourceImports:[`import { DateFormat, Li, NumberFormat, Table, Td, Th, Tr, Ul } from '@dnb/eufemia'`],__buildScope:{Table:i,ScrollView:a,Tr:u,Th:c,Td:l,NumberFormat:f},children:`<Table.ScrollView>
  <Table border outline>
    <thead>
      <Tr noWrap>
        <Th>Style</Th>
...
`}),w=()=>(0,g.jsx)(m,{hideCode:!0,omitWrapper:!0,scope:{Table:i},stableName:`AmountAndCurrency`,sourceImports:[`import { DateFormat, Li, NumberFormat, Table, Td, Th, Tr, Ul } from '@dnb/eufemia'`],__buildScope:{Table:i,ScrollView:a,Tr:u,Th:c,Td:l,NumberFormat:f,Code:r},children:`<Table.ScrollView>
  <Table border outline>
    <thead>
      <Tr noWrap>
        <Th>Variation</Th>
...
`}),T=()=>(0,g.jsx)(m,{hideCode:!0,omitWrapper:!0,scope:{Table:i},stableName:`DateStyles`,sourceImports:[`import { DateFormat, Li, NumberFormat, Table, Td, Th, Tr, Ul } from '@dnb/eufemia'`],__buildScope:{Table:i,ScrollView:a,Tr:u,Th:c,Td:l,DateFormat:d},children:`<Table.ScrollView>
  <Table border outline>
    <thead>
      <Tr noWrap>
        <Th>Style</Th>
...
`}),E=()=>(0,g.jsx)(m,{hideCode:!0,omitWrapper:!0,scope:{Table:i},stableName:`DateAndTime`,sourceImports:[`import { DateFormat, Li, NumberFormat, Table, Td, Th, Tr, Ul } from '@dnb/eufemia'`],__buildScope:{Table:i,ScrollView:a,Tr:u,Th:c,Td:l,DateFormat:d},children:`<Table.ScrollView>
  <Table border outline>
    <thead>
      <Tr noWrap>
        <Th>Style</Th>
...
`}),D=()=>(0,g.jsx)(m,{hideCode:!0,omitWrapper:!0,scope:{Table:i},stableName:`DateWithoutYear`,sourceImports:[`import { DateFormat, Li, NumberFormat, Table, Td, Th, Tr, Ul } from '@dnb/eufemia'`],__buildScope:{Table:i,ScrollView:a,Tr:u,Th:c,Td:l,DateFormat:d},children:`<Table.ScrollView>
  <Table border outline>
    <thead>
      <Tr noWrap>
        <Th>Style</Th>
...
`}),O=()=>(0,g.jsx)(m,{hideCode:!0,omitWrapper:!0,scope:{Table:i},stableName:`DateWithoutYearAndTime`,sourceImports:[`import { DateFormat, Li, NumberFormat, Table, Td, Th, Tr, Ul } from '@dnb/eufemia'`],__buildScope:{Table:i,ScrollView:a,Tr:u,Th:c,Td:l,DateFormat:d},children:`<Table.ScrollView>
  <Table border outline>
    <thead>
      <Tr noWrap>
        <Th>Style</Th>
...
`}),k=()=>(0,g.jsx)(m,{hideCode:!0,omitWrapper:!0,scope:{Table:i},stableName:`RelativeTime`,sourceImports:[`import { DateFormat, Li, NumberFormat, Table, Td, Th, Tr, Ul } from '@dnb/eufemia'`],__buildScope:{Table:i,ScrollView:a,Tr:u,Th:c,Td:l,DateFormat:d},children:`<Table.ScrollView>
  <Table border outline>
    <thead>
      <Tr noWrap>
        <Th>Description</Th>
...
`}),A=()=>(0,g.jsx)(m,{hideCode:!0,omitWrapper:!0,scope:{Table:i},stableName:`DurationStrings`,sourceImports:[`import { DateFormat, Li, NumberFormat, Table, Td, Th, Tr, Ul } from '@dnb/eufemia'`],__buildScope:{Table:i,ScrollView:a,Tr:u,Th:c,Td:l,DateFormat:d},children:`<Table.ScrollView>
  <Table border outline>
    <thead>
      <Tr noWrap>
        <Th>Duration</Th>
...
`,(0,g.jsx)(A,{})]})}function M(e={}){let{wrapper:t}={...p(),...e.components};return t?(0,g.jsx)(t,{...e,children:(0,g.jsx)(j,{...e})}):j(e)}function N(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{M as default};