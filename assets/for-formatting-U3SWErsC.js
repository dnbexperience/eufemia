import{a as e,r as t}from"./rolldown-runtime-BYbx6iT9.js";import{t as n}from"./jsx-runtime-BgMs7Gb-.js";import{n as r,r as i,t as a}from"./Tr-eK5jws6L.js";import{t as o}from"./DateFormat-CSFLI-4Z.js";import{t as s}from"./NumberFormatExport-BrXyzkOu.js";import{On as c,Rr as l,Rt as u,Sn as d,Wi as f,_n as p}from"./index-BIrFyEEc.js";import{t as m}from"./ComponentBox-DFVIRw0w.js";var h=t({AmountAndCurrency:()=>w,BankAccountNumber:()=>v,DateAndTime:()=>E,DateStyles:()=>T,DateWithoutYear:()=>D,DateWithoutYearAndTime:()=>O,DurationStrings:()=>A,NationalIdentificationNumber:()=>y,Numbers:()=>x,NumbersCompact:()=>S,OrganizationNumber:()=>b,Percentage:()=>C,PhoneNumber:()=>_,RelativeTime:()=>k}),g=e(n()),_=()=>(0,g.jsx)(m,{hideCode:!0,omitWrapper:!0,scope:{Table:u},stableName:`PhoneNumber`,sourceImports:[`import { DateFormat, Li, NumberFormat, Table, Td, Th, Tr, Ul } from '@dnb/eufemia'`],__buildScope:{Ul:p,Li:c,NumberFormat:s},children:`<Ul>
  <Li>
...
`}),v=()=>(0,g.jsx)(m,{hideCode:!0,omitWrapper:!0,scope:{Table:u},stableName:`BankAccountNumber`,sourceImports:[`import { DateFormat, Li, NumberFormat, Table, Td, Th, Tr, Ul } from '@dnb/eufemia'`],__buildScope:{Ul:p,Li:c,NumberFormat:s},children:`<Ul>
  <Li>
    <NumberFormat.BankAccountNumber value="12340001358" />
  </Li>
</Ul>
`}),y=()=>(0,g.jsx)(m,{hideCode:!0,omitWrapper:!0,scope:{Table:u},stableName:`NationalIdentificationNumber`,sourceImports:[`import { DateFormat, Li, NumberFormat, Table, Td, Th, Tr, Ul } from '@dnb/eufemia'`],__buildScope:{Ul:p,Li:c,NumberFormat:s},children:`<Ul>
  <Li>
    <NumberFormat.NationalIdentityNumber value="18089212345" />
  </Li>
</Ul>
`}),b=()=>(0,g.jsx)(m,{hideCode:!0,omitWrapper:!0,scope:{Table:u},stableName:`OrganizationNumber`,sourceImports:[`import { DateFormat, Li, NumberFormat, Table, Td, Th, Tr, Ul } from '@dnb/eufemia'`],__buildScope:{Ul:p,Li:c,NumberFormat:s},children:`<Ul>
  <Li>
    <NumberFormat.OrganizationNumber value="123456789" />
  </Li>
</Ul>
`}),x=()=>(0,g.jsx)(m,{hideCode:!0,omitWrapper:!0,stableName:`Numbers`,sourceImports:[`import { DateFormat, Li, NumberFormat, Table, Td, Th, Tr, Ul } from '@dnb/eufemia'`],__buildScope:{Table:u,ScrollView:d,Tr:a,Th:r,Td:i,NumberFormat:s},children:`<Table.ScrollView>
...
`}),S=()=>(0,g.jsx)(m,{hideCode:!0,omitWrapper:!0,scope:{Table:u},stableName:`NumbersCompact`,sourceImports:[`import { DateFormat, Li, NumberFormat, Table, Td, Th, Tr, Ul } from '@dnb/eufemia'`],__buildScope:{Table:u,ScrollView:d,Tr:a,Th:r,Td:i,NumberFormat:s},children:`<Table.ScrollView>
  <Table border outline>
    <thead>
      <Tr noWrap>
        <Th>Style</Th>
...
`}),C=()=>(0,g.jsx)(m,{hideCode:!0,omitWrapper:!0,scope:{Table:u},stableName:`Percentage`,sourceImports:[`import { DateFormat, Li, NumberFormat, Table, Td, Th, Tr, Ul } from '@dnb/eufemia'`],__buildScope:{Table:u,ScrollView:d,Tr:a,Th:r,Td:i,NumberFormat:s},children:`<Table.ScrollView>
  <Table border outline>
    <thead>
      <Tr noWrap>
        <Th>Style</Th>
...
`}),w=()=>(0,g.jsx)(m,{hideCode:!0,omitWrapper:!0,scope:{Table:u},stableName:`AmountAndCurrency`,sourceImports:[`import { DateFormat, Li, NumberFormat, Table, Td, Th, Tr, Ul } from '@dnb/eufemia'`],__buildScope:{Table:u,ScrollView:d,Tr:a,Th:r,Td:i,NumberFormat:s,Code:f},children:`<Table.ScrollView>
  <Table border outline>
    <thead>
      <Tr noWrap>
        <Th>Variation</Th>
...
`}),T=()=>(0,g.jsx)(m,{hideCode:!0,omitWrapper:!0,scope:{Table:u},stableName:`DateStyles`,sourceImports:[`import { DateFormat, Li, NumberFormat, Table, Td, Th, Tr, Ul } from '@dnb/eufemia'`],__buildScope:{Table:u,ScrollView:d,Tr:a,Th:r,Td:i,DateFormat:o},children:`<Table.ScrollView>
  <Table border outline>
    <thead>
      <Tr noWrap>
        <Th>Style</Th>
...
`}),E=()=>(0,g.jsx)(m,{hideCode:!0,omitWrapper:!0,scope:{Table:u},stableName:`DateAndTime`,sourceImports:[`import { DateFormat, Li, NumberFormat, Table, Td, Th, Tr, Ul } from '@dnb/eufemia'`],__buildScope:{Table:u,ScrollView:d,Tr:a,Th:r,Td:i,DateFormat:o},children:`<Table.ScrollView>
  <Table border outline>
    <thead>
      <Tr noWrap>
        <Th>Style</Th>
...
`}),D=()=>(0,g.jsx)(m,{hideCode:!0,omitWrapper:!0,scope:{Table:u},stableName:`DateWithoutYear`,sourceImports:[`import { DateFormat, Li, NumberFormat, Table, Td, Th, Tr, Ul } from '@dnb/eufemia'`],__buildScope:{Table:u,ScrollView:d,Tr:a,Th:r,Td:i,DateFormat:o},children:`<Table.ScrollView>
  <Table border outline>
    <thead>
      <Tr noWrap>
        <Th>Style</Th>
...
`}),O=()=>(0,g.jsx)(m,{hideCode:!0,omitWrapper:!0,scope:{Table:u},stableName:`DateWithoutYearAndTime`,sourceImports:[`import { DateFormat, Li, NumberFormat, Table, Td, Th, Tr, Ul } from '@dnb/eufemia'`],__buildScope:{Table:u,ScrollView:d,Tr:a,Th:r,Td:i,DateFormat:o},children:`<Table.ScrollView>
  <Table border outline>
    <thead>
      <Tr noWrap>
        <Th>Style</Th>
...
`}),k=()=>(0,g.jsx)(m,{hideCode:!0,omitWrapper:!0,scope:{Table:u},stableName:`RelativeTime`,sourceImports:[`import { DateFormat, Li, NumberFormat, Table, Td, Th, Tr, Ul } from '@dnb/eufemia'`],__buildScope:{Table:u,ScrollView:d,Tr:a,Th:r,Td:i,DateFormat:o},children:`<Table.ScrollView>
  <Table border outline>
    <thead>
      <Tr noWrap>
        <Th>Description</Th>
...
`}),A=()=>(0,g.jsx)(m,{hideCode:!0,omitWrapper:!0,scope:{Table:u},stableName:`DurationStrings`,sourceImports:[`import { DateFormat, Li, NumberFormat, Table, Td, Th, Tr, Ul } from '@dnb/eufemia'`],__buildScope:{Table:u,ScrollView:d,Tr:a,Th:r,Td:i,DateFormat:o},children:`<Table.ScrollView>
  <Table border outline>
    <thead>
      <Tr noWrap>
        <Th>Duration</Th>
...
`,(0,g.jsx)(A,{})]})}function M(e={}){let{wrapper:t}={...l(),...e.components};return t?(0,g.jsx)(t,{...e,children:(0,g.jsx)(j,{...e})}):j(e)}function N(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{M as default};