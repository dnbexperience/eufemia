import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{i as n,t as r}from"./portal-query-Cqjr3qe1.js";import{t as i}from"./Hr-BIi-K0Qb.js";import{n as a,t as o}from"./Ul-C9mOKU80.js";import{t as s}from"./Anchor-QIx8Zlc9.js";import{W as c}from"./index-BCXtuv-b.js";import l from"./clone-repo-D49IeSrR.js";import u from"./commit-changes-D5IkyCBi.js";import d from"./install-dependencies-iHdllcil.js";import f from"./make-and-run-tests-BMXBT58y.js";import p from"./making-changes-CiiUcvaM.js";import m from"./update-change-logs-rT4H0g5Z.js";var h=e(t()),g=({edges:e})=>(0,h.jsx)(o,{children:e.sort((e,t)=>e.node.frontmatter.order>t.node.frontmatter.order?1:-1).map(({node:e})=>e.tableOfContents?.items).filter(Boolean).reduce((e,t)=>(t.forEach(t=>e.push(t)),e),[]).map((e,t)=>(0,h.jsx)(_,{...e},`${e.title}-${t}`))});function _({title:e,url:t,items:n}){return(0,h.jsxs)(a,{children:[(0,h.jsx)(s,{href:t,children:e}),n?.length>0&&(0,h.jsx)(o,{children:n.map((e,t)=>(0,h.jsx)(_,{...e},`${e.title}-${t}`))})]})}var v=()=>{let{allMdx:{edges:e}}=n(r`
    query {
      allMdx(
        filter: {
          internal: {
