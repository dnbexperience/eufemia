import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{i as n,t as r}from"./portal-query-B_Ssgp7u.js";import{t as i}from"./Hr-D5svByZg.js";import{n as a,t as o}from"./Ul-BYrNoJV6.js";import{t as s}from"./Anchor-BJikroMV.js";import{U as c}from"./index-GbBmkyvI.js";import l from"./clone-repo-BSUSWgBg.js";import u from"./commit-changes-BDCDwkPq.js";import d from"./install-dependencies-Dr6hEd6-.js";import f from"./make-and-run-tests-BqnuRbxm.js";import p from"./making-changes-BdYjN29I.js";import m from"./update-change-logs-BguT8I4h.js";var h=e(t()),g=({edges:e})=>(0,h.jsx)(o,{children:e.sort((e,t)=>e.node.frontmatter.order>t.node.frontmatter.order?1:-1).map(({node:e})=>e.tableOfContents?.items).filter(Boolean).reduce((e,t)=>(t.forEach(t=>e.push(t)),e),[]).map((e,t)=>(0,h.jsx)(_,{...e},`${e.title}-${t}`))});function _({title:e,url:t,items:n}){return(0,h.jsxs)(a,{children:[(0,h.jsx)(s,{href:t,children:e}),n?.length>0&&(0,h.jsx)(o,{children:n.map((e,t)=>(0,h.jsx)(_,{...e},`${e.title}-${t}`))})]})}var v=()=>{let{allMdx:{edges:e}}=n(r`
    query {
      allMdx(
        filter: {
          internal: {
