import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{t as n}from"./Anchor-BrJZH3oR.js";import{i as r,t as i}from"./portal-query-Cq2WBZnl.js";import{t as a}from"./Hr-BVP8KiKT.js";import{n as o,t as s}from"./Ul-80bgMsZv.js";import{U as c}from"./index-CGxQ8PRe.js";import l from"./clone-repo-BxRbnAHa.js";import u from"./commit-changes-AUsdARVc.js";import d from"./install-dependencies-DdHyGKyD.js";import f from"./make-and-run-tests-Y0EAIoSa.js";import p from"./making-changes-CH4DRNxc.js";import m from"./update-change-logs-tXNycO5i.js";var h=e(t()),g=({edges:e})=>(0,h.jsx)(s,{children:e.sort((e,t)=>e.node.frontmatter.order>t.node.frontmatter.order?1:-1).map(({node:e})=>e.tableOfContents?.items).filter(Boolean).reduce((e,t)=>(t.forEach(t=>e.push(t)),e),[]).map((e,t)=>(0,h.jsx)(_,{...e},`${e.title}-${t}`))});function _({title:e,url:t,items:r}){return(0,h.jsxs)(o,{children:[(0,h.jsx)(n,{href:t,children:e}),r?.length>0&&(0,h.jsx)(s,{children:r.map((e,t)=>(0,h.jsx)(_,{...e},`${e.title}-${t}`))})]})}var v=()=>{let{allMdx:{edges:e}}=r(i`
    query {
      allMdx(
        filter: {
          internal: {
