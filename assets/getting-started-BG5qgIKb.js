import{t as e}from"./jsx-runtime-BgMs7Gb-.js";import{Ct as t,Lr as n,On as r,Tt as i,_n as a,kn as o,kt as s}from"./index--zEB_f_m.js";import c from"./clone-repo-xahisur6.js";import l from"./commit-changes-DEC93oGS.js";import u from"./install-dependencies-JOXWQ6xu.js";import d from"./make-and-run-tests-PS6QlJQl.js";import f from"./making-changes-DFrptmvt.js";import p from"./update-change-logs-D5C0kdaI.js";var m=e(),h=({edges:e})=>(0,m.jsx)(a,{children:e.sort((e,t)=>e.node.frontmatter.order>t.node.frontmatter.order?1:-1).map(({node:e})=>e.tableOfContents?.items).filter(Boolean).reduce((e,t)=>(t.forEach(t=>e.push(t)),e),[]).map((e,t)=>(0,m.jsx)(g,{...e},`${e.title}-${t}`))});function g({title:e,url:t,items:n}){return(0,m.jsxs)(r,{children:[(0,m.jsx)(s,{href:t,children:e}),n?.length>0&&(0,m.jsx)(a,{children:n.map((e,t)=>(0,m.jsx)(g,{...e},`${e.title}-${t}`))})]})}var _=()=>{let{allMdx:{edges:e}}=i(t`
    query {
      allMdx(
        filter: {
          internal: {
