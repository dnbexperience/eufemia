import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{i as n,t as r}from"./portal-query-BYW5RIMA.js";import{t as i}from"./Hr-DHsI5Xv4.js";import{n as a,t as o}from"./Ul-jQpCBea0.js";import{t as s}from"./Anchor-DgRVjnUH.js";import{K as c}from"./index-ppRu2ktv.js";import l from"./clone-repo-C-eMIp4G.js";import u from"./commit-changes-BeOuy_D6.js";import d from"./install-dependencies-CTuDNF7h.js";import f from"./make-and-run-tests-TYv1nhQg.js";import p from"./making-changes-BhJs4tf4.js";import m from"./update-change-logs-Ca4sE1sT.js";var h=e(t()),g=({edges:e})=>(0,h.jsx)(o,{children:e.sort((e,t)=>e.node.frontmatter.order>t.node.frontmatter.order?1:-1).map(({node:e})=>e.tableOfContents?.items).filter(Boolean).reduce((e,t)=>(t.forEach(t=>e.push(t)),e),[]).map((e,t)=>(0,h.jsx)(_,{...e},`${e.title}-${t}`))});function _({title:e,url:t,items:n}){return(0,h.jsxs)(a,{children:[(0,h.jsx)(s,{href:t,children:e}),n?.length>0&&(0,h.jsx)(o,{children:n.map((e,t)=>(0,h.jsx)(_,{...e},`${e.title}-${t}`))})]})}var v=()=>{let{allMdx:{edges:e}}=n(r`
    query {
      allMdx(
        filter: {
          internal: {
