import{a as e}from"./rolldown-runtime-BYbx6iT9.js";import{t}from"./jsx-runtime-BgMs7Gb-.js";import{On as n,Rr as r,_n as i,f as a,g as o,kn as s,u as c}from"./index-Da-r8F54.js";import l from"./clone-repo-DvTFwEdp.js";import u from"./commit-changes-CHlK5ghX.js";import d from"./install-dependencies-2xAjMxGI.js";import f from"./make-and-run-tests-CwDKEFxf.js";import p from"./making-changes-D2FpSfpm.js";import m from"./update-change-logs-CU-vVS9j.js";var h=e(t()),g=({edges:e})=>(0,h.jsx)(i,{children:e.sort((e,t)=>e.node.frontmatter.order>t.node.frontmatter.order?1:-1).map(({node:e})=>e.tableOfContents?.items).filter(Boolean).reduce((e,t)=>(t.forEach(t=>e.push(t)),e),[]).map((e,t)=>(0,h.jsx)(_,{...e},`${e.title}-${t}`))});function _({title:e,url:t,items:r}){return(0,h.jsxs)(n,{children:[(0,h.jsx)(o,{href:t,children:e}),r?.length>0&&(0,h.jsx)(i,{children:r.map((e,t)=>(0,h.jsx)(_,{...e},`${e.title}-${t}`))})]})}var v=()=>{let{allMdx:{edges:e}}=a(c`
    query {
      allMdx(
        filter: {
          internal: {
