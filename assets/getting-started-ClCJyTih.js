import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{i as n,t as r}from"./portal-query-66iyRONR.js";import{t as i}from"./Hr-aAMshbgw.js";import{n as a,t as o}from"./Ul-Cit54Y5N.js";import{t as s}from"./Anchor-BD2JtUnS.js";import{B as c}from"./index-DdG6L_K8.js";import l from"./clone-repo-CML94Of-.js";import u from"./commit-changes-C6P8ctT3.js";import d from"./install-dependencies-_N7kNdAJ.js";import f from"./make-and-run-tests-D3Pr7x7L.js";import p from"./making-changes-B0U06a8z.js";import m from"./update-change-logs-BGrZGJT3.js";var h=e(t()),g=({edges:e})=>(0,h.jsx)(o,{children:e.sort((e,t)=>e.node.frontmatter.order>t.node.frontmatter.order?1:-1).map(({node:e})=>e.tableOfContents?.items).filter(Boolean).reduce((e,t)=>(t.forEach(t=>e.push(t)),e),[]).map((e,t)=>(0,h.jsx)(_,{...e},`${e.title}-${t}`))});function _({title:e,url:t,items:n}){return(0,h.jsxs)(a,{children:[(0,h.jsx)(s,{href:t,children:e}),n?.length>0&&(0,h.jsx)(o,{children:n.map((e,t)=>(0,h.jsx)(_,{...e},`${e.title}-${t}`))})]})}var v=()=>{let{allMdx:{edges:e}}=n(r`
    query {
      allMdx(
        filter: {
          internal: {
