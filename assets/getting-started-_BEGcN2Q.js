import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{i as n,t as r}from"./portal-query-DtkD1mZx.js";import{t as i}from"./Hr-CJrT8ZK6.js";import{n as a,t as o}from"./Ul-B82dvgWP.js";import{t as s}from"./Anchor-EBcWrN_M.js";import{U as c}from"./index-kfZVC31v.js";import l from"./clone-repo-CO6Q_som.js";import u from"./commit-changes-BNuJIHyr.js";import d from"./install-dependencies-MSAZnYC1.js";import f from"./make-and-run-tests-BWE-8ABU.js";import p from"./making-changes-C80U78pm.js";import m from"./update-change-logs-DAPs0Q4j.js";var h=e(t()),g=({edges:e})=>(0,h.jsx)(o,{children:e.sort((e,t)=>e.node.frontmatter.order>t.node.frontmatter.order?1:-1).map(({node:e})=>e.tableOfContents?.items).filter(Boolean).reduce((e,t)=>(t.forEach(t=>e.push(t)),e),[]).map((e,t)=>(0,h.jsx)(_,{...e},`${e.title}-${t}`))});function _({title:e,url:t,items:n}){return(0,h.jsxs)(a,{children:[(0,h.jsx)(s,{href:t,children:e}),n?.length>0&&(0,h.jsx)(o,{children:n.map((e,t)=>(0,h.jsx)(_,{...e},`${e.title}-${t}`))})]})}var v=()=>{let{allMdx:{edges:e}}=n(r`
    query {
      allMdx(
        filter: {
          internal: {
