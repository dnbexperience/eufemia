...
`,(0,n.jsxs)(r.p,{children:[`If you still find yourself reaching for legacy `,(0,n.jsx)(r.code,{children:`--color-*`}),` variables, treat that as a migration signal. Those variables are deprecated; prefer semantic `,(0,n.jsx)(r.code,{children:`--token-*`}),` design tokens instead.`]}),`
