...
`,(0,i.jsxs)(t.p,{children:[`When `,(0,i.jsx)(t.code,{children:`keepInDOM`}),` or `,(0,i.jsx)(t.code,{children:`untilFound`}),` keeps closed content in the DOM, HeightAnimation applies `,(0,i.jsx)(t.code,{children:`aria-hidden="true"`}),`. The collapsed content is therefore unavailable to assistive technologies until it opens.`]}),`
`,(0,i.jsxs)(t.p,{children:[(0,i.jsx)(t.code,{children:`untilFound`}),` uses the native `,(0,i.jsx)(t.code,{children:`hidden="until-found"`}),` behavior, making collapsed text available to browser find-in-page. HeightAnimation reveals matching content internally, so `,(0,i.jsx)(t.code,{children:`onBeforeMatch`}),` is optional. When an external control owns the `,(0,i.jsx)(t.code,{children:`open`}),` state, handle `,(0,i.jsx)(t.code,{children:`onBeforeMatch`}),` by updating the same state passed to `,(0,i.jsx)(t.code,{children:`open`}),`. This keeps the control's `,(0,i.jsx)(t.code,{children:`aria-expanded`}),` value synchronized when the browser reveals a match.`]}),`
`,(0,i.jsxs)(t.p,{children:[(0,i.jsx)(t.code,{children:`untilFound`}),` depends on native browser support for `,(0,i.jsx)(t.code,{children:`hidden="until-found"`}),` (Chromium 102+, Firefox 148+, with partial support in Safari 26.2+). In browsers without support, the collapsed content is `,(0,i.jsx)(t.strong,{children:`not reliably hidden`}),` and can remain visible, because the collapse relies on the browser applying `,(0,i.jsx)(t.code,{children:`content-visibility`}),` for `,(0,i.jsx)(t.code,{children:`hidden="until-found"`}),`. For content that must stay hidden in those browsers, use `,(0,i.jsx)(t.code,{children:`keepInDOM`}),` (or leave `,(0,i.jsx)(t.code,{children:`untilFound`}),` off) instead.`]}),`
