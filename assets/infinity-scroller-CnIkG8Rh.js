...
`,(0,i.jsxs)(t.p,{children:[`Also, it adds an indicator at the bottom until next render, and as long as `,(0,i.jsx)(t.code,{children:`pageCount`}),` has not reached the internal page count. But instead of setting `,(0,i.jsx)(t.code,{children:`pageCount`}),` (total pages), you can programmatically call `,(0,i.jsx)(t.code,{children:`endInfinity()`}),` instead.`]}),`
`,(0,i.jsx)(t.pre,{children:(0,i.jsx)(t.code,{className:`language-jsx`,children:`import { createPagination } from '@dnb/eufemia/components/Pagination'
