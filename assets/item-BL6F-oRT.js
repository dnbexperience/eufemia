...
`,(0,s.jsx)(t.p,{children:`The number will be used to set the item span (a part of the container). It set a percentage unit and apply it on the item via CSS. When the container is tilled to 100%, the remaining items will wrap to a new row.`}),`
...
`,(0,s.jsxs)(t.p,{children:[`For doing so, provide a `,(0,s.jsx)(t.code,{children:`span`}),` property with an object containing `,(0,s.jsx)(t.a,{href:`/uilib/usage/layout/media-queries/`,children:`Media Query`}),` types. Each media span should contain number, like mentioned above.`]}),`
`,(0,s.jsx)(a,{}),`
