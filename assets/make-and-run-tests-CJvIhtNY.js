import{t as e}from"./jsx-runtime-BgMs7Gb-.js";import{Lr as t}from"./index-2AO2Cu5K.js";var n=e();function r(e){let r={a:`a`,code:`code`,em:`em`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,ol:`ol`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...t(),...e.components};return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(r.h1,{children:`Make and run tests`}),`
...
`,(0,n.jsxs)(r.ul,{children:[`
`,(0,n.jsx)(r.li,{children:(0,n.jsx)(r.code,{children:`/packages/dnb-eufemia/visual-diff-report/index.html`})}),`
`]}),`
`,(0,n.jsx)(r.p,{children:`You may check out the CI/CLI logs for more details.`}),`
`,(0,n.jsxs)(r.p,{children:[(0,n.jsx)(r.strong,{children:`GitHub Actions:`}),` If visual screenshot test is failing on the CI, you can navigate to the test "Summary" where you can find "Artifacts". There you can download the `,(0,n.jsx)(r.strong,{children:`visual-test-artifact`}),` zip file, containing the visual diff files as well as the report entry inside `,(0,n.jsx)(r.code,{children:`/visual-diff-report`}),`.`]}),`
