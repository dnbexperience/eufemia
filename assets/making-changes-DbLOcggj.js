...
`,(0,r.jsxs)(t.p,{children:[`Inside `,(0,r.jsx)(t.code,{children:`./packages/dnb-eufemia`}),` you will find the directory `,(0,r.jsx)(t.code,{children:`/src/components`}),` or `,(0,r.jsx)(t.code,{children:`/src/extensions`}),`. There you can place a new directory with all the necessary sub folders. As a reference, take a look at Component folder section in `,(0,r.jsx)(t.a,{href:`/contribute/first-contribution/before-started#component-folder`,children:`Before getting started`}),`.`]}),`
`,(0,r.jsxs)(t.p,{children:[`Run an environment with either `,(0,r.jsx)(t.code,{children:`yarn dev`}),` (for Storybook) or `,(0,r.jsx)(t.code,{children:`yarn start`}),` (for Eufemia Portal). Make sure you follow the `,(0,r.jsx)(t.a,{href:`/contribute/style-guides/coding`,children:`Code guide`}),` under development.`]}),`
...
`,(0,r.jsxs)(t.p,{children:[`SCSS file names starting with `,(0,r.jsx)(t.code,{children:`dnb-`}),` are later possible to get imported as individual packages:`]}),`
`,(0,r.jsxs)(t.ul,{children:[`
`,(0,r.jsx)(t.li,{children:(0,r.jsx)(t.code,{children:`./packages/dnb-eufemia/src/components/button/style/dnb-button.scss`})}),`
`]}),`
`,(0,r.jsx)(t.h3,{children:`Style dependencies`}),`
`,(0,r.jsxs)(t.p,{children:[`In order to test related style dependencies of components, we add style imports in the `,(0,r.jsx)(t.code,{children:`deps.scss`}),` file, which again is used in Jest tests to perform a snapshot comparison:`]}),`
`,(0,r.jsxs)(t.ul,{children:[`
...
`]}),`
`,(0,r.jsxs)(t.p,{children:[`Theming file names ending with `,(0,r.jsx)(t.code,{children:`-ui`}),` will during the package release get packed into the global theming package. More details in the `,(0,r.jsx)(t.a,{href:`/uilib/usage/customisation/theming`,children:`theming section`}),`.`]}),`
`,(0,r.jsx)(t.h3,{children:`SCSS utilities`}),`
`,(0,r.jsxs)(t.p,{children:[`Use the same SASS setup as all the other components. You may re-use all the `,(0,r.jsx)(t.a,{href:`/uilib/helpers/classes`,children:`helper classes`}),`:`]}),`
`,(0,r.jsxs)(t.ul,{children:[`
...
`,(0,r.jsx)(t.p,{children:`Running the build command will walk through all parts and tie together all needed parts (index files of new components) in order to generate valid build bundles.`}),`
...
`,(0,r.jsxs)(t.p,{children:[`Put your translation inside: `,(0,r.jsx)(t.code,{children:`./packages/dnb-eufemia/src/shared/locales/nb-NO.js`}),` as well as to the `,(0,r.jsx)(t.code,{children:`en-GB.js`}),` file:`]}),`
...
`})}),`
`,(0,r.jsxs)(t.p,{children:[`The function `,(0,r.jsx)(t.code,{children:`getTranslation`}),` will along with the properties support both `,(0,r.jsx)(t.code,{children:`locale`}),` and the HTML `,(0,r.jsx)(t.code,{children:`lang`}),` attribute. This way, these properties can be set by a component basis and a context basis.`]}),`
...
`,(0,r.jsxs)(t.p,{children:[`It depends from case to case on how you would make `,(0,r.jsx)(t.a,{href:`/uilib/layout/space`,children:`spacing`}),` support available. But you may always allow the developer to pass in the spacing properties to the very root element of your component.`]}),`
`,(0,r.jsx)(t.pre,{children:(0,r.jsx)(t.code,{className:`language-tsx`,children:`import { Context } from '../../shared'
...
`]}),`
`,(0,r.jsxs)(t.p,{children:[`You may have a look at `,(0,r.jsx)(t.a,{href:`/contribute/style-guides/documentation`,children:`Documentation guide`}),` and existing docs in order to get the right structure.`]})]})}function a(e={}){let{wrapper:t}={...n(),...e.components};return t?(0,r.jsx)(t,{...e,children:(0,r.jsx)(i,{...e})}):i(e)}export{a as default};