import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{U as n}from"./index-DHCu7dhB.js";var r=e(t());function i(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,h4:`h4`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(t.h1,{children:`Making changes`}),`
...
`,(0,r.jsxs)(t.p,{children:[`Form elements should support spacing properties on their rendered root by using `,(0,r.jsx)(t.code,{children:`useSpacing`}),`, as described in `,(0,r.jsx)(t.a,{href:`#spacing-support`,children:`Spacing support`}),` below. Flex uses rendered DOM and CSS gap, so components should not assign `,(0,r.jsx)(t.code,{children:`_supportsSpacingProps`}),`.`]}),`
