...
`,(0,i.jsxs)(t.li,{children:[`Keyboard navigation follows the `,(0,i.jsx)(t.a,{href:`https://www.w3.org/WAI/ARIA/apg/patterns/menu/`,children:`WAI-ARIA Menu Pattern`}),`:`,`
`,(0,i.jsxs)(t.ul,{children:[`
...
`,(0,i.jsxs)(t.p,{children:[`The Menu component uses `,(0,i.jsx)(t.a,{href:`/uilib/components/portal-root`,children:`PortalRoot`}),` internally through Popover to render its top-level menu. See the `,(0,i.jsx)(t.a,{href:`/uilib/components/portal-root`,children:`PortalRoot documentation`}),` for information on how to control where the portal content appears in the DOM, and for the `,(0,i.jsx)(t.a,{href:`/uilib/components/portal-root/#browsertranslate-helper-google-translate`,children:`BrowserTranslate helper`}),` when browser translation tools such as Google Translate should not modify content rendered through PortalRoot.`]}),`
