import{t as e}from"./jsx-runtime-BgMs7Gb-.js";import{Rr as t}from"./index-CMgyXmp3.js";var n=e();function r(e){let r={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,h4:`h4`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...t(),...e.components};return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(r.h1,{children:`ESM and transpiling`}),`
...
`})}),`
`,(0,n.jsx)(r.h4,{children:`Jest and ESM (Node testing environments)`}),`
`,(0,n.jsxs)(r.p,{children:[`Older Jest versions uses still CommonJS as the default module format. If you use the default `,(0,n.jsx)(r.code,{children:`@dnb/eufemia`}),` imports, then you get a mismatch between ES module and CommonJS formats. To ensure that Jest transforms your code in to CJS, you can use the following Jest configuration `,(0,n.jsx)(r.code,{children:`--moduleNameMapper`})]}),`
