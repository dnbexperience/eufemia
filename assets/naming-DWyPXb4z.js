import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{U as n}from"./index-DHCu7dhB.js";var r=e(t());function i(e){let t={code:`code`,em:`em`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(t.h1,{children:`Naming convention`}),`
...
`,(0,r.jsx)(t.h2,{children:`Component prop types`}),`
`,(0,r.jsxs)(t.p,{children:[`Prop types follow a consistent naming convention using the component name in `,(0,r.jsx)(t.strong,{children:`pascal case`}),`:`]}),`
`,(0,r.jsxs)(t.ul,{children:[`
`,(0,r.jsxs)(t.li,{children:[(0,r.jsx)(t.code,{children:`XxxProps`}),` – the component's own, individually documented props. This is the type consumers import.`]}),`
`,(0,r.jsxs)(t.li,{children:[(0,r.jsx)(t.code,{children:`XxxAllProps`}),` – the complete set of props the component accepts. It combines `,(0,r.jsx)(t.code,{children:`XxxProps`}),` with the shared props the component composes on top, such as `,(0,r.jsx)(t.code,{children:`SpacingProps`}),` and forwarded element/HTML attributes. Export it whenever a component adds props beyond its own, and use it as the type of the component function and the `,(0,r.jsx)(t.code,{children:`xxxDefaultProps`}),` object.`]}),`
`,(0,r.jsxs)(t.li,{children:[(0,r.jsx)(t.code,{children:`xxxDefaultProps`}),` – the object holding the component's default prop values, named in `,(0,r.jsx)(t.strong,{children:`camel case`}),`.`]}),`
`]}),`
`,(0,r.jsx)(t.pre,{children:(0,r.jsx)(t.code,{className:`language-tsx`,children:`export type BadgeProps = {
