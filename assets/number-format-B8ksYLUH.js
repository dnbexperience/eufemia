import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{t as n}from"./Currency-aR-bHmFX.js";import{a as r,i,n as a,o,r as s,s as c,t as l}from"./NumberFormatExport-DiAZGuOM.js";import{U as u}from"./index-CGxQ8PRe.js";import d from"./demos-5K2l-S9h.js";var f=e(t());function p(e){let t={a:`a`,blockquote:`blockquote`,code:`code`,h2:`h2`,h3:`h3`,h4:`h4`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,table:`table`,tbody:`tbody`,td:`td`,th:`th`,thead:`thead`,tr:`tr`,ul:`ul`,...u(),...e.components},{RelatedComponents:d}=t;return l||h(`NumberFormat`,!1),i||h(`NumberFormat.BankAccountNumber`,!0),n||h(`NumberFormat.Currency`,!0),s||h(`NumberFormat.NationalIdentityNumber`,!0),c||h(`NumberFormat.Number`,!0),a||h(`NumberFormat.OrganizationNumber`,!0),o||h(`NumberFormat.Percent`,!0),r||h(`NumberFormat.PhoneNumber`,!0),d||h(`RelatedComponents`,!0),(0,f.jsxs)(f.Fragment,{children:[(0,f.jsx)(t.h2,{children:`Import`}),`
...
`,(0,f.jsxs)(t.p,{children:[`It uses the browser API `,(0,f.jsx)(t.code,{children:`Intl.NumberFormat`}),` under the hood, as well as some custom formatters. The locale defaults to:`]}),`
`,(0,f.jsxs)(t.ul,{children:[`
...
`,(0,f.jsx)(t.p,{children:`You can disable this behavior:`}),`
`,(0,f.jsx)(t.pre,{children:(0,f.jsx)(t.code,{className:`language-html`,children:`<html x-ms-format-detection="none">
  ...
</html>
`})}),`
`,(0,f.jsx)(d,{})]})}function m(e={}){let{wrapper:t}={...u(),...e.components};return t?(0,f.jsx)(t,{...e,children:(0,f.jsx)(p,{...e})}):p(e)}function h(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}function g(e){return(0,f.jsxs)(f.Fragment,{children:[(0,f.jsx)(m,{}),`
