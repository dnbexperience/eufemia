import{a as e,r as t}from"./rolldown-runtime-BYbx6iT9.js";import{t as n}from"./jsx-runtime-BgMs7Gb-.js";import{t as r}from"./export-DNWhdCGQ.js";import{Ha as i,Mi as a,Rr as o,Ua as s,wr as c}from"./index-Da-r8F54.js";import{t as l}from"./ComponentBox-DXeEXSK2.js";var u=t({PageLayoutExample:()=>f}),d=e(n());function f(){return(0,d.jsxs)(d.Fragment,{children:[(0,d.jsx)(i,{styles:s`
          /** Reset global styles */
          #dnb-app-content,
        ...
        `}),(0,d.jsx)(l,{hideCode:!0,scope:{useMedia:a},stableName:`PageLayoutExample`,sourceImports:[`import { useState } from 'react'`,`import { Global, css } from '@emotion/react'`,`import { useMedia } from '@dnb/eufemia/shared'`,`import { Button, Grid } from '@dnb/eufemia'`,`import styled from '@emotion/styled'`],__buildScope:{Grid:r,Button:c},noInline:!0,children:`function PageLayout() {
...
render(<PageLayout />)
`})]})}function p(e){let t={p:`p`,...o(),...e.components};return u||h(`Examples`,!1),f||h(`Examples.PageLayoutExample`,!0),(0,d.jsxs)(d.Fragment,{children:[(0,d.jsx)(t.p,{children:`This is a demo of how to use the Grid component for a page layout. It visualizes each column, instead of the actual content.
Resize your browser window to see how it changes based on different breakpoints.`}),`
`,(0,d.jsx)(f,{})]})}function m(e={}){let{wrapper:t}={...o(),...e.components};return t?(0,d.jsx)(t,{...e,children:(0,d.jsx)(p,{...e})}):p(e)}function h(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{m as default};