import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{U as n}from"./index-BsJ3GLEw.js";var r=e(t());function i(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,ul:`ul`,...n(),...e.components},{RelatedComponents:i}=t;return i||o(`RelatedComponents`,!0),(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(t.h2,{children:`Import`}),`
...
`})}),`
`,(0,r.jsxs)(t.p,{children:[`When `,(0,r.jsx)(t.code,{children:`off`}),` is set, every form component inside the scope will have `,(0,r.jsx)(t.code,{children:`translate="no"`}),` on both its trigger element and its portal content. Without `,(0,r.jsx)(t.code,{children:`off`}),`, the component renders children as-is.`]}),`
`,(0,r.jsx)(i,{})]})}function a(e={}){let{wrapper:t}={...n(),...e.components};return t?(0,r.jsx)(t,{...e,children:(0,r.jsx)(i,{...e})}):i(e)}function o(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}function s(e){return(0,r.jsx)(a,{})}function c(e={}){let{wrapper:t}={...n(),...e.components};return t?(0,r.jsx)(t,{...e,children:(0,r.jsx)(s,{...e})}):s(e)}export{c as default};