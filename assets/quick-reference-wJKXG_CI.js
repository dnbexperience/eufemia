import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{U as n}from"./index-kfZVC31v.js";var r=e(t());function i(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,ol:`ol`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(t.h1,{children:`Eufemia quick reference`}),`
...
`,(0,r.jsxs)(t.li,{children:[`For rendering fields or form UI outside the handler subtree, use `,(0,r.jsx)(t.a,{href:`/uilib/extensions/forms/Form/Outlet`,children:`Form.Outlet`}),` together with a shared form handler id (`,(0,r.jsx)(t.code,{children:`formHandlerId`}),`).`]}),`
