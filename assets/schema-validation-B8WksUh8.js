import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{U as n}from"./index-BsJ3GLEw.js";import r from"./demos-DCDUwRj1.js";var i=e(t());function a(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,li:`li`,ol:`ol`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(t.h2,{children:`Relevant links`}),`
...
`,(0,i.jsx)(t.li,{children:(0,i.jsx)(t.a,{href:`#non-finite-numbers-infinity-and-nan`,children:`Non-finite numbers (Infinity and NaN)`})}),`
...
`,(0,i.jsx)(t.h2,{children:`Non-finite numbers (Infinity and NaN)`}),`
`,(0,i.jsxs)(t.p,{children:[`Zod's `,(0,i.jsx)(t.code,{children:`z.number()`}),` does not accept non-finite numbers (`,(0,i.jsx)(t.code,{children:`Infinity`}),`, `,(0,i.jsx)(t.code,{children:`-Infinity`}),` and `,(0,i.jsx)(t.code,{children:`NaN`}),`) and rejects them with a type error. A schema you supply will therefore block submit if the data contains such a value – for example a calculated percentage where the previous value was `,(0,i.jsx)(t.code,{children:`0`}),`, where the division by zero produces `,(0,i.jsx)(t.code,{children:`Infinity`}),`. Eufemia shows a clear, localized message for this instead of a cryptic type error, but does not change the verdict: the value is still invalid.`]}),`
`,(0,i.jsxs)(t.p,{children:[`The recommended approach is to store an empty value (such as `,(0,i.jsx)(t.code,{children:`undefined`}),`) for impossible results instead of a non-finite number:`]}),`
`,(0,i.jsx)(t.pre,{children:(0,i.jsx)(t.code,{className:`language-ts`,children:`const change =
  previous === 0 ? undefined : ((current - previous) / previous) * 100
`})}),`
`,(0,i.jsxs)(t.p,{children:[`If you do need to accept non-finite numbers, widen your schema accordingly, for example with a `,(0,i.jsx)(t.code,{children:`z.preprocess`}),` that maps non-finite values to `,(0,i.jsx)(t.code,{children:`undefined`}),`.`]}),`
`,(0,i.jsxs)(t.p,{children:[`See `,(0,i.jsx)(t.a,{href:`/uilib/extensions/forms/base-fields/Number/#non-finite-values-infinity-and-nan`,children:`Field.Number`}),` for how the field displays and validates these values.`]}),`
