import{t as e}from"./jsx-runtime-BgMs7Gb-.js";import{Lr as t}from"./index-2AO2Cu5K.js";var n=e();function r(e){let r={a:`a`,code:`code`,h1:`h1`,h2:`h2`,p:`p`,pre:`pre`,strong:`strong`,...t(),...e.components};return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(r.h1,{children:`Theming`}),`
...
`,(0,n.jsx)(r.p,{children:`The Eufemia Portal (documentation) uses a dedicated runtime theme loader to handle it both in development and production mode.`}),`
...
`})}),`
`,(0,n.jsx)(r.h2,{children:`Dark surfaces`}),`
...
`,(0,n.jsx)(r.pre,{children:(0,n.jsx)(r.code,{className:`language-tsx`,children:`// DNB theme
...
`})}),`
`,(0,n.jsx)(r.p,{children:`For Tailwind, dark tokens are in a separate file per theme:`}),`
`,(0,n.jsx)(r.pre,{children:(0,n.jsx)(r.code,{className:`language-css`,children:`/* DNB theme */
...
`,(0,n.jsxs)(r.p,{children:[`Read more about the `,(0,n.jsx)(r.a,{href:`/uilib/usage/customisation/theming/theme/`,children:`colorScheme`}),` property, including `,(0,n.jsx)(r.a,{href:`/uilib/usage/customisation/theming/theme/#preventing-dark-mode-flash-fouc`,children:`preventing dark mode flash (FOUC)`}),` for SSR considerations.`]}),`
`,(0,n.jsxs)(r.p,{children:[`For guidance on choosing between base, `,(0,n.jsx)(r.code,{children:`inverse`}),`, and `,(0,n.jsx)(r.code,{children:`ondark`}),` token variants in dark mode, see the `,(0,n.jsx)(r.a,{href:`/uilib/usage/customisation/theming/design-tokens/dark-mode`,children:`Design Tokens dark mode guide`}),`.`]})]})}function i(e={}){let{wrapper:i}={...t(),...e.components};return i?(0,n.jsx)(i,{...e,children:(0,n.jsx)(r,{...e})}):r(e)}export{i as default};