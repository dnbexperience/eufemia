import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{U as n}from"./index-BsJ3GLEw.js";import r from"./demos-C83D37qJ.js";var i=e(t());function a(e){let t={a:`a`,code:`code`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(t.h2,{children:`Import`}),`
`,(0,i.jsx)(t.pre,{children:(0,i.jsx)(t.code,{className:`language-tsx`,children:`import { Form } from '@dnb/eufemia/extensions/forms'
// Use Form.useData, Form.useDataValue or Form.useDataWithoutSubscription
`})}),`
...
`,(0,i.jsxs)(t.p,{children:[`If rendered output depends on one form data path inside `,(0,i.jsx)(t.code,{children:`Form.Handler`}),`, use `,(0,i.jsx)(t.a,{href:`/uilib/extensions/forms/Form/useDataValue/`,children:`Form.useDataValue`}),`.`]}),`
`,(0,i.jsxs)(t.p,{children:[`If you need the imperative helpers without subscribing to form data changes, use `,(0,i.jsx)(t.code,{children:`Form.useDataWithoutSubscription`}),`.`]}),`
`,(0,i.jsxs)(t.p,{children:[`For custom field or value components that render a form value, prefer `,(0,i.jsx)(t.a,{href:`/uilib/extensions/forms/create-component/useFieldProps/`,children:`useFieldProps`}),` or `,(0,i.jsx)(t.a,{href:`/uilib/extensions/forms/create-component/useValueProps/`,children:`useValueProps`}),`. They keep the component reactive with path-scoped form updates.`]}),`
`,(0,i.jsx)(t.h2,{children:`Relevant links`}),`
`,(0,i.jsxs)(t.ul,{children:[`
`,(0,i.jsx)(t.li,{children:(0,i.jsx)(t.a,{href:`https://github.com/dnbexperience/eufemia/tree/main/packages/dnb-eufemia/src/extensions/forms/Form/DataContext/useData.ts`,children:`Source code`})}),`
`,(0,i.jsx)(t.li,{children:(0,i.jsx)(t.a,{href:`https://github.com/dnbexperience/eufemia/tree/main/packages/dnb-eufemia/src/extensions/forms/Form/DataContext/useDataWithoutSubscription.ts`,children:`Source code for useDataWithoutSubscription`})}),`
...
`,(0,i.jsx)(t.li,{children:(0,i.jsx)(t.a,{href:`/uilib/extensions/forms/Form/Outlet/`,children:`Form.Outlet`})}),`
`]}),`
...
`]}),`
`,(0,i.jsx)(t.h3,{children:`Path value subscription`}),`
`,(0,i.jsxs)(t.p,{children:[`Use `,(0,i.jsx)(t.a,{href:`/uilib/extensions/forms/Form/useDataValue/`,children:`Form.useDataValue`}),` when rendered output depends on a single form value inside `,(0,i.jsx)(t.code,{children:`Form.Handler`}),`. It subscribes only to that path.`]}),`
`,(0,i.jsx)(t.h3,{children:`Without subscription`}),`
`,(0,i.jsxs)(t.p,{children:[(0,i.jsx)(t.code,{children:`Form.useData`}),` subscribes the hook consumer to form data changes. This is useful when rendered output depends on the data.`]}),`
`,(0,i.jsxs)(t.p,{children:[`If rendered output depends on one value, use `,(0,i.jsx)(t.a,{href:`/uilib/extensions/forms/Form/useDataValue/`,children:`Form.useDataValue`}),` to subscribe only to that path.`]}),`
`,(0,i.jsxs)(t.p,{children:[`For custom fields and other internal integrations that only need imperative access to form data, use `,(0,i.jsx)(t.code,{children:`Form.useDataWithoutSubscription`}),`. It accepts the same optional `,(0,i.jsx)(t.code,{children:`id`}),` and `,(0,i.jsx)(t.code,{children:`initialData`}),` arguments as `,(0,i.jsx)(t.code,{children:`Form.useData`}),`, but does not subscribe to form data updates.`]}),`
`,(0,i.jsxs)(t.p,{children:[`It returns `,(0,i.jsx)(t.code,{children:`getData`}),`, `,(0,i.jsx)(t.code,{children:`getValue`}),`, `,(0,i.jsx)(t.code,{children:`update`}),`, `,(0,i.jsx)(t.code,{children:`remove`}),`, `,(0,i.jsx)(t.code,{children:`set`}),`, `,(0,i.jsx)(t.code,{children:`filterData`}),` and `,(0,i.jsx)(t.code,{children:`reduceToVisibleFields`}),`. It does not return `,(0,i.jsx)(t.code,{children:`data`}),`, because `,(0,i.jsx)(t.code,{children:`data`}),` would be a stale render snapshot after form changes. Use `,(0,i.jsx)(t.code,{children:`getData`}),` or `,(0,i.jsx)(t.code,{children:`getValue`}),` when you need the latest value without subscribing.`]}),`
`,(0,i.jsxs)(t.p,{children:[(0,i.jsx)(t.code,{children:`Form.useDataWithoutSubscription`}),` is not a replacement for `,(0,i.jsx)(t.a,{href:`/uilib/extensions/forms/create-component/useFieldProps/`,children:`useFieldProps`}),` or `,(0,i.jsx)(t.a,{href:`/uilib/extensions/forms/create-component/useValueProps/`,children:`useValueProps`}),` inside custom fields that render form data. Use those hooks for the rendered field value, and use `,(0,i.jsx)(t.code,{children:`Form.useDataWithoutSubscription`}),` only for additional imperative reads or writes in callbacks, effects or internal handlers.`]}),`
`,(0,i.jsx)(t.pre,{children:(0,i.jsx)(t.code,{className:`language-tsx`,children:`import { Form } from '@dnb/eufemia/extensions/forms'

function MyComponent() {
  const { getData, getValue, update } = Form.useDataWithoutSubscription()

  const handleClick = () => {
    const data = getData()
    const value = getValue('/foo') ?? data?.foo
    update('/bar', value)
  }
...
`,(0,i.jsxs)(t.p,{children:[`If you need to render fields, values, or other `,(0,i.jsx)(t.code,{children:`Form.*`}),` components in another part of the component tree, use `,(0,i.jsx)(t.a,{href:`/uilib/extensions/forms/Form/Outlet/`,children:`Form.Outlet`}),` with the same form handler id (`,(0,i.jsx)(t.code,{children:`formHandlerId`}),`).`]}),`
