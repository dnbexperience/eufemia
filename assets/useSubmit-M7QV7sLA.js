import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{U as n}from"./index-BsJ3GLEw.js";import r from"./demos-CsO914g1.js";var i=e(t());function a(e){let t={a:`a`,code:`code`,h2:`h2`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(t.h2,{children:`Import`}),`
...
`,(0,i.jsxs)(t.p,{children:[`For rendering fields and other form components outside the handler tree, use `,(0,i.jsx)(t.a,{href:`/uilib/extensions/forms/Form/Outlet/`,children:`Form.Outlet`}),` with the same form handler id (`,(0,i.jsx)(t.code,{children:`formHandlerId`}),`).`]}),`
