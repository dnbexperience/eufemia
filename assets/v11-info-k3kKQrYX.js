...
`,(0,i.jsxs)(t.blockquote,{children:[`
`,(0,i.jsxs)(t.p,{children:[(0,i.jsx)(t.strong,{children:`Using AI to migrate?`}),` Set up the `,(0,i.jsx)(t.a,{href:`/uilib/usage/first-steps/tools/#ai-assistance-and-mcp-server`,children:`Eufemia MCP server`}),` to give your AI agent access to the full v11 API documentation alongside this migration guide.`]}),`
`]}),`
...
`,(0,i.jsxs)(t.p,{children:[`The returned `,(0,i.jsx)(t.code,{children:`parts`}),` shape is unchanged. Standard Eufemia formatters preserve semantic formatter parts, while custom formatter objects fall back to parsing the returned display string.`]}),`
