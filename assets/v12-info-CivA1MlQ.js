import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{K as n}from"./index-CsG353ar.js";var r=e(t());function i(e){let t={a:`a`,blockquote:`blockquote`,code:`code`,em:`em`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(t.h1,{children:`v12`}),`
...
`,(0,r.jsx)(t.h3,{children:`TODO: Remove unused CSS custom properties`}),`
`,(0,r.jsxs)(t.blockquote,{children:[`
`,(0,r.jsxs)(t.p,{children:[(0,r.jsx)(t.strong,{children:`This task has not been completed yet.`}),` The properties listed below are still present in the codebase and documentation.`]}),`
`]}),`
`,(0,r.jsxs)(t.p,{children:[`The following CSS custom properties are defined but never consumed via `,(0,r.jsx)(t.code,{children:`var()`}),` in the codebase. They are currently documented and should be removed along with their documentation:`]}),`
`,(0,r.jsxs)(t.p,{children:[(0,r.jsx)(t.strong,{children:`Layout breakpoints`}),` (documented in `,(0,r.jsx)(t.a,{href:`/uilib/layout/media-queries`,children:`media queries`}),` and v10-info.mdx):`]}),`
`,(0,r.jsxs)(t.ul,{children:[`
`,(0,r.jsxs)(t.li,{children:[(0,r.jsx)(t.code,{children:`--layout-small`}),` (`,(0,r.jsx)(t.code,{children:`40em`}),`)`]}),`
`,(0,r.jsxs)(t.li,{children:[(0,r.jsx)(t.code,{children:`--layout-x-large`}),` (`,(0,r.jsx)(t.code,{children:`80em`}),`)`]}),`
`,(0,r.jsxs)(t.li,{children:[(0,r.jsx)(t.code,{children:`--layout-xx-large`}),` (`,(0,r.jsx)(t.code,{children:`90em`}),`)`]}),`
`]}),`
`,(0,r.jsxs)(t.p,{children:[(0,r.jsx)(t.strong,{children:`Shadow partials`}),` (documented in `,(0,r.jsx)(t.a,{href:`/uilib/helpers/classes`,children:`helper classes`}),`):`]}),`
`,(0,r.jsxs)(t.ul,{children:[`
`,(0,r.jsxs)(t.li,{children:[(0,r.jsx)(t.code,{children:`--shadow-default-blur-radius`}),` (`,(0,r.jsx)(t.code,{children:`16px`}),`)`]}),`
`,(0,r.jsxs)(t.li,{children:[(0,r.jsx)(t.code,{children:`--shadow-sharp-x`}),` (`,(0,r.jsx)(t.code,{children:`0`}),`)`]}),`
`,(0,r.jsxs)(t.li,{children:[(0,r.jsx)(t.code,{children:`--shadow-sharp-y`}),` (`,(0,r.jsx)(t.code,{children:`1px`}),`)`]}),`
`,(0,r.jsxs)(t.li,{children:[(0,r.jsx)(t.code,{children:`--shadow-sharp-blur-radius`}),` (`,(0,r.jsx)(t.code,{children:`6px`}),`)`]}),`
`,(0,r.jsxs)(t.li,{children:[(0,r.jsx)(t.code,{children:`--shadow-sharp-color`}),` (`,(0,r.jsx)(t.code,{children:`rgb(0 0 0 / 16%)`}),`)`]}),`
`]}),`
`,(0,r.jsxs)(t.p,{children:[(0,r.jsx)(t.strong,{children:`Typography`}),` (documented in `,(0,r.jsx)(t.a,{href:`/uilib/usage/customisation/styling`,children:`styling`}),`):`]}),`
`,(0,r.jsxs)(t.ul,{children:[`
`,(0,r.jsxs)(t.li,{children:[(0,r.jsx)(t.code,{children:`--font-weight-default`}),` (`,(0,r.jsx)(t.code,{children:`400`}),`)`]}),`
`]}),`
`,(0,r.jsxs)(t.p,{children:[(0,r.jsx)(t.strong,{children:`Colors`}),` (documented in color table):`]}),`
`,(0,r.jsxs)(t.ul,{children:[`
`,(0,r.jsxs)(t.li,{children:[(0,r.jsx)(t.code,{children:`--color-mint-green-25`}),` (`,(0,r.jsx)(t.code,{children:`#e0f5f0`}),`)`]}),`
`]}),`
`,(0,r.jsxs)(t.p,{children:[`When removing these properties, also update the documentation in `,(0,r.jsx)(t.code,{children:`classes.mdx`}),` (shadow helper classes), `,(0,r.jsx)(t.code,{children:`media-queries.mdx`}),`, `,(0,r.jsx)(t.code,{children:`styling.mdx`}),`, and `,(0,r.jsx)(t.code,{children:`ColorTable.tsx`}),` accordingly.`]}),`
