...
`,(0,r.jsxs)(t.ul,{children:[`
`,(0,r.jsxs)(t.li,{children:[`find `,(0,r.jsx)(t.code,{children:`save_alt_01`}),` and replace if with `,(0,r.jsx)(t.code,{children:`save`})]}),`
...
`,(0,r.jsxs)(t.p,{children:[`Soon we will have our own `,(0,r.jsx)(t.em,{children:`DNB font`}),`. This will have impact on both, `,(0,r.jsx)(t.code,{children:`font-family`}),`, `,(0,r.jsx)(t.code,{children:`font-size`}),`, `,(0,r.jsx)(t.code,{children:`font-weight`}),` and `,(0,r.jsx)(t.code,{children:`line-height`}),`.`]}),`
`,(0,r.jsxs)(t.p,{children:[`To get prepared for these changes, you can today already (since `,(0,r.jsx)(t.code,{children:`v4.24`}),`) use the now exposed properties for both:`]}),`
`,(0,r.jsxs)(t.ul,{children:[`
...
`]}),`
`,(0,r.jsxs)(t.p,{children:[`From before we had `,(0,r.jsx)(t.a,{href:`/uilib/typography/font-weight`,children:`font-weight`}),`.`]}),`
...
`,(0,r.jsxs)(t.p,{children:[`The new `,(0,r.jsx)(t.a,{href:`/uilib/components/number`,children:`Number component`}),` is a ready to use DNB number formatter. Use it where over you have to display a number, a currency value, phone number, etc.`]}),`
`,(0,r.jsx)(t.p,{children:`Good reasons for why we have this is to:`}),`
`,(0,r.jsxs)(t.ul,{children:[`
`,(0,r.jsx)(t.li,{children:`uniform the formation of numbers for all DNB applications.`}),`
`,(0,r.jsx)(t.li,{children:`and make numbers accessible to screen readers.`}),`
`]}),`
`,(0,r.jsx)(t.h2,{children:`Color changes`}),`
`,(0,r.jsxs)(t.ul,{children:[`
`,(0,r.jsxs)(t.li,{children:[(0,r.jsx)(t.em,{children:`Cherry Red`}),` will got replaced by `,(0,r.jsx)(t.em,{children:`Fire Red`}),`.`]}),`
`,(0,r.jsxs)(t.li,{children:[(0,r.jsx)(t.em,{children:`Cherry Red 8%`}),` will got replaced by `,(0,r.jsx)(t.em,{children:`Fire Red 8%`}),`.`]}),`
`]}),`
...
`,(0,r.jsxs)(t.p,{children:[(0,r.jsx)(t.strong,{children:`Mostly likely no`}),`. The majority of applications / projects does not to have to make changes.`]}),`
