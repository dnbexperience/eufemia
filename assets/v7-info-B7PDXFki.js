import{s as e,t}from"./jsx-runtime-DnlWeMvz.js";import{U as n}from"./index-DHCu7dhB.js";var r=e(t());function i(e){let t={a:`a`,code:`code`,em:`em`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,ol:`ol`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...n(),...e.components};return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(t.h1,{children:`v7`}),`
...
`]}),`
`]}),`
`,(0,r.jsxs)(t.li,{children:[`The `,(0,r.jsx)(t.a,{href:`/uilib/components/dropdown`,children:`Dropdown`}),` uses now by default React Portal. This can have negative effects on scrollable views. Therefore, use the new `,(0,r.jsx)(t.a,{href:`/uilib/components/scroll-view`,children:`ScrollView`}),` component as the scrollable element.`]}),`
...
`,(0,r.jsxs)(t.li,{children:[`New fragment `,(0,r.jsx)(t.a,{href:`/uilib/components/scroll-view`,children:`ScrollView`}),`, used in `,(0,r.jsx)(t.a,{href:`/uilib/components/modal`,children:`Modal`}),` to fulfill the new Portal mode in the DrawerList scroll dependency inside of a Modal / Drawer.`]}),`
`]}),`
