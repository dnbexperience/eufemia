...
`,(0,r.jsxs)(t.li,{children:[`If you used `,(0,r.jsx)(t.code,{children:`style_type`}),`, like `,(0,r.jsx)(t.code,{children:`<H1 style_type="small">`}),` before, use rather `,(0,r.jsx)(t.code,{children:`<H1 size="x-large">`}),` and the same applies to `,(0,r.jsx)(t.code,{children:`<P style_type="small">`}),`, so use the `,(0,r.jsx)(t.code,{children:`modifier`}),` property here `,(0,r.jsx)(t.code,{children:`<P modifier="small">`})]}),`
...
`,(0,r.jsxs)(t.p,{children:[`We hope with that change we embrace `,(0,r.jsx)(t.a,{href:`/uilib/usage/accessibility/checklist`,children:`better accessibility`}),`.`]}),`
`,(0,r.jsx)(t.h2,{children:`New components`}),`
`,(0,r.jsxs)(t.ul,{children:[`
`,(0,r.jsxs)(t.li,{children:[(0,r.jsx)(t.a,{href:`/uilib/components/heading`,children:`Heading`}),` component to automated semantic headings.`]}),`
...
`,(0,r.jsxs)(t.li,{children:[`Also, the `,(0,r.jsx)(t.a,{href:`/uilib/components/drawer/`,children:`Modal`}),` has now a dark background color and both open and close animation`]}),`
...
`,(0,r.jsxs)(t.li,{children:[`Sortable `,(0,r.jsx)(t.a,{href:`/uilib/elements/tables`,children:`table`}),` header buttons supports now word-wrap by using `,(0,r.jsx)(t.code,{children:`wrap="true"`}),`.`]}),`
`,(0,r.jsxs)(t.li,{children:[(0,r.jsx)(t.a,{href:`/uilib/elements/tables`,children:`Table`}),` headers supports now `,(0,r.jsx)(t.code,{children:`small`}),` font-size (`,(0,r.jsx)(t.code,{children:`.dnb-table--small`}),`) as well as `,(0,r.jsx)(t.code,{children:`right`}),` and `,(0,r.jsx)(t.code,{children:`center`}),` aligned headers.`]}),`
`]}),`
