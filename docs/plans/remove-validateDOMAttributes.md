...
- [x] **AvatarGroup.tsx** — used `removeSpaceProps` (the spread object **and** the child-Avatar context value bypass `useSpacing`); kept the context value spacing-free; added a leak-guard test.
- [ ] Remaining `null`/`{}` sites: [DrawerList.tsx](packages/dnb-eufemia/src/fragments/drawer-list/DrawerList.tsx#L556) (3 of 4 calls), [Icon.tsx](packages/dnb-eufemia/src/components/icon/Icon.tsx#L374), [Space.tsx](packages/dnb-eufemia/src/components/space/Space.tsx#L160), [DialogContent.tsx](packages/dnb-eufemia/src/components/dialog/DialogContent.tsx#L118), and the remaining `null`/`{}` sites.
