...
if (0 && require.main === module && process.env.NODE_ENV !== 'test') {
  ...
  runFactory({
    ...
    tempalteFilePath: path.resolve(
      packpath.self(),
      // './content/pages/uilib/components/template.md' // we can not have a template inside here, else it will be a valid page
    ...
    processDestFilePath: path.resolve(
      packpath.self(),
      './content/pages/uilib/components'
    ),
  ...
  runFactory({
    ...
    tempalteFilePath: path.resolve(
      packpath.self(),
      // './content/pages/uilib/patterns/template.md' // we can not have a template inside here, else it will be a valid page
