...
- New component: [SidebarMenu](/uilib/extensions/sidebar-menu) for persistent navigation with switchable sections, deeply nested accordion groups, and declarative or data-driven composition.
