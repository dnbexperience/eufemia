...
- [Animation Principles](/quickguide-designer/animation-principles/): added visual guidance for motion character, easing, and common interface transitions.
...
- New component: [SidebarMenu](/uilib/components/sidebar-menu) for persistent navigation with switchable sections, deeply nested accordion groups, and declarative or data-driven composition.
