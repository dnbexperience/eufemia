...
Gatsby v4 uses socket.io v3 that has en [issue](https://github.com/socketio/socket.io/issues/3838) when running all visual tests in a batch locally on a development build. To mitigate it, we have installed a newer version of socket.io:
