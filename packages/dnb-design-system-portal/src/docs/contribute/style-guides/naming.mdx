...
**NB:** Existing React components use **snake case** (`on_click`) – but will be converted to use **camel case** in future releases. The reason was to support Web Components – but the support has been discontinued in [v10](/uilib/about-the-lib/releases/eufemia/v10-info/).
