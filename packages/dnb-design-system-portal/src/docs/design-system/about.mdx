...
With Eufemia, DNB can continually increase the product quality for both visual users and users relying on assistive technologies. It follows the industry and regulatory standards [UU Tilsynet](https://www.uutilsynet.no/) alongside [WCAG 2.1](https://www.w3.org/TR/WCAG21/).
...
Thank you to all who have contributed to building Eufemia. People who have contributed heavily to Eufemia are:
...
To ensure this transparency, the code on [GitHub](https://github.com/dnbexperience/eufemia) and the [Eufemia Portal](/) are made available without restrictions.

In summary – we experience that it:

- makes it possible for others and anyone who wants to contribute.
