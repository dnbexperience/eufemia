...
This is a list of all available icons, sorted by categories. It's a combined list where primary and secondary icons are shown together. You may be interested to [read more](/icons/details) about [the differences](/icons/primary) and [how to import](/icons/secondary#react-example-usage) them.
