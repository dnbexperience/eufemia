...
Eufemia SVG icons do simply inherit the used color. In case you do not use the [Icon component](/uilib/components/icon), you have to handle colors by yourself.
