...
contentTitle: 'Accessibility, Inclusiveness, and WCAG'
icon: 'accessibility'
redirect_from:
...
Use the Design Checklist Widget to review your work directly in Figma.

[Open the Design Checklist Widget in Figma](https://www.figma.com/community/widget/1668930550957206964/design-checklist-widget)
