...
icon: 'AnimationPrinciplesIcon'
order: 2
redirect_from:
  - /quickguide-designer/principles/animations
---

import MotionCharacter from './motion/MotionCharacter'
...
This is a proposal for discussion, based on the principles on this page. Motion should help people complete their task and feel in control, rather than ask for attention.

### A little character, a clear purpose

Larger bubbles mean more emphasis, not more animation. Select a quality to see what it means in an interface.

<MotionCharacter />

### Finding the balance

The filled part shows how strongly we want the named quality. These are proposed priorities, not measured percentages. Calm and focus get strong emphasis; energy and delight are used in moderation.

<MotionCharacter.Spectrums />
