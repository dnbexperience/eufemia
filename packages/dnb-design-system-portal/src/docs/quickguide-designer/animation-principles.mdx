...
These are proposals for discussion, based on the principles on this page. Motion should help people complete their task and feel in control, rather than ask for attention.

### Purpose before delight

Start with a reason, guide when it helps, and add delight sparingly.

<MotionCharacter />

### Purpose at the core

Read from the centre out: every motion needs purpose. Add guidance when it helps, and delight only as the outer finishing touch.

<MotionCharacter.Rings />
