...
contentTitle: 'Principles & Values'
icon: 'principles'
order: 1
redirect_from:
  - /quickguide-designer/principles
---
...
Check out the [Animation Principles](/quickguide-designer/animation-principles/) for how to use animations and micro-interactions in DNB applications.
