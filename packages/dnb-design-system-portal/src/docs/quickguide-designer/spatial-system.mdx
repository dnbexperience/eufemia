...
A good spatial system takes some of the guesswork out of layout decisions for designers and developers. It also makes it easier for others to understand the intentions of the designer when viewing design files.
