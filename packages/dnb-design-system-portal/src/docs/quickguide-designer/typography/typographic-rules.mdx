...
You can download the [DNB font files as a ZIP package](https://github.com/dnbexperience/eufemia/tree/main/packages/dnb-eufemia/assets/fonts/DNB.zip?raw=true) **Last update: November 8, 2020**.
