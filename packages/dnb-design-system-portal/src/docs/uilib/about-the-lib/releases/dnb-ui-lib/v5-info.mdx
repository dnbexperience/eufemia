...
The new [Number component](/uilib/components/number-format) is a ready to use DNB number formatter. Use it where over you have to display a number, a currency value, phone number, etc.
