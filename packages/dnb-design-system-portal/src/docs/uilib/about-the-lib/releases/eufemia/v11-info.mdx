...
> **Using AI to migrate?** Load [v11-migration-reference.md](./v11-migration-reference.md) for the complete rename reference, and set up the [Eufemia MCP server](/uilib/usage/first-steps/tools/#ai-assistance-and-mcp-server-beta) for live API docs. See [AI agent migration workflow](#ai-agent-migration-workflow) for the optimal approach.
...
1. Load **[v11-migration-reference.md](./v11-migration-reference.md)** — it contains every rename in a single, dense file optimized for AI consumption. Use it instead of reading all per-component sections.
...
See **[v11-migration-reference.md](./v11-migration-reference.md)** for the complete compact rename reference — it contains every v10 → v11 rename in dense table format, optimized for AI agents and automated migration tools.
