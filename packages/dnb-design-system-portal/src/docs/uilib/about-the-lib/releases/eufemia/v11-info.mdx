...
### ToggleButton: removed ToggleButtonComponent type

The `ToggleButtonComponent` type export has been removed. If you imported this type, use the inferred type from the default export instead:

```diff
-import type { ToggleButtonComponent } from '@dnb/eufemia/components/ToggleButton'
+import ToggleButton from '@dnb/eufemia/components/ToggleButton'
