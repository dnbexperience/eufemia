...
- If you relay on opening and closing a modal by mounting and unmounting the component (legacy behavior), you should change to using the `open` property instead.
