...
- Removed variant `radio-list`. Use [List](/uilib/components/list/) with `variant="radio"` for custom list-based radio layouts ([example](/uilib/extensions/forms/base-fields/Selection/#radio-with-list-composition)).
