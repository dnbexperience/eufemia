...
| `@dnb/eufemia/shared/component-helper`                                      | `@dnb/eufemia/shared/componentHelper`                                               | File renamed to camelCase                     |
...
The following functions have been removed from `@dnb/eufemia/shared/componentHelper`:
