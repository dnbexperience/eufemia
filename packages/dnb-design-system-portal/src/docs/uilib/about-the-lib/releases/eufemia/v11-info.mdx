...
#### Translations \{#helpbutton-translations\}
...
#### TypeScript types \{#autocomplete-typescript-types\}
...
#### DrawerListDataArrayObject \{#autocomplete-drawerlistdataarrayobject\}
...
#### Styling \{#dropdown-styling\}

- Replace CSS class `dnb-dropdown--opened` with `dnb-dropdown--open`.

#### DrawerListDataArrayObject \{#dropdown-drawerlistdataarrayobject\}

Data object property renames: `selected_value` → `selectedValue`, `suffix_value` → `suffixValue`, `search_content` → `searchContent`, `class_name` → `className`. See [DrawerList](#drawerlist) for details.

### [DrawerList](/uilib/components/fragments/drawer-list/)

#### Properties \{#drawerlist-properties\}
...
#### Styling \{#drawerlist-styling\}

- Replace CSS class `dnb-drawer-list--opened` with `dnb-drawer-list--open`.

#### DrawerListDataArrayObject \{#drawerlist-drawerlistdataarrayobject\}
...
#### Properties \{#inputmasked-properties\}
...
#### Properties \{#formlabel-properties\}
...
#### Properties \{#radiogroup-properties\}
...
#### Properties \{#textarea-properties\}
...
#### Properties \{#accordion-properties\}
...
#### Properties \{#accordiongroup-properties\}
...
#### Properties \{#accordionprovider-properties\}
...
#### Properties \{#definition-lists-properties\}
...
#### Properties \{#progressindicator-properties\}
...
#### Properties \{#paymentcard-properties\}
...
#### Translations \{#paymentcard-translations\}
...
#### Properties \{#divider-horizontal-rule-properties\}
...
#### Properties \{#flexitem-properties\}
...
#### TypeScript types \{#checkbox-typescript-types\}
...
#### Properties \{#modal-dialog-and-drawer-properties\}
...
#### Events \{#modal-dialog-and-drawer-events\}

- Replace `on_open` with `onOpen`.
- Replace `on_close` with `onClose`.
- Replace `on_close_prevent` with `onClosePrevent`.

#### TypeScript types \{#modal-dialog-and-drawer-typescript-types\}

- Replace `ModalPropTypes` with `ModalAllProps`.

#### Translations \{#modal-dialog-and-drawer-translations\}
...
#### Properties \{#modalheader-dialogheader-and-drawerheader-properties\}
...
#### Properties \{#modalheaderbar-dialognavigation-and-drawernavigation-properties\}

- Replace `shadow_class` with `shadowClass`.

### [Dialog.Body](/uilib/components/dialog/) and [Drawer.Body](/uilib/components/drawer/)

#### Properties \{#dialogbody-and-drawerbody-properties\}
...
#### Properties \{#h-heading-elements-properties\}
...
##### Events \{#tableclickablehead-events\}

- Replace `on_click` with `onClick`.

### [FormStatus](/uilib/components/form-status/)

#### Properties \{#formstatus-properties\}
...
#### TypeScript types \{#formstatus-typescript-types\}
...
#### TypeScript types \{#slider-typescript-types\}
...
#### Translations \{#timeline-translations\}
...
#### Translations \{#numberformat-translations\}
...
#### Removals \{#stepindicator-removals\}
...
#### Properties \{#stepindicator-properties\}
...
#### Translations \{#stepindicator-translations\}
...
#### Properties \{#togglebuttongroup-properties\}
...
#### Events \{#togglebuttongroup-events\}
...
#### Properties \{#globalstatus-properties\}
...
#### Translations \{#globalstatus-translations\}
...
##### Properties \{#globalstatuscreate-properties\}

- Replace `status_id` with `statusId`.

##### Events \{#globalstatuscreate-events\}
...
##### Properties \{#globalstatusremove-properties\}

- Replace `status_id` with `statusId`.
- Replace `buffer_delay` with `bufferDelay`.

##### Events \{#globalstatusremove-events\}
...
##### Properties \{#globalstatusadd-properties\}

- Replace `status_id` with `statusId`.

##### Events \{#globalstatusadd-events\}
...
##### Properties \{#globalstatusupdate-properties\}

- Replace `status_id` with `statusId`.

##### Events \{#globalstatusupdate-events\}
...
#### Translations \{#copyonclick-translations\}
...
#### Properties \{#component-helpers-properties\}
...
#### Properties \{#every-field-component-properties\}
...
#### Properties \{#fielddate-properties\}
...
#### Styling \{#fielddate-styling\}

- Replace CSS class `dnb-date-picker--opened` with `dnb-date-picker--open`.

### [Field.Expiry](/uilib/extensions/forms/feature-fields/Expiry/)

#### Properties \{#fieldexpiry-properties\}
...
#### Translations \{#fieldphonenumber-translations\}
...
#### Properties \{#fieldpostalcodeandcity-properties\}
...
#### Properties \{#fieldpassword-properties\}
...
#### Properties \{#wizardstep-properties\}
...
#### Properties \{#datacontextprovider-properties\}
...
#### Accordion \{#typed-event-handlers-accordion\}
...
#### Tabs \{#typed-event-handlers-tabs\}
...
#### ToggleButton \{#typed-event-handlers-togglebutton\}

| Prop       | Before                    | After                                      |
| ---------- | ------------------------- | ------------------------------------------ |
| `onChange` | `(...args: any[]) => any` | `(event: ToggleButtonChangeEvent) => void` |

#### ToggleButton.Group \{#typed-event-handlers-togglebuttongroup\}

| Prop       | Before                    | After                                           |
| ---------- | ------------------------- | ----------------------------------------------- |
| `onChange` | `(...args: any[]) => any` | `(event: ToggleButtonGroupChangeEvent) => void` |

#### DrawerList \{#typed-event-handlers-drawerlist\}
...
#### ProgressIndicator \{#typed-event-handlers-progressindicator\}
