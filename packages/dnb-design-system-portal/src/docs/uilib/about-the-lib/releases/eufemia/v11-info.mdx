...
- The `AutocompleteClearEvent`, `AutocompleteTypeEvent`, `AutocompleteFocusEvent`, `AutocompleteBlurEvent`, `AutocompleteChangeEvent`, and `AutocompleteSelectEvent` type names are unchanged.
- Replace `AutocompleteSubmitParams` with `AutocompleteSubmitEvent`.
...
- Replace `OnChangeParams` with `CheckboxChangeEvent`.
- Replace `OnClickParams` with `CheckboxClickEvent`.
