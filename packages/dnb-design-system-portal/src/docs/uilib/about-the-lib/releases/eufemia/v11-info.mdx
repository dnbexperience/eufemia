...
- Replace `thumbTitle` with `thumbAriaLabel`.
- Replace `addTitle` with `addAriaLabel`.
- Replace `subtractTitle` with `subtractAriaLabel`.

#### Translations

- Replace `Slider.addTitle` with `Slider.addAriaLabel`.
- Replace `Slider.subtractTitle` with `Slider.subtractAriaLabel`.
