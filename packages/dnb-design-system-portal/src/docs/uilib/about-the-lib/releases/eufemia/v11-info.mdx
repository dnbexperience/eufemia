...
- Replace `set_content_handler` with `onSetContent`.
- Replace `reset_content_handler` with `onResetContent`.
- Replace `reset_pagination_handler` with `onResetPagination`.
- Replace `end_infinity_handler` with `onEndInfinity`.
- Replace `setContentHandler` with `onSetContent`.
- Replace `resetContentHandler` with `onResetContent`.
- Replace `resetPaginationHandler` with `onResetPagination`.
- Replace `endInfinityHandler` with `onEndInfinity`.
