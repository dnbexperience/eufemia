...
- The `ModalTriggerAttributes` type has been removed. Use `TriggerProps` from `@dnb/eufemia` instead.
...
- The `PopoverTriggerAttributes` type has been removed. Use `triggerProps` instead of `triggerAttributes`.
