...
Do not use the deprecated APIs for new integrations. See the [Flex.Container migration guidance](/uilib/layout/flex/container/#legacy-compatibility-mode) for details.
