...
| `show_clear_button`                                              | _(optional)_ if set to `true`, a clear button is showed inside the input field. Defaults to `false`.                                                                                                                                      |
...
| `show_options_sr`                                                | _(optional)_ only for screen readers. Title of the button in order to show the suggestions / options. It is always present and when activating, it opens the DrawerList and sets the focus on it. Defaults to `Bla gjennom alternativer`. |
