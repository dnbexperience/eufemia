...
| `clear`                                                          | _(optional)_ if set to `true`, dropdown will have a clear-option to remove selected option as value.                                                                    |
| `clearValue`                                                     | _(optional)_ The value to use when clearing/emptying the field. Makes it possible for instance to provide any value when clearing the content.                          |
