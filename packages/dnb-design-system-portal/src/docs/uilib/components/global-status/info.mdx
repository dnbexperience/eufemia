...
But you can also make use of the Eufemia [Provider](/uilib/usage/customisation/provider-info) where you will be able to send the `globalStatus` to the underlying/wrapped components, like:
