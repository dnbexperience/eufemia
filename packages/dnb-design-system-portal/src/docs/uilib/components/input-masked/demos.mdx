...
### Mask with custom steps

Allows for the same input functionality as in the [DatePicker](/uilib/components/date-picker), but with your own defined steps.
