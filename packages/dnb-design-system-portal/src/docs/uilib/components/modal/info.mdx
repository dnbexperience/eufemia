...
**Deprecated:** This feature is deprecated. Please use [PortalRoot](/uilib/components/portal-root) instead for controlling where portal content appears in the DOM.
