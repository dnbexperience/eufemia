...
- [ISO 80000-1](https://www.iso.org/standard/76921.html) (formerly ISO 31-0) is a scientific/technical standard and **not a linguistic style guide**, so we don't use it for how we present numbers to end users on the web.
...
When using spaces as thousand separators, screen readers misinterpret numbers in English – for example: `45 804` → read as “45” and “804” instead of “forty-five thousand eight hundred and four.”
