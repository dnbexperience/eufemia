...
- `Stat.ColorizeBySign` wraps content and applies sign-based text color: green for positive values, red for negative values, and gray for zero. Negative zero (`-0`) is treated as negative.
