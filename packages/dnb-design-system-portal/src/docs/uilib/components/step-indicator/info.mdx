...
## Redesign after version 10.65.1
...
- Custom rendering of steps using the `on_item_render` and `on_render` prosp will no longer do anything of value, it will be the same as using the item's `title` prop.
