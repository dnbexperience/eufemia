...
- Removing the sidebar means the list of steps is not visible initially. Since this was always the case on small screens, it hopefully will not cause many issues.
