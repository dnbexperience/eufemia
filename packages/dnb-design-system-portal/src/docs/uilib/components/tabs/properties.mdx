...
| `align`                                 | _(optional)_ to align the tab list on the right side `align="right"`. Defaults to `left`.                                                                                                                                                                                              |
...
| `prerender`                             | _(optional)_ if set to `true`, the Tabs content will pre-render all contents. The visibility will be handled by using the `hidden` and `aria-hidden` HTML attributes. Can not be used in combination with `prevent_rerender`. Defaults to `false`.                                     |
