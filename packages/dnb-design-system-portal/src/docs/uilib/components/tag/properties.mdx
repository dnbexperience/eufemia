...
| `onClick`                               | _(optional)_ Callback on click. Turns tag into clickable variant.                                                                                                                                               |
| `onAdd`                                 | _(optional)_ Callback on click. Overrides `onClick`. Turns tag into addable variant.                                                                                                                            |
| `onRemove`                              | _(optional)_ Callback on click. Overrides `onClick` and `onAdd`. Turns tag into removable variant.                                                                                                              |
