...
| `variant`                               | _(optional)_ Possible values are `default`, `clickable`, `addable`, or `removable`. Defaults to `default`.                                                                                                      |
...
| `onClick`                               | _(optional)_ Callback on click. Used with `variant` other than `default`.                                                                                                                                       |
