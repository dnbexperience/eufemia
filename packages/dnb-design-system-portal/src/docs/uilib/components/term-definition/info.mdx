...
TermDefinition shows a short term definition using the Popover/Tooltip stack and an anchor-like trigger. It opens on click and can be focused by Tab and toggled with Enter/Space.
