...
- `clearFiles`: a function to clear the files of the Upload component. It can be useful when wanting to programatically clear the files of the Upload component at a given time.
