...
By modifying the file item object, one will change the given file item object, but also what's displayed for the given file in the file list of the Upload component.

<PropertiesTable props={FileItemProperties} />
