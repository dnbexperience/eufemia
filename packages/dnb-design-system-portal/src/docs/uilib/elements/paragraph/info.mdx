...
Both Paragraph and the [Span](/uilib/elements/span/) component have the same typography properties that uses the [typography helper classes](/uilib/typography/helper-classes/).
