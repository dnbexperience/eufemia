...
Both Span and the [Paragraph](/uilib/elements/paragraph/) component have the same typography properties that uses the [typography helper classes](/uilib/typography/helper-classes/).
