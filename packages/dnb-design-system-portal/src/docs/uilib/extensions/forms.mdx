...
- [Base fields](/uilib/extensions/forms/base-fields/) such as for String and Number fields.
- [Feature fields](/uilib/extensions/forms/feature-fields/) such as Email and PhoneNumber fields.
- [StepsLayout](/uilib/extensions/forms/advanced-blocks/StepsLayout/) to create stepped forms.
- [DataContext](/uilib/extensions/forms/create-component/DataContext/) for handling your data-set with your form fields.
