...
Optioanlly you can define a path to the block component. Fields inside the block will get this path as a prefix of their own path. This makes it possible to reuse the same block component in different contexts.
...
You can optioanlly define what the props of the nested fields should accecpt:
