...
Ensure you use the `/postal-codes` endpoint from Bring via your proxy API, returning a list of postal codes in the following format:
...
Use the context to create a validator.

You can use it as an `onChangeValidator` or `onBlurValidator` (recommended) validator, depending on your use case.
