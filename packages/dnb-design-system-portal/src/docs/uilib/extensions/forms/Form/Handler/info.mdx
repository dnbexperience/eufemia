...
- It will return the displayed value (including the mask) for [Number](/uilib/extensions/forms/base-fields/Number/) field as a string. Including:
  - [Currency](/uilib/extensions/forms/feature-fields/Currency/) field as a string.
