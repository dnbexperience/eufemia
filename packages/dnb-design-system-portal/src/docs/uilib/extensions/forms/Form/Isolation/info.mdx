...
In scenarios where you want to ensure users commit their changes in an isolated section before submitting the entire form, you can use the `preventUncommittedChanges` property. This will prevent form submission and prompt the user to commit any uncommitted changes first.
