...
When a field in the section has an error and the section has `validateFieldsInitially` set to true, the whole section will switch to edit mode. The errors will be shown.
