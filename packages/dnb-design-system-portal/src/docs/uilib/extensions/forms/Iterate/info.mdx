...
It is particularly useful when dealing with data that contains a varying number of entries, as the number of components on the screen depends on the number of entries in the data.
