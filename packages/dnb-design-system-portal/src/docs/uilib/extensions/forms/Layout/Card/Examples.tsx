  ...
  return (
    <ComponentBox scope={{ Layout }}>
      <Layout.Card>
        ...
        Suspendisse facilisis mi eu sem eleifend, eu eleifend nulla mattis.
        Sed iaculis, erat at posuere scelerisque, sapien metus ullamcorper
        tortor, et interdum augue tortor id eros.
      </Layout.Card>
    </ComponentBox>
  )
}
