...
Check the [Best Practices for formatting](/uilib/usage/best-practices/for-formatting/) page to see how its locale examples align with what this component renders.
