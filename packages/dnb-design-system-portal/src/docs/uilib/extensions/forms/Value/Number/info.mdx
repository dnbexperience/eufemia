...
For a locale-by-locale reference that pairs these components with their rendered output, see [Best Practices for formatting](/uilib/usage/best-practices/for-formatting/).
