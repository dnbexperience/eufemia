...
- Validation (like `minLength` on text fields) as well as advanced and complex [Ajv](https://ajv.js.org/) JSON schema validator (Ajv is like Joi or Yup – check out [some examples](/uilib/extensions/forms/Form/schema-validation)) support on both single fields and the whole data set.
...
- Parts of your form can be isolated from the rest of the form using the [Form.Isolation](/uilib/extensions/forms/Form/Isolation/) component.
