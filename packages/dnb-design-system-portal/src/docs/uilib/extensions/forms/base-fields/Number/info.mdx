...
`Field.Number` allows the user to enter only numbers (negative and positive) and decimal numbers.
...
Internally, it is user by e.g. [Field.Currency](/uilib/extensions/forms/feature-fields/Currency/).
