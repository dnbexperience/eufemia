...
| --------------------------------------- | --------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `decimalLimit`                          | `number`              | _(optional)_ Max number of decimals. Values with more decimals will be rounded. Defaults to `12`.                                                               |
...
| `currency`                              | `boolean` or `string` | _(optional)_ Currency code (ISO 4217) or `true` to use the default `NOK`. Uses two decimals by default.                                                         |
