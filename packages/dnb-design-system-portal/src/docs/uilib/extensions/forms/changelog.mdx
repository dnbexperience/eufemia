...
- Fixed widths of fields of [Field.DateOfBirth](/uilib/extensions/forms/feature-fields/DateOfBirth/).
- Fixed so [Field.Number](/uilib/extensions/forms/base-fields/Number/) will display error immediately when the input exceeds the maximum possible number.
- Fixed so [Field.Number](/uilib/extensions/forms/base-fields/Number/) will show formatted numbers in error messages.
