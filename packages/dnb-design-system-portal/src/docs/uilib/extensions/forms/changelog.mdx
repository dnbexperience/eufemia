...
- Added [Field.InstallmentDay](/uilib/extensions/forms/feature-fields/InstallmentDay/) and [Value.InstallmentDay](/uilib/extensions/forms/Value/InstallmentDay/) for selecting a day of the month for recurring payments, showing days 1–28 plus an optional "Last day of month" option.
