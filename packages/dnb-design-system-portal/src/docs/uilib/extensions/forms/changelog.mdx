...
- Added `rounding` to [Value.Number](/uilib/extensions/forms/Value/Number/) and [Value.Currency](/uilib/extensions/forms/Value/Currency/).
...
- Added `inheritVisibility` and `inheritVisibility` to [Value.SummaryList](/uilib/extensions/forms/Value/SummaryList/).
