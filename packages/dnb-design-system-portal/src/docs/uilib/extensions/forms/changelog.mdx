...
- Added [Form.SubmitConfirmation](/uilib/extensions/forms/Form/SubmitConfirmation/) to confirm a submit during or before sent
- Added [Value.Provider](/uilib/extensions/forms/Value/Provider/) to propagate value props down to Value components (e.g. `inheritVisibility`).
...
- Fixed error throwing when using [Iterate.useCount hook](/uilib/extensions/forms/Iterate/Count/) or [useData hook](/uilib/extensions/forms/Form/useData/) in Wizard without form id.
...
- Fixed max-width of card in [Wizard(StepIndicator)](/uilib/extensions/forms/Wizard/) by removing the max-width.
