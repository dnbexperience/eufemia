...
- [Field.PhoneNumber](/uilib/extensions/forms/feature-fields/PhoneNumber/) now emits values in pure E.164 format without spaces (e.g. `+4712345678` instead of `+47 12345678`). Auto-detects country codes from E.164 and `00`-prefixed values. Patterns and schemas must be updated to match.
