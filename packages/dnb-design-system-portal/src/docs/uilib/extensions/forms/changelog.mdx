...
- Fixed so there is no outline when `variant="basic"` in [Form.Section](/uilib/extensions/forms/Form/Section/) containers when used in [Wizard](/uilib/extensions/forms/Wizard/).

## 10.57.1

- Fixed so [Form.Card](/uilib/extensions/forms/Form/Card/) supports spacing properties.
