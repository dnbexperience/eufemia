...
When building your custom form components, preferably use the [Layout](/uilib/components/layout) component.

Read more about the [available sizes](/uilib/components/layout/#width-definitions) (`width`) you can use in your custom form components.
