...
| `onSubmit`        | _(optional)_ Will be called when the user submit the form (i.e by clicking a [SubmitButton](/uilib/extensions/forms/advanced-blocks/SubmitButton) component inside), with the data set as argument. |
