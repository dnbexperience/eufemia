...
`FieldBlock` is a reusable wrapper [for building](/uilib/extensions/forms/create-component/) [Field](/uilib/extensions/forms/fields) or [Value](/uilib/extensions/forms/Value) components.
