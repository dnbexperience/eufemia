...
It helps you to handle the value in a standardized way. It also provides a way to transform the value.
...
- `toInput` transforms the value before it is returned as the value. This applies whether the original source of the value is the value prop or the data context.
