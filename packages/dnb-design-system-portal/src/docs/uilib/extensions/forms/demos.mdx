...
<p>
  Base field components are targetting the data type they produce. They can
...
<p>
  Warpping fields with a DataContextProvider component lets them read and
...
<p>Here are some examples of validation properties of field components.</p>
