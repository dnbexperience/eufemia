...
import ListWizardLayoutComponents from './extended-features/Wizard/ListWizardLayoutComponents'
...
## [Wizard layout](/uilib/extensions/forms/extended-features/Wizard/Layout)

`Wizard.Layout` is a wrapper component for showing forms with a StepIndicator for navigation between several steps (multi-steps). It also includes components for navigating between steps.

Example using the [Wizard.Layout](/uilib/extensions/forms/extended-features/Wizard/Layout) for handling stepped layouts:
...
<ListWizardLayoutComponents size="small" />
...
./extended-features/Wizard/ListWizardLayoutComponents ./extended-features/Wizard/ListWizardLayoutComponents
