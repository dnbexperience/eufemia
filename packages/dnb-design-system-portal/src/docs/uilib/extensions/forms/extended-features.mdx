...
import ListWizardComponents from './extended-features/Wizard/ListWizardComponents'
...
## [Wizard layout](/uilib/extensions/forms/extended-features/Wizard/Container)

`Wizard.Container` is a wrapper component for showing forms with a StepIndicator for navigation between several steps (multi-steps). It also includes components for navigating between steps.

Example using the [Wizard.Container](/uilib/extensions/forms/extended-features/Wizard/Container) for handling stepped layouts:
...
./extended-features/Wizard/ListWizardComponents ./extended-features/Wizard/ListWizardComponents
