...
import ListStepsLayoutComponents from './extended-features/Steps/ListStepsLayoutComponents'
...
Steps.Layout is a wrapper component for showing forms with a StepIndicator for navigation between several steps. It also includes components for navigating between steps.

Example using the [Steps.Layout](/uilib/extensions/forms/extended-features/StepsLayout) for handling stepped layouts:
...
Here is a list of all available `Steps.*` components:
...
./extended-features/Steps/ListStepsLayoutComponents
