...
| `animate`       | `boolean`                   | _(optional)_ Define if the content should animate during show/hide.                                        |
| `element`       | `string` or `React.Element` | _(optional)_ Define the type of element. Defaults to `div`. Only for when `animate` is true.               |
