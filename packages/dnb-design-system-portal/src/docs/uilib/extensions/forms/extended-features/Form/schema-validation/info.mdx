...
You can also use the utility `JSONSchemaType` type, so you can validate your data types. This requires `strictNullChecks` in the `tsconfig` settings to be true.
