...
Examples of both the use of `elementPath` and Render Props in `Iterate.Array` can be found on [demos](/uilib/extensions/forms/extended-features/Iterate/Array/demos).
