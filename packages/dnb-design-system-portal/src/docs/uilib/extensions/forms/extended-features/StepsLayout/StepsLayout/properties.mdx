...
| `noAnimation`                           | `boolan`     | _(optional)_ Determines if the height animation for step items and the drawer button will run. Inherited from [StepIndicator](/uilib/components/step-indicator/properties) Defaults to `false`. |
