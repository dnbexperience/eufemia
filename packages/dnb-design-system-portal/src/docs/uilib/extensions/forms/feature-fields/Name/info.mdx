...
- Only letters and characters such as hyphens and spaces are allowed for first and last name (except company name, which can contain characters, letters and numbers, but [must consist of at least three letters from the Norwegian alphabet](https://lovdata.no/lov/1985-06-21-79/§2-1)).
