...
| `city`                                                                             | `object`  | _(optional)_ Properties for the [Field.String](/uilib/extensions/forms/base-fields/String/) component for city.        |
| `omitCityField`                                                                    | `boolean` | _(optional)_ Omits the city field. Defaults to `false`                                                                 |
