...
You can filter data by any given criteria. This is done by using the `filterData` method from:

- [useData](/uilib/extensions/forms/Form/useData/#filter-data)
- [getData](/uilib/extensions/forms/Form/getData/#filter-data)
...
or `filterSubmitData` property from:

- [Form.Handler](/uilib/extensions/forms/Form/Handler/) (for `onSubmit`)
