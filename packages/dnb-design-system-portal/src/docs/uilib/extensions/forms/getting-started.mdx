...
#### How to cstomize translations in a form
...
const myTranslations = {
  'nb-NO': { 'custom.string': 'Min egendefinert streng' },
...
Or custome them with the `<Translation />` component:
...
const myTranslations = {
  'nb-NO': {
    ...
    'custom.string': 'Min egendefinert streng',
  },
  'en-GB': {
