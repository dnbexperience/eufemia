...
It will disable all fields and show an indicator on the [NextButton](/uilib/extensions/forms/extended-features/Wizard/Buttons/) while the **step** is pending ([examples](/uilib/extensions/forms/extended-features/Wizard/Container/demos/)).
...
For monitoring and set your form errors, you can use the [useError](/uilib/extensions/forms/extended-features/Form/useError) hook.
...
- [Form.Appearance](/uilib/extensions/forms/extended-features/Form/Appearance/) for changing sizes (height) of e.g. input fields.
