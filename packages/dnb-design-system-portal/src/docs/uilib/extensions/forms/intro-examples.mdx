...
You can use the [Iterate](/uilib/extensions/forms/Iterate/) component to iterate over repeated data. It also lets you define aniamted containers, so you can easily switch between an edit and a view container.
