...
figmaUrl: 'https://www.figma.com/file/461cAN5Qc3Nks4ztZ9pjtM'
gitHubUrl: 'https://github.com/dnbexperience/eufemia/tree/main/packages/dnb-eufemia/src/extensions/payment-card'
showTabs: true
tabs:
  - title: Info
