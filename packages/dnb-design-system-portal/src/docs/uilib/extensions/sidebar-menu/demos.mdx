...
For a resizable desktop sidebar that can be dragged past its minimum width and restored from the same trigger, see [Dismissible desktop navigation](/uilib/extensions/sidebar-menu/info#dismissible-desktop-navigation).
