...
Prerendered applications can read the storage metadata rendered by Root or Data and restore the position before hydration. This avoids briefly showing the top of a long menu before moving to the selected item.
