...
import { SkipLinkExample } from 'Docs/uilib/usage/accessibility/Examples'
...
### CSS properties \{#drop-shadow-css-properties\}
...
### CSS properties \{#sharp-drop-shadow-css-properties\}
