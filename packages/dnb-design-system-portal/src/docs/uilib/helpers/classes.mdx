...
Adds a smaller, but sharper drop shadow, `box-shadow: 0 1px 6px rgba(0, 0, 0, 0.16)`, to the component. Designed for hovering boxes such as dropdown or calendar.
...
Makes some form components, like [Input](/uilib/components/input) react to small sized screens. But as this can have negative effects when enabled by default, you can enable this optionally using this helper class.
