...
Transforms a string from **snake_case** to [PascalCase](!/uilib/development/naming).
...
Transforms a string from **snake_case** to [camelCase](!/uilib/development/naming).
...
Transforms a string from **PascalCase** to [snake_case](!/uilib/development/naming).
...
Transforms a string from **PascalCase** to [kebab-case](!/uilib/development/naming).
