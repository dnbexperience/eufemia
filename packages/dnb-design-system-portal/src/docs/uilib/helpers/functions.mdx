...
```js
import { isTouchDevice } from '@dnb/eufemia/shared/componentHelper'
...
```js
import { toPascalCase } from '@dnb/eufemia/shared/componentHelper'
...
```js
import { toKebabCase } from '@dnb/eufemia/shared/componentHelper'
...
```js
import { filterProps } from '@dnb/eufemia/shared/componentHelper'
...
```js
import { makeUniqueId } from '@dnb/eufemia/shared/componentHelper'
...
```js
import { slugify } from '@dnb/eufemia/shared/componentHelper'
...
```js
import { checkIfHasScrollbar } from '@dnb/eufemia/shared/componentHelper'
...
```js
import { convertJsxToString } from '@dnb/eufemia/shared/componentHelper'
...
```js
import { InteractionInvalidation } from '@dnb/eufemia/shared/componentHelper'
