...
Use the [Asset CDN](/uilib/usage/assets/) when a web, native, or external
consumer needs public URLs for Eufemia fonts, icons, images, flags, browser
assets, or company logos.
