...
You can find the optimized files in the
[`@dnb/eufemia` source on <Icon icon={GithubLogo} size="default" /> GitHub](https://github.com/dnbexperience/eufemia/tree/main/packages/dnb-eufemia/assets/browser/dnb)
or use their public [stable and versioned CDN URLs](/uilib/usage/assets/). For
example:

```text
https://assets.eufemia.dnb.no/browser/dnb/favicon-32x32.png
https://assets.eufemia.dnb.no/v11.14.1/browser/dnb/favicon-32x32.png
```
