...
- **ui-theme-fonts**: includes only the `@font-face` and properties. You can find this package inside `/style/themes/ui/`.
...
+ import '@dnb/eufemia/style/themes/ui/ui-theme-tags.min.css'
```
