...
@use '@dnb/eufemia/style/dnb-ui-core.min.css' layer(eufemia);
@use '@dnb/eufemia/style/themes/theme-ui/ui-theme-components.min.css' layer(eufemia);
@use '@dnb/eufemia/style/themes/theme-ui/ui-theme-basis.min.css' layer(eufemia);

/* Import Tailwind base, theme and utilities layers */
@use 'tailwindcss/theme.css' layer(theme);
@use 'tailwindcss/utilities.css' layer(utilities);

/* Import Eufemia properties in Tailwind format */
@use '@dnb/eufemia/style/themes/theme-ui/properties-tailwind.css' layer(utilities);
```
