...
```css
@use url('@dnb/eufemia/style/dnb-ui-core.min.css');
@use url('@dnb/eufemia/style/themes/theme-ui/ui-theme-components.min.css');
@use url('@dnb/eufemia/style/themes/theme-ui/ui-theme-basis.min.css');
```
