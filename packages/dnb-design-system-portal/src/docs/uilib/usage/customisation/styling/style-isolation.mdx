...
```css
.mySelector .eufemia-scope--1_2_3 {
  background: #f0f0f0;
}
```
...
```scss
.mySelector [scope-placeholder] .myClass {
  background: #f0f0f0;
}
```
...
```css
.mySelector .eufemia-scope--1_2_3 .myClass {
  background: #f0f0f0;
}
```
