...
This section covers some of the needs out DNB productions has shown a need of.
...
Eufemia is a system that is build on top of brand-assets. This means, it should be possible to swap out or extend these brand-assets.
...
The Eufemia Portal (documentation) uses [`gatsby-plugin-eufemia-theme-handler`](https://github.com/dnbexperience/eufemia/tree/main/packages/gatsby-plugin-eufemia-theme-handler) to handle it both in development and production mode.
