...
### Theme.Context (no wrapper element)

Use `Theme.Context` when you need to provide theme to children without adding a wrapper element. This aligns with React 19's context-as-provider pattern.
