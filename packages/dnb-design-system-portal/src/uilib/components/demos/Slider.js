...
} from 'dnb-ui-lib/src/components/slider/Example'
import Description from 'dnb-ui-lib/src/components/slider/description.md'
import Details from 'dnb-ui-lib/src/components/slider/details.md'
import ExampleCode from 'raw-loader!../examples/Slider.txt'
...
export default class SliderDemo extends Component {
  ...
  render() {
    return <ItemWrapper {...SliderDemo.defaultProps} {...this.props} />
  }
}
