...
import * as globFilesModule from '../../../tools/globFiles'
import * as fs from 'fs-extra'
import { runFactory } from '../themeFactory'

jest.mock('../../../tools/globFiles', () => {
  const actual = jest.requireActual('../../../tools/globFiles')
  return { ...actual, globFiles: jest.fn(actual.globFiles) }
})
jest.mock('fs-extra', () => {
...
describe('runFactory', () => {
  it('has to find all related "ui" theme files', async () => {
    jest
      .spyOn(globFilesModule, 'globFiles')
      .mockResolvedValue([
