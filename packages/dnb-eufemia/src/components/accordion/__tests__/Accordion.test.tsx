...
describe('Accordion tertiary variant', () => {
  ...
  it('renders button-only tertiary accordion with an inline wrapper', () => {
    render(
      <p>
        Text{' '}
        <Accordion
  ...
  it('connects button and separate Accordion.Content via shared id', () => {
    ...
    expect(button.getAttribute('aria-expanded')).toBe('true')
    expect(
      content.querySelector('.dnb-height-animation--is-in-dom')
    ).toBeTruthy()
  ...
  it('does not focus content on pointer click', () => {
    ...
    expect(
      document
        .querySelector('.dnb-accordion__tertiary-content')
        .classList.contains('dnb-tab-focus')
    ).toBe(true)

    setInputIntent('mouse')
  ...
  it('focuses content on keyboard or screen reader activation', () => {
    render(
      <Accordion variant="tertiary" title="Toggle" noAnimation>
        <p>Content</p>
      </Accordion>
  ...
  it('does not focus standalone content on pointer click', () => {
    render(
      <>
        <Accordion
          variant="tertiary"
  ...
  it('focuses standalone content on keyboard or screen reader activation', () => {
    render(
      <>
        <Accordion
          variant="tertiary"
    ...
    expect(
      document
        .getElementById('focus-split-content')
        .classList.contains('dnb-tab-focus')
    ).toBe(true)
  ...
  it('renders standalone Accordion.Content as a section element', () => {
    ...
    expect(section.getAttribute('aria-label')).toBe('Details')
  })

  it('keeps standalone Accordion.Content wrapper in the DOM by default', () => {
    render(
      <>
        <Accordion
          variant="tertiary"
    ...
    const content = document.getElementById('default-keep-test-content')
  ...
  it('supports keepInDOM=false on standalone Accordion.Content', () => {
    ...
    const content = document.getElementById('keep-test-content')

    expect(content).toBeTruthy()
    expect(content.textContent).toBe('')
  })

  it('supports keepInDOM=true on standalone Accordion.Content', () => {
    render(
      <>
        <Accordion
          variant="tertiary"
  ...
  it('supports noAnimation on standalone Accordion.Content', () => {
    ...
    expect(
      document
        .querySelector(
          '.dnb-accordion__tertiary-content .dnb-height-animation'
        )
        .classList.contains('dnb-height-animation--parallax')
    ).toBe(false)
  })

  it('supports function children on standalone Accordion.Content', () => {
    render(
      <>
        <Accordion
          variant="tertiary"
    ...
    expect(
      document.getElementById('function-child-test-content').textContent
    ).toContain('Content')
  })
