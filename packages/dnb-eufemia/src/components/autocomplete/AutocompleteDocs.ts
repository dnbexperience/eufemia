...
export const AutocompleteProperties = {
  ...
  searchInWordIndex: {
    doc: 'This gives you the possibility to change the threshold number, which defines from what word on we search "inside words". Does not work together with `searchNumbers`. Defaults to `3`.',
    type: 'boolean',
    status: 'optional',
  },
  searchMatch: {
