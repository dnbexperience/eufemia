...
describe.each(['ui', 'sbanken'])('Avatar for %s', (themeName) => {
  ...
  describe('children', () => {
    it('should match icon of variant primary as children', async () => {
    ...
    it('should match icon of variant secondary as children', async () => {
      const screenshot = await makeScreenshot({
    ...
    it('should match icon of variant tertiary as children', async () => {
      const screenshot = await makeScreenshot({
    ...
    it('should match logo as children', async () => {
      const screenshot = await makeScreenshot({
  ...
  describe('size', () => {
    it('should match default size', async () => {
      const screenshot = await makeScreenshot({
    ...
    it('should match small size', async () => {
      const screenshot = await makeScreenshot({
    ...
    it('should match medium size', async () => {
      const screenshot = await makeScreenshot({
    ...
    it('should match large size', async () => {
      const screenshot = await makeScreenshot({
    ...
    it('should match x-large size', async () => {
      const screenshot = await makeScreenshot({
  ...
  describe('variant', () => {
    it('should match default variant', async () => {
      const screenshot = await makeScreenshot({
    ...
    it('should match primary variant', async () => {
      const screenshot = await makeScreenshot({
    ...
    it('should match secondary variant', async () => {
      const screenshot = await makeScreenshot({
    ...
    it('should match tertiary variant', async () => {
      const screenshot = await makeScreenshot({
  ...
  describe('src', () => {
    it('should match png image of local src', async () => {
      const screenshot = await makeScreenshot({
    ...
    it('should match svg image of local src', async () => {
      const screenshot = await makeScreenshot({
    ...
    it('should match image of external src', async () => {
      const screenshot = await makeScreenshot({
    ...
    it('should match image when passing imgProps', async () => {
      const screenshot = await makeScreenshot({
  ...
  describe('grouping', () => {
    it('should match grouping of small avatars', async () => {
      const screenshot = await makeScreenshot({
    ...
    it('should match grouping of medium avatars', async () => {
      const screenshot = await makeScreenshot({
    ...
    it('should match grouping of large avatars', async () => {
      const screenshot = await makeScreenshot({
    ...
    it('should match grouping of x-large avatars', async () => {
      const screenshot = await makeScreenshot({
    ...
    it('should match grouping of img avatars', async () => {
      const screenshot = await makeScreenshot({
    ...
    it('should match setting custom colors', async () => {
      const screenshot = await makeScreenshot({
    ...
    it('should match using country flag as a badge', async () => {
      const screenshot = await makeScreenshot({
