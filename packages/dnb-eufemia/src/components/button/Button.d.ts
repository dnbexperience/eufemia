...
import type { DataAttributeTypes, DynamicElement, SpacingProps } from '../../shared/types';
import type { FormStatusBaseProps } from '../FormStatus';
import type { AnchorProps } from '../Anchor';
export type ButtonText = string | React.ReactNode;
export type ButtonVariant = 'primary' | 'secondary' | 'tertiary' | 'signal' | 'unstyled';
...
export type ButtonIconPositionAll = 'left' | 'right' | ButtonIconPositionTertiary;
export type ButtonTooltip = string | (() => React.ReactNode) | React.ReactNode;
export type ButtonTo = string | ReactRouterLink['to'];
export type ButtonSkeleton = SkeletonShow;
export type ButtonChildren = string | (() => React.ReactNode) | React.ReactNode;
...
export type ButtonElement = DynamicElement<HTMLButtonElement | HTMLAnchorElement | AnchorProps> | React.ComponentType<ReactRouterLink & {
    ref?: React.Ref<HTMLAnchorElement>;
}> | React.ReactNode;
export type ButtonClickEvent = {
    event: React.MouseEvent<HTMLButtonElement | HTMLAnchorElement>;
};
export type ButtonOnClick = ((args: ButtonClickEvent) => void) | React.MouseEventHandler<HTMLButtonElement | HTMLAnchorElement> | ((...args: unknown[]) => void);
...
} & FormStatusBaseProps & Partial<DataAttributeTypes & Omit<Partial<React.HTMLAttributes<HTMLButtonElement | HTMLAnchorElement>>, 'onClick'>> & SpacingProps;
 ...
 */
declare class ButtonClass extends React.PureComponent<ButtonProps, ButtonState> {
    static contextType: React.Context<import("../../shared/Context").ContextProps>;
    context: React.ContextType<typeof Context>;
    _id: string | undefined;
    _ref: React.RefObject<HTMLElement | null>;
    static getContent(props: ButtonProps): any;
    constructor(props: ButtonProps);
    getOnClickHandler: (src: ButtonProps) => (event: React.MouseEvent<HTMLButtonElement | HTMLAnchorElement>) => void;
    render(): import("react/jsx-runtime").JSX.Element;
}
/**
 * Function wrapper that forwards `ref` to the inner DOM element of the class component.
 */
declare function Button({ ref, ...props }: ButtonProps): import("react/jsx-runtime").JSX.Element;
declare namespace Button {
    var getContent: typeof ButtonClass.getContent;
}
