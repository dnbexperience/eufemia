  ...
  describe('duration', () => {
    ...
    it('should work with relativeTime prop for actual dates while duration works automatically', () => {
      ...
      expect(dateFormat.textContent).toMatch(
        // eslint-disable-next-line security/detect-unsafe-regex -- test assertion against bounded rendered output; anchored alternation of literals, no untrusted input
