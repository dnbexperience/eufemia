...
export const DatePickerProperties: PropertiesTableProps = {
  ...
  alignPicker: {
    doc: 'Use `right` to change the preferred calendar alignment direction. Defaults to `left`. If the DatePicker is close to the edge of the screen, the alignment will change automatically to fit in the viewport.',
    type: 'string',
    status: 'optional',
  },
  skipPortal: {
