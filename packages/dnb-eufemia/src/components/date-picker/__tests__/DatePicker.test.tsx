...
describe('DatePicker component', () => {
  ...
  it('has correct state at startup', () => {
    ...
    expect(
      document.querySelector('.dnb-date-picker').className
    ).not.toContain('dnb-date-picker--opened')

    expect(document.querySelector('.dnb-date-picker').className).toContain(
      'dnb-date-picker--hidden'
    )
  })

  it('has a disabled attribute, once we set disabled to true', () => {
    render(<Component show_input disabled />)

    expect(
      document.querySelector('.dnb-date-picker__input')
  ...
  it('has correct state after "click" trigger', () => {
    ...
    expect(
      document.querySelector('.dnb-date-picker').className
    ).not.toContain('dnb-date-picker--hidden')
  ...
  it('will close the picker on reset', () => {
    ...
    fireEvent.click(document.querySelector('button[data-testid="reset"]'))
  ...
  it('will render the result of "on_days_render"', () => {
    ...
    expect(singleTd.className).toContain(customClassName)
  })
  ...
  it('has a reacting start date input with valid value', () => {
    ...
    rerender(
      <Component
        {...defaultProps}
        on_change={({ start_date }) => (changedStartDate = start_date)}
      />
    )
    ...
    rerender(<Component {...defaultProps} start_date="2019-01-03" />)
  ...
  it('has a working month correction', () => {
    ...
    // then check the new input value
    expect(dayElem.value).toBe(day)
    expect(monthElem.value).toBe(month)
    expect(yearElem.value).toBe(year)
  })
  ...
  it('has a working min and max date limitation', () => {
    ...
    // by default we have the start day
    expect(startElem.value).toBe('01')
  ...
  it('resets date correctly between interactions', () => {
    ...
    function changeState() {
      const elem = document.querySelector('input.dnb-input__input')[0]
      expect(elem.value).toBe('01')
  ...
  it('is displaying correct month', () => {
    ...
    fireEvent.click(
      document
        ...
        .querySelector('.dnb-date-picker__next button')
    )

    expect(
      document.querySelector('.dnb-date-picker__header__title')[1]
        .textContent
    ).toBe('mars 2019')
  })
  ...
  it('has to react on keydown events', async () => {
    ...
    expect(monthElem.value).toBe('02')
  ...
  describe('size', () => {
    it('has correct small size', () => {
      ...
      expect(document.querySelector('.dnb-date-picker--small')).toBeTruthy
    })
