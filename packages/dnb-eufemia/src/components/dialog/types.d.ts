...
import type { ModalFullscreen, ModalAlignContent, ModalContentMinWidth, ModalContentMaxWidth } from '../modal/types';
...
export interface DialogContentProps extends Omit<DialogActionProps, 'children'> {
    /**
     ...
     */
    modalContent?: React.ReactNode | ((props: DialogContentProps) => React.ReactNode);
    /**
