...
describe('Flex.Horizontal', () => {
  ...
  it('should contain given classes', () => {
    ...
    expect(element).toHaveClass(
      'dnb-space dnb-flex-container dnb-flex-container--css-gap dnb-flex-container--direction-horizontal dnb-flex-container--justify-flex-start dnb-flex-container--align-flex-start dnb-flex-container--spacing-small dnb-flex-container--wrap dnb-flex-container--row-gap-small dnb-flex-container--divider-space custom-class',
      { exact: true }
    )
  })
