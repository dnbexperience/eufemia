...
import type { InputInputAttributes, InputInputElement, InputSize, InputSubmitElement, InputSubmitButtonIcon, InputSuffix, InputChildren, InputProps } from '../Input';
...
export type InputMaskedMask = Array<RegExp | string> | ((value: string, options: Record<string, unknown>) => Array<RegExp | string>) | boolean | {
    mask: Mask | MaskFunction;
    pipe?: Pipe;
} | LooseMaskPair;
export type InputMaskedNumberMask = string | boolean | Record<string, unknown>;
export type InputMaskedCurrencyMask = string | boolean | Record<string, unknown>;
...
export type InputMaskedEventHandler = (payload: InputMaskedChange) => unknown;
export interface InputMaskedProps extends Omit<React.HTMLProps<HTMLInputElement>, 'ref' | 'placeholder' | 'label' | 'children' | 'onChange' | 'onFocus' | 'onBlur' | 'onSubmit' | 'size'>, SpacingProps, FormStatusBaseProps {
    /**
...
declare function InputMasked(props: InputMaskedProps): import("react/jsx-runtime").JSX.Element;
