...
export type ModalTriggerVariant = 'primary' | 'secondary' | 'tertiary' | 'signal';
...
export interface ModalProps extends ModalRootProps {
     ...
     */
    onClosePrevent?: ({ id, event, triggeredBy, close, }: {
        id?: string;
        event?: Event;
        triggeredBy?: string;
        close?: CloseHandler;
     ...
     */
    openModal?: (open?: (e: Event) => void, instance?: any) => () => void | void;
    /**
...
export interface ModalContentProps {
     ...
     * The content which will appear when triggering the modal/drawer.
     */
    modalContent?: React.ReactNode | ((props: ModalContentProps) => React.ReactNode);
    /**
