...
export type PaginationPlaceMakerBeforeContent = boolean;
export type PaginationMinWaitTime = string | number;
export type PaginationDisabled = boolean;
export type PaginationSkeleton = boolean;
export type PaginationMode = 'pagination' | 'infinity';
export type PaginationUseLoadButton = boolean;
export type PaginationItems = string | any[];
export type PaginationHideProgressIndicator = boolean;
...
export type PaginationInstancePlaceMakerBeforeContent = boolean;
export type PaginationInstanceMinWaitTime = string | number;
export type PaginationInstanceDisabled = boolean;
export type PaginationInstanceSkeleton = boolean;
export type PaginationInstanceMode = 'pagination' | 'infinity';
export type PaginationInstanceUseLoadButton = boolean;
export type PaginationInstanceItems = string | any[];
export type PaginationInstanceHideProgressIndicator = boolean;
...
export type InfinityMarkerPlaceMakerBeforeContent = boolean;
export type InfinityMarkerMinWaitTime = string | number;
export type InfinityMarkerDisabled = boolean;
export type InfinityMarkerSkeleton = boolean;
export type InfinityMarkerMode = 'pagination' | 'infinity';
export type InfinityMarkerUseLoadButton = boolean;
export type InfinityMarkerItems = string | any[];
export type InfinityMarkerHideProgressIndicator = boolean;
