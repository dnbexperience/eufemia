...
const PaginationProvider = (props: any) => {
  ...
  const rerenderTimeoutRef = useRef<ReturnType<typeof setTimeout>>()
  const resetContentTimeoutRef = useRef<ReturnType<typeof setTimeout>>()
  const resetInfinityTimeoutRef = useRef<ReturnType<typeof setTimeout>>()
