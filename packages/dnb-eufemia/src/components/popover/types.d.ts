...
export type PopoverTargetElement = React.ReactNode | React.RefObject<unknown> | HTMLElement | PopoverTargetElementObject;
export type PopoverResolvedTargetElement = HTMLElement | null | PopoverTargetElementObject;
export type PopoverTriggerRenderProps = React.HTMLAttributes<HTMLElement> & {
...
export type PopoverRenderable<T> = React.ReactNode | ((context: T) => React.ReactNode);
type PopoverOverlayProps = Omit<PopoverAllProps, 'children' | 'content' | 'title'>;
...
export type PopoverAllProps = PopoverPropsBase & Omit<React.HTMLProps<HTMLElement>, keyof PopoverPropsBase>;
