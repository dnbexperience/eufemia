...
describe('TableAccordion', () => {
  ...
  // @deprecated: Remove this test suite after v11
  describe('TableAccordion using deprecated "accordion" prop', () => {
    ...
    it('tr should not open on interactive element click', () => {
      ...
      jest
        ...
        .mockImplementationOnce(getSelection)
    ...
    it('chevron placement class should be set with accordionChevronPlacement', () => {
      ...
      const select = (
        i: number,
        list: NodeListOf<HTMLTableCellElement>
      ) => (i === -1 ? list[list.length - 1] : list[i])
      const getTh = (i: number) => {
        return select(
          i,
