...
describe('Typography element', () => {
  ...
  describe('responsiveAll', () => {
    it('does not add dnb-t__responsive-all-on class to Typography children', () => {
      render(
        <Typography.Context responsiveAll>
          <Typography>Responsive all text</Typography>
        </Typography.Context>
      )
      const element = document.querySelector('.dnb-p')

      expect(element.classList.contains('dnb-t__responsive-all-on')).toBe(
        false
      )
    })

    it('does not add dnb-t__responsive-all-off class to Typography children', () => {
      render(
        <Typography.Context responsiveAll={false}>
          <Typography>Non-responsive all text</Typography>
        </Typography.Context>
      )
      const element = document.querySelector('.dnb-p')

      expect(element.classList.contains('dnb-t__responsive-all-off')).toBe(
        false
      )
    })

    it('does not add dnb-t__responsive-all-on class to H elements', () => {
      render(
        <Typography.Context responsiveAll>
          <H1>Heading</H1>
        </Typography.Context>
    ...
    it('does not add dnb-t__responsive-all-on class to Heading component', () => {
      render(
        <Typography.Context responsiveAll>
          <Heading>Heading text</Heading>
        </Typography.Context>
    ...
    it('wraps children in a div with dnb-t__responsive-all-on class when responsiveAll is true', () => {
      render(
        <Typography.Context responsiveAll>
          <Typography>Wrapped text</Typography>
        </Typography.Context>
      )
      const wrapper = document.querySelector('.dnb-t__responsive-all-on')

      expect(wrapper.tagName).toBe('DIV')
    })

    it('wraps children in a div with dnb-t__responsive-all-off class when responsiveAll is false', () => {
      render(
        <Typography.Context responsiveAll={false}>
          <Typography>Wrapped text</Typography>
        </Typography.Context>
      )
      const wrapper = document.querySelector('.dnb-t__responsive-all-off')

      expect(wrapper.tagName).toBe('DIV')
    })

    it('does not wrap children in a div when responsiveAll is not set', () => {
      const { container } = render(
        <Typography.Context>
          <Typography>Unwrapped text</Typography>
        </Typography.Context>
      )
    ...
    it('does not wrap children in a div when responsiveAll equals the parent context value', () => {
      const { container } = render(
        <Typography.Context responsiveAll>
          <Typography.Context responsiveAll>
    ...
    it('wraps children in a new div when responsiveAll changes in nested context', () => {
      const { container } = render(
        <Typography.Context responsiveAll>
          <Typography.Context responsiveAll={false}>
            <Typography>Text</Typography>
      ...
      const outerDiv = container.querySelector('.dnb-t__responsive-all-on')
      const innerDiv = outerDiv.querySelector('.dnb-t__responsive-all-off')
