...
import type { GlobalErrorMessagesWithPaths, SubmitState, Path, EventStateObject, EventReturnWithStateObject, FieldProps, ValueProps, OnChange, OnSubmitParams, CountryCode, Identifier, Schema } from '../types';
...
export type EventListenerCall = {
    path?: Path;
    type?: 'onSubmit' | 'onBeforeSubmit' | 'onSubmitCall' | 'onSubmitRequest' | 'onBeforeCommit' | 'onAfterCommit' | 'onPathChange' | 'onMount' | 'onSetFieldError';
    callback: (params?: {
        value: unknown;
    } | {
        preventSubmit: () => void;
...
export interface ContextState {
    ...
    addSetShowAllErrorsRef?: React.RefObject<Array<(showAllErrors: boolean) => void>>;
    fieldDisplayValueRef?: React.RefObject<Record<Path, {
        type: 'field';
    ...
    registerSectionSchema?: (registration: SectionSchemaRegistration) => () => void;
