...
export const ProviderProperties: PropertiesTableProps = {
  ...
  asyncSubmitTimeout: {
    doc: 'The maximum time to display the submit indicator before it changes back to normal. In case something went wrong during submission. It also limits how long a field waits for an async `onChange` or validator before it clears its pending state. Defaults to 30s.',
    type: 'number',
    status: 'optional',
  },
  scrollTopOnSubmit: {
