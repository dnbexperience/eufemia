...
describe('Field.BankAccountNumber', () => {
  ...
  describe('should validate Norwegian bank account numbers', () => {
    const errorMessages = {
      errorBankAccountNumber: nb.BankAccountNumber.errorBankAccountNumber,
    ...
    it.each(validBankAccountNumbers)(
      ...
      (bankAccountNo) => {
        expect(
          norwegianBbanValidator(bankAccountNo, errorMessages)
        ).toBeUndefined()
      }
    )
    ...
    it.each(invalidBankAccountNumbers)(
      ...
      (bankAccountNo) => {
        const result = norwegianBbanValidator(bankAccountNo, errorMessages)
