...
describe('Field.Date', () => {
  ...
  it('should show required warning', async () => {
    ...
    await userEvent.keyboard('07122023')
  ...
  it('should show required warning in range mode', async () => {
    ...
    await userEvent.keyboard('0102202304052026')
    await userEvent.click(document.body)
  ...
  it('should support keyboard interactions in range mode when id includes start or end', async () => {
    ...
    await userEvent.keyboard('{Backspace}122024')
    await userEvent.click(endMonth)
    await userEvent.keyboard('{Backspace>2}2802')
    await userEvent.click(document.body)
  ...
  describe('validation', () => {
    ...
    it('should display date limit error messages based on locale', async () => {
      ...
      await userEvent.keyboard('{Backspace>2}31122024')
      await userEvent.click(document.body)
      ...
      await userEvent.click(day)
      await userEvent.keyboard('{Backspace>2}01022025')
      await userEvent.click(document.body)
    ...
    it('should display date limit error messages based on locale when in `range` mode', async () => {
      ...
      await userEvent.keyboard('{Backspace}31122024')
      await userEvent.click(endDay)
      await userEvent.keyboard('{Backspace}01022025')
      await userEvent.click(document.body)
    ...
    it('should display error when start date is after end date in range mode', async () => {
      ...
      await userEvent.click(startDay)
      await userEvent.keyboard('{Backspace>2}25')
      await userEvent.click(document.body)
      ...
      await userEvent.click(startDay)
      await userEvent.keyboard('{Backspace>2}15')
      await userEvent.click(document.body)
    ...
    it('should display error when end date is changed to be before start date in range mode', async () => {
      ...
      await userEvent.click(endDay)
      await userEvent.keyboard('{Backspace}10012025')
      await userEvent.click(document.body)
      ...
      await userEvent.click(endDay)
      await userEvent.keyboard('{Backspace}20012025')
      await userEvent.click(document.body)
  ...
  it('should show required error when reset clears to empty initial value', async () => {
    render(
      <Form.Handler>
    ...
    await waitFor(() => {
      expect(screen.getByText(nb.Date.errorRequired)).toBeInTheDocument()
    })
  ...
  it('should show required error when reset clears to empty initial value in range mode', async () => {
    render(
      <Form.Handler>
    ...
    await userEvent.click(startDay)
    await userEvent.keyboard('01082025')
    await userEvent.keyboard('15082025')
  ...
  it('should show error when reset restores an initial value outside minDate', async () => {
  ...
  it('should show error when reset restores an initial value outside maxDate', async () => {
  ...
  it('should update Form data context when clicking reset with initial value', async () => {
    ...
    // Inputs should show initial value
    expect(day.value).toBe('15')
  })
  ...
  it('should export `dateValidator`', async () => {
    ...
    await userEvent.click(day)
    await userEvent.keyboard('{Backspace}01')
    await userEvent.click(document.body)
    ...
    await userEvent.click(day)
    await userEvent.keyboard('{Backspace}03')
    await userEvent.click(document.body)
    ...
    await userEvent.click(day)
    await userEvent.keyboard('{Backspace}02012025')
    await userEvent.click(document.body)
  ...
  describe('minDate and maxDate', () => {
    ...
    describe('validation', () => {
      ...
      it('should display error messages if start date and end date is outside of `minDate` and `maxDate` in `range` mode', async () => {
        ...
        await userEvent.click(startDay)
        await userEvent.keyboard('{Backspace}3112202401022025')
        await userEvent.click(document.body)
  ...
  describe('required', () => {
    it('should show required error when not completing the date', async () => {
      ...
      await userEvent.click(startDay)
      await userEvent.keyboard('0101202')
      await userEvent.click(document.body)
    ...
    it('should show required error when not completing the date in range mode', async () => {
      ...
      await userEvent.click(endDay)
      await userEvent.keyboard('0202202')
      await userEvent.click(document.body)
    ...
    it('should not show required error when moving to next input when in range mode', async () => {
      ...
      await userEvent.click(startDay)
      await userEvent.keyboard('01012025')
      // Moving away from the range picker triggers blur validation.
      // Since the end date is still empty, the required-range error appears.
      await userEvent.click(document.body)
      ...
      await userEvent.click(endDay)
      await userEvent.keyboard('02022025')
      await userEvent.click(document.body)
