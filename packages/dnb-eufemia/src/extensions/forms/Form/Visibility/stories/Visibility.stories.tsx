...
import type { FilterDataHandlerParameters } from '../../../DataContext/Context'
...
const filterDataHandler = ({ props }: FilterDataHandlerParameters) => {
  return !('data-exclude-field' in props && props['data-exclude-field'])
}
