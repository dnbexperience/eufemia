...
describe('Value.InstallmentDate', () => {
  it('should render value', () => {
    render(<Value.InstallmentDate value={15} />)

    const element = document.querySelector(
      '.dnb-forms-value-installment-date'
    )
    expect(element).toHaveTextContent('15')
  })

  it('should render default label', () => {
    render(<Value.InstallmentDate value={1} />)
  ...
  it('should render custom label', () => {
    render(<Value.InstallmentDate label="Custom label" value={1} />)
  ...
  it('should render label when showEmpty is true', () => {
    render(<Value.InstallmentDate label="Day" showEmpty />)
  ...
  it('should work with Form.Handler data context', () => {
    render(
      <Form.Handler defaultData={{ installmentDay: 20 }}>
        <Value.InstallmentDate path="/installmentDay" />
      </Form.Handler>
    )
  ...
  it('should render value 31', () => {
    render(<Value.InstallmentDate value={31} />)
  ...
  it('should render last day label when value is "last"', () => {
    render(<Value.InstallmentDate value="last" />)
