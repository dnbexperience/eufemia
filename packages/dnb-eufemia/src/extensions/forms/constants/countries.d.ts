...
export type ContinentType = 'Asia' | 'Europe' | 'Africa' | 'Oceania' | 'Antarctica' | 'North America' | 'South America' | 'None';
export type CountryLang = keyof CountryType['i18n'];
export declare const prioritizedCountries: string[];
