declare const _default: {
    'da-DK': {
        ...
        Isolation: {
            ...
            preventUncommittedChangesText: string;
        };
        Step: {
            summaryTitle: string;
            stepHasError: string;
        ...
        NumberField: {
            errorMinimum: string;
            errorMaximum: string;
            errorExclusiveMinimum: string;
            errorExclusiveMaximum: string;
        ...
        Date: {
            ...
            errorInvalidStartDate: string;
            errorInvalidEndDate: string;
        };
        Expiry: {
            label: string;
            errorMonth: string;
        ...
        NationalIdentityNumber: {
            ...
            errorMinimumAgeValidator: string;
            errorMinimumAgeValidatorLength: string;
        };
        OrganizationNumber: {
            label: string;
            errorRequired: string;
