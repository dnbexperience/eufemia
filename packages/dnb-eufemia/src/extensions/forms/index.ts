...
/**
 * IMPORTANT: AJV is no longer imported by default in Eufemia Forms
 *
 * If you use JSON Schema validation (AJV schemas), you MUST:
 * 1. Import AJV: import Ajv from 'ajv/dist/2020'
 ...
 *
 * For new projects, consider using Zod schemas instead, which work without AJV.
 */
