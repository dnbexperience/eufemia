...
export default {
  title: 'Eufemia/Forms/PizzaDemoDraft',
}
        ...
        <StepsLayout>
          ...
          <StepsLayout.Step title="Delivery address">
            ...
            <Card stack>
              ...
              <Field.String label="First name" required />
              <Field.String label="Last name" required />
            </Card>
            ...
            <Card stack>
              ...
              <FieldBlock label="Address" width="large">
                <Flex.Horizontal>
                  <Field.String label="Street" width="medium" required />
                  <Field.Number label="Nr." width="small" required />
                </Flex.Horizontal>
              </FieldBlock>
