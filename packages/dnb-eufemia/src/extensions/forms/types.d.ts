...
import type { FormsTranslationFlat, FormsTranslationLocale } from './hooks/useTranslation';
...
export type Schema<Value = unknown> = AllJSONSchemaVersions<Value> | ZodSchema;
...
export type ValidatorWithCustomValidators<Value, FieldValidators extends Record<string, Validator<Value>>, ErrorMessages extends DefaultErrorMessages = DefaultErrorMessages> = (value: Value, additionalArgs: Omit<ReceiveAdditionalEventArgs<Value, ErrorMessages>, 'validators'> & {
...
export type DefaultErrorMessages = Partial<InternalErrorMessages> & Partial<DotNotationErrorMessages>;
...
export type StatusError = string | React.ReactElement | Error | FormError | Array<string | React.ReactElement | Error | FormError>;
...
export interface UseFieldProps<Value = unknown, EmptyValue = undefined | unknown, ErrorMessages extends DefaultErrorMessages = DefaultErrorMessages, ExtraValue extends ProvideAdditionalEventArgs = ProvideAdditionalEventArgs> extends DataValueReadWriteComponentProps<Value, EmptyValue>, AriaAttributes {
    /**
     ...
     * Public API. Should not be used internally.
     */
    transformOut?: (internal: Value | ExtraValue, additionalArgs?: unknown) => unknown;
    /**
...
export type FieldProps<Value = unknown, EmptyValue = undefined | unknown, ErrorMessages extends DefaultErrorMessages = DefaultErrorMessages, ExtraValue extends ProvideAdditionalEventArgs = ProvideAdditionalEventArgs> = UseFieldProps<Value, EmptyValue, ErrorMessages, ExtraValue> & SharedFieldBlockProps;
...
export type FieldPropsWithExtraValue<Value = unknown, ExtraValue extends ProvideAdditionalEventArgs = ProvideAdditionalEventArgs, EmptyValue = undefined | unknown, ErrorMessages extends DefaultErrorMessages = DefaultErrorMessages> = Omit<FieldProps<Value, EmptyValue, ErrorMessages, ExtraValue>, keyof DataValueWriteProps> & DataValueWriteProps<Value, EmptyValue, ExtraValue>;
