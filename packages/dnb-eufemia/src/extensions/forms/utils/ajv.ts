 ...
 */
export function ajvErrorsToOneFormError(errors?: ErrorObject[] | null): FormError | undefined {
 ...
 * @returns 
 */
export const ajvErrorsToFormErrors = (errors?: ErrorObject[] | null): Record<string, FormError> => (errors ?? []).reduce(
  (errors, ajvError) => {
    return {
      ...errors,
