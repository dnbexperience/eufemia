...
export const SidebarMenuResponsiveProviderProperties: PropertiesTableProps =
  {
    ...
    compactAt: {
      doc: 'Maximum available content width at which the inline menu becomes an icon rail that expands over adjacent content on interaction. Use an Eufemia breakpoint name or an explicit em value.',
      type: ['MediaQuerySizes', '`${number}em`'],
      status: 'optional',
    },
    compactOffset: {
...
export const SidebarMenuResponsiveInlineProperties: PropertiesTableProps =
  {
    ...
    compactWidth: {
      doc: 'Width reserved while the inline menu is compact.',
      type: 'CSSProperties["width"]',
      defaultValue: '"4rem"',
      status: 'optional',
    },
...
export const SidebarMenuResponsiveAsideProperties: PropertiesTableProps = {
  ...
  compactWidth: {
    doc: 'Width reserved while the inline sidebar is compact.',
    type: 'CSSProperties["width"]',
    defaultValue: '"4rem"',
    status: 'optional',
  },
