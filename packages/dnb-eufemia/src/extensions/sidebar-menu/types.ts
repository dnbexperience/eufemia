...
export type SidebarMenuItemData = {
  ...
  suffix?: ReactNode
  /** Additional properties passed to the Badge component. A nested notification variant is indicated on collapsible ancestor accordions. */
...
export type SidebarMenuContainerProps = {
  ...
  /** Controlled id of the selected item or page accordion. A selected page accordion opens when selection initializes or changes, regardless of stored open state, and can then be collapsed manually. Its ancestor accordions and section open automatically, but ancestors can remain collapsed with medium-weight labels to indicate that they contain the current page. */
  selectedItem?: string
  /**
