...
const file_txt_medium = (props?: IconSVGProps) => (
  <svg
  ...
  >
    ...
    <path
      fill="#000"
      d="M11.262 12h-5.3v1.2h1.9V19h1.5v-5.8h1.9zm6.346 7-2.02-3.6 1.93-3.4h-1.65l-1.05 2.11-1.01-2.11h-1.71l1.92 3.5-2.01 3.5h1.72l1.07-2.14 1.03 2.14zm6.046-7h-5.3v1.2h1.9V19h1.5v-5.8h1.9z"
    />
  </svg>
)
