...
const file_xls = (props?: IconSVGProps) => (
  <svg
  ...
  >
    ...
    <path
      fill="#000"
      d="m7.608 12.667-1.347-2.4L7.548 8h-1.1l-.7 1.407L5.075 8h-1.14l1.28 2.334-1.34 2.333H5.02l.714-1.427.686 1.427zm1.797-.8V8h-1v4.667h3.067v-.8zm4.625.867c1.026 0 1.673-.554 1.673-1.434 0-.693-.427-1.153-1.3-1.386l-.447-.12c-.4-.107-.553-.254-.553-.534 0-.3.26-.5.653-.5.34 0 .613.22.68.56l.853-.4c-.12-.586-.746-.986-1.546-.986-.96 0-1.64.58-1.64 1.386 0 .7.406 1.147 1.246 1.374l.447.12c.447.12.607.28.607.58 0 .32-.254.513-.674.513-.426 0-.653-.193-.88-.767l-.833.487q.372 1.108 1.713 1.107"
    />
  </svg>
)
