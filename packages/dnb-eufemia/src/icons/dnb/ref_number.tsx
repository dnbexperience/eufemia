...
const ref_number = (props?: IconSVGProps) => (
  <svg
  ...
  >
    ...
    <path
      fill="#000"
      d="M5.296 10.274H6.33l-.884-1.686c.528-.167.825-.582.825-1.194 0-.808-.522-1.277-1.42-1.277H3.195v4.157h.89V8.671h.446zM4.085 6.83h.623c.452 0 .66.178.66.564s-.208.564-.66.564h-.623zm5.362 0v-.713H6.894v4.157h2.553v-.713H7.785V8.558H9.21v-.713H7.785V6.83zm3.312 0v-.713h-2.554v4.157h.891V8.558h1.425v-.713h-1.425V6.83z"
    />
  </svg>
)
