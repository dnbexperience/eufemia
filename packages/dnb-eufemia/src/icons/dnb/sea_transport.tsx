...
const sea_transport = (props?: IconSVGProps) => (
  ...
  >
    <path
      ...
      strokeWidth={1.5}
      d="M12 7.51V3.996c0-.529-.21-1.036-.586-1.41A2 2 0 0 0 10 2H6a1.993 1.993 0 0 0-2 1.995v3.516m11 1.197L8.371 6.062a1 1 0 0 0-.742 0L1 8.708m1.239-.495 1.06 3.166m4.701-.4V5.991m5.761 2.222-1.108 3.31m.26-.777L8 9.496l-4.913 1.25M1 14c.5 0 .594-.015 1.113-.188a3.7 3.7 0 0 0 1.387-.837 3.033 3.033 0 0 0 4.5 0 3.033 3.033 0 0 0 4.5 0c.394.378.868.664 1.387.837S14.5 14 15 14M7 2h2"
    />
  </svg>
)
