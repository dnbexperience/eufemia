...
export default {
  'sv-SE': {
    ...
    PaymentCard: {
      ...
      text_status_blocked: 'Spärrat',
      text_status_expired: 'Utgånget',
      text_status_not_active: 'Inaktiv',
      text_status_new_order: 'Beställd',
      text_status_order_in_process: 'På väg',
      text_status_replaced: 'Ersatt',
