...
export default {
  ...
  '--carnegie-font-family-heading': "'ArizonaFlare', var(--font-family-default)",
  '--carnegie-color-ocean-green': '#00343e',
  '--carnegie-color-burgundy-red': '#5c0022',
  '--carnegie-color-noir-green': '#001114',
  '--carnegie-color-sea-green': '#007272',
  '--carnegie-color-noir-red': '#24000d',
  '--carnegie-color-sober-red': '#8e4049',
  '--carnegie-color-classic-beige': '#f6eae4',
  '--carnegie-color-pale-green': '#ccf0e7',
  '--carnegie-color-pale-red': '#ffdedb',
  '--font-family-default': "'DNB', sans-serif",
  '--font-family-heading': 'var(--carnegie-font-family-heading)',
  ...
  '--color-sea-green': 'var(--carnegie-color-ocean-green)',
