...
export default class AccordionGroup extends React.PureComponent {
  ...
  static getDerivedStateFromProps(props, state) {
    if (state._listenForPropChanges) {
      ...
      //   state.values = AccordionGroup.getValues(props)
      // }
  ...
  render() {
    ...
    const classes = classnames(
      'dnb-accordion-group',
      // status && `dnb-accordion-group__status--${status_state}`,
      // !label && 'dnb-accordion-group--no-label',
      // `dnb-accordion-group--${layout_direction}`,
      // 'dnb-form-component',
    ...
    const context = {
      ...
      //   // this is ued in the "constructor" inside the Accordion.js component
        ...
        <div className={classes}>
          ...
          >
            ...
            <span className="dnb-accordion-group__children">
              ...
              {/* {suffix && (
                  <span
                    className="dnb-accordion-group__suffix"
