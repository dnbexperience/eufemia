...
import _drawer_list from '../style/_drawer-list.scss' // eslint-disable-line
import dnb_drawer_list from '../style/dnb-drawer-list.scss' // eslint-disable-line
import dnb_drawer_list_theme_ui from '../style/themes/dnb-drawer-list-theme-ui.scss' // eslint-disable-line
...
const props = { id: 'drawer-list-id', value: 2 }
...
describe('DrawerList component', () => {
  ...
  it('has correct value on keydown "ArrowDown" and "Enter"', async () => {
    ...
    expect(Comp.find('.dnb-drawer-list__text__inner').text()).toBe(
  ...
  it('has correct value after forcing rerender', async () => {
    ...
    expect(Comp.find('.dnb-drawer-list__text__inner').text()).toBe(title)
  })
  ...
  it('has a default title if no value is given', () => {
    ...
    expect(
      Comp.find('.dnb-drawer-list__text__inner').instance().innerHTML
    ).toBe(title)
  })
  ...
  it('has a corret value content if we send in a React component', () => {
    ...
    expect(
      Comp1.find('.dnb-drawer-list__text__inner').instance().innerHTML
    ).toBe(aStringOf)
    expect(
      Comp2.find('.dnb-drawer-list__text__inner').instance().innerHTML
    ).toBe(aStringOf)
    expect(
      Comp3.find('.dnb-drawer-list__text__inner').instance().innerHTML
    ).toBe(aStringOf)
  })
  ...
  it('has a disabled attribute, once we set disabled to true', () => {
    ...
    expect(
      Comp.find('button.dnb-drawer-list__trigger')
        .instance()
