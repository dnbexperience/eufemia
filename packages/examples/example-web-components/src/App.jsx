...
// import Icon from 'dnb-ui-lib/es/components/icon' // alternative method to import dnb-ui-lib
// import Button from 'dnb-ui-lib/es/components/Button' // alternative method to import dnb-ui-lib
// import dnb from 'dnb-ui-lib/es/components' // alternative method to import dnb-ui-lib
// import 'dnb-ui-lib/es/components/Button/style' // Import only the button styles
// import 'dnb-ui-lib/es/components/Icon/style' // Import only the icon styles
// import 'dnb-ui-lib/es/components' // in case we only use web component version

import dnb from 'dnb-ui-lib/es/components/lib' // optional, import "dnb-ui-lib/es/components/web-components" to enable Web Components
import { Button, Input, Icon } from 'dnb-ui-lib/es/components'
import { H1, H2, P } from 'dnb-ui-lib/es/elements'
import { bell_medium as Bell } from 'dnb-ui-lib/es/icons'
