...
1.  Design System principles: a set of principles for users of the Design System.
1.  End-user principles: the principles upon which we build DNB products and services for our users.
1.  Brand values: located in the Brandbook.

### Design System Principles (Eufemia Principles)

1. Do not add bloat to the system; at the same time, do not let the system develop debt - old content that is no longer relevant.
...
1. Add content to the system like it is your last day - add comments, clear succinct descriptions to code and design files.
...
1. Focus more on communication than the tools of the trade - common language and understanding, frequent discussions, including all stakeholders.
1. Stay agnostic - code, data, and design file formats should remain as platform and application-independent as possible.
1. Comply with the [living system](/uilib/about-the-lib/living-system) principles as well as the [maintainability](/uilib/about-the-lib/maintainability) principles.
1. Test, test, test - continually test the system with its users to ensure it is relevant, usable, and achieves its goals.
...
**Curiosity**, **Responsibility**, and **Bravery**
