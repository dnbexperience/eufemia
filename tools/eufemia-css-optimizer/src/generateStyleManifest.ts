...
/** Every Element can emit these classes through spacing and skeleton props. */
const ELEMENT_RUNTIME_PREFIXES = new Set(['dnb-skeleton', 'dnb-space'])
...
function deriveFoundationPrefixes(
  ...
  const prefixes = new Set<string>(ELEMENT_RUNTIME_PREFIXES)
