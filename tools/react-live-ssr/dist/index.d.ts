...
declare const CodeEditor: {
  (props: Props$3): React.ReactElement
...
declare function LiveProvider({
  ...
  noInline,
  skipInitialRender,
}: PropsWithChildren<Props$2>): React.ReactElement
...
type Props$1<
  T extends React__default.ElementType = React__default.ElementType,
> = {
  Component?: T
