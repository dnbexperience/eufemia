...
metadata: https://eufemia.dnb.no/uilib/about-the-lib/releases/dnb-ui-lib/v5.8-info/metadata.json
---
...
- added `min_date` and `max_date` properties, with a event return of `is_valid_start_date` and `is_valid_end_date`
