...
version: 11.1.0
generatedAt: 2026-05-04T18:06:20.502Z
...
1. If you used `style_type`, like `<H1 style_type="small">` before, use rather `<H1 size="x-large">` and the same applies to `<P style_type="small">`, so use the `modifier` property here `<P modifier="small">`
