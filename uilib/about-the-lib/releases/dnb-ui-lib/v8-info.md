...
metadata: https://eufemia.dnb.no/uilib/about-the-lib/releases/dnb-ui-lib/v8-info/metadata.json
---
...
1. Add pure `trigger` property to [Modal & Drawer](/uilib/components/modal).
