...
metadata: https://eufemia.dnb.no/uilib/about-the-lib/releases/eufemia/v9-info/metadata.json
---
...
- Has now a deprecation warning when properties like `use_navigation`, `active_item`, `active_url`, `url`, `url_future` and `url_passed` are used.
...
- New useful properties added to `<Tabs content_style="..." />` to define a section style.
