...
version: 11.2.1
generatedAt: 2026-05-08T08:59:10.213Z
...
```tsx
render(<Avatar.Group label="Persons">
...
```tsx
render(<Avatar.Group label="Stocks">
...
```tsx
render(<Avatar.Group label="Companies">
...
```tsx
render(<Avatar.Group label="TV Shows">
...
```tsx
render(<Avatar.Group label="Dogs">
...
```tsx
render(<Avatar.Group label="Cities">
...
```tsx
render(<Avatar.Group label="Countries">
...
```tsx
render(<Avatar.Group label="Cars">
...
```tsx
render(<Avatar.Group label="Icons" variant="secondary">
...
```tsx
render(<Avatar.Group label="Logos">
      <Avatar>
...
```tsx
render(<Avatar.Group label="Icons">
...
```tsx
render(<Avatar.Group label="Icons">
      <Avatar variant="tertiary" src="/dnb/safari-pinned-tab.svg" alt="DNB Logo" />
    </Avatar.Group>)
```


```tsx
render(<Avatar.Group label="Banks">
      <Avatar src="/dnb/android-chrome-192x192.png" alt="DNB Logo" size="x-large" />
    </Avatar.Group>)
```


```tsx
render(<Avatar.Group label="Profiles">
      <Avatar src="/images/avatars/1501870.jpg" alt="Profile picture" size="large" />
    </Avatar.Group>)
```
...
```tsx
render(<Avatar.Group label="Employees" size="medium" maxElements={5}>
      <Avatar>Anders</Avatar>
      <Avatar>Bjørnar</Avatar>
      <Avatar>Cathrine</Avatar>
      <Avatar>Didrik</Avatar>
...
```tsx
render(<Avatar.Group label="Borrowers" size="large" variant="tertiary" maxElements={4}>
      <Avatar>Anders</Avatar>
      <Avatar>Bjørnar</Avatar>
      <Avatar>Cathrine</Avatar>
      <Avatar>Didrik</Avatar>
...
```tsx
render(<Avatar.Group label="Enemies" size="x-large" variant="secondary" maxElements={3}>
      <Avatar>Anders</Avatar>
      <Avatar>Bjørnar</Avatar>
      <Avatar>Cathrine</Avatar>
      <Avatar>Didrik</Avatar>
...
```tsx
render(<Avatar.Group label="Eufemia contributors" size="large" maxElements={5}>
...
```tsx
<Badge content={<CountryFlag iso="NO" size="xx-small" />} vertical="bottom" horizontal="right" variant="content">
    <Avatar.Group label="Persons">
      <Avatar size="small">A</Avatar>
    </Avatar.Group>
  </Badge>
<Badge content={<CountryFlag iso="NO" size="x-small" />} vertical="bottom" horizontal="right" variant="content">
    <Avatar.Group label="Persons">
      <Avatar size="medium">A</Avatar>
    </Avatar.Group>
  </Badge>
<Badge content={<CountryFlag iso="NO" size="medium" />} vertical="bottom" horizontal="right" variant="content">
    <Avatar.Group label="Persons">
      <Avatar size="large">A</Avatar>
    </Avatar.Group>
  </Badge>
<Badge content={<CountryFlag iso="NO" size="large" />} vertical="bottom" horizontal="right" variant="content">
    <Avatar.Group label="Persons">
