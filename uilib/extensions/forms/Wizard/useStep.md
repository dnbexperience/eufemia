...
version: 11.1.1
generatedAt: 2026-05-05T18:42:13.291Z
...
render(<Wizard.Container mode="loose">
...
```tsx
const onStepChange1 = (index, mode, {
  preventNavigation
}) => {
  console.log('onStepChange from Step1:', index, mode, typeof preventNavigation);
};
const onStepChange2 = (index, mode, {
  preventNavigation
}) => {
  console.log('onStepChange from Step2:', index, mode, typeof preventNavigation);
};
const onStepChange3 = (index, mode, {
  preventNavigation
}) => {
  console.log('onStepChange from Step3:', index, mode, typeof preventNavigation);
};
const Step1 = () => {
  Wizard.useStep(undefined, {
    onStepChange: onStepChange1
  });
  return <Wizard.Step title="Step 1">
              <Wizard.Buttons />
            </Wizard.Step>;
};
const Step2 = () => {
  ...
  return <Wizard.Step title="Step 2">
              <Wizard.Buttons />
            </Wizard.Step>;
};
const Step3 = () => {
  ...
  return <Wizard.Step title="Step 3">
              <Wizard.Buttons />
            </Wizard.Step>;
};
render(<Wizard.Container mode="loose">
