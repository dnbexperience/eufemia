...
version: 11.2.0
generatedAt: 2026-05-08T07:25:37.773Z
...
```tsx
render(<Field.Composition info="Info at the bottom" width="large">
...
```tsx
render(<Field.Composition label="A legend for the fieldset" width="large">
...
```tsx
render(<Field.Composition label="Label text" info="FieldBlock info">
...
```tsx
render(<Field.Composition error={new Error('Error at the bottom')} width="large">
      <Field.String label="Field A" width="stretch" />
      <Field.String label="Field B with a long label that wraps" width="medium" />
    </Field.Composition>)
```
...
```tsx
render(<Field.Composition label="Label text" align="center">
...
```tsx
render(<Field.Composition label="A legend for the fieldset" width="large" help={{
  title: 'Help title',
  content: 'Help content',
  open: true
}}>
      <Field.String label="Field label" help={{
    title: 'Help title',
    content: 'Help content',
    open: true
  }} />
      <Field.String label="Field label" width="stretch" help={{
    title: 'Help title',
    content: 'Help content',
    open: true
  }} />
...
render(<Flex.Stack>
        <Form.Card>
          ...
          <Field.Composition label={sixtyOneChars} help={{
      title: 'Help title',
      content: 'Help content'
    }}>
            <Field.String value="string" />
        ...
        <Form.Card>
          ...
          <Field.Composition label={sixtyOneCharsIncludingASpace} help={{
      title: 'Help title',
      content: 'Help content'
    }}>
            <Field.String value="string" />
        ...
        <Form.Card>
          ...
          <Field.Composition label={fiftyEightCharsIncludingASpace} help={{
      title: 'Help title',
      content: 'Help content'
    }}>
            <Field.String value="string" />
