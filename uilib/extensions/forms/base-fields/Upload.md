...
version: 11.5.0
generatedAt: 2026-06-03T07:21:25.001Z
...
- [Docs code](https://github.com/dnbexperience/eufemia/tree/main/packages/dnb-design-system-portal/src/docs/uilib/extensions/forms/base-fields/Upload)
...
Here is [an example](/uilib/extensions/forms/base-fields/Upload/#with-file-size-validation) of how to use the `fileHandler` property to validate file sizes.
