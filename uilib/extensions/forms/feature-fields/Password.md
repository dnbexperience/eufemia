...
version: 11.6.1
generatedAt: 2026-06-15T12:17:01.914Z
...
- [Docs code](https://github.com/dnbexperience/eufemia/tree/main/packages/dnb-design-system-portal/src/docs/uilib/extensions/forms/feature-fields/Password)
...
```json
{
  ...
  "entries": {
    ...
    "Password.ariaLabelHide": {
      "nb-NO": "Skjul passord",
      "en-GB": "Hide password",
      "sv-SE": "Dölj lösenord",
      "da-DK": "Skjul adgangskode"
    },
    "Password.ariaLabelShow": {
      "nb-NO": "Vis passord",
      "en-GB": "Show password",
      "sv-SE": "Visa lösenord",
      "da-DK": "Vis adgangskode"
    },
    "Password.errorRequired": {
      "nb-NO": "Du må fylle inn et passord.",
      "en-GB": "You must enter a password.",
      "sv-SE": "Du måste fylla i ett lösenord.",
      "da-DK": "Du skal udfylde en adgangskode."
    },
    "Password.label": {
      "nb-NO": "Passord",
      "en-GB": "Password",
