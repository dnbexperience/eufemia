---
metadata: https://eufemia.dnb.no/uilib/intro/03-accessibility/metadata.json
---
...
- [VisuallyHidden](/uilib/components/visually-hidden) hides text visually, while makes it available for screen readers. It's based on the helper HTML class `dnb-sr-only`.
...
<IntroFooter
  href="/uilib/intro/04-ux-handover"
  text="Next - UX handover"
/>
