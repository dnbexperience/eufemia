...
metadata: https://eufemia.dnb.no/uilib/usage/accessibility/screenreader/metadata.json
---
...
There are limitations to when or where you can use `aria-label`, `aria-labelledby`, and `aria-describedby` attributes, because they do not work consistently with all HTML elements.
