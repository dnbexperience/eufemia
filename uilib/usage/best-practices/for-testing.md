...
metadata: https://eufemia.dnb.no/uilib/usage/best-practices/for-testing/metadata.json
---
...
React Testing Library provides queries that allow you to find elements by their role, label, placeholder, text contents, display value, alt text, title, test ID (it is only recommended to use this after the other queries do not work for your use case).
