...
version: 11.5.0
generatedAt: 2026-06-03T07:21:25.093Z
...
Other formatting utilities like `formatNationalIdentityNumber`, `formatOrganizationNumber`, and `formatPhoneNumber` work the same way. See the [NumberFormat](/uilib/components/number-format/) docs for the full list.
