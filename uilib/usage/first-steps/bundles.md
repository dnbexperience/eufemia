...
metadata: https://eufemia.dnb.no/uilib/usage/first-steps/bundles/metadata.json
---
...
Requires React and ReactDOM to be loaded.
...
Requires React and ReactDOM to be loaded as a module resolution ([importmap](https://github.com/WICG/import-maps)). Uses ES modules (**NB:** That is the aim, right now it is also transpiled [for broad browser compatibility](/uilib/usage/#supported-browsers-and-platforms)).
...
_Note:_ Because React does not deliver an ESM bundle right now, we have to create our own.
